...
0,h=0;e="string"===typeof c?c.match(/^\/Date\((([\-+])?[0-9]+)(([\-+])([0-9]{2})([0-9]{2}))?\)\/$/):null;var m=function(a,b){a=String(a);for(b=parseInt(b,10)||2;a.length<b;)a="0"+a;return a},g={m:1,d:1,y:1970,h:0,i:0,s:0,u:0},u=function(a,b){0===a?12===b&&(b=0):12!==b&&(b+=12);return b};v=a.extend(!0,{},(r.formatter||{}).date,null!=this.p?r.getRes(t[this.p.locale],"formatter.date")||{}:{},v||{});void 0===v.parseRe&&(v.parseRe=/[#%\\\/:_;.,\t\s\-]/);v.masks.hasOwnProperty(b)&&(b=v.masks[b]);if(c&&
...
f;l++){switch(b[l]){case "M":e=a.inArray(c[l],v.monthNames);-1!==e&&12>e&&(c[l]=e+1,g.m=c[l]);break;case "F":e=a.inArray(c[l],v.monthNames,12);-1!==e&&11<e&&(c[l]=e+1-12,g.m=c[l]);break;case "n":g.m=parseInt(c[l],10);break;case "j":g.d=parseInt(c[l],10);break;case "g":g.h=parseInt(c[l],10);break;case "a":e=a.inArray(c[l],v.AmPm);-1!==e&&2>e&&c[l]===v.AmPm[e]&&(c[l]=e,g.h=u(c[l],g.h));break;case "A":e=a.inArray(c[l],v.AmPm),-1!==e&&1<e&&c[l]===v.AmPm[e]&&(c[l]=e-2,g.h=u(c[l],g.h))}void 0!==c[l]&&(g[b[l].toLowerCase()]=
...
b=g.getMinutes();c=g.getDate();u=g.getMonth()+1;e=g.getTimezoneOffset();l=g.getSeconds();f=g.getMilliseconds();var q=g.getDay(),n=g.getFullYear(),A=(q+6)%7+1,p=(new Date(n,u-1,c)-new Date(n,0,1))/864E5,w=5>A?Math.floor((p+A-1)/7)+1:Math.floor((p+A-1)/7)||(4>((new Date(n-1,0,1)).getDay()+6)%7?53:52),x={d:m(c),D:v.dayNames[q],j:c,l:v.dayNames[q+7],N:A,S:v.S(c),w:q,z:p,W:w,F:v.monthNames[u-1+12],m:m(u),M:v.monthNames[u-1],n:u,t:"?",L:"?",o:"?",Y:n,y:String(n).substring(2),a:12>h?v.AmPm[0]:v.AmPm[1],
...
d=r.getCell.call(this,a,b);c.treeGrid&&0<d.children("div.tree-wrap").length&&(d=d.children("span.cell-wrapperleaf,span.cell-wrapper"));return c.colModel[b].autoResizable?d.children("span."+c.autoResizing.wrapperClassName):d},enumEditableCells:function(b,c,d){var e=this.grid,g=this.rows,l=this.p;if(null==e||null==g||null==l||null==b||null==b.rowIndex||!b.id||!a.isFunction(d))return null;var f,g=l.colModel,h=g.length,m,u,q=b.rowIndex,n,A,p;f=e.fbRows;var w=(e=null!=f)?f[q]:null;e&&(b=this.rows[q]);
for(f=0;f<h&&(m=g[f],u=m.name,"cb"===u||"subgrid"===u||"rn"===u||(e&&!m.frozen&&(e=!1),n=(e?w:b).cells[f],A=a(n),A.hasClass("not-editable-cell")||(p=A.width(),!0===l.treeGrid&&u===l.ExpandColumn?(p-=A.children("div.tree-wrap").outerWidth(),A=A.children("span.cell-wrapperleaf,span.cell-wrapper").first()):p=0,u={rowid:b.id,iCol:f,iRow:q,cmName:u,cm:m,mode:c,td:n,tr:b,trFrozen:w,dataElement:A[0],dataWidth:p},m.edittype||(m.edittype="text"),m=m.editable,m=a.isFunction(m)?m.call(this,u):m,!0!==m||!1!==
d.call(this,u))));f++);},getEditedValue:function(b,c,d){var e,g,l=d?"text":"val",f=c.formatoptions||{};d=c.editoptions||{};var h=d.custom_value,m="[name="+r.jqID(c.name)+"]",u=a(this);switch(c.edittype){case "checkbox":e=["Yes","No"];"string"===typeof d.value&&(e=d.value.split(":"));e=b.find("input[type=checkbox]").is(":checked")?e[0]:e[1];break;case "text":case "password":case "textarea":case "button":b=b.find("input"+m+",textarea"+m);e=b.val();"date"===b[this.p.propOrAttr]("type")&&3===String(e).split("-").length&&
(b=f.newformat||u.jqGrid("getGridRes","formatter.date.newformat"),e=r.parseDate.call(this,"Y-m-d",e,b));break;case "select":b=b.find("select option:selected");d.multiple?(g=[],b.each(function(){g.push(a(this)[l]())}),e=g.join(",")):e=b[l]();break;case "custom":try{if(a.isFunction(h)){if(e=h.call(this,b.find(".customelement"),"get"),void 0===e)throw"e2";}else throw"e1";}catch(q){b=r.info_dialog,d=function(a){u.jqGrid("getGridRes",a)},c=d("errors.errcap"),f=d("edit.bClose"),"e1"===q&&b.call(this,c,
...
function(a,b){return null===B?e:null!==a&&null!==b?B(a,b):null!==u&&C?B(u,a):B(a)};this._equals=function(a,b){return 0===e._compare(a,b,1)};this._compare=function(a,b,c){void 0===c&&(c=1);void 0===a&&(a=null);void 0===b&&(b=null);if(null===a&&null===b)return 0;if(null===a&&null!==b)return 1;if(null!==a&&null===b)return-1;if("[object Date]"===w.call(a)&&"[object Date]"===w.call(b))return a<b?-c:a>b?c:0;l||"number"===typeof a||"number"===typeof b||(a=String(a),b=String(b));return a<b?-c:a>b?c:0};this._performSort=
function(){0!==p.length&&(g=e._doSort(g,0))};this._doSort=function(a,b){var c=p[b].by,d=p[b].dir,k=p[b].type,g=p[b].datefmt,l=p[b].sfunc;if(b===p.length-1)return e._getOrder(a,c,d,k,g,l);b++;c=e._getGroup(a,c,d,k,g);d=[];for(k=0;k<c.length;k++)for(l=e._doSort(c[k].items,b),g=0;g<l.length;g++)d.push(l[g]);return d};this._getOrder=function(b,d,g,f,k,v){var h=[],B=[],z="a"===g?1:-1,u,q;void 0===f&&(f="text");q="float"===f||"number"===f||"currency"===f||"numeric"===f?function(a){a=parseFloat(String(a).replace(m,
""));return isNaN(a)?Number.NEGATIVE_INFINITY:a}:"int"===f||"integer"===f?function(a){return a?parseFloat(String(a).replace(m,"")):Number.NEGATIVE_INFINITY}:"date"===f||"datetime"===f?function(a){return r.parseDate.call(c,k,a).getTime()}:a.isFunction(f)?f:function(b){b=null!=b?a.trim(String(b)):"";return l?b:b.toUpperCase()};a.each(b,function(a,b){u=""!==d?r.getAccessor(b,d):b;void 0===u&&(u="");u=q(u,b);B.push({vSort:u,index:a})});a.isFunction(v)?B.sort(function(a,b){a=a.vSort;b=b.vSort;return v.call(this,
...
0<=a.inArray(e,["0","false",c[1].toLowerCase()])&&(b=!1));return b},parseDataToHtml:function(b,c,e,d,g,l,f){var h=this,m=h.p,u=a(h),q,n,A,p,w,C,x,E=!1,y=[],t=!0===m.altRows?m.altclass:"",I=[],L=m.grouping?!0===m.groupingView.groupCollapse:!1,k=parseInt(m.rowNum,10),S,W=a.fn.jqGrid,ba=!0===m.treeGrid&&-1<m.treeANode?h.rows[m.treeANode].rowIndex+1:h.rows.length,ca=h.formatCol,ha=function(a,b,c,k,e,d){b=h.formatter(a,b,c,e,"add",d);return"<td role='gridcell' "+ca(c,k,b,e,a,d)+">"+b+"</td>"},ja=function(a,
b,c,k){return"<td role='gridcell' "+ca(b,c,"",null,a,!0)+"><input role='checkbox' type='checkbox' id='jqg_"+m.id+"_"+a+"' class='cbox' name='jqg_"+m.id+"_"+a+"'"+(k?" checked='checked' aria-checked='true'":" aria-checked='false'")+"/></td>"},da=function(a,b,c,k){c=(parseInt(c,10)-1)*parseInt(k,10)+1+b;return"<td role='gridcell' class='"+W.getGuiStyles.call(u,"rowNum","jqgrid-rownum")+"' "+ca(a,b,c,null,b,!0)+">"+c+"</td>"};1>=ba&&(m.rowIndexes={});"local"!==m.datatype||m.deselectAfterSort||(E=!0);
l&&(k*=l+1);for(l=0;l<Math.min(b,k);l++){p=c[l];w=e[l];C=null!=d?d[l]:w;q=1===g?0:g;n=1===(q+l)%2?t:"";E&&(A=m.multiselect?-1!==a.inArray(p,m.selarrrow):p===m.selrow);x=y.length;y.push("");for(q=0;q<m.colModel.length;q++)switch(S=m.colModel[q].name,S){case "rn":y.push(da(q,l,m.page,m.rowNum));break;case "cb":y.push(ja(p,q,l,A));break;case "subgrid":y.push(W.addSubGridCell.call(u,q,l+g));break;default:y.push(ha(p,w[S],q,l+g,C,w))}y[x]=h.constructTr(p,L,n,w,C,A);y.push("</tr>");m.rowIndexes[p]=ba;ba++;
m.grouping&&(I.push(y),m.groupingView._locgr||W.groupingPrepare.call(u,w,l),y=[]);y.length>m.maxItemsToJoin&&(y=[y.join("")])}m.grouping&&(f&&(m.groupingView._locgr=!0),y=[W.groupingRender.call(u,I,m.colModel.length,m.page,k)],r.clearArray(I));return y},getMethod:function(b){return this.getAccessor(a.fn.jqGrid,b)},extend:function(b){a.extend(a.fn.jqGrid,b);this.no_legacy_api||a.fn.extend(b)}});var d=r.clearArray,f=r.jqID,h=r.getGridComponentIdSelector,b=r.getGridComponentId,c=r.getGridComponent,e=
r.stripPref,l=r.randId,m=r.getAccessor,g=r.convertOnSaveLocally,u=r.stripHtml,w=r.htmlEncode,A=r.htmlDecode,q=r.mergeCssClasses,y=r.hasOneFromClasses,E=function(){var b=a.makeArray(arguments);b.unshift("");b.unshift("");b.unshift(this.p);return r.feedback.apply(this,b)};a.fn.jqGrid=function(g){var D=a.fn.jqGrid,z;if("string"===typeof g){z=D[g];if(!z)throw"jqGrid - No such method: "+g;return z.apply(this,a.makeArray(arguments).slice(1))}return this.each(function(){if(!this.grid){var v=this,z,A,G=a(v),
p=a.isFunction,C=a.isArray,F=a.extend,K=a.inArray,H=a.trim,N=a.each,Y=D.setSelection,X=D.getGridRes,T=p(n.fatalError)?n.fatalError:alert,x=g.locale||n.locale||"en-US",O=null!=t[x]&&"boolean"===typeof t[x].isRTL?t[x].isRTL?"rtl":"ltr":"ltr",aa=g.iconSet||n.iconSet||"jQueryUI",Q=g.guiStyle||n.guiStyle||"jQueryUI",I=function(a){return r.getIconRes(aa,a)},L=function(a,b){return q(r.getRes(r.guiStyles[Q],a),b||"")};null==g&&(g={datatype:"local"});void 0!==g.datastr&&C(g.datastr)&&(A=g.datastr,g.datastr=
...
plusicon:I("grouping.plus"),minusicon:I("grouping.minus")},ignoreCase:!0,cmTemplate:{},idPrefix:"",iconSet:aa,guiStyle:Q,locale:x,multiSort:!1,treeIcons:{commonIconClass:I("treeGrid.common"),plusLtr:I("treeGrid.plusLtr"),plusRtl:I("treeGrid.plusRtl"),minus:I("treeGrid.minus"),leaf:I("treeGrid.leaf")},subGridOptions:{commonIconClass:I("subgrid.common"),plusicon:I("subgrid.plus"),minusicon:I("subgrid.minus")}},n,{navOptions:F(!0,{commonIconClass:I("nav.common"),editicon:I("nav.edit"),addicon:I("nav.add"),
delicon:I("nav.del"),searchicon:I("nav.search"),refreshicon:I("nav.refresh"),viewicon:I("nav.view"),saveicon:I("nav.save"),cancelicon:I("nav.cancel"),buttonicon:I("nav.newbutton")},r.nav||{}),actionsNavOptions:F(!0,{commonIconClass:I("actions.common"),editicon:I("actions.edit"),delicon:I("actions.del"),saveicon:I("actions.save"),cancelicon:I("actions.cancel")},r.actionsNav||{}),formEditing:F(!0,{commonIconClass:I("form.common"),prevIcon:I("form.prev"),nextIcon:I("form.next"),saveicon:[!0,"left",I("form.save")],
closeicon:[!0,"left",I("form.undo")]},r.edit||{}),searching:F(!0,{commonIconClass:I("search.common"),findDialogIcon:I("search.search"),resetDialogIcon:I("search.reset"),queryDialogIcon:I("search.query")},r.search||{}),formViewing:F(!0,{commonIconClass:I("form.common"),prevIcon:I("form.prev"),nextIcon:I("form.next"),closeicon:[!0,"left",I("form.cancel")]},r.view||{}),formDeleting:F(!0,{commonIconClass:I("form.common"),delicon:[!0,"left",I("form.del")],cancelicon:[!0,"left",I("form.cancel")]},r.del||
{})},g||{}),S=function(a){var b=r.getRes(k,a);return void 0!==b?b:X.call(G,"defaults."+a)};k.recordpos=k.recordpos||("rtl"===k.direction?"left":"right");k.subGridOptions.openicon="rtl"===k.direction?I("subgrid.openRtl"):I("subgrid.openLtr");k.autoResizing.widthOfVisiblePartOfSortIcon=void 0!==k.autoResizing.widthOfVisiblePartOfSortIcon?k.autoResizing.widthOfVisiblePartOfSortIcon:"fontAwesome"===k.iconSet?13:12;k.datatype=void 0!==k.datatype?k.datatype:void 0!==z||null==k.url?"local":null!=k.jsonReader&&
...
e:e.name]=c;return b},ja=function(){var b={},c,k;this.p.rowIndexes=b;for(k=0;k<this.rows.length;k++)c=this.rows[k],a(c).hasClass("jqgrow")&&(b[c.id]=c.rowIndex)},da=function(){var b,c=k.colModel;b=k.cmNamesInputOrder;var e=k.additionalProperties,d=b.length,g,l,f,h;k.arrayReaderInfos={};g=k.arrayReaderInfos;for(h=0;h<d;h++)l=b[h],0>K(l,k.reservedColumnNames)&&!g.hasOwnProperty(l)&&(f=k.iColByName[l],void 0!==f?g[l]={name:c[f].name,index:f,order:h,type:0}:(f=k.iPropByName[l],void 0!==f?g[l]={name:c[f].name,
index:f,order:h,type:1}:l===(k.prmNames.rowidName||"rowid")&&(g[l]={index:f,type:2})));d=c.length;for(b=0;b<d;b++)l=c[b].name,0>K(l,k.reservedColumnNames)&&!g.hasOwnProperty(l)&&(g[l]={name:l,index:b,order:h,type:0},h++);d=e.length;for(b=0;b<d;b++)l=e[b],null==l||g.hasOwnProperty(l)||("object"===typeof l&&"string"===a.type(l.name)&&(l=l.name),g[l]={name:l,index:b,order:h,type:1},h++)},P=function(b){var c=a(this).data("pageX");c?(c=String(c).split(";"),c=c[c.length-1],a(this).data("pageX",c+";"+b.pageX)):
...
r.msiever();k.direction=H(k.direction.toLowerCase());-1===K(k.direction,["ltr","rtl"])&&(k.direction="ltr");fa=k.direction;a(O).insertBefore(v);G.removeClass("scroll").appendTo(O);z=a("<div class='"+L("gBox","ui-jqgrid")+"'></div>");a(z).attr({id:k.gBoxId,dir:fa}).insertBefore(O);a(O).attr("id",k.gViewId).appendTo(z);a("<div class='"+L("overlay","jqgrid-overlay")+"' id='lui_"+k.id+"'></div>").insertBefore(O);a("<div class='"+L("loading","loading")+"' id='load_"+k.id+"'>"+S("loadtext")+"</div>").insertBefore(O);
...
d.formatter,f,c||"add"):p(d.getCellBuilder)&&(d.cellBuilder=d.getCellBuilder.call(v,f,c||"add")))},la=function(b,c,e,g){var f=a(this),h=new Date,v=k.datatype,u="local"!==v&&k.loadonce||"xmlstring"===v||"jsonstring"===v,z=("xmlstring"===v||"xml"===v)&&a.isXMLDoc(b),B=k.localReader,q=m;if(b&&("xml"!==v||z)){-1!==k.treeANode||k.scroll?c=1<c?c:1:(M.emptyRows.call(this,!1,!0),c=1);u&&(d(k.data),d(k.lastSelectedData),k._index={},k.localReader.id="_id_");k.reccount=0;switch(v){case "xml":case "xmlstring":B=
k.xmlReader;q=r.getXmlData;break;case "json":case "jsonp":case "jsonstring":B=k.jsonReader}var n,A,G,w,x,J={},V,F=k.colModel,y=F.length,K,H,t,N,P,sa=k.arrayReaderInfos,X={},O=function(a){return function(b){b=b.getAttribute(a);return null!==b?b:void 0}},Y=function(a){return function(){var b=X[a];if(null!=b)return b=b.childNodes,0<b.length?b[0].nodeValue:void 0}};k.page=ea(q(b,B.page),k.page);k.lastpage=ea(q(b,B.total),1);k.records=ea(q(b,B.records));p(B.userdata)?k.userData=B.userdata.call(this,b)||
{}:z?q(b,B.userdata,!0).each(function(){k.userData[this.getAttribute("name")]=a(this).text()}):k.userData=q(b,B.userdata)||{};ta();var T={},L=k.additionalProperties,S=function(a){z&&"string"===typeof a&&(/^\w+$/.test(a)?T[a]=Y(a):/^\[\w+\]$/.test(a)&&(T[a]=O(a.substring(1,a.length-1))))};for(n=0;n<y;n++)if(J=F[n],K=J.name,"cb"!==K&&"subgrid"!==K&&"rn"!==K){G=z?J.xmlmap||K:"local"===v&&!k.dataTypeOrg||"json"===v||"jsonp"===v?J.jsonmap||K:K;!1!==k.keyName&&!0===J.key&&(k.keyName=K);if("string"===typeof G||
p(G))T[K]=G;S(K)}y=L.length;for(n=0;n<y;n++)H=L[n],"object"===typeof H&&null!=H&&(H=H.name),S(H);w=!1===k.keyName?p(B.id)?B.id.call(this,b):B.id:k.keyName;isNaN(w)?p(w)||(sa[K]&&(x=sa[K].order),z&&("string"===typeof w&&/^\[\w+\]$/.test(w)?w=O(w.substring(1,w.length-1)):"string"===typeof w&&/^\w+$/.test(w)&&(w=Y(w)))):x=Number(w);G=q(b,B.root,!0);if(B.row)if(1===G.length&&"string"===typeof B.row&&/^\w+$/.test(B.row)){v=[];t=G[0].childNodes;N=t.length;for(H=0;H<N;H++)P=t[H],1===P.nodeType&&P.nodeName===
B.row&&v.push(P);G=v}else G=q(G,B.row,!0);null==G&&C(b)&&(G=b);G||(G=[]);b=G.length;0<b&&0>=k.page&&(k.page=1);y=parseInt(k.rowNum,10);g&&(y*=g+1);var S=[],F=[],I,v=[];for(n=0;n<b;n++){I=G[n];A=B.repeatitems&&B.cell?q(I,B.cell,!0)||I:I;V=B.repeatitems&&(z||C(A));J={};X={};if(z&&!V&&null!=A)for(t=A.childNodes,N=t.length,H=0;H<N;H++)P=t[H],1===P.nodeType&&(X[P.nodeName]=P);for(K in sa)sa.hasOwnProperty(K)&&(H=sa[K],V?(t=A[H.order],z&&null!=t&&(t=t.textContent||t.text)):t=null!=T[K]&&"string"!==typeof T[K]?
T[K](A):q(A,"string"===typeof T[K]?T[K]:H.name),1===H.type&&(H=L[H.index],null!=H&&p(H.convert)&&(t=H.convert(t,A))),void 0!==t&&(J[K]=t));void 0!==J[w]?I=void 0!==J[w]?J[w]:l():(I=q(I,C(I)?x:w),void 0===I&&(I=q(A,C(A)?x:w)),void 0===I&&(I=l()));I=String(I);V=k.idPrefix+I;k.treeGrid&&za(J);if(n<y)F.push(V),S.push(A),v.push(J);else if(!u)break;if(u||!0===k.treeGrid)J._id_=I,k.data.push(J),k._index[J._id_]=k.data.length-1}c=r.parseDataToHtml.call(this,b,F,v,S,c,g,u);ta(!0);g=-1<k.treeANode?k.treeANode:
...
v[n],S[n]);k.totaltime=new Date-h;0<n&&0===k.records&&(k.records=b);d(c);if(!0===k.treeGrid)try{D.setTreeNode.call(f,g+1,n+g+1)}catch(W){}k.reccount=Math.min(b,y);k.treeANode=-1;k.userDataOnFooter&&D.footerData.call(f,"set",k.userData,!0);u&&(k.records=b,k.lastpage=Math.ceil(b/y));e||this.updatepager(!1,!0);pa.call(this)}},wa=function(){function b(a){var c=0,e,d,g,f,h,m,v;if(null!=a.groups){(d=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&w.orBegin();for(e=0;e<a.groups.length;e++){0<
c&&d&&w.or();try{b(a.groups[e])}catch(u){T(u)}c++}d&&w.orEnd()}if(null!=a.rules)try{(g=a.rules.length&&"OR"===a.groupOp.toString().toUpperCase())&&w.orBegin();for(e=0;e<a.rules.length;e++)h=a.rules[e],f=a.groupOp.toString().toUpperCase(),A[h.op]&&h.field?(0<c&&f&&"OR"===f&&(w=w.or()),v=l[h.field],m=v.reader,w=A[h.op](w,f)(p(m)?'jQuery.jgrid.getAccessor(this,jQuery("'+k.idSel+'")[0].p.colModel['+v.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+m+"')",h.data,l[h.field])):null!=k.customSortOperations&&
null!=k.customSortOperations[h.op]&&p(k.customSortOperations[h.op].filter)&&(w=w.custom(h.op,h.field,h.data)),c++;g&&w.orEnd()}catch(D){T(D)}}var c=a(this),e=k.multiSort?[]:"",d=[],g=!1,l={},f=[],h=[],m,v,u,z=X.call(G,"formatter.date");if(!C(k.data))return{};var B=k.grouping?k.groupingView:!1,q,n;N(k.colModel,function(a){var b=this.index||this.name;v=this.sorttype||"text";l[this.name]={reader:k.dataTypeOrg?this.name:this.jsonmap||this.name,iCol:a,stype:v,srcfmt:"",newfmt:"",sfunc:this.sortfunc||null};
if("date"===v||"datetime"===v)this.formatter&&"string"===typeof this.formatter&&"date"===this.formatter?(m=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:z.srcformat,u=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:z.newformat):m=u=this.datefmt||"Y-m-d",l[this.name].srcfmt=m,l[this.name].newfmt=u;if(k.grouping)for(n=0,q=B.groupField.length;n<q;n++)this.name===B.groupField[n]&&(f[n]=l[b],h[n]=b);k.multiSort?this.lso&&(e.push(this.name),
...
k.data);k.ignoreCase&&(w=w.ignoreCase());if(!0===k.search){var J=k.postData.filters;if(J)"string"===typeof J&&(J=r.parse(J)),b(J);else try{w=A[k.postData.searchOper](w)(k.postData.searchField,k.postData.searchString,l[k.postData.searchField])}catch(x){}}if(k.grouping)for(n=0;n<q;n++)w.orderBy(h[n],B.groupOrder[n],f[n].stype,f[n].srcfmt);k.multiSort?N(e,function(a){w.orderBy(this,d[a],l[this].stype,l[this].srcfmt,l[this].sfunc)}):e&&k.sortorder&&g&&("DESC"===k.sortorder.toUpperCase()?w.orderBy(k.sortname,
"d",l[e].stype,l[e].srcfmt,l[e].sfunc):w.orderBy(k.sortname,"a",l[e].stype,l[e].srcfmt,l[e].sfunc));k.lastSelectedData=w.select();var J=parseInt(k.rowNum,10),V=k.lastSelectedData.length,F=parseInt(k.page,10),E=Math.ceil(V/J),y={};if(k.grouping&&k.groupingView._locgr){k.groupingView.groups=[];var K,H,t;if(k.footerrow&&k.userDataOnFooter){for(H in k.userData)k.userData.hasOwnProperty(H)&&(k.userData[H]=0);t=!0}for(K=0;K<V;K++){if(t)for(H in k.userData)k.userData.hasOwnProperty(H)&&(k.userData[H]+=parseFloat(k.lastSelectedData[K][H]||
0));D.groupingPrepare.call(c,k.lastSelectedData[K],K,J)}}l=w=null;c=k.localReader;y[c.total]=E;y[c.page]=F;y[c.records]=V;y[c.root]=k.lastSelectedData.slice((F-1)*J,F*J);y[c.userdata]=k.userData;return y},Aa=function(b){var c=b.outerWidth();0>=c&&(c=a(this).closest(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px",a(document.body).append("<div id='testpg' class='"+L("gBox","ui-jqgrid")+"' style='font-size:"+c+";visibility:hidden;margin:0;padding:0;' ></div>"),a(b).clone().appendTo("#testpg"),
c=a("#testpg>.ui-pg-table").width(),a("#testpg").remove());0<c&&b.parent().width(c);return c},ua=function(){this.grid.hDiv.loading=!0;k.hiddengrid||D.progressBar.call(a(this),{method:"show",loadtype:k.loadui,htmlcontent:S("loadtext")})},va=function(){this.grid.hDiv.loading=!1;D.progressBar.call(a(this),{method:"hide",loadtype:k.loadui})},qa=function(b){var c=this,e=a(c),g=c.grid;if(!g.hDiv.loading){var l=k.scroll&&!1===b,f={},h,m=k.prmNames;0>=k.page&&(k.page=Math.min(1,k.lastpage));null!==m.search&&
(f[m.search]=k.search);null!==m.nd&&(f[m.nd]=(new Date).getTime());if(isNaN(parseInt(k.rowNum,10))||0>=parseInt(k.rowNum,10))k.rowNum=k.maxRowNum;null!==m.rows&&(f[m.rows]=k.rowNum);null!==m.page&&(f[m.page]=k.page);null!==m.sort&&(f[m.sort]=k.sortname);null!==m.order&&(f[m.order]=k.sortorder);null!==k.rowTotal&&null!==m.totalrows&&(f[m.totalrows]=k.rowTotal);var u=p(k.loadComplete),z=u?k.loadComplete:null,B=0;b=b||1;1<b?null!==m.npage?(f[m.npage]=b,B=b-1,b=1):z=function(a){k.page++;g.hDiv.loading=
!1;u&&k.loadComplete.call(c,a);qa.call(c,b-1)}:null!==m.npage&&delete k.postData[m.npage];if(k.grouping){D.groupingSetup.call(e);var q=k.groupingView,n,A="",G,w,J;for(n=0;n<q.groupField.length;n++){G=q.groupField[n];for(w=0;w<k.colModel.length;w++)J=k.colModel[w],J.name===G&&J.index&&(G=J.index);A+=G+" "+q.groupOrder[n]+", "}f[m.sort]=A+f[m.sort]}F(k.postData,f);var x=k.scroll?c.rows.length-1:1,V=function(){var a=e.width(),b=e.closest(".ui-jqgrid-view").width(),c=e.css("height");b<a&&0===k.reccount?
...
("left"===k.pagerpos?"margin-right:auto;":"right"===k.pagerpos?"margin-left:auto;":"margin-left:auto;margin-right:auto;")+"' class='ui-pg-table'><tbody><tr>",u="",D,z,B,q,n=function(a,b,c){if(!E.call(v,"onPaging",a,{newPage:b,currentPage:ea(k.page,1),lastPage:ea(k.lastpage,1),currentRowNum:ea(k.rowNum,10),newRowNum:c}))return!1;k.selrow=null;k.multiselect&&(d(k.selarrrow),sa.call(v,!1));d(k.savedRow);return!0};c+="_"+b;D="pg_"+b;z=b+"_left";B=b+"_center";q=b+"_right";a("#"+f(b)).append("<div id='"+
D+"' class='ui-pager-control' role='group'><table "+(ka?"cellspacing='0' ":"")+"class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;'><tbody><tr><td id='"+z+"' style='text-align:left;'></td><td id='"+B+"' style='text-align:center;white-space:pre;'></td><td id='"+q+"' style='text-align:right;'></td></tr></tbody></table></div>").attr("dir","ltr");D="#"+f(D);if(0<k.rowList.length){u="<td dir='"+fa+"'>";z=S("pgrecs");u+="<select class='"+L("pagerSelect","ui-pg-selbox")+"' role='listbox' "+
(z?"title='"+z+"'":"")+">";for(z=0;z<k.rowList.length;z++)B=k.rowList[z].toString().split(":"),1===B.length&&(B[1]=B[0]),u+='<option role="option" value="'+B[0]+'"'+(ea(k.rowNum,0)===ea(B[0],0)?' selected="selected"':"")+">"+B[1]+"</option>";u+="</select></td>"}"rtl"===fa&&(m+=u);!0===k.pginput&&(h="<td dir='"+fa+"'>"+r.format(S("pgtext")||"","<input class='"+L("pagerInput","ui-pg-input")+"' type='text' size='2' maxlength='7' value='0' role='textbox'/>","<span id='sp_1_"+b+"'>0</span>")+"</td>");
b="#"+f(b);if(!0===k.pgbuttons){B=["first","prev","next","last"];var G=L("pagerButton","ui-pg-button");q=function(a){var b=S("pg"+a);return"<td role='button' tabindex='0' id='"+a+c+"' class='"+G+"' "+(b?"title='"+b+"'":"")+"><span class='"+I("pager."+a)+"'></span></td>"};"rtl"===fa&&B.reverse();for(z=0;z<B.length;z++)m+=q(B[z]),1===z&&(m+=""!==h?l+h+l:"")}else""!==h&&(m+=h);"ltr"===fa&&(m+=u);m+="</tr></tbody></table>";!0===k.viewrecords&&a("td"+b+"_"+k.recordpos,D).append("<span dir='"+fa+"' style='text-align:"+
...
!0===k.pgbuttons&&(a(".ui-pg-button",D).hover(function(){y(this,g)?this.style.cursor="default":(a(this).addClass(e),this.style.cursor="pointer")},function(){y(this,g)||(a(this).removeClass(e),this.style.cursor="default")}),a("#first"+f(c)+", #prev"+f(c)+", #next"+f(c)+", #last"+f(c)).click(function(){if(y(this,g))return!1;var a=ea(k.page,1),b=a,e=this.id,d=ea(k.lastpage,1),l=!1,f=!0,h=!0,m=!0,u=!0;0===d||1===d?u=m=h=f=!1:1<d&&1<=a?1===a?h=f=!1:a===d&&(u=m=!1):1<d&&0===a&&(u=m=!1,a=d-1);this.id===
"first"+c&&f&&(e="first",b=1,l=!0);this.id==="prev"+c&&h&&(e="prev",b=a-1,l=!0);this.id==="next"+c&&m&&(e="next",b=a+1,l=!0);this.id==="last"+c&&u&&(e="last",b=d,l=!0);if(!n(e,b,ea(k.rowNum,10)))return!1;k.page=b;l&&qa.call(v);return!1}));!0===k.pginput&&a("input.ui-pg-input",D).bind("keypress.jqGrid",function(b){b=b.charCode||b.keyCode||0;var c=ea(a(this).val(),1);if(13===b){if(!n("user",c,ea(k.rowNum,10)))return!1;a(this).val(c);k.page=0<a(this).val()?a(this).val():k.page;qa.call(v);return!1}return this});
A.children(".ui-pg-table").bind("keydown.jqGrid",function(a){13===a.which&&(a=A.find(":focus"),0<a.length&&a.trigger("click"))})};var Ra=function(b,c){var e,d="",g=k.colModel,l=g[b],f=!1,h="",m=L("states.disabled"),u=k.frozenColumns?a(c):a(v.grid.headers[b].el),D=u.find("span.s-ico"),z=D.children("span.ui-icon-asc"),B=D.children("span.ui-icon-desc"),q=z,n=B;u.find("span.ui-grid-ico-sort").addClass(m);u.attr("aria-selected","false");if(l.lso)if("asc"===l.lso)l.lso+="-desc",h="desc",q=B,n=z;else if("desc"===
l.lso)l.lso+="-asc",h="asc";else{if("asc-desc"===l.lso||"desc-asc"===l.lso)l.lso="",k.viewsortcols[0]||D.hide()}else l.lso=h=l.firstsortorder||"asc",q=z,n=B;h&&(D.show(),q.removeClass(m).css("display",""),k.showOneSortIcon&&n.hide(),u.attr("aria-selected","true"));k.sortorder="";N(g,function(a){this.lso&&(0<a&&f&&(d+=", "),e=this.lso.split("-"),d+=g[a].index||g[a].name,d+=" "+e[e.length-1],f=!0,k.sortorder=e[e.length-1])});d=d.substring(0,d.lastIndexOf(k.sortorder));k.sortname=d},Oa=function(b,c,
e,g,l){var h=this.grid,m=L("states.disabled");if(k.colModel[c].sortable&&!(0<k.savedRow.length)){e||(k.lastsort===c&&""!==k.sortname?"asc"===k.sortorder?k.sortorder="desc":"desc"===k.sortorder&&(k.sortorder="asc"):k.sortorder=k.colModel[c].firstsortorder||"asc",k.page=1);if(k.multiSort)Ra(c,l);else{if(g){if(k.lastsort===c&&k.sortorder===g&&!e)return;k.sortorder=g}var v=h.headers;e=h.fhDiv;g=v[k.lastsort]?a(v[k.lastsort].el):a();l=k.frozenColumns?a(l):a(v[c].el);var v=l.find("span.s-ico"),u=k.colModel[k.lastsort],
...
k.localReader);k.scroll&&(k.pgbuttons=!1,k.pginput=!1,k.rowList=[]);if(!0===k.treeGrid){try{D.setTreeGrid.call(G)}catch(Va){}"local"!==k.datatype&&(k.localReader={id:"_id_"});k.iPropByName=ha(k.additionalProperties)}(function(){var a=k.remapColumns,b=k.colModel,c=b.length,e=[],d,g;for(d=0;d<c;d++)g=b[d].name,0>K(g,k.reservedColumnNames)&&e.push(g);if(null!=a)for(b=e.slice(),d=0;d<a.length;d++)e[d]=b[a[d]];k.cmNamesInputOrder=e})();da();k.data.length&&(Ea.call(v),ma());if(!0===k.shrinkToFit&&!0===
k.forceFit)for(Z=k.colModel.length-1;0<=Z;Z--)if(!0!==k.colModel[Z].hidden){k.colModel[Z].resizable=!1;break}var Ia,Fa,Ga,Ha,ca=[],ha=[];ia=[];var da="<thead><tr class='ui-jqgrid-labels' role='row'>",Ba=L("states.hover"),Ca=L("states.disabled");if(k.multiSort)for(ca=k.sortname.split(","),Z=0;Z<ca.length;Z++)ia=H(ca[Z]).split(" "),ca[Z]=H(ia[0]),ha[Z]=ia[1]?H(ia[1]):k.sortorder||"asc";for(Z=0;Z<k.colNames.length;Z++){H=k.colModel[Z];ia=k.headertitles||H.headerTitle?' title="'+u("string"===typeof H.headerTitle?
...
"</div></th>";H.width=H.width?parseInt(H.width,10):150;"boolean"!==typeof H.title&&(H.title=!0);H.lso="";ia===k.sortname&&(k.lastsort=Z);k.multiSort&&(ia=K(ia,ca),-1!==ia&&(H.lso=ha[ia]))}G.append(da+"</tr></thead>");a(v.tHead).children("tr").children("th").hover(function(){a(this).addClass(Ba)},function(){a(this).removeClass(Ba)});k.multiselect&&a(k.cb,v).bind("click",function(){d(k.selarrrow);var b=L("states.select"),c,e=[],g=k.iColByName.cb,l=function(c,e){a(c)[e?"addClass":"removeClass"](b).attr(e?
...
1&&null!=l&&l.autoResizable&&D.autoResizeColumn.call(G,d);return!1});k.pager||a(M.cDiv).nextAll("div:visible").filter(":last").addClass(Ja);a(".ui-jqgrid-labels",M.hDiv).bind("selectstart",function(){return!1});v.formatCol=xa;v.sortData=Oa;v.updatepager=function(b,e){var d=this,g=a(d),l=d.grid,f,h,m,v,u,z,D=k.pager||"",B=k.pager?"_"+k.pager.substr(1):"";f=l.bDiv;var q=a.fmatter?a.fmatter.NumberFormat:null,n=k.toppager?"_"+k.toppager.substr(1):"",A=L("states.hover"),p=L("states.disabled");h=parseInt(k.page,
10)-1;0>h&&(h=0);h*=parseInt(k.rowNum,10);v=h+k.reccount;if(k.scroll){z=a(c(21,f)[0].rows).slice(1);h=v-z.length;k.reccount=z.length;if(z=z.outerHeight()||l.prevRowHeight)m=h*z,u=r.fixMaxHeightOfDiv.call(d,parseInt(k.records,10)*z),a(f).children("div").first().css({height:u+"px"}).children("div").first().css({height:m+"px",display:m+"px"?"":"none"}),0===f.scrollTop&&1<k.page&&(f.scrollTop=k.rowNum*(k.page-1)*z);f.scrollLeft=l.hDiv.scrollLeft}if(D+=k.toppager?(D?",":"")+k.toppager:"")z=X.call(G,"formatter.integer")||
{},l=ea(k.page),f=ea(k.lastpage),a(".selbox",D)[W]("disabled",!1),!0===k.pginput&&(a(".ui-pg-input",D).val(k.page),m=k.toppager?"#sp_1"+B+",#sp_1"+n:"#sp_1"+B,a(m).html(a.fmatter?q(k.lastpage,z):k.lastpage).closest(".ui-pg-table").each(function(){Aa.call(d,a(this))})),k.viewrecords&&(0===k.reccount?a(".ui-paging-info",D).html(S("emptyrecords")):(m=h+1,u=k.records,a.fmatter&&(m=q(m,z),v=q(v,z),u=q(u,z)),a(".ui-paging-info",D).html(r.format(S("recordtext"),m,v,u)))),!0===k.pgbuttons&&(0>=l&&(l=f=0),
...
d,g,b):"string"===typeof k.rowattr&&null!=r.rowattr&&p(r.rowattr[k.rowattr])?r.rowattr[k.rowattr].call(this,d,g,b):{});if(null!=l&&!a.isEmptyObject(l)){l.hasOwnProperty("id")&&(b=l.id,delete l.id);l.hasOwnProperty("tabindex")&&(f=l.tabindex,delete l.tabindex);l.hasOwnProperty("style")&&(v+=l.style,delete l.style);l.hasOwnProperty("class")&&(e+=" "+l["class"],delete l["class"]);try{delete l.role}catch(u){}for(m in l)l.hasOwnProperty(m)&&(h+=" "+m+"="+l[m])}k.treeGrid&&parseInt(d[k.treeReader.level_field],
...
c[d],a(g).hasClass("jqgrow")&&b.push(g.id)});return b},setSelection:function(b,c,e){return this.each(function(){function d(b,c){var e=c.clientHeight,g=c.scrollTop,l=a(b).position().top,f=b.clientHeight;l+f>=e+g?c.scrollTop=l-(e+g)+f+g:l<e+g&&l<g&&(c.scrollTop=l)}var g=a(this),l=this.p,f,h,m,u=C.getGuiStyles;m=C.getGridRowById;var n=u.call(g,"states.select"),q=u.call(g,"states.disabled"),A=this.grid.fbRows,u=function(b,c){var e=c?"addClass":"removeClass",d=l.iColByName.cb,g=c?{"aria-selected":"true",
...
l.selrow=f.id,m=a.inArray(l.selrow,l.selarrrow),-1===m?(g=!0,l.selarrrow.push(l.selrow)):null!==r.detectRowEditing.call(this,f.id)?g=!0:(g=!1,l.selarrrow.splice(m,1),m=l.selarrrow[0],l.selrow=void 0===m?null:m),"ui-subgrid"!==f.className&&u(f,g),c&&E.call(this,"onSelectRow",f.id,g,e)):"ui-subgrid"!==f.className&&(l.selrow!==f.id?(null!==l.selrow&&(g=m.call(g,l.selrow))&&u(g,!1),u(f,!0),g=!0):g=!1,l.selrow=f.id,c&&E.call(this,"onSelectRow",f.id,g,e))))})},resetSelection:function(b){return this.each(function(){var c=
a(this),e=this.p,g=C.getGuiStyles,l=C.getGridRowById,f=g.call(c,"states.select"),h="edit-cell "+f,g="selected-row "+g.call(c,"states.hover"),m=e.iColByName.cb,u=void 0!==m,n=this.grid.fbRows,q=function(b){var c={"aria-selected":"false",tabindex:"-1"};a(b).removeClass(f).attr(c);if(u)a(b.cells[m]).children("input.cbox")[e.propOrAttr]("checked",!1);if(n&&(b=n[b.rowIndex],a(b).removeClass(f).attr(c),u))a(b.cells[m]).children("input.cbox")[e.propOrAttr]("checked",!1)};void 0!==b?(c=l.call(c,b),q(c),u&&
...
a(c).removeClass(g))));d(e.savedRow)})},getRowData:function(b,c){var d={},g;"object"===typeof b&&(c=b,b=void 0);c=c||{};this.each(function(){var l=this.p,f=!1,h,m=2,u=0,n=this.rows,q,p,w,r,E;if(void 0===b)f=!0,g=[],m=n.length;else if(h=C.getGridRowById.call(a(this),b),!h)return d;for(;u<m;){f&&(h=n[u]);if(a(h).hasClass("jqgrow")){p=a("td[role=gridcell]",h);for(q=0;q<p.length;q++)if(w=l.colModel[q],r=w.name,!("cb"===r||"subgrid"===r||"rn"===r||"actions"===w.formatter||c.skipHidden&&w.hidden))if(E=
p[q],!0===l.treeGrid&&r===l.ExpandColumn)d[r]=A(a("span",E).first().html());else try{d[r]=a.unformat.call(this,E,{rowId:h.id,colModel:w},q)}catch(y){d[r]=A(a(E).html())}!c.includeId||!1!==l.keyName&&null!=d[l.keyName]||(d[l.prmNames.id]=e(l.idPrefix,h.id));f&&(g.push(d),d={})}u++}});return g||d},delRowData:function(b){var c=!1,d,g,l;this.each(function(){var f=this.p;d=C.getGridRowById.call(a(this),b);if(!d)return!1;f.subGrid&&(l=a(d).next(),l.hasClass("ui-subgrid")&&l.remove());a(d).remove();f.records--;
f.reccount--;this.updatepager(!0,!1);c=!0;f.multiselect&&(g=a.inArray(b,f.selarrrow),-1!==g&&f.selarrrow.splice(g,1));f.multiselect&&0<f.selarrrow.length?f.selrow=f.selarrrow[f.selarrrow.length-1]:f.selrow===b&&(f.selrow=null);if("local"===f.datatype){var h=e(f.idPrefix,b),h=f._index[h];void 0!==h&&(f.data.splice(h,1),this.refreshIndex())}this.rebuildRowIndexes();if(!0===f.altRows&&c){var m=f.altclass,u=this.grid.fbRows;a(this.rows).each(function(b){var c=a(this);u&&(c=c.add(u[this.rowIndex]));c[0===
b%2?"addClass":"removeClass"](m)})}E.call(this,"afterDelRow",b)});return c},setRowData:function(b,c,d){var l=!0;this.each(function(){var f=this,h=f.p,q,n,A=typeof d,p={};if(!f.grid)return!1;n=C.getGridRowById.call(a(f),b);if(!n)return!1;if(c)try{var w=e(h.idPrefix,b),r,y=h._index[w],t=null!=y?h.data[y]:void 0;a(h.colModel).each(function(e){var d=this.name,l;l=m(c,d);void 0!==l&&("local"===h.datatype&&null!=t&&(q=g.call(f,l,this,t[d],w,t,e),a.isFunction(this.saveLocally)?this.saveLocally.call(f,{newValue:q,
newItem:p,oldItem:t,id:w,cm:this,cmName:d,iCol:e}):p[d]=q),q=f.formatter(b,l,e,c,"edit"),l=this.title?{title:u(q)}:{},e=a(n.cells[e]),!0===h.treeGrid&&d===h.ExpandColumn&&(e=e.children("span.cell-wrapperleaf,span.cell-wrapper").first()),e.html(q).attr(l))});if("local"===h.datatype){if(h.treeGrid)for(r in h.treeReader)h.treeReader.hasOwnProperty(r)&&delete p[h.treeReader[r]];void 0!==t&&(h.data[y]=a.extend(!0,t,p));p=null}E.call(f,"afterSetRow",{rowid:b,inputData:c,iData:y,iRow:n.rowIndex,tr:n,localData:p,
cssProp:d})}catch(X){l=!1}l&&("string"===A?a(n).addClass(d):null!==d&&"object"===A&&a(n).css(d),a(f).triggerHandler("jqGridAfterGridComplete"))});return l},addRowData:function(b,c,e,d){0>a.inArray(e,"first last before after afterSelected beforeSelected".split(" "))&&(e="last");var f=!1,h,u,q,n,A,p,w,y,t,X,T;c&&(a.isArray(c)?(p=!0,w=b):(c=[c],p=!1),this.each(function(){var x=this.p,O=c.length,aa=a(this),Q=this.rows,I=0,L=C.getGridRowById,k=x.colModel,S={},W=x.additionalProperties;p||(void 0!==b?b=
String(b):(b=l(),!1!==x.keyName&&(w=x.keyName,void 0!==c[0][w]&&(b=c[0][w]))));for(y=x.altclass;I<O;){t=c[I];u=[];if(p)try{b=t[w],void 0===b&&(b=l())}catch(ba){b=l()}T=b;for(n=0;n<k.length;n++)X=k[n],h=X.name,"rn"!==h&&"cb"!==h&&"subgrid"!==h&&(A=g.call(this,t[h],X,void 0,T,{},n),a.isFunction(X.saveLocally)?X.saveLocally.call(this,{newValue:A,newItem:S,oldItem:{},id:T,cm:X,cmName:h,iCol:n}):void 0!==A&&(S[h]=A));for(n=0;n<W.length;n++)A=m(t,W[n]),void 0!==A&&(S[W[n]]=A);"local"===x.datatype&&(S[x.localReader.id]=
T,x._index[T]=x.data.length,x.data.push(S));u=r.parseDataToHtml.call(this,1,[b],[t]);u=u.join("");if(0===Q.length)a("table:first",this.grid.bDiv).append(u);else{if("afterSelected"===e||"beforeSelected"===e)void 0===d&&null!==x.selrow?(d=x.selrow,e="afterSelected"===e?"after":"before"):e="afterSelected"===e?"last":"first";switch(e){case "last":a(Q[Q.length-1]).after(u);q=Q.length-1;break;case "first":a(Q[0]).after(u);q=1;break;case "after":if(q=L.call(aa,d))a(Q[q.rowIndex+1]).hasClass("ui-subgrid")?
(a(Q[q.rowIndex+1]).after(u),q=q.rowIndex+2):(a(q).after(u),q=q.rowIndex+1);break;case "before":if(q=L.call(aa,d))a(q).before(u),q=q.rowIndex-1}}!0===x.subGrid&&C.addSubGrid.call(aa,x.iColByName.subgrid,q);x.records++;x.reccount++;0===x.lastpage&&(x.lastpage=1);E.call(this,"afterAddRow",{rowid:b,inputData:c,position:e,srcRowid:d,iRow:q,localData:S,iData:x.data.length-1});I++}!0!==x.altRows||p||("last"===e?0===(Q.length-1)%2&&a(Q[Q.length-1]).addClass(y):a(Q).each(function(b){1===b%2?a(this).addClass(y):
a(this).removeClass(y)}));this.rebuildRowIndexes();this.updatepager(!0,!0);f=!0}));return f},footerData:function(b,c,e){function d(a){for(var b in a)if(a.hasOwnProperty(b))return!1;return!0}var l,g=!1,f={},h;null==b&&(b="get");"boolean"!==typeof e&&(e=!0);b=b.toLowerCase();this.each(function(){var m=this,q=m.p,n;if(!m.grid||!q.footerrow||"set"===b&&d(c))return!1;g=!0;a(q.colModel).each(function(d){l=this.name;"set"===b?void 0!==c[l]&&(n=e?m.formatter("",c[l],d,c,"edit"):c[l],h=this.title?{title:u(n)}:
{},a("tr.footrow td:eq("+d+")",m.grid.sDiv).html(n).attr(h),g=!0):"get"===b&&(f[l]=a("tr.footrow td:eq("+d+")",m.grid.sDiv).html())})});return"get"===b?f:g},showHideCol:function(b,c){return this.each(function(){var e=this,d=a(e),l=e.grid,g=!1,f=e.p,h=r.cell_width?0:f.cellLayout,m;if(l){"string"===typeof b&&(b=[b]);c="none"!==c?"":"none";var u=""===c?!0:!1,q=f.groupHeader;(q=q&&("object"===typeof q||a.isFunction(q)))&&C.destroyGroupHeader.call(d,!1);a(f.colModel).each(function(d){if(-1!==a.inArray(this.name,
b)&&this.hidden===u){if(!0===f.frozenColumns&&!0===this.frozen)return!0;a("tr[role=row]",l.hDiv).each(function(){a(this.cells[d]).css("display",c)});a(e.rows).each(function(){var b=this.cells[d];(!a(this).hasClass("jqgroup")||null!=b&&1===b.colSpan)&&a(b).css("display",c)});f.footerrow&&a("tr.footrow td:eq("+d+")",l.sDiv).css("display",c);m=parseInt(this.width,10);f.tblwidth="none"===c?f.tblwidth-(m+h):f.tblwidth+(m+h);this.hidden=!u;g=!0;E.call(e,"onShowHideCol",u,this.name,d)}});!0===g&&C.setGridWidth.call(d,
...
b,"")})},remapColumns:function(b,c,e){function d(c){var e=c.length?u(c):a.extend({},c);a.each(b,function(a){c[a]=e[this]})}function l(c,e){(e?c.children(e):c.children()).each(function(){var c=this,e=u(c.cells);a.each(b,function(a){var b=e[this],d=c.cells[a];b.cellIndex!==a&&b.parentNode.insertBefore(b,d)})})}var g=this[0],f=g.p,h=g.grid,m,u=a.makeArray;if(null!=h&&null!=f){d(f.colModel);d(f.colNames);d(h.headers);l(a(h.hDiv).find(">div>.ui-jqgrid-htable>thead"),e&&":not(.ui-jqgrid-labels)");c&&l(a(g.tBodies[0]),
"tr.jqgfirstrow,tr.jqgrow,tr.jqfoot");f.footerrow&&l(a(h.sDiv).find(">div>.ui-jqgrid-ftable>tbody").first());f.remapColumns&&(f.remapColumns.length?d(f.remapColumns):f.remapColumns=u(b));f.lastsort=a.inArray(f.lastsort,b);f.iColByName={};h=0;for(m=f.colModel.length;h<m;h++)f.iColByName[f.colModel[h].name]=h;E.call(g,"onRemapColumns",b,c,e)}},remapColumnsByName:function(b,c,e){var d=this[0].p,l=[],g,f;b=b.slice();g=a.inArray;d.subGrid&&0>g("subgrid",b)&&b.unshift("subgrid");d.multiselect&&0>g("cb",
b)&&b.unshift("cb");d.rownumbers&&0>g("rn",b)&&b.unshift("rn");g=0;for(f=b.length;g<f;g++)l.push(d.iColByName[b[g]]);C.remapColumns.call(this,l,c,e);return this},setGridWidth:function(b,e){return this.each(function(){var d=this.p,g,l=this.grid,f=0,h,m=0,u=!1,q,n=0,A=r.isCellClassHidden;if(l&&null!=d){this.fixScrollOffsetAndhBoxPadding();var p=d.colModel,w=d.scrollOffset,C=r.cell_width?0:d.cellLayout,y=l.headers,x=l.footers,E=l.bDiv,t=l.hDiv,Q=l.sDiv,I=l.cols,L,k,S=a(t).find(">div>.ui-jqgrid-htable>thead>tr").first()[0].cells,
...
function(){!1!==this.hidden||A(this.classes)||(g=this.widthOrg,f+=g+C,this.fixed?n+=this.width+C:m++)});if(0===m)return;d.tblwidth=parseInt(f,10);q=b-C*m-n;!isNaN(d.height)&&(E.clientHeight<E.scrollHeight||1===this.rows.length)&&(u=!0,q-=w);k=q/(d.tblwidth-C*m-n);if(0>k)return;f=0;L=0<I.length;a.each(p,function(a){!1!==this.hidden||A(this.classes)||this.fixed||(this.width=g=Math.round(this.widthOrg*k),f+=g,y[a].width=g,S[a].style.width=g+"px",d.footerrow&&(x[a].style.width=g+"px"),L&&(I[a].style.width=
g+"px"),h=a)});if(!h)return;q=0;u?b-n-(f+C*m)!==w&&(q=b-n-(f+C*m)-w):1!==Math.abs(b-n-(f+C*m))&&(q=b-n-(f+C*m));p=p[h];p.width+=q;d.tblwidth=parseInt(f+q+C*m+n,10);d.tblwidth>b&&(q=d.tblwidth-parseInt(b,10),d.tblwidth=b,p.width-=q);g=p.width;q=y[h];q.width=g;S[h].style.width=g+"px";L&&(I[h].style.width=g+"px");d.footerrow&&(x[h].style.width=g+"px");d.tblwidth+(u?w:0)<d.width&&W(d.tblwidth+(u?w:0));E.offsetWidth>E.clientWidth&&(d.autowidth||void 0!==d.widthOrg&&"auto"!==d.widthOrg&&"100%"!==d.widthOrg||
W(E.offsetWidth))}d.tblwidth&&(d.tblwidth=parseInt(d.tblwidth,10),b=d.tblwidth,a(this).css("width",b+"px"),c(14,t).css("width",b+"px"),t.scrollLeft=E.scrollLeft,d.footerrow&&c(27,Q).css("width",b+"px"),q=Math.abs(b-d.width),d.shrinkToFit&&!e&&3>q&&0<q&&(b<d.width&&W(b),E.offsetWidth>E.clientWidth&&(d.autowidth||void 0!==d.widthOrg&&"auto"!==d.widthOrg&&"100%"!==d.widthOrg||W(E.offsetWidth))));this.fixScrollOffsetAndhBoxPadding();a(this).triggerHandler("jqGridResetFrozenHeights")}}})},setGridHeight:function(b){return this.each(function(){var c=
...
this.p,q=-1,n=m.colModel,p,w,E,y,t,X,T,x={},O;if(this.grid&&(q=isNaN(c)?m.iColByName[c]:parseInt(c,10),0<=q&&(y=C.getGridRowById.call(a(this),b)))){t=r.getCell.call(this,y,q);if(""!==d||!0===h){w=n[q];"local"===m.datatype&&(O=e(m.idPrefix,b),p=m._index[O],void 0!==p&&(E=m.data[p]));if(null==E)for(p=0;p<y.cells.length;p++){if(p!==q&&(X=r.getDataFieldOfCell.call(this,y,p),0<X.length)){try{T=a.unformat.call(this,X,{rowId:b,colModel:n[p]},p)}catch(aa){T=A(X[0].innerHTML)}x[n[p].name]=T}}else x=E;x[w.name]=
d;n=this.formatter(b,d,q,x,"edit");m=m.colModel[q].title?{title:u(n)}:{};t.html(n).attr(m);null!=E&&(n=g.call(this,d,w,E[w.name],O,E,q),a.isFunction(w.saveLocally)?w.saveLocally.call(this,{newValue:n,newItem:E,oldItem:E,id:O,cm:w,cmName:w.name,iCol:q}):E[w.name]=n)}if(l||f){t=r.getCell.call(this,y,q);if(l)t["string"===typeof l?"addClass":"css"](l);"object"===typeof f&&t.attr(f)}}})},getCell:function(b,c){var e=!1;this.each(function(){var d,g=this.p,l,f;if(this.grid&&(d=isNaN(c)?g.iColByName[c]:parseInt(c,
10),0<=d&&(l=C.getGridRowById.call(a(this),b)))){f=r.getDataFieldOfCell.call(this,l,d).first();try{e=a.unformat.call(this,f,{rowId:l.id,colModel:g.colModel[d]},d)}catch(h){e=A(f.html())}}});return e},getCol:function(b,c,e){var d=[],g,l=0,f,h,m;c="boolean"!==typeof c?!1:c;void 0===e&&(e=!1);this.each(function(){var u,q=this.p,n;if(this.grid&&(u=isNaN(b)?q.iColByName[b]:parseInt(b,10),0<=u)){var p=this.rows,w=p.length,C=0,E=0,x;if(w&&0<w){for(;C<w;){x=p[C];if(a(x).hasClass("jqgrow")){n=r.getDataFieldOfCell.call(this,
x,u).first();try{g=a.unformat.call(this,n,{rowId:x.id,colModel:q.colModel[u]},u)}catch(y){g=A(n.html())}e?(m=parseFloat(g),isNaN(m)||(l+=m,void 0===h&&(h=f=m),f=Math.min(f,m),h=Math.max(h,m),E++)):c?d.push({id:x.id,value:g}):d.push(g)}C++}if(e)switch(e.toLowerCase()){case "sum":d=l;break;case "avg":d=l/E;break;case "count":d=w-1;break;case "min":d=f;break;case "max":d=h}}}});return d},clearGridData:function(b){return this.each(function(){var c=this.p,e=this.rows,g=this.grid;g&&c&&e&&("boolean"!==
...
l=parseFloat(m.css("padding-left")||0);d=parseFloat(m.css("padding-right")||0);g=e.find("span.s-ico");var u=e.find(">."+f.autoResizing.wrapperClassName),q=u.outerWidth(),n=parseFloat(u.css("width")||0),p=m=0,w=null!=h.autoResizing&&void 0!==h.autoResizable.compact?h.autoResizable.compact:f.autoResizing.compact,A=f.autoResizing.wrapperClassName;if(null==h||!h.autoResizable||0===u.length||h.hidden||r.isCellClassHidden(h.classes)||h.fixed)return-1;if(!w||g.is(":visible")||"none"!==g.css("display"))p=
...
a(this),c=this.p,e=c.colModel,d=e.length,g,l,f=c.shrinkToFit,h=c.autoResizing.adjustGridWidth,m=c.autoResizing.fixWidthOnShrink,u=parseInt(c.widthOrg,10),q=this.grid,n=C.autoResizeColumn;c.shrinkToFit=!1;c.autoResizing.adjustGridWidth=!0;c.autoResizing.fixWidthOnShrink=!1;for(g=0;g<d;g++)l=e[g],l.autoResizable&&"actions"!==l.formatter&&n.call(b,g,!0);q.hDiv.scrollLeft=q.bDiv.scrollLeft;c.footerrow&&(q.sDiv.scrollLeft=q.bDiv.scrollLeft);this.fixScrollOffsetAndhBoxPadding();isNaN(u)?h&&C.setGridWidth.call(b,
q.newWidth+c.scrollOffset,!1):C.setGridWidth.call(b,u,!1);c.autoResizing.fixWidthOnShrink=m;c.autoResizing.adjustGridWidth=h;c.shrinkToFit=f})}})})(jQuery);
(function(a){var p=a.jgrid,r=function(){var d=a.makeArray(arguments);d.unshift("");d.unshift("");d.unshift(this.p);return p.feedback.apply(this,d)},t=function(a,f){return p.mergeCssClasses(p.getRes(p.guiStyles[this.p.guiStyle],"states."+a),f||"")},n=function(d,f){var h=this.grid.fbRows;return a((null!=h&&h[0].cells.length>f?h[d.rowIndex]:d).cells[f])};p.extend({editCell:function(d,f,h){return this.each(function(){var b=this,c=a(b),e=b.p,l,m,g,u;l=b.rows;if(b.grid&&!0===e.cellEdit&&null!=l&&null!=
l[d]){d=parseInt(d,10);f=parseInt(f,10);var w=l[d],A=w.id,q=a(w),y=parseInt(e.iCol,10),E=parseInt(e.iRow,10),C=a(l[E]),B=e.savedRow;e.selrow=A;e.knv||c.jqGrid("GridNav");if(0<B.length){if(!0===h&&d===E&&f===y)return;c.jqGrid("saveCell",B[0].id,B[0].ic)}else setTimeout(function(){a("#"+p.jqID(e.knv)).attr("tabindex","-1").focus()},1);u=e.colModel[f];l=u.name;if("subgrid"!==l&&"cb"!==l&&"rn"!==l){g=n.call(b,w,f);w=u.editable;a.isFunction(w)&&(w=w.call(b,{rowid:A,iCol:f,iRow:d,name:l,cm:u,mode:"cell"}));
var D=t.call(b,"select","edit-cell"),z=t.call(b,"hover","selected-row");if(!0!==w||!0!==h||g.hasClass("not-editable-cell"))0<=y&&0<=E&&(n.call(b,C[0],y).removeClass(D),C.removeClass(z)),g.addClass(D),q.addClass(z),m=g.html().replace(/\&#160\;/ig,""),r.call(b,"onSelectCell",A,l,m,d,f);else{0<=y&&0<=E&&(n.call(b,C[0],y).removeClass(D),C.removeClass(z));g.addClass(D);q.addClass(z);u.edittype||(u.edittype="text");q=u.edittype;try{m=a.unformat.call(b,g,{rowId:A,colModel:u},f)}catch(v){m="textarea"===q?
g.text():g.html()}e.autoencode&&(m=p.htmlDecode(m));B.push({id:d,ic:f,name:l,v:m});if("&nbsp;"===m||"&#160;"===m||1===m.length&&160===m.charCodeAt(0))m="";a.isFunction(e.formatCell)&&(y=e.formatCell.call(b,A,l,m,d,f),void 0!==y&&(m=y));r.call(b,"beforeEditCell",A,l,m,d,f);u=a.extend({},u.editoptions||{},{id:d+"_"+l,name:l,rowId:A,mode:"cell"});var V=p.createEl.call(b,q,u,m,!0,a.extend({},p.ajaxOptions,e.ajaxSelectOptions||{})),q=g;(y=!0===e.treeGrid&&l===e.ExpandColumn)&&(q=g.children("span.cell-wrapperleaf,span.cell-wrapper"));
q.html("").append(V).attr("tabindex","0");y&&a(V).width(g.width()-g.children("div.tree-wrap").outerWidth());p.bindEv.call(b,V,u);setTimeout(function(){a(V).focus()},1);a("input, select, textarea",g).bind("keydown",function(e){27===e.keyCode&&(0<a("input.hasDatepicker",g).length?a(".ui-datepicker").is(":hidden")?c.jqGrid("restoreCell",d,f):a("input.hasDatepicker",g).datepicker("hide"):c.jqGrid("restoreCell",d,f));if(13===e.keyCode&&!e.shiftKey)return c.jqGrid("saveCell",d,f),!1;if(9===e.keyCode){if(b.grid.hDiv.loading)return!1;
e.shiftKey?c.jqGrid("prevCell",d,f):c.jqGrid("nextCell",d,f)}e.stopPropagation()});r.call(b,"afterEditCell",A,l,m,d,f);c.triggerHandler("jqGridAfterEditCell",[A,l,m,d,f])}e.iCol=f;e.iRow=d}}})},saveCell:function(d,f){return this.each(function(){var h=this,b=a(h),c=h.p,e=p.info_dialog,l=p.jqID;if(h.grid&&!0===c.cellEdit){var m=b.jqGrid("getGridRes","errors"),g=m.errcap,u=b.jqGrid("getGridRes","edit").bClose,w=c.savedRow,A=1<=w.length?0:null;if(null!==A){var q=h.rows[d],y=q.id,E=a(q),C=c.colModel[f],
...
z).datepicker("hide");"date"===C.formatter&&!0!==q.sendFormatted&&(D=a.unformat.date.call(h,D,C));if("remote"===c.cellsubmit)if(c.cellurl){var t={};c.autoencode&&(D=p.htmlEncode(D));t[B]=D;var m=c.prmNames,C=m.oper,J=h.grid.hDiv;t[m.id]=p.stripPref(c.idPrefix,y);t[C]=m.editoper;t=a.extend(A,t);b.jqGrid("progressBar",{method:"show",loadtype:c.loadui,htmlcontent:p.defaults.savetext||"Saving..."});J.loading=!0;a.ajax(a.extend({url:c.cellurl,data:p.serializeFeedback.call(h,c.serializeCellData,"jqGridSerializeCellData",
t),type:"POST",complete:function(l){b.jqGrid("progressBar",{method:"hide",loadtype:c.loadui});J.loading=!1;if((300>l.status||304===l.status)&&(0!==l.status||4!==l.readyState)){var m=b.triggerHandler("jqGridAfterSubmitCell",[h,l,t.id,B,D,d,f])||[!0,""];!0===m[0]&&a.isFunction(c.afterSubmitCell)&&(m=c.afterSubmitCell.call(h,l,t.id,B,D,d,f));!0===m[0]?(b.jqGrid("setCell",y,f,D,!1,!1,!0),z.addClass("dirty-cell"),E.addClass("edited"),r.call(h,"afterSaveCell",y,B,D,d,f),w.splice(0,1)):(e.call(h,g,m[1],
u),b.jqGrid("restoreCell",d,f))}},error:function(m,q,n){a("#lui_"+l(c.id)).hide();J.loading=!1;b.triggerHandler("jqGridErrorCell",[m,q,n]);a.isFunction(c.errorCell)?c.errorCell.call(h,m,q,n):e.call(h,g,m.status+" : "+m.statusText+"<br/>"+q,u);b.jqGrid("restoreCell",d,f)}},p.ajaxOptions,c.ajaxCellOptions||{}))}else try{e.call(h,g,m.nourl,u),b.jqGrid("restoreCell",d,f)}catch(G){}"clientArray"===c.cellsubmit&&(b.jqGrid("setCell",y,f,D,!1,!1,!0),z.addClass("dirty-cell"),E.addClass("edited"),r.call(h,
"afterSaveCell",y,B,D,d,f),w.splice(0,1))}else try{setTimeout(function(){e.call(h,g,D+" "+v[1],u)},100),b.jqGrid("restoreCell",d,f)}catch(R){}}else b.jqGrid("restoreCell",d,f)}setTimeout(function(){a("#"+l(c.knv)).attr("tabindex","-1").focus()},0)}})},restoreCell:function(d,f){return this.each(function(){var h=this.p,b=this.rows[d],c=b.id,e,l;if(this.grid&&!0===h.cellEdit){var m=h.savedRow;e=n.call(this,b,f);if(1<=m.length){if(a.isFunction(a.fn.datepicker))try{a("input.hasDatepicker",e).datepicker("hide")}catch(g){}b=
...
c.knv+"'></div></div>");a(u).insertBefore(e.cDiv);a("#"+c.knv).focus().keydown(function(a){var e=parseInt(c.iRow,10),g=parseInt(c.iCol,10);m=a.keyCode;"rtl"===c.direction&&(37===m?m=39:39===m&&(m=37));switch(m){case 38:0<e-1&&(d(e-1,g,"vu"),b.jqGrid("editCell",e-1,g,!1));break;case 40:e+1<=h.rows.length-1&&(d(e+1,g,"vd"),b.jqGrid("editCell",e+1,g,!1));break;case 37:0<=g-1&&(l=f(g-1,"lft"),d(e,l,"h"),b.jqGrid("editCell",e,l,!1));break;case 39:g+1<=c.colModel.length-1&&(l=f(g+1,"rgt"),d(e,l,"h"),b.jqGrid("editCell",
...
"move"),a(g).jqDrag(q);else try{a(g).draggable({handle:a("#"+l(q.id))})}catch(C){}if(f.resize)if(a.fn.jqResize)a(g).append("<div class='jqResize ui-resizable-handle ui-resizable-se "+f.resizingRightBottomIcon+"'></div>"),a(u).jqResize(".jqResize",A);else try{a(g).resizable({handles:"se, sw",alsoResize:A})}catch(B){}!0===f.closeOnEscape&&a(g).keydown(function(b){27===b.which&&(b=a(u).data("onClose")||f.onClose,p.hideModal(u,{gb:f.gbox,jqm:f.jqModal,onClose:b,removemodal:f.removemodal||!1,formprop:!f.recreateForm||
...
info_dialog:function(n,d,f,h){var b=this,c=b.p,e=a.extend(!0,{width:290,height:"auto",dataheight:"auto",drag:!0,resize:!1,left:250,top:170,zIndex:1E3,jqModal:!0,modal:!1,closeOnEscape:!0,align:"center",buttonalign:"center",buttons:[]},p.jqModal||{},null!=c?c.jqModal||{}:{},{caption:"<b>"+n+"</b>"},h||{}),l=e.jqModal;a.fn.jqm&&!l&&(l=!1);n="";var m=t.call(b,"states.hover");if(0<e.buttons.length)for(h=0;h<e.buttons.length;h++)void 0===e.buttons[h].id&&(e.buttons[h].id="info_button_"+h),n+=p.builderFmButon.call(b,
e.buttons[h].id,e.buttons[h].text);h=isNaN(e.dataheight)?e.dataheight:e.dataheight+"px";d="<div id='info_id'>"+("<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:"+h+";"+("text-align:"+e.align+";")+"'>"+d+"</div>");if(f||""!==n)d+="<hr class='"+t.call(b,"dialog.hr")+"' style='margin:1px'/><div style='text-align:"+e.buttonalign+";padding:.8em 0 .5em 0;background-image:none;border-width: 1px 0 0 0;'>"+(f?p.builderFmButon.call(b,"closedialog",f):
...
{jqm:l,onClose:a("#info_dialog").data("onClose")||e.onClose,gb:a("#info_dialog").data("gbox")||e.gbox});return!1});a(".fm-button","#info_dialog").hover(function(){a(this).addClass(m)},function(){a(this).removeClass(m)});a.isFunction(e.beforeOpen)&&e.beforeOpen();p.viewModal("#info_dialog",{onHide:function(a){a.w.hide().remove();a.o&&a.o.remove()},modal:e.modal,jqm:l});a.isFunction(e.afterOpen)&&e.afterOpen();try{a("#info_dialog").focus()}catch(u){}},bindEv:function(n,d){a.isFunction(d.dataInit)&&
...
D&&g.call(l,u,"function 'custom_element' "+A.nodefined,w),"e2"===D?g.call(l,u,"function 'custom_element' "+A.novalue,w):g.call(l,u,"string"===typeof D?D:D.message,w)}}return e},checkDate:function(a,d){var f={},h;a=a.toLowerCase();h=-1!==a.indexOf("/")?"/":-1!==a.indexOf("-")?"-":-1!==a.indexOf(".")?".":"/";a=a.split(h);d=d.split(h);if(3!==d.length)return!1;var b=-1,c,e=h=-1,l;for(l=0;l<a.length;l++)c=isNaN(d[l])?0:parseInt(d[l],10),f[a[l]]=c,c=a[l],-1!==c.indexOf("y")&&(b=l),-1!==c.indexOf("m")&&
...
b+": "+m.maxValue+" "+f.maxValue,""];var u;if(!(!0!==f.email||!1===e&&l(n)||(u=/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i,
u.test(n))))return[!1,b+": "+m.email,""];if(!(!0!==f.integer||!1===e&&l(n)||!isNaN(n)&&0===n%1&&-1===n.indexOf(".")))return[!1,b+": "+m.integer,""];if(!(!0!==f.date||!1===e&&l(n)||(h.formatoptions&&h.formatoptions.newformat?(c=h.formatoptions.newformat,g.hasOwnProperty(c)&&(c=g[c])):c=c[d].datefmt||"Y-m-d",p.checkDate(c,n))))return[!1,b+": "+m.date+" - "+c,""];if(!0===f.time&&!(!1===e&&l(n)||p.checkTime(n)))return[!1,b+": "+m.date+" - hh:mm (am/pm)",""];if(!(!0!==f.url||!1===e&&l(n)||(u=/^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i,
u.test(n))))return[!1,b+": "+m.url,""];if(!0===f.custom&&(!1!==e||!l(n)))return a.isFunction(f.custom_func)?(n=f.custom_func.call(this,n,b,d),a.isArray(n)?n:[!1,m.customarray,""]):[!1,m.customfcheck,""]}return[!0,"",""]}})})(jQuery);
(function(a){var p=a.jgrid,r=p.getMethod("getGridRes"),t=p.jqID,n=function(a,f){return p.mergeCssClasses(p.getRes(p.guiStyles[this.p.guiStyle||p.defaults.guiStyle||"jQueryUI"],a),f||"")};p.extend({getColProp:function(a){var f=this[0];return null!=f&&f.grid&&(a=f.p.iColByName[a],void 0!==a)?f.p.colModel[a]:{}},setColProp:function(d,f){return this.each(function(){var h=this.p,b;this.grid&&null!=h&&f&&(b=h.iColByName[d],void 0!==b&&a.extend(!0,h.colModel[b],f))})},sortGrid:function(a,f,h){return this.each(function(){var b=
this.grid,c=this.p,e=c.colModel,l=e.length,m,g,u=!1;if(b)for(a||(a=c.sortname),"boolean"!==typeof f&&(f=!1),g=0;g<l;g++)if(m=e[g],m.index===a||m.name===a){!0===c.frozenColumns&&!0===m.frozen&&(u=b.fhDiv.find("#"+c.id+"_"+a));u&&0!==u.length||(u=b.headers[g].el);b=m.sortable;("boolean"!==typeof b||b)&&this.sortData("jqgh_"+c.id+"_"+a,g,f,h,u);break}})},clearBeforeUnload:function(){return this.each(function(){var d=this.p,f=this.grid,h,b=p.clearArray,c=Object.prototype.hasOwnProperty;a.isFunction(f.emptyRows)&&
...
if(!this.ftoolbar){var m=a.extend(!0,{autosearch:!0,autosearchDelay:500,searchOnEnter:!0,beforeSearch:null,afterSearch:null,beforeClear:null,afterClear:null,searchurl:"",stringResult:!1,groupOp:"AND",defaultSearch:"bw",searchOperators:!1,resetIcon:"x",applyLabelClasses:!0,operands:{eq:"==",ne:"!",lt:"<",le:"<=",gt:">",ge:">=",bw:"^",bn:"!^","in":"=",ni:"!=",ew:"|",en:"!@",cn:"~",nc:"!~",nu:"#",nn:"!#"}},p.search,c.searching||{},d||{}),g=c.colModel,u=function(a){return r.call(b,a)},w=u("errors.errcap"),
A=u("edit.bClose"),q=u("edit.msg"),y=n.call(f,"states.hover"),E=n.call(f,"states.select"),C=n.call(f,"filterToolbar.dataField"),B=function(){var e={},d=0,l={};a.each(g,function(){var b=this,g=b.index||b.name,q,p;q=b.searchoptions||{};var n=a("#gs_"+t(b.name),!0===b.frozen&&!0===c.frozenColumns?h.fhDiv:h.hDiv),v=function(a,c){var e=b.formatoptions||{};return void 0!==e[a]?e[a]:u("formatter."+(c||b.formatter)+"."+a)},A=function(a){var b=v("thousandsSeparator").replace(/([\.\*\_\'\(\)\{\}\+\?\\])/g,
...
!A&&a.isFunction(m.beforeSearch)&&(A=m.beforeSearch.call(f));A||b.jqGrid("setGridParam",{search:q}).trigger("reloadGrid",[a.extend({page:1},m.reloadGridSearchOptions||{})]);v&&b.jqGrid("setGridParam",{url:v});b.triggerHandler("jqGridToolbarAfterSearch");a.isFunction(m.afterSearch)&&m.afterSearch.call(f)},D=u("search.odata")||[],z=c.customSortOperations,v=function(e,d,l){a("#sopt_menu").remove();d=parseInt(d,10);l=parseInt(l,10)+18;var f,h=0,u=[],q=a(e).data("soper"),h=a(e).data("colname");d='<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="z-index:9999;font-size:'+
(a(".ui-jqgrid-view").css("font-size")||"11px")+";left:"+d+"px;top:"+l+'px;">';h=c.iColByName[h];if(void 0!==h){h=g[h];l=a.extend({},h.searchoptions);var n,v,A;l.sopt||(l.sopt=[],l.sopt[0]="select"===h.stype?"eq":m.defaultSearch);a.each(D,function(){u.push(this.oper)});null!=z&&a.each(z,function(a){u.push(a)});for(h=0;h<l.sopt.length;h++)v=l.sopt[h],f=a.inArray(v,u),-1!==f&&(f=D[f],void 0!==f?(A=m.operands[v],n=f.text):null!=z&&(n=z[v],A=n.operand,n=n.text),f=q===v?E:"",d+='<li class="ui-menu-item '+
...
d=a(this).data("oper");b.triggerHandler("jqGridToolbarSelectOper",[c,d,e]);a("#sopt_menu").hide();a(e).text(d).data("soper",c);!0===m.autosearch&&(d=a(e).parent().next().children()[0],(a(d).val()||"nu"===c||"nn"===c)&&B())})}},V,J=a("<tr class='ui-search-toolbar' role='row'></tr>");a.each(g,function(b){var d,g;g="";var h,v,r=this.searchoptions,E=this.editoptions,y=a("<th role='columnheader' class='"+n.call(f,"colHeaders","ui-th-column ui-th-"+c.direction+" "+(m.applyLabelClasses?this.labelClasses||
"":""))+"'></th>"),t=a("<div style='position:relative;height:auto;'></div>"),T=a("<table class='ui-search-table'"+(p.msie&&8>p.msiever()?" cellspacing='0'":"")+"><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear' style='width:1px'></td></tr></table>");!0===this.hidden&&a(y).css("display","none");this.search=!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");d=a.extend({mode:"filter"},r||{});if(this.search){if(m.searchOperators){g=d.sopt?d.sopt[0]:
"select"===this.stype?"eq":m.defaultSearch;for(v=0;v<D.length;v++)if(D[v].oper===g){h=m.operands[g]||"";break}if(void 0===h&&null!=z)for(var x in z)if(z.hasOwnProperty(x)&&x===g){h=z[x].operand;break}void 0===h&&(h="=");g="<a title='"+(null!=d.searchtitle?d.searchtitle:u("search.operandTitle"))+"' style='padding-right: 0.5em;' data-soper='"+g+"' class='soptclass' data-colname='"+this.name+"'>"+h+"</a>"}a("td",T).filter(":first").data("colindex",b).append(g);null!=d.sopt&&1!==d.sopt.length||a("td.ui-search-oper",
T).hide();void 0===d.clearSearch&&(d.clearSearch="text"===this.stype?!0:!1);d.clearSearch?(g=u("search.resetTitle")||"Clear Search Value",a("td",T).eq(2).append("<a title='"+g+"' style='padding-right: 0.2em;padding-left: 0.3em;' class='clearsearchclass'>"+m.resetIcon+"</a>")):a("td",T).eq(2).hide();switch(this.stype){case "select":if(g=this.surl||d.dataUrl)a(t).append(T),a.ajax(a.extend({url:g,context:{stbl:T,options:d,cm:this,iCol:b},dataType:"html",success:function(a,b,c){b=this.cm;var d=this.iCol,
g=this.options,l=this.stbl.find(">tbody>tr>td.ui-search-input");void 0!==g.buildSelect?(a=g.buildSelect.call(f,a,c,b,d))&&l.append(a):l.append(a);a=l.children("select");void 0!==g.defaultValue&&a.val(g.defaultValue);a.attr({name:b.index||b.name,id:"gs_"+b.name});g.attr&&a.attr(g.attr);a.addClass(C);a.css({width:"100%"});e.call(f,a[0],g);p.fullBoolFeedback.call(f,g.selectFilled,"jqGridSelectFilled",{elem:a[0],options:g,cm:b,cmName:b.name,iCol:d,mode:"filter"});!0===m.autosearch&&a.change(function(){B();
...
g[L].split(aa),Q=document.createElement("option"),Q.value=O[0],Q.innerHTML=O[1],I.appendChild(Q);else if("object"===typeof O)for(L in O)O.hasOwnProperty(L)&&(Q=document.createElement("option"),Q.value=L,Q.innerHTML=O[L],I.appendChild(Q));void 0!==d.defaultValue&&a(I).val(d.defaultValue);d.attr&&a(I).attr(d.attr);a(I).addClass(C);a(t).append(T);e.call(f,I,d);a("td",T).eq(1).append(I);p.fullBoolFeedback.call(f,d.selectFilled,"jqGridSelectFilled",{elem:I,options:r||E||{},cm:this,cmName:this.name,iCol:b,
mode:"filter"});!0===m.autosearch&&a(I).change(function(){B();return!1})}}break;case "text":b=void 0!==d.defaultValue?d.defaultValue:"";a("td",T).eq(1).append("<input type='text' role='textbox' class='"+C+"' style='width:100%;padding:0;' name='"+(this.index||this.name)+"' id='gs_"+this.name+"' value='"+b+"'/>");a(t).append(T);d.attr&&a("input",t).attr(d.attr);e.call(f,a("input",t)[0],d);!0===m.autosearch&&(m.searchOnEnter?a("input",t).keypress(function(a){return 13===(a.charCode||a.keyCode||0)?(B(),
!1):this}):a("input",t).keydown(function(a){switch(a.which){case 13:return!1;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:V&&clearTimeout(V),V=setTimeout(function(){B()},m.autosearchDelay)}}));break;case "custom":a("td",T).eq(1).append("<span style='width:95%;padding:0;' class='"+C+"' name='"+(this.index||this.name)+"' id='gs_"+this.name+"'/>");a(t).append(T);try{if(a.isFunction(d.custom_element))if(I=d.custom_element.call(f,void 0!==d.defaultValue?d.defaultValue:"",d))I=a(I).addClass("customelement"),
a(t).find("span[name='"+(this.index||this.name)+"']").append(I);else throw"e2";else throw"e1";}catch(k){"e1"===k&&l.call(f,w,"function 'custom_element' "+q.nodefined,A),"e2"===k?l.call(f,w,"function 'custom_element' "+q.novalue,A):l.call(f,w,"string"===typeof k?k:k.message,A)}}}a(y).append(t);a(J).append(y);m.searchOperators||a("td",T).eq(0).hide()});a(h.hDiv).find(">div>.ui-jqgrid-htable>thead").append(J);m.searchOperators&&(a(".soptclass",J).click(function(b){var c=a(this).offset();v(this,c.left,
...
f.ftoolbar=!0;f.triggerToolbar=B;f.clearToolbar=function(e){var d={},l=0,u;e="boolean"!==typeof e?!0:e;a.each(g,function(){var b,e=a("#gs_"+t(this.name),!0===this.frozen&&!0===c.frozenColumns?h.fhDiv:h.hDiv),g,m=this.searchoptions||{};void 0!==m.defaultValue&&(b=m.defaultValue);u=this.index||this.name;switch(this.stype){case "select":g=0<e.length?!e[0].multiple:!0;e.find("option").each(function(c){this.selected=0===c&&g;if(a(this).val()===b)return this.selected=!0,!1});if(void 0!==b)d[u]=b,l++;else try{delete c.postData[u]}catch(q){}break;
case "text":e.val(b||"");if(void 0!==b)d[u]=b,l++;else try{delete c.postData[u]}catch(p){}break;case "custom":a.isFunction(m.custom_value)&&0<e.length&&"SPAN"===e[0].nodeName.toUpperCase()&&m.custom_value.call(f,e.children(".customelement").filter(":first"),"set",b||"")}});var q=0<l?!0:!1;c.resetsearch=!0;if(m.stringResult||m.searchOperators||"local"===c.datatype){var p='{"groupOp":"'+m.groupOp+'","rules":[',n=0;a.each(d,function(a,b){0<n&&(p+=",");p+='{"field":"'+a+'",';p+='"op":"eq",';p+='"data":"'+
...
setFrozenColumns:function(){return this.each(function(){var d=this,f=a(d),h=d.p,b=d.grid;if(b&&null!=h&&!0!==h.frozenColumns){var c=h.colModel,e,l=c.length,m=-1,g=!1,u=[],p=t(h.id),A=n.call(d,"states.hover"),q=n.call(d,"states.disabled");if(!0!==h.subGrid&&!0!==h.treeGrid&&!h.scroll){for(e=0;e<l&&!0===c[e].frozen;e++)g=!0,m=e,u.push("#jqgh_"+p+"_"+t(c[e].name));h.sortable&&(c=a(b.hDiv).find(".ui-jqgrid-htable .ui-jqgrid-labels"),c.sortable("destroy"),f.jqGrid("setGridParam",{sortable:{options:{items:0<
u.length?">th:not(:has("+u.join(",")+"),:hidden)":">th:not(:hidden)"}}}),f.jqGrid("sortableColumns",c));if(0<=m&&g){g=h.caption?a(b.cDiv).outerHeight():0;u=a(".ui-jqgrid-htable",h.gView).height();h.toppager&&(g+=a(b.topDiv).outerHeight());!0===h.toolbar[0]&&"bottom"!==h.toolbar[1]&&(g+=a(b.uDiv).outerHeight());b.fhDiv=a('<div style="position:absolute;overflow:hidden;" + (p.direction === "rtl" ? "right:0;" : "left:0;") + "top:'+g+"px;height:"+u+'px;" class="'+n.call(d,"hDiv","frozen-div ui-jqgrid-hdiv")+
'"></div>');b.fbDiv=a('<div style="position:absolute;overflow:hidden;" + (p.direction === "rtl" ? "right:0;" : "left:0;") + "top:'+(parseInt(g,10)+parseInt(u,10)+1)+'px;overflow:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>');a(h.gView).append(b.fhDiv);c=a(".ui-jqgrid-htable",h.gView).clone(!0);if(h.groupHeader){a("tr.jqg-first-row-header",c).each(function(){a("th:gt("+m+")",this).remove()});a("tr.jqg-third-row-header",c).each(function(){a(this).children("th[id]").each(function(){var b=a(this).attr("id");
...
!1}).scroll(function(){this.scrollLeft=0});h.footerrow&&(c=a(".ui-jqgrid-bdiv",h.gView).height(),b.fsDiv=a('<div style="position:absolute;" + (p.direction === "rtl" ? "right:0;" : "left:0;") + "top:'+(parseInt(g,10)+parseInt(u,10)+parseInt(c,10)+1)+'px;" class="frozen-sdiv ui-jqgrid-sdiv"></div>'),a(h.gView).append(b.fsDiv),g=a(".ui-jqgrid-ftable",h.gView).clone(!0),a("tr",g).each(function(){a("td:gt("+m+")",this).remove()}),a(g).width(1),a(b.fsDiv).append(g));f.bind("jqGridSortCol.setFrozenColumns",
...
var D=function(a,b){var c=a.height();1<=Math.abs(c-b)&&(a.height(b),c=a.height(),1<=Math.abs(b-c)&&a.height(b+Math.round(b-c)))},z=function(a,b){var c=a.width();1<=Math.abs(c-b)&&(a.width(b),c=a.width(),1<=Math.abs(b-c)&&a.width(b+Math.round(b-c)))},v=function(b,c){var d,g,l,f,u,q,p,n,v=a(c).position().top,A,w;if(null!=b&&0<b.length){b.css("rtl"===h.direction?{top:v,right:0}:{top:v,left:0});l=b.children("table").children("tbody,thead").children("tr");f=a(c).children("div").children("table").children("tbody,thead").children("tr");
g=Math.min(l.length,f.length);A=0<g?a(l[0]).position().top:0;w=0<g?a(f[0]).position().top:0;for(d=0;d<g;d++){u=a(f[d]);v=u.position().top;q=a(l[d]);p=q.position().top;n=u.height();if(null!=h.groupHeader&&h.groupHeader.useColSpanStyle&&0===n)for(e=n=0;e<m;e++)"TH"===u[0].cells[e].nodeName.toUpperCase()&&(n=Math.max(n,a(u[0].cells[e]).height()));u=n+(v-w)+(A-p);D(q,u)}D(b,c.clientHeight)}};f.bind("jqGridAfterGridComplete.setFrozenColumns",function(){a(h.idSel+"_frozen").remove();a(b.fbDiv).height(b.hDiv.clientHeight);
...
(function(a){var p=a.jgrid;a.fn.jqFilter=function(r){if("string"===typeof r){var t=a.fn.jqFilter[r];if(!t)throw"jqFilter - No such method: "+r;var n=a.makeArray(arguments).slice(1);return t.apply(this,n)}var d=a.extend(!0,{filter:null,columns:[],onChange:null,afterRedraw:null,checkValues:null,error:!1,errmsg:"",errorcheck:!0,showQuery:!0,sopt:null,ops:[],operands:null,numopts:"eq ne lt le gt ge nu nn in ni".split(" "),stropts:"eq ne bw bn ew en cn nc nu nn in ni".split(" "),strarr:["text","string",
...
(function(a){var p=a.jgrid,r=p.feedback,t=p.fullBoolFeedback,n=p.jqID,d=p.hideModal,f=p.viewModal,h=p.createModal,b=p.info_dialog,c=p.mergeCssClasses,e=p.hasOneFromClasses,l=a.fn.jqGrid,m=p.builderFmButon,g=function(a,b){var c=a[0].style[b];return 0<=c.indexOf("px")?parseFloat(c):c},u=function(b,c,e){var d=e.w;c=a(c);var l,f,h;e.c.toTop?(l=this.closest(".ui-jqgrid").offset(),f=d.offset(),h=f.top-l.top,l=f.left-l.left):(h=g(d,"top"),l=g(d,"left"));this.data(b,{top:h,left:l,width:g(d,"width"),height:g(d,
...
a.charCodeAt(0)};p.extend({searchGrid:function(b){return this.each(function(){function e(b){H("beforeShow",b)&&(a(R).data("onClose",v.onClose),f(R,{gbox:U,jqm:v.jqModal,overlay:v.overlay,modal:v.modal,overlayClass:v.overlayClass,toTop:v.toTop,onHide:function(a){u.call(w,"searchProp",y,a)}}),H("afterShow",b))}var g=this,w=a(g),z=g.p;if(g.grid&&null!=z){var v=a.extend(!0,{recreateFilter:!1,drag:!0,sField:"searchField",sValue:"searchString",sOper:"searchOper",sFilter:"filters",loadDefaults:!0,beforeShowSearch:null,
...
ge:">=",bw:"LIKE",bn:"NOT LIKE","in":"IN",ni:"NOT IN",ew:"LIKE",en:"NOT LIKE",cn:"LIKE",nc:"NOT LIKE",nu:"IS NULL",nn:"IS NOT NULL"}},l.getGridRes.call(w,"search"),p.search||{},z.searching||{},b||{}),y="fbox_"+z.id,J=v.commonIconClass,G={themodal:"searchmod"+y,modalhead:"searchhd"+y,modalcontent:"searchcnt"+y,resizeAlso:y},R="#"+n(G.themodal),U=z.gBox,F=z.gView,K=z.postData[v.sFilter],H=function(){var b=a.makeArray(arguments);b.unshift("Search");b.unshift("Filter");b.unshift(v);return r.apply(g,b)};
"string"===typeof K&&(K=p.parse(K));!0===v.recreateFilter?a(R).remove():w.data("searchProp")&&a.extend(v,w.data("searchProp"));if(void 0!==a(R)[0])e(a("#fbox_"+z.idSel));else{var N=a("<div><div id='"+y+"' class='searchFilter' style='overflow:auto'></div></div>").insertBefore(F);"rtl"===z.direction&&N.attr("dir","rtl");var Y="",X="",T,x=!1,O,aa=-1,Q=a.extend([],z.colModel);O=m.call(g,y+"_search",v.Find,c(J,v.findDialogIcon),"right");var I=m.call(g,y+"_reset",v.Reset,c(J,v.resetDialogIcon),"left");
v.showQuery&&(Y=m.call(g,y+"_query","Query",c(J,v.queryDialogIcon),"left")+"&#160;");v.columns.length?(Q=v.columns,aa=0,T=Q[0].index||Q[0].name):a.each(Q,function(a,b){b.label||(b.label=z.colNames[a]);if(!x){var c=void 0===b.search?!0:b.search,e=!0===b.hidden;if(b.searchoptions&&!0===b.searchoptions.searchhidden&&c||c&&!e)x=!0,T=b.index||b.name,aa=a}});if(!K&&T||!1===v.multipleSearch)J="eq",0<=aa&&Q[aa].searchoptions&&Q[aa].searchoptions.sopt?J=Q[aa].searchoptions.sopt[0]:v.sopt&&v.sopt.length&&(J=
v.sopt[0]),K={groupOp:"AND",rules:[{field:T,op:J,data:""}]};x=!1;v.tmplNames&&v.tmplNames.length&&(x=!0,X=v.tmplLabel,X+="<select class='ui-template'>",X+="<option value='default'>Default</option>",a.each(v.tmplNames,function(a,b){X+="<option value='"+a+"'>"+b+"</option>"}),X+="</select>");O="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+y+"_2'><tbody><tr><td colspan='2'><hr class='"+A.call(g,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='EditButton EditButton-"+
z.direction+"'  style='float:"+("rtl"===z.direction?"right":"left")+";'>"+I+X+"</td><td class='EditButton EditButton-"+z.direction+"'>"+Y+O+"</td></tr></tbody></table>";y=n(y);v.gbox="#gbox_"+y;v.height="auto";y="#"+y;a(y).jqFilter({columns:Q,filter:v.loadDefaults?K:null,showQuery:v.showQuery,errorcheck:v.errorcheck,sopt:v.sopt,groupButton:v.multipleGroup,ruleButtons:v.multipleSearch,afterRedraw:v.afterRedraw,ops:v.odata,cops:z.customSortOperations,operands:v.operands,ajaxSelectOptions:z.ajaxSelectOptions,
groupOps:v.groupOps,onChange:function(){this.p.showQuery&&a(".query",this).html(this.toUserFriendlyString());t.call(g,v.afterChange,"jqGridFilterAfterChange",a(y),v)},direction:z.direction,id:z.id});N.append(O);x&&v.tmplFilters&&v.tmplFilters.length&&a(".ui-template",N).bind("change",function(){var b=a(this).val();"default"===b?a(y).jqFilter("addFilter",K):a(y).jqFilter("addFilter",v.tmplFilters[parseInt(b,10)]);return!1});!0===v.multipleGroup&&(v.multipleSearch=!0);H("onInitialize",a(y));v.layer?
h.call(g,G,N,v,F,a(U)[0],"#"+n(v.layer),{position:"relative"}):h.call(g,G,N,v,F,a(U)[0]);(v.searchOnEnter||v.closeOnEscape)&&a(R).keydown(function(b){var c=a(b.target);if(!(!v.searchOnEnter||13!==b.which||c.hasClass("add-group")||c.hasClass("add-rule")||c.hasClass("delete-group")||c.hasClass("delete-rule")||c.hasClass("fm-button")&&c.is("[id$=_query]")))return a(y+"_search").click(),!1;if(v.closeOnEscape&&27===b.which)return a("#"+n(G.modalhead)).find(".ui-jqdialog-titlebar-close").click(),!1});Y&&
...
d(R,{gb:U,jqm:v.jqModal,onClose:v.onClose,removemodal:v.removemodal});return!1});a(y+"_reset").bind("click",function(){var b={},c=a(y);z.search=!1;z.resetsearch=!0;!1===v.multipleSearch?b[v.sField]=b[v.sValue]=b[v.sOper]="":b[v.sFilter]="";c[0].resetFilter();x&&a(".ui-template",N).val("default");a.extend(z.postData,b);t.call(g,v.onReset,"jqGridFilterReset")&&w.trigger("reloadGrid",[a.extend({page:1},v.reloadGridResetOptions||{})]);v.closeAfterReset&&d(R,{gb:U,jqm:v.jqModal,onClose:v.onClose,removemodal:v.removemodal});
return!1});e(a(y));var L=q.call(g,"hover");a(".fm-button:not(."+q.call(g,"disabled").split(" ").join(".")+")",N).hover(function(){a(this).addClass(L)},function(){a(this).removeClass(L)})}}})},editGridRow:function(g,t){return this.each(function(){function B(){a(I+" > tbody > tr > td .FormElement").each(function(){var c=a(".customelement",this),e=this.name;if(c.length){if(e=c.attr("name"),c=ha[e],void 0!==c&&(c=ca[c],c=c.editoptions||{},a.isFunction(c.custom_value))){try{if(P[e]=c.custom_value.call(K,
a("#"+n(e),I),"get"),void 0===P[e])throw"e1";}catch(d){"e1"===d?b.call(K,fa,"function 'custom_value' "+x.msg.novalue,x.bClose):b.call(K,fa,d.message,x.bClose)}return!0}}else{switch(a(this)[0].type){case "checkbox":P[e]=a(this).is(":checked")?a(this).val():a(this).data("offval");break;case "select-one":P[e]=a("option:selected",this).val();break;case "select-multiple":P[e]=a(this).val();P[e]=P[e]?P[e].join(","):"";a("option:selected",this).each(function(b,c){a(c).text()});break;case "password":case "text":case "textarea":case "button":P[e]=
a(this).val();break;case "date":P[e]=a(this).val(),3===String(P[e]).split("-").length&&(c=ha[e],void 0!==c&&(c=ca[c],c=c.formatoptions||{},c=c.newformat||X.call(H,"formatter.date.newformat"),P[e]=p.parseDate.call(H[0],"Y-m-d",P[e],c)))}N.autoencode&&(P[e]=p.htmlEncode(P[e]))}});return!0}function D(b,c,e){var d=0,g=[],f=!1,k="",h;for(h=1;h<=e;h++)k+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==b&&(f=l.getInd.call(H,b));a(ca).each(function(l){var h=this.name,m,u,q,v,
w;m=this.editable;var r=!1,z=!1;w="_empty"===b?"addForm":"editForm";a.isFunction(m)&&(m=m.call(K,{rowid:b,iCol:l,iRow:f,cmName:h,cm:this,mode:w}));v=(this.editrules&&!0===this.editrules.edithidden?0:!0===this.hidden||"hidden"===m)?"style='display:none'":"";switch(String(m).toLowerCase()){case "hidden":m=!0;break;case "disabled":r=m=!0;break;case "readonly":z=m=!0}if("cb"!==h&&"subgrid"!==h&&!0===m&&"rn"!==h){if(!1===f)q="";else{m=a(K.rows[f].cells[l]);try{q=a.unformat.call(K,m,{rowId:b,colModel:this},
l)}catch(B){q=this.edittype&&"textarea"===this.edittype?m.text():m.html()}y(q)&&(q="")}m=a.extend({},this.editoptions||{},{id:h,name:h,rowId:b,mode:w});var D=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),t=parseInt(D.rowpos,10)||d+1,C=parseInt(2*(parseInt(D.colpos,10)||1),10);"_empty"===b&&m.defaultValue&&(q=a.isFunction(m.defaultValue)?m.defaultValue.call(K):m.defaultValue);this.edittype||(this.edittype="text");N.autoencode&&(q=p.htmlDecode(q));w=p.createEl.call(K,
this.edittype,m,q,!1,a.extend({},p.ajaxOptions,N.ajaxSelectOptions||{}));if(x.checkOnSubmit||x.checkOnUpdate)x._savedData[h]=q;a(w).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(w).addClass(A.call(K,"dialog.dataField"));u=a(c).find("tr[data-rowpos="+t+"]");if(D.rowabove){var E=a("<tr><td class='contentinfo' colspan='"+2*e+"'>"+D.rowcontent+"</td></tr>");a(c).append(E);E[0].rp=t}0===u.length&&(u=a("<tr "+v+" data-rowpos='"+t+"'></tr>").addClass("FormData").attr("id",
"tr_"+h),a(u).append(k),a(c).append(u),u[0].rp=t);v=a("td:eq("+(C-2)+")",u[0]);u=a("td:eq("+(C-1)+")",u[0]);v.html(void 0===D.label?N.colNames[l]:D.label||"&#160;");u[y(u.html())?"html":"append"](D.elmprefix).append(w).append(D.elmsuffix);r?(v.addClass(ga),u.addClass(ga),a(w).prop("readonly",!0),a(w).prop("disabled",!0)):z&&a(w).prop("readonly",!0);"custom"===this.edittype&&a.isFunction(m.custom_value)&&m.custom_value.call(K,a("#"+n(h),O),"set",q);p.bindEv.call(K,w,m);g[d]=l;d++}});0<d&&(h=a("<tr class='FormData' style='display:none'><td class='CaptionTD'>&#160;</td><td colspan='"+
(2*e-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+Y+"_id' value='"+b+"'/></td></tr>"),h[0].rp=d+999,a(c).append(h),x.checkOnSubmit||x.checkOnUpdate)&&(x._savedData[Y+"_id"]=b);return g}function z(c,e){var d,g=0,f,h,k,m,u;if(x.checkOnSubmit||x.checkOnUpdate)x._savedData={},x._savedData[Y+"_id"]=c;var q=N.colModel;if("_empty"===c)a(q).each(function(){d=this.name;k=a.extend({},this.editoptions||{});(h=a("#"+n(d),e))&&h.length&&null!==h[0]&&(m="","custom"===this.edittype&&
a.isFunction(k.custom_value)?k.custom_value.call(K,h,"set",m):k.defaultValue?(m=a.isFunction(k.defaultValue)?k.defaultValue.call(K):k.defaultValue,"checkbox"===h[0].type?(u=m.toLowerCase(),0>u.search(/(false|f|0|no|n|off|undefined)/i)&&""!==u?(h[0].checked=!0,h[0].defaultChecked=!0,h[0].value=m):(h[0].checked=!1,h[0].defaultChecked=!1)):h.val(m)):"checkbox"===h[0].type?(h[0].checked=!1,h[0].defaultChecked=!1,m=a(h).data("offval")):h[0].type&&"select"===h[0].type.substr(0,6)?h[0].selectedIndex=0:h.val(m),
!0===x.checkOnSubmit||x.checkOnUpdate)&&(x._savedData[d]=m)}),a("#id_g",e).val(c);else{var v=l.getInd.call(H,c,!0);v&&(a(v.cells).filter("td[role=gridcell]").each(function(l){d=q[l].name;if("cb"!==d&&"subgrid"!==d&&"rn"!==d&&!0===q[l].editable){try{f=a.unformat.call(K,a(this),{rowId:c,colModel:q[l]},l)}catch(h){f="textarea"===q[l].edittype?a(this).text():a(this).html()}N.autoencode&&(f=p.htmlDecode(f));if(!0===x.checkOnSubmit||x.checkOnUpdate)x._savedData[d]=f;d="#"+n(d);switch(q[l].edittype){case "password":case "text":case "button":case "image":case "textarea":y(f)&&
...
e)[ba]({checked:!0,defaultChecked:!0});else a(d,e)[ba]({checked:!1,defaultChecked:!1});else f=f.toLowerCase(),0>f.search(/(false|f|0|no|n|off|undefined)/i)&&""!==f?(a(d,e)[ba]("checked",!0),a(d,e)[ba]("defaultChecked",!0)):(a(d,e)[ba]("checked",!1),a(d,e)[ba]("defaultChecked",!1));break;case "custom":try{if(q[l].editoptions&&a.isFunction(q[l].editoptions.custom_value))q[l].editoptions.custom_value.call(K,a(d,e),"set",f);else throw"e1";}catch(m){"e1"===m?b.call(K,fa,"function 'custom_value' "+x.msg.nodefined,
x.bClose):b.call(K,fa,m.message,x.bClose)}}g++}}),0<g&&a("#id_g",I).val(c))}}function v(){var b=x.url||N.editurl;a.each(ca,function(c,e){var d=e.name,g=P[d];"date"!==e.formatter||null!=e.formatoptions&&!0===e.formatoptions.sendFormatted||(P[d]=a.unformat.date.call(K,g,e));"clientArray"!==b&&e.editoptions&&!0===e.editoptions.NullIfEmpty&&P.hasOwnProperty(d)&&""===g&&(P[d]="null")})}function V(){var b=[!0,"",""],c={},e=N.prmNames,g,f,h,k,m,u=H.triggerHandler("jqGridAddEditBeforeCheckValues",[a(O),M]);
u&&"object"===typeof u&&(P=u);a.isFunction(x.beforeCheckValues)&&(u=x.beforeCheckValues.call(K,P,a(O),M))&&"object"===typeof u&&(P=u);for(h in P)if(P.hasOwnProperty(h)&&(b=p.checkValues.call(K,P[h],h),!1===b[0]))break;v();b[0]&&(c=H.triggerHandler("jqGridAddEditClickSubmit",[x,P,M]),void 0===c&&a.isFunction(x.onclickSubmit)&&(c=x.onclickSubmit.call(K,x,P,M)||{}),b=H.triggerHandler("jqGridAddEditBeforeSubmit",[P,a(O),M]),void 0===b&&(b=[!0,"",""]),b[0]&&a.isFunction(x.beforeSubmit)&&(b=x.beforeSubmit.call(K,
P,a(O),M)));if(b[0]&&!x.processing){x.processing=!0;a("#sData",L).addClass(Ea);h=x.url||N.editurl;f=e.oper;g="clientArray"===h&&!1!==N.keyName?N.keyName:e.id;P[f]="_empty"===a.trim(P[Y+"_id"])?e.addoper:e.editoper;P[f]!==e.addoper?P[g]=P[Y+"_id"]:void 0===P[g]&&(P[g]=P[Y+"_id"]);delete P[Y+"_id"];P=a.extend(P,x.editData,c);if(!0===N.treeGrid)for(m in P[f]===e.addoper&&(k=N.selrow,P["adjacency"===N.treeGridModel?N.treeReader.parent_id_field:"parent_id"]=k),N.treeReader)N.treeReader.hasOwnProperty(m)&&
(c=N.treeReader[m],!P.hasOwnProperty(c)||P[f]===e.addoper&&"parent_id_field"===m||delete P[c]);P[g]=p.stripPref(N.idPrefix,P[g]);m=a.extend({url:h,type:x.mtype,data:p.serializeFeedback.call(K,a.isFunction(x.serializeEditData)?x.serializeEditData:N.serializeEditData,"jqGridAddEditSerializeEditData",P),complete:function(c,h){a("#sData",L).removeClass(Ea);P[g]=N.idPrefix+a("#id_g",I).val();300<=c.status&&304!==c.status||0===c.status&&4===c.readyState?(b[0]=!1,b[1]=H.triggerHandler("jqGridAddEditErrorTextFormat",
[c,M]),a.isFunction(x.errorTextFormat)?b[1]=x.errorTextFormat.call(K,c,M):b[1]=h+" Status: '"+c.statusText+"'. Error code: "+c.status):(b=H.triggerHandler("jqGridAddEditAfterSubmit",[c,P,M]),void 0===b&&(b=[!0,"",""]),b[0]&&a.isFunction(x.afterSubmit)&&(b=x.afterSubmit.call(K,c,P,M)));if(!1===b[0])a("#FormError>td",I).html(b[1]),a("#FormError",I).show();else{N.autoencode&&a.each(P,function(a,b){P[a]=p.htmlDecode(b)});var m=[a.extend({},x.reloadGridOptions||{})];P[f]===e.addoper?(b[2]||(b[2]=p.randId()),
null==P[g]||"_empty"===P[g]||P[f]===e.addoper?P[g]=b[2]:b[2]=P[g],x.reloadAfterSubmit?H.trigger("reloadGrid",m):!0===N.treeGrid?l.addChildNode.call(H,b[2],k,P):l.addRowData.call(H,b[2],P,x.addedrow),x.closeAfterAdd?(!0!==N.treeGrid&&T.call(H,b[2]),d(S,{gb:W,jqm:x.jqModal,onClose:x.onClose,removemodal:x.removemodal,formprop:!x.recreateForm,form:x.form})):x.clearAfterAdd&&z("_empty",O)):(x.reloadAfterSubmit?(H.trigger("reloadGrid",m),x.closeAfterEdit||setTimeout(function(){T.call(H,P[g])},1E3)):!0===
N.treeGrid?l.setTreeRow.call(H,P[g],P):l.setRowData.call(H,P[g],P),x.closeAfterEdit&&d(S,{gb:W,jqm:x.jqModal,onClose:x.onClose,removemodal:x.removemodal,formprop:!x.recreateForm,form:x.form}));if(a.isFunction(x.afterComplete)){var u=c;setTimeout(function(){H.triggerHandler("jqGridAddEditAfterComplete",[u,P,a(O),M]);x.afterComplete.call(K,u,P,a(O),M);u=null},50)}if(x.checkOnSubmit||x.checkOnUpdate)if(a(O).data("disabled",!1),"_empty"!==x._savedData[Y+"_id"])for(var q in x._savedData)x._savedData.hasOwnProperty(q)&&
P[q]&&(x._savedData[q]=P[q])}x.processing=!1;try{a(":input:visible",O)[0].focus()}catch(n){}}},p.ajaxOptions,x.ajaxEditOptions);m.url||x.useDataProxy||(a.isFunction(N.dataProxy)?x.useDataProxy=!0:(b[0]=!1,b[1]+=" "+p.errors.nourl));b[0]&&(x.useDataProxy?(c=N.dataProxy.call(K,m,"set_"+Y),void 0===c&&(c=[!0,""]),!1===c[0]?(b[0]=!1,b[1]=c[1]||"Error deleting the selected row!"):(m.data.oper===e.addoper&&x.closeAfterAdd&&d(S,{gb:W,jqm:x.jqModal,onClose:x.onClose,removemodal:x.removemodal,formprop:!x.recreateForm,
form:x.form}),m.data.oper===e.editoper&&x.closeAfterEdit&&d(S,{gb:W,jqm:x.jqModal,onClose:x.onClose,removemodal:x.removemodal,formprop:!x.recreateForm,form:x.form}))):"clientArray"===m.url?(x.reloadAfterSubmit=!1,P=m.data,m.complete({status:200,statusText:""},"")):a.ajax(m))}!1===b[0]&&(a("#FormError>td",I).html(b[1]),a("#FormError",I).show())}function J(a,b){var c=!1,e;for(e in a)if(a.hasOwnProperty(e)&&String(a[e])!==String(b[e])){c=!0;break}return c}function G(){var b=!0;a("#FormError",I).hide();
x.checkOnUpdate&&(P={},B(),ea=J(P,x._savedData))&&(a(O).data("disabled",!0),a(".confirm",S).show(),b=!1);return b}function R(){var b=p.detectRowEditing.call(K,g);if(null!=b)if("inlineEditing"===b.mode)l.restoreRow.call(H,g);else{var b=b.savedRow,c=K.rows[b.id];l.restoreCell.call(H,b.id,b.ic);a(c.cells[b.ic]).removeClass("edit-cell "+za);a(c).addClass(za).attr({"aria-selected":"true",tabindex:"0"})}}function U(b,c){var d=c[1].length-1;0===b?a("#pData",L).addClass(ga):void 0!==c[1][b-1]&&e(a("#"+n(c[1][b-
1])),ga)?a("#pData",L).addClass(ga):a("#pData",L).removeClass(ga);b===d?a("#nData",L).addClass(ga):void 0!==c[1][b+1]&&e(a("#"+n(c[1][b+1])),ga)?a("#nData",L).addClass(ga):a("#nData",L).removeClass(ga)}function F(){var b=l.getDataIDs.call(H),c=a("#id_g",I).val();return[a.inArray(c,b),b]}var K=this,H=a(K),N=K.p;if(K.grid&&null!=N&&g){var Y=N.id,X=l.getGridRes,T=l.setSelection,x=a.extend(!0,{top:0,left:0,width:300,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,url:null,mtype:"POST",
...
overlayClass:"ui-widget-overlay",removemodal:!0,form:"edit"},X.call(H,"edit"),p.edit,N.formEditing||{},t||{}),O="FrmGrid_"+Y,aa=O,Q="TblGrid_"+Y,I="#"+n(Q),L=I+"_2",k={themodal:"editmod"+Y,modalhead:"edithd"+Y,modalcontent:"editcnt"+Y,resizeAlso:O},S="#"+n(k.themodal),W=N.gBox,ba=N.propOrAttr,ca=N.colModel,ha=N.iColByName,ja=1,da=0,P,ea,M,Z=x.commonIconClass,fa=X.call(H,"errors.errcap"),ka=function(){var b=a.makeArray(arguments);b.unshift("");b.unshift("AddEdit");b.unshift(x);return r.apply(K,b)},
xa=q.call(K,"hover"),ga=q.call(K,"disabled"),za=q.call(K,"select"),Ea=q.call(K,"active"),ma=q.call(K,"error"),O="#"+n(O);"new"===g?(g="_empty",M="add",x.caption=x.addCaption):(x.caption=x.editCaption,M="edit");if(!x.recreateForm){var pa=H.data("formProp");pa&&(pa.top=Math.max(pa.top,0),pa.left=Math.max(pa.left,0),a.extend(x,pa))}pa=!0;!x.checkOnUpdate||!0!==x.jqModal&&void 0!==x.jqModal||x.modal||(pa=!1);var ta=isNaN(x.dataheight)?x.dataheight:x.dataheight+"px",la=isNaN(x.datawidth)?x.datawidth:x.datawidth+
...
2*ja+"'>&#160;</td></tr>");ma[0].rp=0;a(wa).append(ma);ma=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*ja+"'>"+(x.topinfo||"&#160;")+"</td></tr>");ma[0].rp=0;a(wa).append(ma);if(ka("beforeInitData",aa,M)){R();ta=(ma="rtl"===N.direction?!0:!1)?"nData":"pData";la=ma?"pData":"nData";D(g,wa,ja);var ta=m.call(K,ta,"",c(Z,x.prevIcon),"","left"),la=m.call(K,la,"",c(Z,x.nextIcon),"","right"),Aa=m.call(K,"sData",x.bSubmit),ua=m.call(K,"cData",x.bCancel),Q="<table"+(p.msie&&8>
p.msiever()?" cellspacing='0'":"")+" class='EditTable' id='"+Q+"_2'><tbody><tr><td colspan='2'><hr class='"+A.call(K,"dialog.hr")+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-"+N.direction+"'>"+(ma?la+ta:ta+la)+"</td><td class='EditButton EditButton-"+N.direction+"'>"+Aa+"&#160;"+ua+"</td></tr>",Q=Q+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+(x.bottominfo||"&#160;")+"</td></tr>"),Q=Q+"</tbody></table>";if(0<da){var va=[];a.each(a(wa)[0].rows,
function(a,b){va[a]=b});va.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(va,function(b,c){a("tbody",wa).append(c)})}x.gbox=W;var qa=!1;!0===x.closeOnEscape&&(x.closeOnEscape=!1,qa=!0);Q=a("<div></div>").append(aa).append(Q);h.call(K,k,Q,x,N.gView,a(W)[0]);x.topinfo&&a(".tinfo",I).show();x.bottominfo&&a(".binfo",L).show();Q=Q=null;a(S).keydown(function(b){var c=(b.target.tagName||"").toUpperCase(),e,g;if(!0===a(O).data("disabled"))return!1;if(13===b.which&&"TEXTAREA"!==c){e=a(L).find(":focus");
g=e.attr("id");if(0<e.length&&0<=a.inArray(g,["pData","nData","cData"]))return e.trigger("click"),!1;if(!0===x.savekey[0]&&13===x.savekey[1])return a("#sData",L).trigger("click"),!1}if(!0===x.savekey[0]&&b.which===x.savekey[1]&&"TEXTAREA"!==c)return a("#sData",L).trigger("click"),!1;if(27===b.which){if(!G())return!1;qa&&d(S,{gb:x.gbox,jqm:x.jqModal,onClose:x.onClose,removemodal:x.removemodal,formprop:!x.recreateForm,form:x.form});return!1}if(!0===x.navkeys[0]){if("_empty"===a("#id_g",I).val())return!0;
if(b.which===x.navkeys[1])return a("#pData",L).trigger("click"),!1;if(b.which===x.navkeys[2])return a("#nData",L).trigger("click"),!1}});x.checkOnUpdate&&(a("a.ui-jqdialog-titlebar-close span",S).removeClass("jqmClose"),a("a.ui-jqdialog-titlebar-close",S).unbind("click").click(function(){if(!G())return!1;d(S,{gb:W,jqm:x.jqModal,onClose:x.onClose,removemodal:x.removemodal,formprop:!x.recreateForm,form:x.form});return!1}));w(a("#sData",L),x.saveicon,Z);w(a("#cData",L),x.closeicon,Z);if(x.checkOnSubmit||
x.checkOnUpdate)Aa=m.call(K,"sNew",x.bYes),la=m.call(K,"nNew",x.bNo),ua=m.call(K,"cNew",x.bExit),k=x.zIndex||999,k++,a("<div class='"+x.overlayClass+" jqgrid-overlay confirm' style='z-index:"+k+";display:none;'>&#160;</div><div class='"+A.call(K,"dialog.content","confirm ui-jqconfirm")+"' style='z-index:"+(k+1)+"'>"+x.saveData+"<br/><br/>"+Aa+la+ua+"</div>").insertAfter(O),a("#sNew",S).click(function(){V();a(O).data("disabled",!1);a(".confirm",S).hide();return!1}),a("#nNew",S).click(function(){a(".confirm",
S).hide();a(O).data("disabled",!1);setTimeout(function(){a(":input:visible",O)[0].focus()},0);return!1}),a("#cNew",S).click(function(){a(".confirm",S).hide();a(O).data("disabled",!1);d(S,{gb:W,jqm:x.jqModal,onClose:x.onClose,removemodal:x.removemodal,formprop:!x.recreateForm,form:x.form});return!1});ka("onInitializeForm",a(O),M);"_empty"!==g&&x.viewPagerButtons?a("#pData,#nData",L).show():a("#pData,#nData",L).hide();ka("beforeShowForm",a(O),M);a(S).data("onClose",x.onClose);f(S,{gbox:W,jqm:x.jqModal,
overlay:x.overlay,modal:x.modal,overlayClass:x.overlayClass,toTop:x.toTop,onHide:function(a){u.call(H,"formProp",O,a)}});pa||a("."+n(x.overlayClass)).click(function(){if(!G())return!1;d(S,{gb:W,jqm:x.jqModal,onClose:x.onClose,removemodal:x.removemodal,formprop:!x.recreateForm,form:x.form});return!1});a(".fm-button",S).hover(function(){a(this).addClass(xa)},function(){a(this).removeClass(xa)});a("#sData",L).click(function(){P={};a("#FormError",I).hide();B();"_empty"===P[Y+"_id"]?V():!0===x.checkOnSubmit?
(ea=J(P,x._savedData))?(a(O).data("disabled",!0),a(".confirm",S).show()):V():V();return!1});a("#cData",L).click(function(){if(!G())return!1;d(S,{gb:W,jqm:x.jqModal,onClose:x.onClose,removemodal:x.removemodal,formprop:!x.recreateForm,form:x.form});return!1});a("#nData",L).click(function(){if(!G())return!1;a("#FormError",I).hide();var b=F();b[0]=parseInt(b[0],10);if(-1!==b[0]&&b[1][b[0]+1]){if(!ka("onclickPgButtons","next",a(O),b[1][b[0]]))return!1;z(b[1][b[0]+1],O);T.call(H,b[1][b[0]+1]);ka("afterclickPgButtons",
"next",a(O),b[1][b[0]+1]);U(b[0]+1,b)}return!1});a("#pData",L).click(function(){if(!G())return!1;a("#FormError",I).hide();var b=F();if(-1!==b[0]&&b[1][b[0]-1]){if(!ka("onclickPgButtons","prev",a(O),b[1][b[0]])||e(a("#"+n(b[1][b[0]-1])),ga))return!1;z(b[1][b[0]-1],O);T.call(H,b[1][b[0]-1]);ka("afterclickPgButtons","prev",a(O),b[1][b[0]-1]);U(b[0]-1,b)}return!1});ka("afterShowForm",a(O),M);k=F();U(k[0],k)}}})},viewGridRow:function(b,g){return this.each(function(){function B(){!0!==F.closeOnEscape&&
!0!==F.navkeys[0]||setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+n(x.modalhead)).attr("tabindex","-1").focus()},0)}function D(b,c,e){var d,g,f,h=0,k,m,u=[],q=l.getInd.call(G,b),n;n=A.call(J,"dialog.viewData","DataTD form-view-data");var v=A.call(J,"dialog.viewLabel","CaptionTD form-view-label"),w="<td class='"+v+"' width='"+F.labelswidth+"'>&#160;</td><td class='"+n+" ui-helper-reset'>&#160;</td>",r="",v="<td class='"+v+"'></td><td class='"+n+"'></td>",z=["integer","number","currency"],
x=0,B=0,D,t,C;for(n=1;n<=e;n++)r+=1===n?w:v;a(Q).each(function(){(g=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,z)?x=Math.max(x,parseInt(this.width,10)):B=Math.max(B,parseInt(this.width,10)))});D=0!==x?x:0!==B?B:0;a(Q).each(function(b){d=this.name;t=!1;m=(g=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";C="boolean"!==typeof this.viewable?!0:this.viewable;
if("cb"!==d&&"subgrid"!==d&&"rn"!==d&&C){k=!1===q?"":p.getDataFieldOfCell.call(J,J.rows[q],b).html();t="right"===this.align&&0!==D?!0:!1;var l=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),n=parseInt(l.rowpos,10)||h+1,v=parseInt(2*(parseInt(l.colpos,10)||1),10);if(l.rowabove){var w=a("<tr><td class='contentinfo' colspan='"+2*e+"'>"+l.rowcontent+"</td></tr>");a(c).append(w);w[0].rp=n}f=a(c).find("tr[data-rowpos="+n+"]");0===f.length&&(f=a("<tr "+m+" data-rowpos='"+n+"'></tr>").addClass("FormData").attr("id",
"trv_"+d),a(f).append(r),a(c).append(f),f[0].rp=n);l=void 0===l.label?R.colNames[b]:l.label;n=a("td:eq("+(v-1)+")",f[0]);a("td:eq("+(v-2)+")",f[0]).html("<b>"+(l||"&nbsp;")+"</b>");n[y(n.html())?"html":"append"]("<span>"+(k||"&nbsp;")+"</span>").attr("id","v_"+d);t&&a("td:eq("+(v-1)+") span",f[0]).css({"text-align":"right",width:D+"px"});u[h]=b;h++}});0<h&&(b=a("<tr class='FormData' style='display:none'><td class='CaptionTD'>&#160;</td><td colspan='"+(2*e-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+
b+"'/></td></tr>"),b[0].rp=h+99,a(c).append(b));return u}function z(b){var c,e,d=0,g=l.getInd.call(G,b,!0),f;g&&(a("td",g).each(function(b){f=Q[b];c=f.name;e=f.editrules&&!0===f.editrules.edithidden?!1:!0===f.hidden?!0:!1;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&(c=n("v_"+c),a("#"+c+" span",H).html(p.getDataFieldOfCell.call(J,g,b).html()),e&&a("#"+c,H).parents("tr:first").hide(),d++)}),0<d&&a("#id_g",H).val(b))}function v(b,c){var d=c[1].length-1;0===b?a("#pData",N).addClass(W):void 0!==c[1][b-1]&&e(a("#"+
n(c[1][b-1])),W)?a("#pData",N).addClass(W):a("#pData",N).removeClass(W);b===d?a("#nData",N).addClass(W):void 0!==c[1][b+1]&&e(a("#"+n(c[1][b+1])),W)?a("#nData",N).addClass(W):a("#nData",N).removeClass(W)}function t(){var b=l.getDataIDs.call(G),c=a("#id_g",H).val();return[a.inArray(c,b),b]}var J=this,G=a(J),R=J.p;if(J.grid&&null!=R&&b){var U=R.id,F=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,closeOnEscape:!1,labelswidth:"30%",navkeys:[!1,38,
40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0,recreateForm:!1,removemodal:!0,form:"view"},l.getGridRes.call(G,"view"),p.view||{},R.formViewing||{},g||{}),K="#ViewGrid_"+n(U),H="#ViewTbl_"+n(U),N=H+"_2",Y="ViewGrid_"+U,X="ViewTbl_"+U,T=F.commonIconClass,x={themodal:"viewmod"+U,modalhead:"viewhd"+U,modalcontent:"viewcnt"+U,resizeAlso:Y},O="#"+n(x.themodal),aa=R.gBox,Q=R.colModel,I=1,L=0,k=function(){var b=a.makeArray(arguments);b.unshift("");b.unshift("View");b.unshift(F);
return r.apply(J,b)},S=q.call(J,"hover"),W=q.call(J,"disabled");F.recreateForm||G.data("viewProp")&&a.extend(F,G.data("viewProp"));var U=isNaN(F.dataheight)?F.dataheight:F.dataheight+"px",ba=isNaN(F.datawidth)?F.datawidth:F.datawidth+"px",Y=a("<form name='FormPost' id='"+Y+"' class='FormGrid' style='width:"+ba+";overflow:auto;position:relative;height:"+U+";'></form>"),ca=a("<table id='"+X+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
a(Q).each(function(){var a=this.formoptions;I=Math.max(I,a?a.colpos||0:0);L=Math.max(L,a?a.rowpos||0:0)});Y.append(ca);if(k("beforeInitData",Y)){D(b,ca,I);var ha=(U="rtl"===R.direction?!0:!1)?"pData":"nData",ba=m.call(J,U?"nData":"pData","",c(T,F.prevIcon),"","left"),ha=m.call(J,ha,"",c(T,F.nextIcon),"","right"),ja=m.call(J,"cData",F.bClose);if(0<L){var da=[];a.each(a(ca)[0].rows,function(a,b){da[a]=b});da.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(da,function(b,c){a("tbody",ca).append(c)})}F.gbox=
aa;X=a("<div></div>").append(Y).append("<table border='0' class='EditTable' id='"+X+"_2'><tbody><tr id='Act_Buttons'><td class='navButton navButton-"+R.direction+"' width='"+(F.labelswidth||"auto")+"'>"+(U?ha+ba:ba+ha)+"</td><td class='EditButton EditButton-"+R.direction+"'>"+ja+"</td></tr></tbody></table>");h.call(J,x,X,F,R.gView,a(R.gView)[0]);F.viewPagerButtons||a("#pData, #nData",N).hide();X=null;a(O).keydown(function(b){var c,e;if(!0===a(K).data("disabled"))return!1;if(13===b.which&&(c=a(N).find(":focus"),
e=c.attr("id"),0<c.length&&0<=a.inArray(e,["pData","nData","cData"])))return c.trigger("click"),!1;if(27===b.which)return F.closeOnEscape&&d(O,{gb:aa,jqm:F.jqModal,onClose:F.onClose,removemodal:F.removemodal,formprop:!F.recreateForm,form:F.form}),!1;if(!0===F.navkeys[0]){if(b.which===F.navkeys[1])return a("#pData",N).trigger("click"),!1;if(b.which===F.navkeys[2])return a("#nData",N).trigger("click"),!1}});w(a("#cData",N),F.closeicon,T);k("beforeShowForm",a(K));f(O,{gbox:aa,jqm:F.jqModal,overlay:F.overlay,
toTop:F.toTop,modal:F.modal,onHide:function(a){u.call(G,"viewProp",K,a)}});a(".fm-button:not(."+W.split(" ").join(".")+")",N).hover(function(){a(this).addClass(S)},function(){a(this).removeClass(S)});B();a("#cData",N).click(function(){d(O,{gb:aa,jqm:F.jqModal,onClose:F.onClose,removemodal:F.removemodal,formprop:!F.recreateForm,form:F.form});return!1});a("#nData",N).click(function(){a("#FormError",H).hide();var b=t();b[0]=parseInt(b[0],10);if(-1!==b[0]&&b[1][b[0]+1]){if(!k("onclickPgButtons","next",
a(K),b[1][b[0]]))return!1;z(b[1][b[0]+1]);l.setSelection.call(G,b[1][b[0]+1]);k("afterclickPgButtons","next",a(K),b[1][b[0]+1]);v(b[0]+1,b)}B();return!1});a("#pData",N).click(function(){a("#FormError",H).hide();var b=t();if(-1!==b[0]&&b[1][b[0]-1]){if(!k("onclickPgButtons","prev",a(K),b[1][b[0]]))return!1;z(b[1][b[0]-1]);l.setSelection.call(G,b[1][b[0]-1]);k("afterclickPgButtons","prev",a(K),b[1][b[0]-1]);v(b[0]-1,b)}B();return!1});T=t();v(T[0],T)}}})},delGridRow:function(b,c){return this.each(function(){var e=
this,g=e.p,u=a(e);if(e.grid&&null!=g&&b){var v=g.id,t=a.extend(!0,{top:0,left:0,width:240,removemodal:!0,height:"auto",dataheight:"auto",drag:!0,resize:!0,url:"",mtype:"POST",reloadAfterSubmit:!0,beforeShowForm:null,beforeInitData:null,afterShowForm:null,beforeSubmit:null,onclickSubmit:null,afterSubmit:null,closeOnEscape:!1,delData:{},onClose:null,ajaxDelOptions:{},processing:!1,serializeDelData:null,useDataProxy:!1},l.getGridRes.call(u,"del"),p.del||{},g.formDeleting||{},c||{}),y="DelTbl_"+v,G="#DelTbl_"+
n(v),R,U,F,K,H={themodal:"delmod"+v,modalhead:"delhd"+v,modalcontent:"delcnt"+v,resizeAlso:y},N="#"+n(H.themodal),Y=g.gBox,X=t.commonIconClass,T=function(){var b=a.makeArray(arguments);b.unshift("");b.unshift("Delete");b.unshift(t);return r.apply(e,b)},x=q.call(e,"hover"),O=q.call(e,"active"),aa=q.call(e,"error");a.isArray(b)||(b=[String(b)]);if(void 0!==a(N)[0]){if(!T("beforeInitData",a(G)))return;a("#DelData>td",G).text(b.join()).data("rowids",b);a("#DelError",G).hide();!0===t.processing&&(t.processing=
!1,a("#dData",G).removeClass(O));T("beforeShowForm",a(G));f(N,{gbox:Y,jqm:t.jqModal,jqM:!1,overlay:t.overlay,toTop:t.toTop,modal:t.modal})}else{var Q=isNaN(t.dataheight)?t.dataheight:t.dataheight+"px",I=isNaN(t.datawidth)?t.datawidth:t.datawidth+"px",Q="<div id='"+y+"' class='formdata' style='width:"+I+";overflow:auto;position:relative;height:"+Q+";'><table class='DelTable'><tbody>",Q=Q+("<tr id='DelError' style='display:none'><td class='"+aa+"'></td></tr>"),Q=Q+("<tr id='DelData' style='display:none'><td >"+
b.join()+"</td></tr>"),Q=Q+('<tr><td class="delmsg" style="white-space:pre;">'+t.msg+"</td></tr><tr><td >&#160;</td></tr>"),Q=Q+"</tbody></table></div>",aa=m.call(e,"dData",t.bSubmit),I=m.call(e,"eData",t.bCancel),Q=Q+("<table"+(p.msie&&8>p.msiever()?" cellspacing='0'":"")+" class='EditTable' id='"+y+"_2'><tbody><tr><td><hr class='"+A.call(e,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton EditButton-"+g.direction+"'>"+aa+"&#160;"+I+"</td></tr></tbody></table>");t.gbox=
Y;h.call(e,H,Q,t,g.gView,a(g.gView)[0]);a("#DelData>td",G).data("rowids",b);if(!T("beforeInitData",a(Q)))return;a(".fm-button",G+"_2").hover(function(){a(this).addClass(x)},function(){a(this).removeClass(x)});w(a("#dData",G+"_2"),t.delicon,X);w(a("#eData",G+"_2"),t.cancelicon,X);a("#dData",G+"_2").click(function(){var b=[!0,""],c,f=a("#DelData>td",G),h=f.text(),m=f.data("rowids"),f={};a.isFunction(t.onclickSubmit)&&(f=t.onclickSubmit.call(e,t,h)||{});a.isFunction(t.beforeSubmit)&&(b=t.beforeSubmit.call(e,
h));if(b[0]&&!t.processing){t.processing=!0;F=g.prmNames;R=a.extend({},t.delData,f);K=F.oper;R[K]=F.deloper;U=F.id;h=m.slice();if(!h.length)return!1;for(c in h)h.hasOwnProperty(c)&&(h[c]=p.stripPref(g.idPrefix,h[c]));R[U]=h.join();a(this).addClass(O);c=a.extend({url:t.url||g.editurl,type:t.mtype,data:a.isFunction(t.serializeDelData)?t.serializeDelData.call(e,R):R,complete:function(c,f){var k;a("#dData",G+"_2").removeClass(O);300<=c.status&&304!==c.status||0===c.status&&4===c.readyState?(b[0]=!1,a.isFunction(t.errorTextFormat)?
b[1]=t.errorTextFormat.call(e,c):b[1]=f+" Status: '"+c.statusText+"'. Error code: "+c.status):a.isFunction(t.afterSubmit)&&(b=t.afterSubmit.call(e,c,R));if(!1===b[0])a("#DelError>td",G).html(b[1]),a("#DelError",G).show();else{if(t.reloadAfterSubmit&&"local"!==g.datatype)u.trigger("reloadGrid",[a.extend({},t.reloadGridOptions||{})]);else if(!0===g.treeGrid)try{l.delTreeNode.call(u,m[0])}catch(q){}else for(m=m.slice(),k=0;k<m.length;k++)l.delRowData.call(u,m[k]);setTimeout(function(){T("afterComplete",
c,h,a(G))},50)}t.processing=!1;b[0]&&d(N,{gb:Y,jqm:t.jqModal,onClose:t.onClose,removemodal:t.removemodal})}},p.ajaxOptions,t.ajaxDelOptions);c.url||t.useDataProxy||(a.isFunction(g.dataProxy)?t.useDataProxy=!0:(b[0]=!1,b[1]+=" "+p.errors.nourl));b[0]&&(t.useDataProxy?(c=g.dataProxy.call(e,c,"del_"+v),void 0===c&&(c=[!0,""]),!1===c[0]?(b[0]=!1,b[1]=c[1]||"Error deleting the selected row!"):d(N,{gb:Y,jqm:t.jqModal,onClose:t.onClose,removemodal:t.removemodal})):"clientArray"===c.url?(R=c.data,c.complete({status:200,
statusText:""},"")):a.ajax(c))}!1===b[0]&&(a("#DelError>td",G).html(b[1]),a("#DelError",G).show());return!1});a("#eData",G+"_2").click(function(){d(N,{gb:Y,jqm:t.jqModal,onClose:t.onClose,removemodal:t.removemodal});return!1});T("beforeShowForm",a(G));f(N,{gbox:Y,jqm:t.jqModal,overlay:t.overlay,toTop:t.toTop,modal:t.modal})}T("afterShowForm",a(G));!0===t.closeOnEscape&&setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+n(H.modalhead)).attr("tabindex","-1").focus()},0)}})},navGrid:function(b,
d,g,m,u,v,w){"object"===typeof b&&(w=v,v=u,u=m,m=g,g=d,d=b,b=void 0);m=m||{};g=g||{};w=w||{};u=u||{};v=v||{};return this.each(function(){var t=this,r=t.p,y=a(t);if(t.grid&&null!=r&&!(t.nav&&0<a(b).find(".navtable").length)){var U=r.id,F=a.extend({edit:!0,add:!0,del:!0,search:!0,refresh:!0,refreshstate:"firstpage",view:!1,closeOnEscape:!0,beforeRefresh:null,afterRefresh:null,cloneToTop:!1,hideEmptyPagerParts:!0,alertwidth:200,alertheight:"auto",alerttop:null,removemodal:!0,alertleft:null,alertzIndex:null,
iconsOverText:!1},l.getGridRes.call(y,"nav"),p.nav||{},r.navOptions||{},d||{});F.position=F.position||("rtl"===r.direction?"right":"left");var K,H=r.idSel,N=r.gBox,Y=F.commonIconClass,X={themodal:"alertmod_"+U,modalhead:"alerthd_"+U,modalcontent:"alertcnt_"+U},T=function(){return function(){var b=document.documentElement,c=window,e=1024,d=768,g=y.closest(".ui-jqgrid").offset();void 0===a("#"+n(X.themodal))[0]&&(F.alerttop||F.alertleft||(void 0!==c.innerWidth?(e=c.innerWidth,d=c.innerHeight):null!=
b&&void 0!==b.clientWidth&&0!==b.clientWidth&&(e=b.clientWidth,d=b.clientHeight),e=e/2-parseInt(F.alertwidth,10)/2-g.left,d=d/2-25-g.top),h.call(t,X,"<div>"+F.alerttext+"</div><span tabindex='0'><span tabindex='-1' id='"+U+"_jqg_alrt'></span></span>",{gbox:N,jqModal:F.jqModal,drag:!0,resize:!0,caption:F.alertcap,top:null!=F.alerttop?F.alerttop:d,left:null!=F.alertleft?F.alertleft:e,width:F.alertwidth,height:F.alertheight,closeOnEscape:F.closeOnEscape,zIndex:F.alertzIndex,removemodal:F.removemodal},
r.gView,a(N)[0],!1));f("#"+n(X.themodal),{gbox:N,toTop:F.alertToTop,jqm:F.jqModal});var l=a("#"+n(X.modalhead)).find(".ui-jqdialog-titlebar-close");l.attr({tabindex:"0",href:"#",role:"button"});setTimeout(function(){l.focus()},50)}}(),x,O=function(b){if(13===b.which&&(b=a(this).find(":focus"),0<b.length))return b.trigger("click"),!1},aa=q.call(t,"hover"),Q=q.call(t,"disabled");if(t.grid){t.modalAlert=T;void 0===b&&(r.pager?(b=r.pager,r.toppager&&(F.cloneToTop=!0)):r.toppager&&(b=r.toppager));var I=
1,L,k,S,W,ba,ca=["left","center","right"],ha="<div class='ui-pg-button "+Q+"'><span class='ui-separator'></span></div>",ja=function(){e(this,Q)||a(this).addClass(aa)},da=function(){a(this).removeClass(aa)},P=function(){e(this,Q)||(a.isFunction(F.addfunc)?F.addfunc.call(t):l.editGridRow.call(y,"new",m));return!1},ea=function(b,c,d){if(!e(this,Q)){var g=r.selrow;g?a.isFunction(b)?b.call(t,g):l[c].call(y,g,d):T()}return!1},M=function(){return ea.call(this,F.editfunc,"editGridRow",g)},Z=function(){return ea.call(this,
F.viewfunc,"viewGridRow",w)},fa=function(){var b;e(this,Q)||(r.multiselect?(b=r.selarrrow,0===b.length&&(b=null)):b=r.selrow,b?a.isFunction(F.delfunc)?F.delfunc.call(t,b):l.delGridRow.call(y,b,u):T());return!1},ka=function(){e(this,Q)||(a.isFunction(F.searchfunc)?F.searchfunc.call(t,v):l.searchGrid.call(y,v));return!1},xa=function(){if(!e(this,Q)){a.isFunction(F.beforeRefresh)&&F.beforeRefresh.call(t);r.search=!1;r.resetsearch=!0;try{if("currentfilter"!==F.refreshstate){r.postData.filters="";try{a("#fbox_"+
H).jqFilter("resetFilter")}catch(b){}a.isFunction(t.clearToolbar)&&t.clearToolbar(!1)}}catch(c){}switch(F.refreshstate){case "firstpage":y.trigger("reloadGrid",[a.extend({},F.reloadGridOptions||{},{page:1})]);break;case "current":case "currentfilter":y.trigger("reloadGrid",[a.extend({},F.reloadGridOptions||{},{current:!0})])}a.isFunction(F.afterRefresh)&&F.afterRefresh.call(t)}return!1},ga=function(b,e,d,g,l){var f=a("<div class='ui-pg-button ui-corner-all' tabindex='0' role='button'></div>"),h=F[b+
"icon"],k=a.trim(F[b+"text"]);f.append("<div class='ui-pg-div'><span class='"+(F.iconsOverText?c("ui-pg-button-icon-over-text",Y,h):c(Y,h))+"'></span>"+(k?"<span class='ui-pg-button-text"+(F.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+k+"</span>":"")+"</div>");a(g).append(f);f.attr({title:F[b+"title"]||"",id:e||b+"_"+l}).click(d).hover(ja,da);return f};F.cloneToTop&&r.toppager&&(I=2);for(L=0;L<I;L++){x=a("<div class='ui-pg-table navtable' role='toolbar' style='float:"+("rtl"===r.direction?
"right":"left")+";table-layout:auto;'></div>");0===L?(k=b,S=U,k===r.toppager&&(S+="_top",I=1)):(k=r.toppager,S=U+"_top");F.add&&ga("add",m.id,P,x,S);F.edit&&ga("edit",g.id,M,x,S);F.view&&ga("view",w.id,Z,x,S);F.del&&ga("del",u.id,fa,x,S);(F.add||F.edit||F.del||F.view)&&a(x).append(ha);F.search&&(K=ga("search",v.id,ka,x,S),v.showOnLoad&&!0===v.showOnLoad&&a(K,x).click());F.refresh&&ga("refresh","",xa,x,S);K=a(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px";a("body").append("<div id='testpg2' class='"+
A.call(t,"gBox","ui-jqgrid")+"' style='font-size:"+K+";visibility:hidden;' ></div>");K=a(x).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(k+"_"+F.position,k).append(x);if(F.hideEmptyPagerParts)for(S=0;S<ca.length;S++)ca[S]!==F.position&&(ba=a(k+"_"+ca[S],k),0===ba.length||0===ba[0].childNodes.length?ba.hide():1===ba[0].childNodes.length&&(W=ba[0].firstChild,!a(W).is("table.ui-pg-table")||0!==W.rows&&0!==W.rows[0].cells.length||ba.hide()));r._nvtd&&(K>r._nvtd[0]&&(a(k+"_"+F.position,
k).width(K),r._nvtd[0]=K),r._nvtd[1]=K);t.nav=!0;x.bind("keydown.jqGrid",O)}y.triggerHandler("jqGridResetFrozenHeights")}}})},navButtonAdd:function(b,d){"object"===typeof b&&(d=b,b=void 0);return this.each(function(){var g=this,f=g.p;if(g.grid){var h=a.extend({caption:"newButton",title:"",onClickButton:null,position:"last",cursor:"pointer",iconsOverText:!1},l.getGridRes.call(a(g),"nav"),p.nav||{},f.navOptions||{},d||{}),m=q.call(g,"hover"),u=q.call(g,"disabled");if(void 0===b)if(f.pager)if(l.navButtonAdd.call(a(g),
f.pager,h),f.toppager)b=f.toppager;else return;else f.toppager&&(b=f.toppager);"string"===typeof b&&0!==b.indexOf("#")&&(b="#"+n(b));var f=a(".navtable",b),w=h.commonIconClass;if(0<f.length&&!(h.id&&0<f.find("#"+n(h.id)).length)){var t=a("<div tabindex='0' role='button'></div>");"NONE"===h.buttonicon.toString().toUpperCase()?a(t).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>"+(h.caption?"<span class='ui-pg-button-text"+(h.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+
h.caption+"</span>":"")+"</div>"):a(t).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'><span class='"+(h.iconsOverText?c("ui-pg-button-icon-over-text",w,h.buttonicon):c(w,h.buttonicon))+"'></span>"+(h.caption?"<span class='ui-pg-button-text"+(h.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+h.caption+"</span>":"")+"</div>");h.id&&a(t).attr("id",h.id);"first"===h.position&&0<f.children("div.ui-pg-button").length?f.children("div.ui-pg-button").filter(":first").before(t):
f.append(t);a(t,f).attr("title",h.title||"").click(function(b){e(this,u)||a.isFunction(h.onClickButton)&&h.onClickButton.call(g,h,b);return!1}).hover(function(){e(this,u)||a(this).addClass(m)},function(){a(this).removeClass(m)});a(g).triggerHandler("jqGridResetFrozenHeights")}}})},navSeparatorAdd:function(b,c){c=a.extend({sepclass:"ui-separator",sepcontent:"",position:"last"},c||{});return this.each(function(){if(this.grid){"string"===typeof b&&0!==b.indexOf("#")&&(b="#"+n(b));var e=a(".navtable",
...
(function(a){var p=a.jgrid,r=a.fn.jqGrid;p.extend({groupingSetup:function(){return this.each(function(){var t,n;n=this.p;var d=n.colModel,f=n.groupingView,h,b,c=function(){return""};if(null===f||"object"!==typeof f&&!a.isFunction(f))n.grouping=!1;else if(f.groupField.length){void 0===f.visibiltyOnNextGrouping&&(f.visibiltyOnNextGrouping=[]);f.lastvalues=[];f._locgr||(f.groups=[]);f.counters=[];for(t=0;t<f.groupField.length;t++)f.groupOrder[t]||(f.groupOrder[t]="asc"),f.groupText[t]||(f.groupText[t]=
"{0}"),"boolean"!==typeof f.groupColumnShow[t]&&(f.groupColumnShow[t]=!0),"boolean"!==typeof f.groupSummary[t]&&(f.groupSummary[t]=!1),f.groupSummaryPos[t]||(f.groupSummaryPos[t]="footer"),h=d[n.iColByName[f.groupField[t]]],!0===f.groupColumnShow[t]?(f.visibiltyOnNextGrouping[t]=!0,null!=h&&!0===h.hidden&&r.showCol.call(a(this),f.groupField[t])):(f.visibiltyOnNextGrouping[t]=a("#"+p.jqID(n.id+"_"+f.groupField[t])).is(":visible"),null!=h&&!0!==h.hidden&&r.hideCol.call(a(this),f.groupField[t]));f.summary=
[];f.hideFirstGroupCol&&(f.formatDisplayField[0]=function(a){return a});t=0;for(n=d.length;t<n;t++)h=d[t],f.hideFirstGroupCol&&!h.hidden&&f.groupField[0]===h.name&&(h.formatter=c),h.summaryType&&(b={nm:h.name,st:h.summaryType,v:"",sr:h.summaryRound,srt:h.summaryRoundType||"round"},h.summaryDivider&&(b.sd=h.summaryDivider,b.vd=""),f.summary.push(b))}else n.grouping=!1})},groupingPrepare:function(p,n){this.each(function(){var d=this,f=d.p.groupingView,h=f.groups,b=f.counters,c=f.lastvalues,e=f.isInTheSameGroup,
l=f.groupField.length,m,g,u,w,A=0,q=r.groupingCalculations.handler,y=function(){a.isFunction(this.st)?this.v=this.st.call(d,this.v,this.nm,p):(this.v=q.call(a(d),this.st,this.v,this.nm,this.sr,this.srt,p),"avg"===this.st.toLowerCase()&&this.sd&&(this.vd=q.call(a(d),this.st,this.vd,this.sd,this.sr,this.srt,p)))};for(m=0;m<l;m++)g=f.groupField[m],u=f.displayField[m],w=p[g],u=null==u?null:p[u],null==u&&(u=w),void 0!==w&&(g={idx:m,dataIndex:g,value:w,displayValue:u,startRow:n,cnt:1,summary:[]},0===n?
(h.push(g),c[m]=w,b[m]={cnt:1,pos:h.length-1,summary:a.extend(!0,[],f.summary)}):(u={cnt:1,pos:h.length,summary:a.extend(!0,[],f.summary)},"object"===typeof w||(a.isArray(e)&&a.isFunction(e[m])?e[m].call(d,c[m],w,m,f):c[m]===w)?1===A?(h.push(g),c[m]=w,b[m]=u):(b[m].cnt+=1,h[b[m].pos].cnt=b[m].cnt):(h.push(g),c[m]=w,A=1,b[m]=u)),a.each(b[m].summary,y),h[b[m].pos].summary=b[m].summary)});return this},groupingToggle:function(t){this.each(function(){var n=this.p,d=p.jqID,f=n.groupingView,h=f.minusicon,
b=f.plusicon,c=a("#"+d(t)),c=c.length?c[0].nextSibling:null,e=a("#"+d(t)+" span.tree-wrap-"+n.direction),l,m,g=!1,u=n.frozenColumns?n.id+"_frozen":!1,d=(d=u?a("#"+d(t),"#"+d(u)):!1)&&d.length?d[0].nextSibling:null;l=t.split("_");var w=parseInt(l[l.length-2],10),r,q=function(b){b=a.map(b.split(" "),function(a){if(a.substring(0,r.length+1)===r+"_")return parseInt(a.substring(r.length+1),10)});return 0<b.length?b[0]:void 0};l.splice(l.length-2,2);r=l.join("_");if(e.hasClass(h)){for(;c;){if(a(c).hasClass("jqfoot")){l=
parseInt(a(c).data("jqfootlevel"),10);if(!f.showSummaryOnHide&&l===w||l>w)a(c).hide(),u&&a(d).hide();if(l<w)break}else{l=q(c.className);if(void 0!==l&&l<=w)break;a(c).hide();u&&a(d).hide()}c=c.nextSibling;u&&(d=d.nextSibling)}e.removeClass(h).addClass(b);g=!0}else{for(m=void 0;c;){if(a(c).hasClass("jqfoot")){l=parseInt(a(c).data("jqfootlevel"),10);if(l===w||f.showSummaryOnHide&&l===w+1)a(c).show(),u&&a(d).show();if(l<=w)break}l=q(c.className);void 0===m&&(m=void 0===l);if(void 0!==l){if(l<=w)break;
l===w+1&&(a(c).show().find(">td>span.tree-wrap-"+n.direction).removeClass(h).addClass(b),u&&a(d).show().find(">td>span.tree-wrap-"+n.direction).removeClass(h).addClass(b))}else m&&(a(c).show(),u&&a(d).show());c=c.nextSibling;u&&(d=d.nextSibling)}e.removeClass(b).addClass(h)}a(this).triggerHandler("jqGridGroupingClickGroup",[t,g]);a.isFunction(n.onClickGroup)&&n.onClickGroup.call(this,t,g)});return!1},groupingRender:function(r,n,d,f){function h(a,b,c){var e=!1,d;if(0===b)e=c[a];else if(d=c[a].idx,
0===d)e=c[a];else for(;0<=a;a--)if(c[a].idx===d-b){e=c[a];break}return e}function b(b,c,d,g){var f=h(b,c,d),m=l.colModel,u=f.cnt;b="";var q,w,r;c=function(){var a;if(this.nm===m[q].name){r=m[q].summaryTpl||"{0}";"string"===typeof this.st&&"avg"===this.st.toLowerCase()&&(this.sd&&this.vd?this.v/=this.vd:this.v&&0<u&&(this.v/=u));try{this.groupCount=f.cnt,this.groupIndex=f.dataIndex,this.groupValue=f.value,a=e.formatter("",this.v,q,this)}catch(b){a=this.v}w="<td "+e.formatCol(q,1,"")+">"+p.format(r,
a)+"</td>";return!1}};for(q=g;q<n;q++)w="<td "+e.formatCol(q,1,"")+">&#160;</td>",a.each(f.summary,c),b+=w;return b}var c="",e=this[0],l=e.p,m=0,g=l.groupingView,u=a.makeArray(g.groupSummary),w,A=[],q="",y,E,C=(g.groupCollapse?g.plusicon:g.minusicon)+" tree-wrap-"+l.direction,B=g.groupField.length;a.each(l.colModel,function(a,b){var c;for(c=0;c<B;c++)if(g.groupField[c]===b.name){A[c]=a;break}});u.reverse();a.each(g.groups,function(h,z){if(g._locgr&&!(z.startRow+z.cnt>(d-1)*f&&z.startRow<d*f))return!0;
...
'<tr id="'+y+'"'+(g.groupCollapse&&0<z.idx?' style="display:none;" ':" ")+'role="row" class="ui-widget-content jqgroup ui-row-'+l.direction+" "+E+'"><td style="padding-left:'+12*z.idx+'px;"';var V=a.isFunction(g.groupText[z.idx])?g.groupText[z.idx].call(e,w,z.cnt,z.summary):p.template(g.groupText[z.idx],w,z.cnt,z.summary),J=1,G,R,U;R=0;U=B-1===z.idx;"string"!==typeof V&&"number"!==typeof V&&(V=w);"header"===g.groupSummaryPos[z.idx]?(J=1,"cb"!==l.colModel[0].name&&"cb"!==l.colModel[1].name||J++,"subgrid"!==
l.colModel[0].name&&"subgrid"!==l.colModel[1].name||J++,c+=(1<J?" colspan='"+J+"'":"")+">"+q+V+"</td>",c+=b(h,0,g.groups,!1===g.groupColumnShow[z.idx]?J-1:J)):c+=' colspan="'+(!1===g.groupColumnShow[z.idx]?n-1:n)+'">'+q+V+"</td>";c+="</tr>";if(U){V=g.groups[h+1];U=z.startRow;J=void 0!==V?V.startRow:g.groups[h].startRow+g.groups[h].cnt;g._locgr&&(R=(d-1)*f,R>z.startRow&&(U=R));for(;U<J&&r[U-R];U++)c+=r[U-R].join("");if("header"!==g.groupSummaryPos[z.idx]){if(void 0!==V){for(G=0;G<g.groupField.length&&
V.dataIndex!==g.groupField[G];G++);m=g.groupField.length-G}for(V=0;V<m;V++)u[V]&&(R="",g.groupCollapse&&!g.showSummaryOnHide&&(R=' style="display:none;"'),c+="<tr"+R+' data-jqfootlevel="'+(z.idx-V)+'" role="row" class="ui-widget-content jqfoot ui-row-'+l.direction+'">',c+=b(h,V,g.groups,0),c+="</tr>");m=G}}});return c},groupingGroupBy:function(t,n){return this.each(function(){var d=this.p,f=d.groupingView,h,b;"string"===typeof t&&(t=[t]);d.grouping=!0;f._locgr=!1;void 0===f.visibiltyOnNextGrouping&&
(f.visibiltyOnNextGrouping=[]);for(h=0;h<f.groupField.length;h++)b=d.colModel[d.iColByName[f.groupField[h]]],!f.groupColumnShow[h]&&f.visibiltyOnNextGrouping[h]&&null!=b&&!0===b.hidden&&r.showCol.call(a(this),f.groupField[h]);for(h=0;h<t.length;h++)f.visibiltyOnNextGrouping[h]=a(d.idSel+"_"+p.jqID(t[h])).is(":visible");d.groupingView=a.extend(d.groupingView,n||{});f.groupField=t;a(this).trigger("reloadGrid")})},groupingRemove:function(p){return this.each(function(){var n=this.p,d=this.tBodies[0],
...
type:p.mtype,data:p.impData,dataType:"xml",complete:function(d){!(300>d.status||304===d.status)||0===d.status&&4===d.readyState||(t(d.responseXML,p),a(r).triggerHandler("jqGridImportComplete",[d,p]),a.isFunction(p.importComplete)&&p.importComplete(d))}},p.ajaxOptions));break;case "xmlstring":p.impstring&&"string"===typeof p.impstring&&(d=a.parseXML(p.impstring))&&(t(d,p),a(r).triggerHandler("jqGridImportComplete",[d,p]),a.isFunction(p.importComplete)&&p.importComplete(d),p.impstring=null);break;case "json":a.ajax(a.extend({url:p.impurl,
...
null)}})},jqGridExport:function(p){p=a.extend({exptype:"xmlstring",root:"grid",ident:"\t"},p||{});var r=null;this.each(function(){if(this.grid){var t,n=a.extend(!0,{},a(this).jqGrid("getGridParam"));n.rownumbers&&(n.colNames.splice(0,1),n.colModel.splice(0,1));n.multiselect&&(n.colNames.splice(0,1),n.colModel.splice(0,1));n.subGrid&&(n.colNames.splice(0,1),n.colModel.splice(0,1));n.knv=null;if(n.treeGrid)for(t in n.treeReader)n.treeReader.hasOwnProperty(t)&&(n.colNames.splice(n.colNames.length-1),
...
(function(a){var p=a.jgrid,r=p.fullBoolFeedback,t=p.hasOneFromClasses,n=p.enumEditableCells,d=p.info_dialog,f=function(b){var c=a.makeArray(arguments).slice(1);c.unshift("");c.unshift("Inline");c.unshift(b);return p.feedback.apply(this,c)},h=function(a){return p.getRes(p.guiStyles[this.p.guiStyle],"states."+a)};p.inlineEdit=p.inlineEdit||{};p.extend({editRow:function(b,c,e,d,m,g,u,w,t,q){var y={},E=a.makeArray(arguments).slice(1);"object"===a.type(E[0])?y=E[0]:(void 0!==c&&(y.keys=c),a.isFunction(e)&&
(y.oneditfunc=e),a.isFunction(d)&&(y.successfunc=d),void 0!==m&&(y.url=m),null!=g&&(y.extraparam=g),a.isFunction(u)&&(y.aftersavefunc=u),a.isFunction(w)&&(y.errorfunc=w),a.isFunction(t)&&(y.afterrestorefunc=t),a.isFunction(q)&&(y.beforeEditRow=q));return this.each(function(){var c=this,e=a(c),d=c.p,g=0,l=null,m={},u=d.colModel,q=d.prmNames;if(c.grid){var w=a.extend(!0,{keys:!1,oneditfunc:null,successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,
beforeEditRow:null,mtype:"POST",focusField:!0},p.inlineEdit,d.inlineEditing||{},y),t=e.jqGrid("getInd",b,!0),A=w.focusField;if(!1!==t&&(w.extraparam[q.oper]===q.addoper||f.call(c,w,"beforeEditRow",w,b))&&"0"===(a(t).attr("editable")||"0")&&!a(t).hasClass("not-editable-row")){q=p.detectRowEditing.call(c,b);if(null!=q&&"cellEditing"===q.mode){var q=q.savedRow,E=c.rows[q.id],H=h.call(c,"select");e.jqGrid("restoreCell",q.id,q.ic);a(E.cells[q.ic]).removeClass("edit-cell "+H);a(E).addClass(H).attr({"aria-selected":"true",
tabindex:"0"})}n.call(c,t,a(t).hasClass("jqgrid-new-row")?"add":"edit",function(e){var f=e.cm,h=a(e.dataElement),u=e.dataWidth,q,n=f.name,w=f.edittype,r=e.iCol,t=f.editoptions||{};try{q=a.unformat.call(this,e.td,{rowId:b,colModel:f},r)}catch(A){q="textarea"===w?h.text():h.html()}m[n]=q;h.html("");f=a.extend({},t,{id:b+"_"+n,name:n,rowId:b,mode:e.mode});if("&nbsp;"===q||"&#160;"===q||1===q.length&&160===q.charCodeAt(0))q="";q=p.createEl.call(c,w,f,q,!0,a.extend({},p.ajaxOptions,d.ajaxSelectOptions||
{}));a(q).addClass("editable");h.append(q);u&&a(q).width(e.dataWidth);p.bindEv.call(c,q,f);"select"===w&&!0===t.multiple&&void 0===t.dataUrl&&p.msie&&a(q).width(a(q).width());null===l&&(l=r);g++});0<g&&(m.id=b,d.savedRow.push(m),a(t).attr("editable","1"),A&&("number"===typeof A&&parseInt(A,10)<=u.length?l=A:"string"===typeof A&&(l=d.iColByName[A]),setTimeout(function(){var b=a(t.cells[l]).find("input,textarea,select,button,object,*[tabindex]").filter(":input:visible:not(:disabled)");0<b.length&&b.focus()},
0)),!0===w.keys&&a(t).bind("keydown",function(a){if(27===a.keyCode)return e.jqGrid("restoreRow",b,w.afterrestorefunc),!1;if(13===a.keyCode){if("TEXTAREA"===a.target.tagName)return!0;e.jqGrid("saveRow",b,w);return!1}}),r.call(c,w.oneditfunc,"jqGridInlineEditRow",b,w))}}})},saveRow:function(b,c,e,l,m,g,u,w){var t=a.makeArray(arguments).slice(1),q={},y=this[0],E=a(y),C=null!=y?y.p:null,B;if(y.grid&&null!=C){"object"===a.type(t[0])?q=t[0]:(a.isFunction(c)&&(q.successfunc=c),void 0!==e&&(q.url=e),void 0!==
l&&(q.extraparam=l),a.isFunction(m)&&(q.aftersavefunc=m),a.isFunction(g)&&(q.errorfunc=g),a.isFunction(u)&&(q.afterrestorefunc=u),a.isFunction(w)&&(q.beforeSaveRow=w));var D=function(a){return E.jqGrid("getGridRes",a)},q=a.extend(!0,{successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,beforeSaveRow:null,ajaxSaveOptions:{},serializeSaveData:null,mtype:"POST",saveui:"enable",savetext:D("defaults.savetext")||"Saving..."},p.inlineEdit,C.inlineEditing||
{},q),z={},v={},t={},V,J,G;J=E.jqGrid("getInd",b,!0);var R=a(J);B=C.prmNames;var U=D("errors.errcap"),F=D("edit.bClose"),K;if(!1!==J&&(B=q.extraparam[B.oper]===B.addoper?"add":"edit",f.call(y,q,"beforeSaveRow",q,b,B)&&(B=R.attr("editable"),q.url=q.url||C.editurl,K="clientArray"!==q.url,"1"===B)))if(n.call(y,J,R.hasClass("jqgrid-new-row")?"add":"edit",function(b){var c=b.cm,e,d=c.formatter,g=c.editoptions||{},l=c.formatoptions||{};e=p.getEditedValue.call(y,a(b.dataElement),c,!d);G=p.checkValues.call(y,
e,b.iCol);if(!1===G[0])return!1;K&&C.autoencode&&(e=p.htmlEncode(e));"date"===d&&!0!==l.sendFormatted&&(e=a.unformat.date.call(y,e,c));K&&!0===g.NullIfEmpty&&""===e&&(e="null");z[c.name]=e}),!1===G[0])try{var H=E.jqGrid("getGridRowById",b),N=p.findPos(H);d.call(y,U,G[1],F,{left:N[0],top:N[1]+a(H).outerHeight()})}catch(Y){alert(G[1])}else if(H=b,B=C.prmNames,N=!1===C.keyName?B.id:C.keyName,z&&(z[B.oper]=B.editoper,void 0===z[N]||""===z[N]?z[N]=b:J.id!==C.idPrefix+z[N]&&(J=p.stripPref(C.idPrefix,b),
void 0!==C._index[J]&&(C._index[z[N]]=C._index[J],delete C._index[J]),b=C.idPrefix+z[N],R.attr("id",b),C.selrow===H&&(C.selrow=b),a.isArray(C.selarrrow)&&(J=a.inArray(H,C.selarrrow),0<=J&&(C.selarrrow[J]=b)),C.multiselect&&(J="jqg_"+C.id+"_"+b,R.find("input.cbox").attr("id",J).attr("name",J))),z=a.extend({},z,C.inlineData||{},q.extraparam)),K)E.jqGrid("progressBar",{method:"show",loadtype:q.saveui,htmlcontent:q.savetext}),t=a.extend({},z,t),t[N]=p.stripPref(C.idPrefix,t[N]),a.ajax(a.extend({url:q.url,
data:p.serializeFeedback.call(y,a.isFunction(q.serializeSaveData)?q.serializeSaveData:C.serializeRowData,"jqGridInlineSerializeSaveData",t),type:q.mtype,complete:function(c,e){E.jqGrid("progressBar",{method:"hide",loadtype:q.saveui,htmlcontent:q.savetext});if((300>c.status||304===c.status)&&(0!==c.status||4!==c.readyState)){var d,g;g=E.triggerHandler("jqGridInlineSuccessSaveRow",[c,b,q]);a.isArray(g)||(g=[!0,z]);g[0]&&a.isFunction(q.successfunc)&&(g=q.successfunc.call(y,c));a.isArray(g)?(d=g[0],z=
g[1]||z):d=g;if(!0===d){C.autoencode&&a.each(z,function(a,b){z[a]=p.htmlDecode(b)});z=a.extend({},z,v);E.jqGrid("setRowData",b,z);R.attr("editable","0");for(d=0;d<C.savedRow.length;d++)if(String(C.savedRow[d].id)===String(b)){V=d;break}0<=V&&C.savedRow.splice(V,1);r.call(y,q.aftersavefunc,"jqGridInlineAfterSaveRow",b,c,z,q);R.removeClass("jqgrid-new-row").unbind("keydown")}else r.call(y,q.errorfunc,"jqGridInlineErrorSaveRow",b,c,e,null,q),!0===q.restoreAfterError&&E.jqGrid("restoreRow",b,q.afterrestorefunc)}},
error:function(c,e,g){a("#lui_"+p.jqID(C.id)).hide();E.triggerHandler("jqGridInlineErrorSaveRow",[b,c,e,g,q]);if(a.isFunction(q.errorfunc))q.errorfunc.call(y,b,c,e,g);else{c=c.responseText||c.statusText;try{d.call(y,U,'<div class="'+h.call(y,"error")+'">'+c+"</div>",F,{buttonalign:"right"})}catch(l){alert(c)}}!0===q.restoreAfterError&&E.jqGrid("restoreRow",b,q.afterrestorefunc)}},p.ajaxOptions,C.ajaxRowOptions,q.ajaxSaveOptions||{}));else{z=a.extend({},z,v);J=E.jqGrid("setRowData",b,z);R.attr("editable",
"0");for(t=0;t<C.savedRow.length;t++)if(String(C.savedRow[t].id)===String(H)){V=t;break}0<=V&&C.savedRow.splice(V,1);r.call(y,q.aftersavefunc,"jqGridInlineAfterSaveRow",b,J,z,q);R.removeClass("jqgrid-new-row").unbind("keydown")}}},restoreRow:function(b,c){var e=a.makeArray(arguments).slice(1),d={};"object"===a.type(e[0])?d=e[0]:a.isFunction(c)&&(d.afterrestorefunc=c);return this.each(function(){var c=this,e=a(c),h=c.p,n=-1,t={},q;if(c.grid){var y=a.extend(!0,{},p.inlineEdit,h.inlineEditing||{},d),
E=e.jqGrid("getInd",b,!0);if(!1!==E&&f.call(c,y,"beforeCancelRow",y,b)){for(q=0;q<h.savedRow.length;q++)if(String(h.savedRow[q].id)===String(b)){n=q;break}if(0<=n){if(a.isFunction(a.fn.datepicker))try{a("input.hasDatepicker","#"+p.jqID(E.id)).datepicker("hide")}catch(C){}a.each(h.colModel,function(){var b=this.name;h.savedRow[n].hasOwnProperty(b)&&(t[b]=h.savedRow[n][b],!this.formatter||"date"!==this.formatter||null!=this.formatoptions&&!0===this.formatoptions.sendFormatted||(t[b]=a.unformat.date.call(c,
t[b],this)))});e.jqGrid("setRowData",b,t);a(E).attr("editable","0").unbind("keydown");h.savedRow.splice(n,1);a("#"+p.jqID(b),c).hasClass("jqgrid-new-row")&&setTimeout(function(){e.jqGrid("delRowData",b);e.jqGrid("showAddEditButtons",!1)},0)}r.call(c,y.afterrestorefunc,"jqGridInlineAfterRestoreRow",b)}}})},addRow:function(b){return this.each(function(){if(this.grid){var c=this,e=a(c),d=c.p,h=a.extend(!0,{rowID:null,initdata:{},position:"first",useDefValues:!0,useFormatter:!1,beforeAddRow:null,addRowParams:{extraparam:{}}},
...
a("#"+p.jqID(h.rowID)+" .ui-inline-edit",c).click():(d=d.prmNames,h.addRowParams.extraparam[d.oper]=d.addoper,e.jqGrid("editRow",h.rowID,h.addRowParams),e.jqGrid("setSelection",h.rowID)))}})},inlineNav:function(b,c){"object"===typeof b&&(c=b,b=void 0);return this.each(function(){var e=this,d=a(e),f=e.p;if(this.grid&&null!=f){var g,u=b===f.toppager?f.idSel+"_top":f.idSel,n=b===f.toppager?f.id+"_top":f.id,r=h.call(e,"disabled"),q=a.extend(!0,{edit:!0,editicon:"ui-icon-pencil",add:!0,addicon:"ui-icon-plus",
save:!0,saveicon:"ui-icon-disk",cancel:!0,cancelicon:"ui-icon-cancel",commonIconClass:"ui-icon",iconsOverText:!1,addParams:{addRowParams:{extraparam:{}}},editParams:{},restoreAfterSelect:!0},d.jqGrid("getGridRes","nav"),p.nav||{},f.navOptions||{},c||{});if(void 0===b)if(f.pager)if(d.jqGrid("inlineNav",f.pager,q),f.toppager)b=f.toppager,u=f.idSel+"_top",n=f.id+"_top";else return;else f.toppager&&(b=f.toppager,u=f.idSel+"_top",n=f.id+"_top");if(void 0!==b&&(g=a(b),!(0>=g.length))){0>=g.find(".navtable").length&&
...
c).css({width:d.width,margin:"0 auto"}),e.css("width",d.width));d.height&&(a(">div",c).css("height",d.height),e.css("height",d.height-10));e.empty();var q=b.groupHeader,y={},E,C,B,D,z;if(null!=q&&null!=q.groupHeaders)for(E=0,B=q.groupHeaders.length;E<B;E++)for(z=q.groupHeaders[E],C=0;C<z.numberOfColumns;C++)D=b.iColByName[z.startColumnName]+C,y[D]=a.isFunction(d.buildItemText)?d.buildItemText.call(h[0],{iCol:D,cm:n[D],cmName:n[D].name,colName:u[D],groupTitleText:z.titleText}):a.jgrid.stripHtml(z.titleText)+
": "+a.jgrid.stripHtml(""===u[D]?n[D].name:u[D]);for(D=0;D<g;D++)void 0===y[D]&&(y[D]=a.isFunction(d.buildItemText)?d.buildItemText.call(h[0],{iCol:D,cm:n[D],cmName:n[D].name,colName:u[D],groupTitleText:null}):a.jgrid.stripHtml(u[D]));a.each(n,function(a){l[this.name]=a;this.hidedlg?this.hidden||m.push(a):e.append("<option value='"+a+"'"+(b.headertitles||this.headerTitle?' title="'+p.stripHtml("string"===typeof this.headerTitle?this.headerTitle:y[a])+'"':"")+(this.hidden?"":" selected='selected'")+
...
100*g.options.dividerLocation+"%",height:"100%",margin:"auto",boxSizing:"border-box"}),g.selectedList.css("height","auto"),g.availableList.css("height","auto"),u=Math.max(g.selectedList.height(),g.availableList.height()),u=Math.min(u,a(window).height()),g.selectedList.css("height",u),g.availableList.css("height",u)}},sortableRows:function(d){return this.each(function(){var f=this,h=f.grid,b=f.p;h&&!b.treeGrid&&a.fn.sortable&&(d=a.extend({cursor:"move",axis:"y",items:">.jqgrow"},d||{}),d.start&&a.isFunction(d.start)?
...
b=a(b).closest("table.ui-jqgrid-btable");return 0<b.length&&void 0!==a.data(b[0],"dnd")?(b=a.data(b[0],"dnd").connectWith,-1!==a.inArray("#"+t(this.id),b)?!0:!1):!1},drop:function(c,d){if(a(d.draggable).hasClass("jqgrow")){var g=a(d.draggable).attr("id"),g=d.draggable.parent().parent().jqGrid("getRowData",g);if(!b.dropbyname){var f=0,p={},n,q,r=a("#"+t(this.id)).jqGrid("getGridParam","colModel");try{for(q in g)g.hasOwnProperty(q)&&(n=r[f].name,"cb"!==n&&"rn"!==n&&"subgrid"!==n&&g.hasOwnProperty(q)&&
r[f]&&(p[n]=g[q]),f++);g=p}catch(E){}}d.helper.dropped=!0;b.beforedrop&&a.isFunction(b.beforedrop)&&(n=b.beforedrop.call(this,c,d,g,a("#"+t(h.p.id)),a(this)),void 0!==n&&null!==n&&"object"===typeof n&&(g=n));if(d.helper.dropped){var C;b.autoid&&(a.isFunction(b.autoid)?C=b.autoid.call(this,g):(C=Math.ceil(1E3*Math.random()),C=b.autoidprefix+C));a("#"+t(this.id)).jqGrid("addRowData",C,g,b.droppos);g[h.p.localReader.id]=C}b.ondrop&&a.isFunction(b.ondrop)&&b.ondrop.call(this,c,d,g)}}},b.drop_opts||{})},
...
r.prototype.getIndexesOfSourceData=function(a){return this.indexesOfSourceData[a]};r.prototype.createDataIndex=function(p){var d,f=p.length,h=this.fieldLength,b,c,e=this.fieldNames,l=this.indexesOfSourceData,m,g,u=this.items,w;for(d=0;d<f;d++){g=p[d];b=Array(h);for(m=0;m<h;m++)c=g[e[m]],void 0!==c&&("string"===typeof c&&this.trimByCollect&&(c=a.trim(c)),b[m]=c);g=0;w=u.length-1;if(0>w)u.push(b),l.push([d]);else if(c=this.compareVectors(b,u[w]),0===c)l[w].push(d);else if(1===c||this.skipSort)u.push(b),
l.push([d]);else if(c=this.compareVectors(u[0],b),1===c)u.unshift(b),l.unshift([d]);else if(0===c)l[0].push(d);else for(;;){if(2>w-g){u.splice(w,0,b);l.splice(w,0,[d]);break}m=Math.floor((g+w)/2);c=this.compareVectors(u[m],b);if(0===c){l[m].push(d);break}1===c?w=m:g=m}}};var t=a.jgrid;t.extend({pivotSetup:function(n,d){var f=this[0],h=a.isArray,b={},c={groupField:[],groupSummary:[],groupSummaryPos:[]},e={grouping:!0,groupingView:c},l=a.extend({totals:!1,useColSpanStyle:!1,trimByCollect:!0,skipSortByX:!1,
skipSortByY:!1,caseSensitive:!1,footerTotals:!1,groupSummary:!0,groupSummaryPos:"header",frozenStaticCols:!1,defaultFormatting:!0,data:n},d||{}),m,g,u,w=n.length,A,q,y,E,C,B,D=l.xDimension,z=l.yDimension,v=l.aggregates,V,w=l.totalText||l.totals||l.rowTotals||l.totalHeader,J,G=h(D)?D.length:0;E=h(z)?z.length:0;var R=h(v)?v.length:0,U=E-(1===R?1:0),F=[],K=[],H=[],h=[],N=Array(R),Y=Array(E),X,T,x,O,aa,Q,I,L,k,S,W;g=function(b,c,e){b=new r(l.trimByCollect,l.caseSensitive,c,b);a.isFunction(e)&&(b.compareVectorsEx=
...
d])});delete b.member;delete b.aggregator;return b};C=function(a,b,c){var e,d;for(e=0;e<R;e++)d=v[e],void 0===d.template&&void 0===d.formatter&&l.defaultFormatting&&(d.template="count"===d.aggregator?"integer":"number"),H.push(ba(a,d,e,b,c))};X=function(b,c,e){var d,g,l,h;for(d=U-1;d>=c;d--)if(K[d]){for(g=0;g<=d;g++)k=F[g].groupHeaders,k[k.length-1].numberOfColumns+=R;A=z[d];l=A.totalHeader;h=A.headerOnTop;for(g=d+1;g<=U-1;g++)F[g].groupHeaders.push({titleText:h&&g===d+1||!h&&g===U-1?a.isFunction(l)?
l.call(f,e,d):t.template.call(f,l||"",e[d],d):"",startColumnName:"y"+(b-1)+"t"+d+(1===R?"":"a0"),numberOfColumns:R})}};var ca=function(a){a=new p("count"===v[a].aggregator?"sum":v[a].aggregator,f,d);a.groupInfo={iRows:[],rows:[],ys:[],iYs:[]};return a},ha=function(){var a,b;for(a=U-1;0<=a;a--)if(K[a])for(null==Y[a]&&(Y[a]=Array(R)),b=0;b<R;b++)Y[a][b]=ca(b)},ja=function(a,b,c,e){var d,g=W.getIndexOfDifferences(b,c),f,l;if(null!==c)for(g=Math.max(g,0),d=U-1;d>=g;d--)f="y"+a+"t"+d+(1<R?"a"+e:""),K[d]&&
void 0===I[f]&&(l=Y[d][e],l.getResult(I,f),I.pivotInfos[f]={colType:1,iA:e,a:v[e],level:d,iRows:l.groupInfo.iRows,rows:l.groupInfo.rows,ys:l.groupInfo.ys,iYs:l.groupInfo.iYs},b!==c&&(Y[d][e]=ca(e)))},da=function(b,c,e,d,g,f,l){var h;if(b!==c)for(c=U-1;0<=c;c--)K[c]&&(h=Y[c][d],h.calc(g[e.member],e.member,g,f,n),h=h.groupInfo,0>a.inArray(l,h.iYs)&&(h.iYs.push(l),h.ys.push(b)),0>a.inArray(f,h.iRows)&&(h.iRows.push(f),h.rows.push(g)))};if(0===G||0===R)throw"xDimension or aggregates options are not set!";
S=g(D,l.skipSortByX,l.compareVectorsByX);W=g(z,l.skipSortByY,l.compareVectorsByY);d.xIndex=S;d.yIndex=W;for(g=0;g<G;g++)u=D[g],q={name:"x"+g,label:null!=u.label?a.isFunction(u.label)?u.label.call(f,u,g,l):u.label:u.dataName,frozen:l.frozenStaticCols},g<G-1&&(c.groupField.push(q.name),c.groupSummary.push(l.groupSummary),c.groupSummaryPos.push(l.groupSummaryPos)),q=a.extend(q,u),delete q.dataName,delete q.footerText,H.push(q);2>G&&(e.grouping=!1);e.sortname=H[G-1].name;c.hideFirstGroupCol=!0;for(g=
0;g<E;g++)A=z[g],K.push(A.totals||A.rowTotals||A.totalText||A.totalHeader?!0:!1);L=W.getItem(0);C(0,E-1,0);c=W.getIndexLength();for(q=1;q<c;q++){x=W.getItem(q);g=W.getIndexOfDifferences(x,L);for(u=U-1;u>=g;u--)K[u]&&C(1,u,q-1);L=x;C(0,E-1,q)}for(g=U-1;0<=g;g--)K[g]&&C(1,g,c-1);w&&C(2);L=W.getItem(0);for(u=0;u<U;u++)F.push({useColSpanStyle:l.useColSpanStyle,groupHeaders:[{titleText:L[u],startColumnName:1===R?"y0":"y0a0",numberOfColumns:R}]});for(q=1;q<c;q++){x=W.getItem(q);g=W.getIndexOfDifferences(x,
L);X(q,g,L);for(u=U-1;u>=g;u--)F[u].groupHeaders.push({titleText:x[u],startColumnName:"y"+q+(1===R?"":"a0"),numberOfColumns:R});for(u=0;u<g;u++)k=F[u].groupHeaders,k[k.length-1].numberOfColumns+=R;L=x}X(c,0,L);if(w)for(g=0;g<U;g++)F[g].groupHeaders.push({titleText:g<U-1?"":l.totalHeader||"",startColumnName:"t"+(1===R?"":"a0"),numberOfColumns:R});X=S.getIndexLength();for(E=0;E<X;E++){u=S.getItem(E);C={iX:E,x:u};I={pivotInfos:C};for(g=0;g<G;g++)I["x"+g]=u[g];T=S.getIndexesOfSourceData(E);if(w)for(u=
0;u<R;u++)N[u]=ca(u);L=null;ha();for(q=0;q<c;q++){x=W.getItem(q);O=W.getIndexesOfSourceData(q);for(u=0;u<R;u++){null!==L&&ja(q-1,x,L,u);aa=[];for(g=0;g<O.length;g++)y=O[g],0<=a.inArray(y,T)&&aa.push(y);if(0<aa.length){B=Array(aa.length);Q=v[u];V=new p(Q.aggregator,f,d);for(y=0;y<aa.length;y++)g=aa[y],m=n[g],B[y]=m,V.calc(m[Q.member],Q.member,m,g,n),w&&(J=N[u],J.calc(m[Q.member],Q.member,m,g,n),J=J.groupInfo,0>a.inArray(g,J.iYs)&&(J.iYs.push(q),J.ys.push(x)),0>a.inArray(g,J.iRows)&&(J.iRows.push(g),
J.rows.push(m))),da(x,L,Q,u,m,g,q);m="y"+q+(1===R?"":"a"+u);V.getResult(I,m);C[m]={colType:0,iY:q,y:x,iA:u,a:Q,iRows:aa,rows:B}}}L=x}if(null!==L)for(u=0;u<R;u++)ja(c-1,L,L,u);if(w)for(u=0;u<R;u++)m="t"+(1===R?"":"a"+u),J=N[u],J.getResult(I,m),J=J.groupInfo,C[m]={colType:2,iA:u,a:v[u],iRows:J.iRows,rows:J.rows,iYs:J.iYs,ys:J.ys};h.push(I)}if(l.footerTotals||l.colTotals){w=h.length;for(g=0;g<G;g++)b["x"+g]=D[g].footerText||"";for(g=G;g<H.length;g++){m=H[g].name;V=new p(l.footerAggregator||"sum",f,d);
for(y=0;y<w;y++)I=h[y],V.calc(I[m],m,I,y,h);V.getResult(b,m)}}d.colHeaders=F;return{colModel:H,options:d,rows:h,groupOptions:e,groupHeaders:F,summary:b}},jqPivot:function(p,d,f,h){return this.each(function(){function b(b){var g=l.pivotSetup.call(e,b,d),h=g.groupHeaders,p=g.summary,n=0,q;for(q in p)p.hasOwnProperty(q)&&n++;p=0<n?!0:!1;n=g.groupOptions.groupingView;q=t.from.call(c,g.rows);var r;if(d.skipSortByX)for(r=0;r<n.groupField.length;r++)q.orderBy(n.groupField[r],null!=f&&f.groupingView&&null!=
...
var c=this,e=a(c),l=a.fn.jqGrid;"string"===typeof p?a.ajax(a.extend({url:p,dataType:"json",success:function(a){b(t.getAccessor(a,h&&h.reader?h.reader:"rows"))}},h||{})):b(p)})}})})(jQuery);
(function(a){var p=a.jgrid,r=p.jqID,t=a.fn.jqGrid,n=function(){var d=a.makeArray(arguments);d[0]="subGrid"+d[0].charAt(0).toUpperCase()+d[0].substring(1);d.unshift("");d.unshift("");d.unshift(this.p);return p.feedback.apply(this,d)};p.extend({setSubGrid:function(){return this.each(function(){var d=this.p,f=d.subGridModel[0];d.subGridOptions=a.extend({expandOnLoad:!1,delayOnLoad:50,selectOnExpand:!1,selectOnCollapse:!1,reloadOnExpand:!0},d.subGridOptions||{});d.colNames.unshift("");d.colModel.unshift({name:"subgrid",
...
h.formatCol(a,f)+"><a style='cursor:pointer;'><span class='"+p.mergeCssClasses(b.commonIconClass,b.plusicon)+"'></span></a></td>"},addSubGrid:function(d,f){return this.each(function(){var h=this,b=h.p,c=function(a,b){return t.getGuiStyles.call(h,"subgrid."+a,b||"")},e=c("thSubgrid","ui-th-subgrid ui-th-column ui-th-"+b.direction),l=c("rowSubTable","ui-subtblcell"),m=c("row","ui-subgrid ui-row-"+b.direction),g=c("tdWithIcon","subgrid-cell"),u=c("tdData","subgrid-data"),w=function(c,e,d){e=a("<td align='"+
b.subGridModel[0].align[d]+"'></td>").html(e);a(c).append(e)},A=function(c,d){var g,f,m,q,u=a("<table"+(p.msie&&8>p.msiever()?" cellspacing='0'":"")+"><tbody></tbody></table>"),n=a("<tr></tr>");for(f=0;f<b.subGridModel[0].name.length;f++)g=a("<th class='"+e+"'></th>"),a(g).html(b.subGridModel[0].name[f]),a(g).width(b.subGridModel[0].width[f]),a(n).append(g);a(u).append(n);c&&(m=b.xmlReader.subgrid,a(m.root+" "+m.row,c).each(function(){n=a("<tr class='"+l+"'></tr>");if(!0===m.repeatitems)a(m.cell,
this).each(function(b){w(n,a(this).text()||"&#160;",b)});else if(q=b.subGridModel[0].mapping||b.subGridModel[0].name)for(f=0;f<q.length;f++)w(n,a(q[f],this).text()||"&#160;",f);a(u).append(n)}));a("#"+r(b.id+"_"+d)).append(u);h.grid.hDiv.loading=!1;a("#load_"+r(b.id)).hide();return!1},q=function(c,d){var g,f,m,q,u,n,t=a("<table"+(p.msie&&8>p.msiever()?" cellspacing='0'":"")+"><tbody></tbody></table>"),A=a("<tr></tr>");for(f=0;f<b.subGridModel[0].name.length;f++)g=a("<th class='"+e+"'></th>"),a(g).html(b.subGridModel[0].name[f]),
a(g).width(b.subGridModel[0].width[f]),a(A).append(g);a(t).append(A);if(c&&(q=b.jsonReader.subgrid,g=p.getAccessor(c,q.root),void 0!==g))for(f=0;f<g.length;f++){m=g[f];A=a("<tr class='"+l+"'></tr>");if(!0===q.repeatitems)for(q.cell&&(m=m[q.cell]),u=0;u<m.length;u++)w(A,m[u]||"&#160;",u);else if(n=b.subGridModel[0].mapping||b.subGridModel[0].name,n.length)for(u=0;u<n.length;u++)w(A,m[n[u]]||"&#160;",u);a(t).append(A)}a("#"+r(b.id+"_"+d)).append(t);h.grid.hDiv.loading=!1;a("#load_"+r(b.id)).hide();
...
m=b.treeReader.level_field,g=b.treeReader.left_field,p=b.treeReader.right_field;if(!h[c]){var w=r(h,b.localReader.id);if(f.call(this,"beforeExpandNode",{rowid:w,item:h})){var t=a("#"+b.idPrefix+n(w),this.grid.bDiv)[0],q=b._index[w];"local"===b.treedatatype||d.isNodeLoaded.call(a(this),b.data[q])?(h[c]=!0,a("div.treeclick",t).removeClass(b.treeIcons.plus+" tree-plus").addClass(b.treeIcons.commonIconClass).addClass(b.treeIcons.minus+" tree-minus")):this.grid.hDiv.loading||(h[c]=!0,a("div.treeclick",
t).removeClass(b.treeIcons.plus+" tree-plus").addClass(b.treeIcons.commonIconClass).addClass(b.treeIcons.minus+" tree-minus"),b.treeANode=t.rowIndex,b.datatype=b.treedatatype,d.setGridParam.call(a(this),{postData:"nested"===b.treeGridModel?{nodeid:w,n_level:h[m],n_left:h[g],n_right:h[p]}:{nodeid:w,n_level:h[m],parentid:h[e]}}),a(this).trigger("reloadGrid"),h[l]=!0,d.setGridParam.call(a(this),{postData:"nested"===b.treeGridModel?{nodeid:"",n_level:"",n_left:"",n_right:""}:{nodeid:"",n_level:"",parentid:""}}));
...
item:d}))}}})},SortTree:function(f,b,c,e){return this.each(function(){var l=this,m=l.p,g=a(l);if(l.grid&&m.treeGrid){var u,t,A,q=[];u=d.getRootNodes.call(g);u=p.from.call(l,u);u.orderBy(f,b,c,e);var y=u.select();u=0;for(t=y.length;u<t;u++)A=y[u],q.push(A),d.collectChildrenSortTree.call(g,q,A,f,b,c,e);a.each(q,function(b){var c=r(this,m.localReader.id);a(l.rows[b]).after(g.find(">tbody>tr#"+n(c)))})}})},collectChildrenSortTree:function(f,b,c,e,l,m){return this.each(function(){var g=a(this);if(this.grid&&
this.p.treeGrid){var n,r,t;n=d.getNodeChildren.call(g,b);n=p.from.call(this,n);n.orderBy(c,e,l,m);var q=n.select();n=0;for(r=q.length;n<r;n++)t=q[n],f.push(t),d.collectChildrenSortTree.call(g,f,t,c,e,l,m)}})},setTreeRow:function(f,b){var c=!1;this.each(function(){this.grid&&this.p.treeGrid&&(c=d.setRowData.call(a(this),f,b))});return c},delTreeNode:function(f){return this.each(function(){var b=this.p,c,e,l,m;l=b.localReader.id;var g,n=a(this),r=b.treeReader.left_field,t=b.treeReader.right_field;if(this.grid&&
b.treeGrid&&(g=b._index[f],void 0!==g)){c=parseInt(b.data[g][t],10);e=c-parseInt(b.data[g][r],10)+1;var q=d.getFullTreeNode.call(n,b.data[g]);if(0<q.length)for(g=0;g<q.length;g++)d.delRowData.call(n,q[g][l]);if("nested"===b.treeGridModel){l=p.from.call(this,b.data).greater(r,c,{stype:"integer"}).select();if(l.length)for(m in l)l.hasOwnProperty(m)&&(l[m][r]=parseInt(l[m][r],10)-e);l=p.from.call(this,b.data).greater(t,c,{stype:"integer"}).select();if(l.length)for(m in l)l.hasOwnProperty(m)&&(l[m][t]=
parseInt(l[m][t],10)-e)}}})},addChildNode:function(f,b,c,e){var l=a(this),m=l[0],g=m.p,n=d.getInd;if(c){var r,t,q,y,E;r=0;var C=b,B,D,z=g.treeReader.expanded_field;D=g.treeReader.leaf_field;var v=g.treeReader.level_field,V=g.treeReader.parent_id_field,J=g.treeReader.left_field,G=g.treeReader.right_field,R=g.treeReader.loaded;void 0===e&&(e=!1);if(null==f){E=g.data.length-1;if(0<=E)for(;0<=E;)r=Math.max(r,parseInt(g.data[E][g.localReader.id],10)),E--;f=r+1}var U=n.call(l,b);B=!1;void 0===b||null===
b||""===b?(C=b=null,r="last",y=g.tree_root_level,E=g.data.length+1):(r="after",t=g._index[b],q=g.data[t],b=q[g.localReader.id],y=parseInt(q[v],10)+1,E=d.getFullTreeNode.call(l,q),E.length?(C=E=E[E.length-1][g.localReader.id],E=n.call(l,C)+1):E=n.call(l,b)+1,q[D]&&(B=!0,q[z]=!0,a(m.rows[U]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(g.treeIcons.leaf+" tree-leaf").addClass(g.treeIcons.commonIconClass).addClass(g.treeIcons.minus+
" tree-minus"),g.data[t][D]=!1,q[R]=!0));n=E+1;void 0===c[z]&&(c[z]=!1);void 0===c[R]&&(c[R]=!1);c[v]=y;void 0===c[D]&&(c[D]=!0);"adjacency"===g.treeGridModel&&(c[V]=b);if("nested"===g.treeGridModel){var F;if(null!==b){D=parseInt(q[G],10);g=p.from.call(m,g.data);g=g.greaterOrEquals(G,D,{stype:"integer"});v=g.select();if(v.length)for(F in v)v.hasOwnProperty(F)&&(v[F][J]=v[F][J]>D?parseInt(v[F][J],10)+2:v[F][J],v[F][G]=v[F][G]>=D?parseInt(v[F][G],10)+2:v[F][G]);c[J]=D;c[G]=D+1}else{D=parseInt(d.getCol.call(l,
G,!1,"max"),10);v=p.from.call(m,g.data).greater(J,D,{stype:"integer"}).select();if(v.length)for(F in v)v.hasOwnProperty(F)&&(v[F][J]=parseInt(v[F][J],10)+2);v=p.from.call(m,g.data).greater(G,D,{stype:"integer"}).select();if(v.length)for(F in v)v.hasOwnProperty(F)&&(v[F][G]=parseInt(v[F][G],10)+2);c[J]=D+1;c[G]=D+2}}if(null===b||d.isNodeLoaded.call(l,q)||B)d.addRowData.call(l,f,c,r,C),d.setTreeNode.call(l,E,n);q&&!q[z]&&e&&a(m.rows[U]).find("div.treeclick").click()}}})})(jQuery);
(function(a){var p="mousedown",r="mousemove",t="mouseup",n=function(a){var b=a.originalEvent.targetTouches;return b?(b=b[0],{x:b.pageX,y:b.pageY}):{x:a.pageX,y:a.pageY}},d={drag:function(a){var b=a.data,c=b.e,e=b.dnr,d=b.ar,b=b.dnrAr;a=n(a);"move"===e.k?c.css({left:e.X+a.x-e.pX,top:e.Y+a.y-e.pY}):(c.css({width:Math.max(a.x-e.pX+e.W,0),height:Math.max(a.y-e.pY+e.H,0)}),b&&d.css({width:Math.max(a.x-b.pX+b.W,0),height:Math.max(a.y-b.pY+b.H,0)}));return!1},stop:function(){a(document).unbind(r,d.drag).unbind(t,
...
b[0].scrollHeight||0,pX:q.x,pY:q.y,k:c.k};g=h&&"move"!==c.k?{X:g.left||p(h,"left")||0,Y:g.top||p(h,"top")||0,W:h[0].offsetWidth||p(h,"width")||0,H:h[0].offsetHeight||p(h,"height")||0,pX:q.x,pY:q.y,k:c.k}:!1;c=b.find("input.hasDatepicker");if(0<c.length)try{c.datepicker("hide")}catch(E){}b={e:b,dnr:f,ar:h,dnrAr:g};a(document).bind(r,b,d.drag);a(document).bind(t,b,d.stop);return!1}})})};window.PointerEvent?(p+=".jqGrid pointerdown.jqGrid",r+=".jqGrid pointermove.jqGrid",t+=".jqGrid pointerup.jqGrid"):
window.MSPointerEvent?(p+=".jqGrid mspointerdown.jqGrid",r+=".jqGrid mspointermove.jqGrid",t+=".jqGrid mspointerup"):(p+=".jqGrid touchstart.jqGrid",r+=".jqGrid touchmove.jqGrid",t+=".jqGrid touchend.jqGrid");a.jqDnR=d;a.fn.jqDrag=function(a){return f(this,a,"move")};a.fn.jqResize=function(a,b){return f(this,a,"resize",b)}})(jQuery);
(function(a){var p=0,r,t=[],n=function(b){try{a(":input:visible",b.w).first().focus()}catch(c){}},d=function(b){var c=r[t[t.length-1]],e=!a(b.target).parents(".jqmID"+c.s)[0],d=a(b.target).offset(),f=void 0!==b.pageX?b.pageX:d.left,g=void 0!==b.pageY?b.pageY:d.top,d=function(){var b=!1;a(".jqmID"+c.s).each(function(){var c=a(this),e=c.offset();if(e.top<=g&&g<=e.top+c.height()&&e.left<=f&&f<=e.left+c.width())return b=!0,!1});return b};if("mousedown"!==b.type&&d())return!0;"mousedown"===b.type&&e&&
...
p,left:d.left+h}));if(g.onShow)g.onShow(e);else e.w.show();n(e);return!1},close:function(b){b=r[b];if(!b.a)return!1;b.a=!1;t[0]&&(t.pop(),t[0]||f("unbind"));b.c.toTop&&b.o&&a("#jqmP"+b.w[0]._jqm).after(b.w).remove();if(b.c.onHide)b.c.onHide(b);else b.w.hide(),b.o&&b.o.remove();return!1},params:{}};r=a.jqm.hash})(jQuery);
(function(a){a.fmatter=a.fmatter||{};a.jgrid=a.jgrid||{};var p=a.fmatter,r=a.jgrid,t=r.getMethod("getGridRes");a.extend(!0,r,{formatter:{date:{parseRe:/[#%\\\/:_;.,\t\s\-]/,masks:{ISO8601Long:"Y-m-d H:i:s",ISO8601Short:"Y-m-d",SortableDateTime:"Y-m-d\\TH:i:s",UniversalSortableDateTime:"Y-m-d H:i:sO"},reformatAfterEdit:!0,userLocalTime:!1},baseLinkUrl:"",showAction:"",target:"",checkbox:{disabled:!0},idName:"id"},cmTemplate:{integerStr:{formatter:"integer",align:"right",sorttype:"integer",searchoptions:{sopt:"eq ne lt le gt ge".split(" ")}},
...
d=-1<d?d:g.length,h=void 0===b.decimalSeparator?"":g.substring(d),r=-1,q;for(q=d;0<q;q--)r++,0===r%3&&q!==d&&(!f||1<q)&&(h=n+h),h=g.charAt(q-1)+h;g=h}return g}return a}});var n=function(b,e,d,f,g){var h=e;d=a.extend({},t.call(a(this),"formatter"),d);try{h=a.fn.fmatter[b].call(this,e,d,f,g)}catch(p){}return h};a.fn.fmatter=n;n.getCellBuilder=function(b,e,d){b=null!=a.fn.fmatter[b]?a.fn.fmatter[b].getCellBuilder:null;return a.isFunction(b)?b.call(this,a.extend({},t.call(a(this),"formatter"),e),d):null};
...
h="",g={target:e.target};null!=f&&(g=a.extend({},g,f.formatoptions||{}));g.target&&(h="target="+g.target);return p.isEmpty(b)?d(b,g):"<a "+h+' href="'+b+'">'+b+"</a>"};n.showlink=function(b,e,f){var h=this,g=e.colModel,n={baseLinkUrl:e.baseLinkUrl,showAction:e.showAction,addParam:e.addParam||"",target:e.target,idName:e.idName,hrefDefaultValue:"#"},r="",t,q,y=function(d){return a.isFunction(d)?d.call(h,{cellValue:b,rowid:e.rowId,rowData:f,options:n}):d||""};null!=g&&(n=a.extend({},n,g.formatoptions||
{}));n.target&&(r="target="+y(n.target));g=y(n.baseLinkUrl)+y(n.showAction);t=n.idName?encodeURIComponent(y(n.idName))+"="+encodeURIComponent(y(n.rowId)||e.rowId):"";q=y(n.addParam);"object"===typeof q&&null!==q&&(q=(""!==t?"&":"")+a.param(q));g+=t||q?"?"+t+q:"";""===g&&(g=y(n.hrefDefaultValue));return"string"===typeof b||p.isNumber(b)||a.isFunction(n.cellValue)?"<a "+r+' href="'+g+'">'+(a.isFunction(n.cellValue)?y(n.cellValue):b)+"</a>":d(b,n)};n.showlink.getCellBuilder=function(b){var e={baseLinkUrl:b.baseLinkUrl,
showAction:b.showAction,addParam:b.addParam||"",target:b.target,idName:b.idName,hrefDefaultValue:"#"};b=b.colModel;null!=b&&(e=a.extend({},e,b.formatoptions||{}));return function(b,c,g){var f=this,h=c.rowId,n="",q,r,t=function(c){return a.isFunction(c)?c.call(f,{cellValue:b,rowid:h,rowData:g,options:e}):c||""};e.target&&(n="target="+t(e.target));q=t(e.baseLinkUrl)+t(e.showAction);c=e.idName?encodeURIComponent(t(e.idName))+"="+encodeURIComponent(t(h)||c.rowId):"";r=t(e.addParam);"object"===typeof r&&
null!==r&&(r=(""!==c?"&":"")+a.param(r));q+=c||r?"?"+c+r:"";""===q&&(q=t(e.hrefDefaultValue));return"string"===typeof b||p.isNumber(b)||a.isFunction(e.cellValue)?"<a "+n+' href="'+q+'">'+(a.isFunction(e.cellValue)?t(e.cellValue):b)+"</a>":d(b,e)}};n.showlink.pageFinalization=function(b){var d=a(this),f=this.p,h=f.colModel[b],g,p=this.rows,n=p.length,r,q=function(f){var g=a(this).closest(".jqgrow");if(0<g.length)return h.formatoptions.onClick.call(d[0],{iCol:b,iRow:g[0].rowIndex,rowid:g.attr("id"),
...
"edit"!==e?function(a){return p.isEmpty(a)?d(a,f):h.call(this,g,a,n,f)}:function(a){return d(a,f)}};n.select=function(b,e){var f=[],h=e.colModel,g,h=a.extend({},h.editoptions||{},h.formatoptions||{}),n=h.value,r=h.separator||":",t=h.delimiter||";";if(n){var q=!0===h.multiple?!0:!1,y=[],E=function(a,b){if(0<b)return a};q&&(y=a.map(String(b).split(","),function(b){return a.trim(b)}));if("string"===typeof n){var C=n.split(t),B,D;for(B=0;B<C.length;B++)if(t=C[B].split(r),2<t.length&&(t[1]=a.map(t,E).join(r)),
D=a.trim(t[0]),h.defaultValue===D&&(g=t[1]),q)-1<a.inArray(D,y)&&f.push(t[1]);else if(D===a.trim(b)){f=[t[1]];break}}else p.isObject(n)&&(g=n[h.defaultValue],f=q?a.map(y,function(a){return n[a]}):[void 0===n[b]?"":n[b]])}b=f.join(", ");return""!==b?b:void 0!==h.defaultValue?g:d(b,h)};n.select.getCellBuilder=function(b){b=b.colModel;var d=n.defaultFormat,f=a.extend({},b.editoptions||{},b.formatoptions||{}),h=f.value;b=f.separator||":";var g=f.delimiter||";",u,r=void 0!==f.defaultValue,t=!0===f.multiple?
!0:!1,q,y={},E=function(a,b){if(0<b)return a};if("string"===typeof h)for(h=h.split(g),g=h.length,q=g-1;0<=q;q--)g=h[q].split(b),2<g.length&&(g[1]=a.map(g,E).join(b)),y[a.trim(g[0])]=g[1];else if(p.isObject(h))y=h;else return function(a){return a?String(a):d(a,f)};r&&(u=y[f.defaultValue]);return t?function(b){var c=[],g,h=a.map(String(b).split(","),function(b){return a.trim(b)});for(g=0;g<h.length;g++)b=h[g],y.hasOwnProperty(b)&&c.push(y[b]);b=c.join(", ");return""!==b?b:r?u:d(b,f)}:function(a){var b=
y[String(a)];return""!==b&&void 0!==b?b:r?u:d(a,f)}};n.rowactions=function(b,d){var f=a(this).closest("tr.jqgrow"),h=f.attr("id"),g=a(this).closest("table.ui-jqgrid-btable").attr("id").replace(/_frozen([^_]*)$/,"$1"),n=a("#"+r.jqID(g)),g=n[0],p=g.p,t=p.colModel[r.getCellIndex(this)],t=a.extend(!0,{extraparam:{}},r.actionsNav||{},p.actionsNavOptions||{},t.formatoptions||{});void 0!==p.editOptions&&(t.editOptions=p.editOptions);void 0!==p.delOptions&&(t.delOptions=p.delOptions);f.hasClass("jqgrid-new-row")&&
(t.extraparam[p.prmNames.oper]=p.prmNames.addoper);var q={keys:t.keys,oneditfunc:t.onEdit,successfunc:t.onSuccess,url:t.url,extraparam:t.extraparam,aftersavefunc:t.afterSave,errorfunc:t.onError,afterrestorefunc:t.afterRestore,restoreAfterError:t.restoreAfterError,mtype:t.mtype};!p.multiselect&&h!==p.selrow||p.multiselect&&0>a.inArray(h,p.selarrrow)?n.jqGrid("setSelection",h,!0,b):r.fullBoolFeedback.call(g,"onSelectRow","jqGridSelectRow",h,!0,b);switch(d){case "edit":n.jqGrid("editRow",h,q);break;
case "save":n.jqGrid("saveRow",h,q);break;case "cancel":n.jqGrid("restoreRow",h,t.afterRestore);break;case "del":t.delOptions=t.delOptions||{};void 0===t.delOptions.top&&(t.delOptions.top=f.offset().top+f.outerHeight()-n.closest(".ui-jqgrid").offset().top);n.jqGrid("delGridRow",h,t.delOptions);break;case "formedit":t.editOptions=t.editOptions||{};void 0===t.editOptions.top&&(t.editOptions.top=f.offset().top+f.outerHeight()-n.closest(".ui-jqgrid").offset().top,t.editOptions.recreateForm=!0);n.jqGrid("editGridRow",
h,t.editOptions);break;default:if(null!=t.custom&&0<t.custom.length)for(n=t.custom.length,f=0;f<n;f++)p=t.custom[f],p.action===d&&a.isFunction(p.onClick)&&p.onClick.call(g,{rowid:h,event:b,action:d,options:p})}b.stopPropagation&&b.stopPropagation();return!1};n.actions=function(b,d,f,h){b=d.rowId;var g="",n=this.p,w=a(this),A={},q=t.call(w,"edit")||{},w=a.extend({editbutton:!0,delbutton:!0,editformbutton:!1,commonIconClass:"ui-icon",editicon:"ui-icon-pencil",delicon:"ui-icon-trash",saveicon:"ui-icon-disk",
cancelicon:"ui-icon-cancel",savetitle:q.bSubmit||"",canceltitle:q.bCancel||""},t.call(w,"nav")||{},r.nav||{},n.navOptions||{},t.call(w,"actionsNav")||{},r.actionsNav||{},n.actionsNavOptions||{},d.colModel.formatoptions||{}),q=r.mergeCssClasses,n=q(r.getRes(r.guiStyles[n.guiStyle],"states.hover")),n="onmouseover=jQuery(this).addClass('"+n+"'); onmouseout=jQuery(this).removeClass('"+n+"'); ",y=[{action:"edit",actionName:"formedit",display:w.editformbutton},{action:"edit",display:!w.editformbutton&&
...
function(b){var d=a(this),f=this.p,h=f.colModel,g=h[b],n=function(n,p){var t=0,u,r;u=h.length;for(r=0;r<u&&!0===h[r].frozen;r++)t=r;u=d.jqGrid("getGridRowById",p);null!=u&&null!=u.cells&&(b=f.iColByName[g.name],r=a(u.cells[b]).children(".ui-jqgrid-actions"),g.frozen&&f.frozenColumns&&b<=t&&(r=r.add(a(d[0].grid.fbRows[u.rowIndex].cells[b]).children(".ui-jqgrid-actions"))),n?(r.find(">.ui-inline-edit,>.ui-inline-del").show(),r.find(">.ui-inline-save,>.ui-inline-cancel").hide()):(r.find(">.ui-inline-edit,>.ui-inline-del").hide(),
r.find(">.ui-inline-save,>.ui-inline-cancel").show()))},p=function(a,b){n(!0,b);return!1},t=function(a,b){n(!1,b);return!1};null!=g.formatoptions&&g.formatoptions.editformbutton||(d.unbind("jqGridInlineAfterRestoreRow.jqGridFormatter jqGridInlineAfterSaveRow.jqGridFormatter",p),d.bind("jqGridInlineAfterRestoreRow.jqGridFormatter jqGridInlineAfterSaveRow.jqGridFormatter",p),d.unbind("jqGridInlineEditRow.jqGridFormatter",t),d.bind("jqGridInlineEditRow.jqGridFormatter",t))};a.unformat=function(b,d,f,
...
t="",n;for(n in a)a.hasOwnProperty(n)&&(t+=r(a[n],n,""));return p?t.replace(/\t/g,p):t.replace(/\t|\n/g,"")},toObj:function(a){var p={},r=/function/i,t,n=0,d=0,f=!1;if(1===a.nodeType){if(a.attributes.length)for(t=0;t<a.attributes.length;t+=1)p["@"+a.attributes[t].nodeName]=(a.attributes[t].nodeValue||"").toString();if(a.firstChild){for(t=a.firstChild;t;t=t.nextSibling)1===t.nodeType?f=!0:3===t.nodeType&&t.nodeValue.match(/[^ \f\n\r\t\v]/)?n+=1:4===t.nodeType&&(d+=1);if(f)if(2>n&&2>d)for(this.removeWhite(a),
t=a.firstChild;t;t=t.nextSibling)3===t.nodeType?p["#text"]=this.escape(t.nodeValue):4===t.nodeType?r.test(t.nodeValue)?p[t.nodeName]=[p[t.nodeName],t.nodeValue]:p["#cdata"]=this.escape(t.nodeValue):p[t.nodeName]?p[t.nodeName]instanceof Array?p[t.nodeName][p[t.nodeName].length]=this.toObj(t):p[t.nodeName]=[p[t.nodeName],this.toObj(t)]:p[t.nodeName]=this.toObj(t);else a.attributes.length?p["#text"]=this.escape(this.innerXml(a)):p=this.escape(this.innerXml(a));else if(n)a.attributes.length?p["#text"]=
this.escape(this.innerXml(a)):(p=this.escape(this.innerXml(a)),"__EMPTY_ARRAY_"===p?p="[]":"__EMPTY_STRING_"===p&&(p=""));else if(d)if(1<d)p=this.escape(this.innerXml(a));else for(t=a.firstChild;t;t=t.nextSibling){if(r.test(a.firstChild.nodeValue)){p=a.firstChild.nodeValue;break}p["#cdata"]=this.escape(t.nodeValue)}}a.attributes.length||a.firstChild||(p=null)}else 9===a.nodeType?p=this.toObj(a.documentElement):alert("unhandled node type: "+a.nodeType);return p},toJson:function(a,p,r,t){void 0===t&&
(t=!0);var n=p?'"'+p+'"':"",d="\t",f="\n",h,b,c=[];h=[];t||(f=d="");if("[]"===a)n+=p?":[]":"[]";else if(a instanceof Array){b=0;for(h=a.length;b<h;b+=1)c[b]=this.toJson(a[b],"",r+d,t);n+=(p?":[":"[")+(1<c.length?f+r+d+c.join(","+f+r+d)+f+r:c.join(""))+"]"}else if(null===a)n+=(p&&":")+"null";else if("object"===typeof a){for(b in a)a.hasOwnProperty(b)&&(h[h.length]=this.toJson(a[b],b,r+d,t));n+=(p?":{":"{")+(1<h.length?f+r+d+h.join(","+f+r+d)+f+r:h.join(""))+"}"}else n="string"===typeof a?n+((p&&":")+

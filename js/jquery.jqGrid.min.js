...
(l+=" "+p+"="+g[p])}return'<tr role="row" id="'+b+'" tabindex="'+k+'" class="'+e+'"'+(""===c?"":' style="'+c+'"')+l+">"},F=function(b,c,e,f,h){var g=new Date,k="local"!==d.p.datatype&&d.p.loadonce||"xmlstring"===d.p.datatype,l=d.p.xmlReader,p="local"===d.p.datatype?"local":"xml";k&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;if(a.isXMLDoc(b)){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(w.call(d,!1,!0),e=1);var n=a(d),m,q,t=0,A,N=!0===d.p.multiselect?1:0,z=0,Q,F=!0===d.p.rownumbers?
1:0,E,H=[],O,B={},G,K,I=[],P=!0===d.p.altRows?d.p.altclass:"",ia;!0===d.p.subGrid&&(z=1,Q=a.jgrid.getMethod("addSubGridCell"));l.repeatitems||(H=y(p));E=!1===d.p.keyName?a.isFunction(l.id)?l.id.call(d,b):l.id:d.p.keyName;p=-1===String(E).indexOf("[")?H.length?function(b,d){return a(E,b).text()||d}:function(b,d){return a(l.cell,b).eq(E).text()||d}:function(a,b){return a.getAttribute(E.replace(/[\[\]]/g,""))||b};d.p.userData={};d.p.page=r(a.jgrid.getXmlData(b,l.page),d.p.page);d.p.lastpage=r(a.jgrid.getXmlData(b,
l.total),1);d.p.records=r(a.jgrid.getXmlData(b,l.records));a.isFunction(l.userdata)?d.p.userData=l.userdata.call(d,b)||{}:a.jgrid.getXmlData(b,l.userdata,!0).each(function(){d.p.userData[this.getAttribute("name")]=a(this).text()});b=a.jgrid.getXmlData(b,l.root,!0);(b=a.jgrid.getXmlData(b,l.row,!0))||(b=[]);var R=b.length,J=0,U=[],L=parseInt(d.p.rowNum,10),M=d.p.scroll?a.jgrid.randId():1;0<R&&0>=d.p.page&&(d.p.page=1);if(b&&R){h&&(L*=h+1);h=a.isFunction(d.p.afterInsertRow);var Z=!1,W;d.p.grouping&&
(Z=!0===d.p.groupingView.groupCollapse,W=a.jgrid.getMethod("groupingPrepare"));for(;J<R;){G=b[J];K=p(G,M+J);K=d.p.idPrefix+K;m=0===e?0:e+1;ia=1===(m+J)%2?P:"";var ca=I.length;I.push("");F&&I.push(u(0,J,d.p.page,d.p.rowNum));N&&I.push(x(K,F,J,!1));z&&I.push(Q.call(n,N+F,J+e));if(l.repeatitems){O||(O=C(N+z+F));var ea=a.jgrid.getXmlData(G,l.cell,!0);a.each(O,function(a){var b=ea[this];if(!b)return!1;A=b.textContent||b.text;B[d.p.colModel[a+N+z+F].name]=A;I.push(v(K,A,a+N+z+F,J+e,G,B))})}else for(m=0;m<
H.length;m++)A=a.jgrid.getXmlData(G,H[m]),B[d.p.colModel[m+N+z+F].name]=A,I.push(v(K,A,m+N+z+F,J+e,G,B));I[ca]=D(K,Z,ia,B,G,!1);I.push("</tr>");d.p.grouping&&(U.push(I),d.p.groupingView._locgr||W.call(n,B,J),I=[]);if(k||!0===d.p.treeGrid)B._id_=a.jgrid.stripPref(d.p.idPrefix,K),d.p.data.push(B),d.p._index[B._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("tbody:first",c).append(I.join("")),n.triggerHandler("jqGridAfterInsertRow",[K,B,G]),h&&d.p.afterInsertRow.call(d,K,B,G),I=[]);B={};t++;J++;if(t===
L)break}}!0===d.p.gridview&&(q=-1<d.p.treeANode?d.p.treeANode:0,d.p.grouping?k||(n.jqGrid("groupingRender",U,d.p.colModel.length,d.p.page,L),U=null):!0===d.p.treeGrid&&0<q?a(d.rows[q]).after(I.join("")):(d.firstElementChild.innerHTML+=I.join(""),d.grid.cols=d.rows[0].cells));if(!0===d.p.subGrid)try{n.jqGrid("addSubGrid",N+F)}catch(da){}d.p.totaltime=new Date-g;0<t&&0===d.p.records&&(d.p.records=R);I=null;if(!0===d.p.treeGrid)try{n.jqGrid("setTreeNode",q+1,t+q+1)}catch(S){}d.p.reccount=t;d.p.treeANode=
-1;d.p.userDataOnFooter&&n.jqGrid("footerData","set",d.p.userData,!0);k&&(d.p.records=R,d.p.lastpage=Math.ceil(R/L));f||d.updatepager(!1,!0);if(k){for(;t<R;){G=b[t];K=p(G,t+M);K=d.p.idPrefix+K;if(l.repeatitems){O||(O=C(N+z+F));var ba=a.jgrid.getXmlData(G,l.cell,!0);a.each(O,function(a){var b=ba[this];if(!b)return!1;A=b.textContent||b.text;B[d.p.colModel[a+N+z+F].name]=A})}else for(m=0;m<H.length;m++)A=a.jgrid.getXmlData(G,H[m]),B[d.p.colModel[m+N+z+F].name]=A;B._id_=a.jgrid.stripPref(d.p.idPrefix,
K);d.p.grouping&&W.call(n,B,t);d.p.data.push(B);d.p._index[B._id_]=d.p.data.length-1;B={};t++}d.p.grouping&&(d.p.groupingView._locgr=!0,n.jqGrid("groupingRender",U,d.p.colModel.length,d.p.page,L),U=null)}}},G=function(b,c,e,f,h){var g=new Date;if(b){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(w.call(d,!1,!0),e=1);var k,l="local"!==d.p.datatype&&d.p.loadonce||"jsonstring"===d.p.datatype;l&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;"local"===d.p.datatype?(c=d.p.localReader,
k="local"):(c=d.p.jsonReader,k="json");var p=a(d),n,m,q,t,N=d.p.multiselect?1:0,A=!0===d.p.subGrid?1:0,z,Q=!0===d.p.rownumbers?1:0,F=C(N+A+Q);k=y(k);var E,H,B,G,K={},O,I=[],J=!0===d.p.altRows?d.p.altclass:"",ia;d.p.page=r(a.jgrid.getAccessor(b,c.page),d.p.page);d.p.lastpage=r(a.jgrid.getAccessor(b,c.total),1);d.p.records=r(a.jgrid.getAccessor(b,c.records));d.p.userData=a.jgrid.getAccessor(b,c.userdata)||{};A&&(z=a.jgrid.getMethod("addSubGridCell"));B=!1===d.p.keyName?a.isFunction(c.id)?c.id.call(d,
b):c.id:d.p.keyName;isNaN(B)||(G=Number(B));for(m=0;m<d.p.colModel.length;m++)if(d.p.colModel[m].name===B){G=m;break}H=a.jgrid.getAccessor(b,c.root);null==H&&a.isArray(b)&&(H=b);H||(H=[]);b=H.length;0<b&&0>=d.p.page&&(d.p.page=1);var R=parseInt(d.p.rowNum,10),P=d.p.scroll?a.jgrid.randId():1,U=!1,L;h&&(R*=h+1);"local"!==d.p.datatype||d.p.deselectAfterSort||(U=!0);var W=a.isFunction(d.p.afterInsertRow),M=[],Z=!1,ca,ea;d.p.grouping&&(Z=!0===d.p.groupingView.groupCollapse,ca=a.jgrid.getMethod("groupingPrepare"));
for(m=0;m<b&&m<R;m++){t=H[m];h=c.repeatitems&&c.cell?a.jgrid.getAccessor(t,c.cell)||t:t;E=c.repeatitems&&a.isArray(h)?F:k;t=!1===d.p.keyName?a.jgrid.getAccessor(t,B):a.jgrid.getAccessor(h,E[G]);void 0===t&&(isNaN(B)||null==d.p.colModel[Number(B)+N+A+Q]||(t=a.jgrid.getAccessor(h,E[Number(B)])),void 0===t&&(t=P+m));t=d.p.idPrefix+t;q=1===e?0:e;ia=1===(q+m)%2?J:"";U&&(L=d.p.multiselect?-1!==a.inArray(t,d.p.selarrrow):t===d.p.selrow);ea=I.length;I.push("");Q&&I.push(u(0,m,d.p.page,d.p.rowNum));N&&I.push(x(t,
Q,m,L));A&&I.push(z.call(p,N+Q,m+e));for(q=0;q<E.length;q++)n=a.jgrid.getAccessor(h,E[q]),K[d.p.colModel[q+N+A+Q].name]=n,I.push(v(t,n,q+N+A+Q,m+e,h,K));I[ea]=D(t,Z,ia,K,h,L);I.push("</tr>");d.p.grouping&&(M.push(I),d.p.groupingView._locgr||ca.call(p,K,m),I=[]);if(l||!0===d.p.treeGrid)K._id_=a.jgrid.stripPref(d.p.idPrefix,t),d.p.data.push(K),d.p._index[K._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("#"+a.jgrid.jqID(d.p.id)+" tbody:first").append(I.join("")),p.triggerHandler("jqGridAfterInsertRow",
[t,K,h]),W&&d.p.afterInsertRow.call(d,t,K,h),I=[]);K={}}!0===d.p.gridview&&(O=-1<d.p.treeANode?d.p.treeANode:0,d.p.grouping?l||(p.jqGrid("groupingRender",M,d.p.colModel.length,d.p.page,R),M=null):!0===d.p.treeGrid&&0<O?a(d.rows[O]).after(I.join("")):(d.firstElementChild.innerHTML+=I.join(""),d.grid.cols=d.rows[0].cells));if(!0===d.p.subGrid)try{p.jqGrid("addSubGrid",N+Q)}catch(ba){}d.p.totaltime=new Date-g;0<m&&0===d.p.records&&(d.p.records=b);if(!0===d.p.treeGrid)try{p.jqGrid("setTreeNode",O+1,m+
O+1)}catch(da){}d.p.reccount=m;d.p.treeANode=-1;d.p.userDataOnFooter&&p.jqGrid("footerData","set",d.p.userData,!0);l&&(d.p.records=b,d.p.lastpage=Math.ceil(b/R));f||d.updatepager(!1,!0);if(l){for(e=m;e<b&&H[e];e++)if(t=H[e],h=c.repeatitems&&c.cell?a.jgrid.getAccessor(t,c.cell)||t:t,E=c.repeatitems&&a.isArray(h)?F:k,t=!1===d.p.keyName?a.jgrid.getAccessor(t,B):a.jgrid.getAccessor(h,E[G]),void 0===t&&(isNaN(B)||null==d.p.colModel[Number(B)+N+A+Q]||(t=a.jgrid.getAccessor(h,E[Number(B)])),void 0===t&&
(t=P+e)),h){for(q=0;q<E.length;q++)K[d.p.colModel[q+N+A+Q].name]=a.jgrid.getAccessor(h,E[q]);K._id_=a.jgrid.stripPref(d.p.idPrefix,t);d.p.grouping&&ca.call(p,K,e);d.p.data.push(K);d.p._index[K._id_]=d.p.data.length-1;K={}}d.p.grouping&&(d.p.groupingView._locgr=!0,p.jqGrid("groupingRender",M,d.p.colModel.length,d.p.page,R))}}},z=function(){function b(a){var d=0,c,e,f,g,k;if(null!=a.groups){(e=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&v.orBegin();for(c=0;c<a.groups.length;c++){0<
d&&e&&v.or();try{b(a.groups[c])}catch(l){alert(l)}d++}e&&v.orEnd()}if(null!=a.rules)try{(f=a.rules.length&&"OR"===a.groupOp.toString().toUpperCase())&&v.orBegin();for(c=0;c<a.rules.length;c++)k=a.rules[c],g=a.groupOp.toString().toUpperCase(),t[k.op]&&k.field&&(0<d&&g&&"OR"===g&&(v=v.or()),v=t[k.op](v,g)(k.field,k.data,h[k.field])),d++;f&&v.orEnd()}catch(p){alert(p)}}var c=d.p.multiSort?[]:"",e=[],f=!1,h={},g=[],k=[],l,p,m;if(a.isArray(d.p.data)){var n=d.p.grouping?d.p.groupingView:!1,r,q;a.each(d.p.colModel,
function(){p=this.sorttype||"text";"date"===p||"datetime"===p?(this.formatter&&"string"===typeof this.formatter&&"date"===this.formatter?(l=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:a.jgrid.formatter.date.srcformat,m=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:a.jgrid.formatter.date.newformat):l=m=this.datefmt||"Y-m-d",h[this.name]={stype:p,srcfmt:l,newfmt:m,sfunc:this.sortfunc||null}):h[this.name]={stype:p,srcfmt:"",newfmt:"",
...
a.andNot().equals},"in":function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,b){return"OR"===b?a.orNot().isNull:a.andNot().isNull}},v=a.jgrid.from(d.p.data);d.p.ignoreCase&&(v=v.ignoreCase());if(!0===d.p.search){var u=d.p.postData.filters;if(u)"string"===typeof u&&(u=a.jgrid.parse(u)),b(u);else try{v=t[d.p.postData.searchOper](v)(d.p.postData.searchField,d.p.postData.searchString,h[d.p.postData.searchField])}catch(w){}}if(d.p.grouping)for(q=0;q<r;q++)v.orderBy(k[q],n.groupOrder[q],
g[q].stype,g[q].srcfmt);d.p.multiSort?a.each(c,function(a){v.orderBy(this,e[a],h[this].stype,h[this].srcfmt,h[this].sfunc)}):c&&d.p.sortorder&&f&&("DESC"===d.p.sortorder.toUpperCase()?v.orderBy(d.p.sortname,"d",h[c].stype,h[c].srcfmt,h[c].sfunc):v.orderBy(d.p.sortname,"a",h[c].stype,h[c].srcfmt,h[c].sfunc));var u=v.select(),y=parseInt(d.p.rowNum,10),x=u.length,D=parseInt(d.p.page,10),C=Math.ceil(x/y),N={};if((d.p.search||d.p.resetsearch)&&d.p.grouping&&d.p.groupingView._locgr){d.p.groupingView.groups=
[];var A,z=a.jgrid.getMethod("groupingPrepare"),Q,F;if(d.p.footerrow&&d.p.userDataOnFooter){for(Q in d.p.userData)d.p.userData.hasOwnProperty(Q)&&(d.p.userData[Q]=0);F=!0}for(A=0;A<x;A++){if(F)for(Q in d.p.userData)d.p.userData[Q]+=parseFloat(u[A][Q]||0);z.call(a(d),u[A],A,y)}}u=u.slice((D-1)*y,D*y);h=v=null;N[d.p.localReader.total]=C;N[d.p.localReader.page]=D;N[d.p.localReader.records]=x;N[d.p.localReader.root]=u;N[d.p.localReader.userdata]=d.p.userData;u=null;return N}}},P=function(){d.grid.hDiv.loading=
...
d.p.datatype="local";d.p.datastr=null;B();break;case "jsonstring":P();e="string"===typeof d.p.datastr?a.jgrid.parse(d.p.datastr):d.p.datastr;G(e,d.grid.bDiv);a(d).triggerHandler("jqGridLoadComplete",[e]);g&&d.p.loadComplete.call(d,e);a(d).triggerHandler("jqGridAfterLoadComplete",[e]);d.p.datatype="local";d.p.datastr=null;B();break;case "local":case "clientside":P(),d.p.datatype="local",e=z(),G(e,d.grid.bDiv,q,1<b,l),a(d).triggerHandler("jqGridLoadComplete",[e]),k&&k.call(d,e),a(d).triggerHandler("jqGridAfterLoadComplete",
[e]),c&&d.grid.populateVisible(),B()}}}},S=function(b){a("#cb_"+a.jgrid.jqID(d.p.id),d.grid.hDiv)[d.p.useProp?"prop":"attr"]("checked",b);if(d.p.frozenColumns&&d.p.id+"_frozen")a("#cb_"+a.jgrid.jqID(d.p.id),d.grid.fhDiv)[d.p.useProp?"prop":"attr"]("checked",b)},V=function(b,c){var e="",f="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",h="",g,k,p,m,n=function(b){var c;a.isFunction(d.p.onPaging)&&(c=d.p.onPaging.call(d,b));if("stop"===c)return!1;
d.p.selrow=null;d.p.multiselect&&(d.p.selarrrow=[],S(!1));d.p.savedRow=[];return!0};b=b.substr(1);c+="_"+b;g="pg_"+b;k=b+"_left";p=b+"_center";m=b+"_right";a("#"+a.jgrid.jqID(b)).append("<div id='"+g+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+k+"' align='left'></td><td id='"+p+"' align='center' style='white-space:pre;'></td><td id='"+m+"' align='right'></td></tr></tbody></table></div>").attr("dir",
...
d.p._nvtd[0]=f?Math.floor((d.p.width-f)/2):Math.floor(d.p.width/3);d.p._nvtd[1]=0;f=null;a(".ui-pg-selbox","#"+g).bind("change",function(){if(!n("records"))return!1;d.p.page=Math.round(d.p.rowNum*(d.p.page-1)/this.value-.5)+1;d.p.rowNum=this.value;d.p.pager&&a(".ui-pg-selbox",d.p.pager).val(this.value);d.p.toppager&&a(".ui-pg-selbox",d.p.toppager).val(this.value);L();return!1});!0===d.p.pgbuttons&&(a(".ui-pg-button","#"+g).hover(function(){a(this).hasClass("ui-state-disabled")?this.style.cursor="default":
...
k=!1,b=e-1);if(!n(this.id))return!1;this.id==="first"+c&&h&&(d.p.page=1,f=!0);this.id==="prev"+c&&g&&(d.p.page=b-1,f=!0);this.id==="next"+c&&k&&(d.p.page=b+1,f=!0);this.id==="last"+c&&l&&(d.p.page=e,f=!0);f&&L();return!1}));!0===d.p.pginput&&a("input.ui-pg-input","#"+g).keypress(function(b){if(13===(b.charCode||b.keyCode||0)){if(!n("user"))return!1;a(this).val(r(a(this).val(),1));d.p.page=0<a(this).val()?a(this).val():d.p.page;L();return!1}return this})},Y=function(b,c){var e,f="",h=d.p.colModel,
...
a("span.s-ico",k).hide();d.p.sortorder="";a.each(h,function(a){this.lso&&(0<a&&g&&(f+=", "),e=this.lso.split("-"),f+=h[a].index||h[a].name,f+=" "+e[e.length-1],g=!0,d.p.sortorder=e[e.length-1])});k=f.lastIndexOf(d.p.sortorder);f=f.substring(0,k);d.p.sortname=f},I=function(b,c,e,f,h){if(d.p.colModel[c].sortable&&!(0<d.p.savedRow.length)){e||(d.p.lastsort===c&&""!==d.p.sortname?"asc"===d.p.sortorder?d.p.sortorder="desc":"desc"===d.p.sortorder&&(d.p.sortorder="asc"):d.p.sortorder=d.p.colModel[c].firstsortorder||
...
id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},d.p.jsonReader);d.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},d.p.localReader);d.p.scroll&&(d.p.pgbuttons=!1,d.p.pginput=!1,d.p.rowList=[]);d.p.data.length&&(E(),A());M="<thead><tr class='ui-jqgrid-labels' role='row'>";var K,O,Z,U,R,J,H,ga,ca=ga="",ja=[],ea=[];O=[];if(!0===d.p.shrinkToFit&&
!0===d.p.forceFit)for(k=d.p.colModel.length-1;0<=k;k--)if(!d.p.colModel[k].hidden){d.p.colModel[k].resizable=!1;break}"horizontal"===d.p.viewsortcols[1]&&(ga=" ui-i-asc",ca=" ui-i-desc");K=c?"class='ui-th-div-ie'":"";ga="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+ga+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+l+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ca+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+
l+"'></span></span>");if(d.p.multiSort)for(ja=d.p.sortname.split(","),k=0;k<ja.length;k++)O=a.trim(ja[k]).split(" "),ja[k]=a.trim(O[0]),ea[k]=O[1]?a.trim(O[1]):d.p.sortorder||"asc";for(k=0;k<this.p.colNames.length;k++)O=d.p.headertitles?' title="'+a.jgrid.stripHtml(d.p.colNames[k])+'"':"",M+="<th id='"+d.p.id+"_"+d.p.colModel[k].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+l+"'"+O+">",O=d.p.colModel[k].index||d.p.colModel[k].name,M+="<div id='jqgh_"+d.p.id+"_"+d.p.colModel[k].name+
"' "+K+">"+d.p.colNames[k],d.p.colModel[k].width=d.p.colModel[k].width?parseInt(d.p.colModel[k].width,10):150,"boolean"!==typeof d.p.colModel[k].title&&(d.p.colModel[k].title=!0),d.p.colModel[k].lso="",O===d.p.sortname&&(d.p.lastsort=k),d.p.multiSort&&(O=a.inArray(O,ja),-1!==O&&(d.p.colModel[k].lso=ea[O])),M+=ga+"</div></th>";M+="</tr></thead>";ga=null;a(this).append(M);a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});
if(this.p.multiselect){var ka=[],da;a("#cb_"+a.jgrid.jqID(d.p.id),this).bind("click",function(){d.p.selarrrow=[];var b=!0===d.p.frozenColumns?d.p.id+"_frozen":"";this.checked?(a(d.rows).each(function(c){0<c&&!(a(this).hasClass("ui-subgrid")||a(this).hasClass("jqgroup")||a(this).hasClass("ui-state-disabled")||a(this).hasClass("jqfoot"))&&(a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id))[d.p.useProp?"prop":"attr"]("checked",!0),a(this).addClass("ui-state-highlight").attr("aria-selected","true"),
...
!1),a(this).removeClass("ui-state-highlight").attr("aria-selected","false"),ka.push(this.id),b&&(a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id),d.grid.fbDiv)[d.p.useProp?"prop":"attr"]("checked",!1),a("#"+a.jgrid.jqID(this.id),d.grid.fbDiv).removeClass("ui-state-highlight")))}),d.p.selrow=null,da=!1);a(d).triggerHandler("jqGridSelectAll",[da?d.p.selarrrow:ka,da]);a.isFunction(d.p.onSelectAll)&&d.p.onSelectAll.call(d,da?d.p.selarrrow:ka,da)})}!0===d.p.autowidth&&(M=a(m).innerWidth(),d.p.width=
0<M?M:"nw");(function(){var b=0,c=a.jgrid.cell_width?0:r(d.p.cellLayout,0),e=0,f,g=r(d.p.scrollOffset,0),k,l=!1,p,m=0,n;a.each(d.p.colModel,function(){void 0===this.hidden&&(this.hidden=!1);if(d.p.grouping&&d.p.autowidth){var f=a.inArray(this.name,d.p.groupingView.groupField);0<=f&&d.p.groupingView.groupColumnShow.length>f&&(this.hidden=!d.p.groupingView.groupColumnShow[f])}this.widthOrg=k=r(this.width,0);!1===this.hidden&&(b+=k+c,this.fixed?m+=k+c:e++)});isNaN(d.p.width)&&(d.p.width=b+(!1!==d.p.shrinkToFit||
...
d.p.width&&(d.p.colModel[f].width-=d.p.tblwidth-parseInt(d.p.width,10),d.p.tblwidth=d.p.width))})();a(m).css("width",h.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+d.p.id+"'>&#160;</div>");a(p).css("width",h.width+"px");M=a("thead:first",d).get(0);var fa="";d.p.footerrow&&(fa+="<table role='presentation' style='width:"+d.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+l+"'>");var p=
a("tr:first",M),ha="<tr class='jqgfirstrow' role='row' style='height:auto'>";d.p.disableClick=!1;a("th",p).each(function(b){Z=d.p.colModel[b].width;void 0===d.p.colModel[b].resizable&&(d.p.colModel[b].resizable=!0);d.p.colModel[b].resizable?(U=document.createElement("span"),a(U).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+l).css("cursor","col-resize"),a(this).addClass(d.p.resizeclass)):U="";a(this).css("width",Z+"px").prepend(U);U=null;var c="";d.p.colModel[b].hidden&&(a(this).css("display",
"none"),c="display:none;");ha+="<td role='gridcell' style='height:0px;width:"+Z+"px;"+c+"'></td>";h.headers[b]={width:Z,el:this};R=d.p.colModel[b].sortable;"boolean"!==typeof R&&(R=d.p.colModel[b].sortable=!0);c=d.p.colModel[b].name;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&d.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");R&&(d.p.multiSort?d.p.viewsortcols[0]?(a("div span.s-ico",this).show(),d.p.colModel[b].lso&&a("div span.ui-icon-"+d.p.colModel[b].lso,this).removeClass("ui-state-disabled")):
d.p.colModel[b].lso&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+d.p.colModel[b].lso,this).removeClass("ui-state-disabled")):d.p.viewsortcols[0]?(a("div span.s-ico",this).show(),b===d.p.lastsort&&a("div span.ui-icon-"+d.p.sortorder,this).removeClass("ui-state-disabled")):b===d.p.lastsort&&""!==d.p.sortname&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+d.p.sortorder,this).removeClass("ui-state-disabled")));d.p.footerrow&&(fa+="<td role='gridcell' "+q(b,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(b){if(1===
...
1);a(d.p.colModel).each(function(a){if(this.name===g)return h=a,!1})}else h=W(this);d.p.viewsortcols[2]||(e=!0,f=b.attr("sort"));null!=h&&I(a("div",this)[0].id,h,e,f,this);return!1}});if(d.p.sortable&&a.fn.sortable)try{a(d).jqGrid("sortableColumns",p)}catch(oa){}d.p.footerrow&&(fa+="</tr></tbody></table>");ha+="</tr>";p=document.createElement("tbody");this.appendChild(p);a(this).addClass("ui-jqgrid-btable").append(ha);var ha=null,p=a("<table class='ui-jqgrid-htable' style='width:"+d.p.tblwidth+"px' role='presentation' aria-labelledby='gbox_"+
this.id+"' cellspacing='0' cellpadding='0' border='0'></table>").append(M),X=d.p.caption&&!0===d.p.hiddengrid?!0:!1;k=a("<div class='ui-jqgrid-hbox"+("rtl"===l?"-rtl":"")+"'></div>");M=null;h.hDiv=document.createElement("div");a(h.hDiv).css({width:h.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(k);a(k).append(p);p=null;X&&a(h.hDiv).hide();d.p.pager&&("string"===typeof d.p.pager?"#"!==d.p.pager.substr(0,1)&&(d.p.pager="#"+d.p.pager):d.p.pager="#"+a(d.p.pager).attr("id"),a(d.p.pager).css({width:h.width+
"px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(m),X&&a(d.p.pager).hide(),V(d.p.pager,""));!1===d.p.cellEdit&&!0===d.p.hoverrows&&a(d).bind("mouseover",function(b){H=a(b.target).closest("tr.jqgrow");"ui-subgrid"!==a(H).attr("class")&&a(H).addClass("ui-state-hover")}).bind("mouseout",function(b){H=a(b.target).closest("tr.jqgrow");a(H).removeClass("ui-state-hover")});var T,aa,la;a(d).before(h.hDiv).click(function(b){J=b.target;H=a(J,d.rows).closest("tr.jqgrow");if(0===
a(H).length||-1<H[0].className.indexOf("ui-state-disabled")||(a(J,d).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==d.id)return this;var c=a(J).hasClass("cbox"),e=a(d).triggerHandler("jqGridBeforeSelectRow",[H[0].id,b]),e=!1===e||"stop"===e?!1:!0;if(a.isFunction(d.p.beforeSelectRow)){var f=d.p.beforeSelectRow.call(d,H[0].id,b);if(!1===f||"stop"===f)e=!1}if("A"!==J.tagName&&("INPUT"!==J.tagName&&"TEXTAREA"!==J.tagName&&"OPTION"!==J.tagName&&"SELECT"!==J.tagName||c))if(T=
H[0].id,J=a(J).closest("tr.jqgrow>td"),0<J.length&&(aa=a.jgrid.getCellIndex(J),la=a(J).closest("td,th").html(),a(d).triggerHandler("jqGridCellSelect",[T,aa,la,b]),a.isFunction(d.p.onCellSelect)&&d.p.onCellSelect.call(d,T,aa,la,b)),!0===d.p.cellEdit)if(d.p.multiselect&&c&&e)a(d).jqGrid("setSelection",T,!0,b);else{if(0<J.length){T=H[0].rowIndex;try{a(d).jqGrid("editCell",T,aa,!0)}catch(h){}}}else if(e)if(d.p.multikey)b[d.p.multikey]?a(d).jqGrid("setSelection",T,!0,b):d.p.multiselect&&c&&(c=a("#jqg_"+
a.jgrid.jqID(d.p.id)+"_"+T).is(":checked"),a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+T)[d.p.useProp?"prop":"attr"]("checked",c));else{if(d.p.multiselect&&d.p.multiboxonly&&!c){var g=d.p.frozenColumns?d.p.id+"_frozen":"";a(d.p.selarrrow).each(function(b,c){var e=a(d).jqGrid("getGridRowById",c);e&&a(e).removeClass("ui-state-highlight");a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(c))[d.p.useProp?"prop":"attr"]("checked",!1);g&&(a("#"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(g)).removeClass("ui-state-highlight"),
a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(g))[d.p.useProp?"prop":"attr"]("checked",!1))});d.p.selarrrow=[]}a(d).jqGrid("setSelection",T,!0,b)}}).bind("reloadGrid",function(b,c){!0===d.p.treeGrid&&(d.p.datatype=d.p.treedatatype);c&&c.current&&d.grid.selectionPreserver(d);"local"===d.p.datatype?(a(d).jqGrid("resetSelection"),d.p.data.length&&(E(),A())):d.p.treeGrid||(d.p.selrow=null,d.p.multiselect&&(d.p.selarrrow=[],S(!1)),d.p.savedRow=[]);d.p.scroll&&w.call(d,!0,!1);if(c&&
c.page){var e=c.page;e>d.p.lastpage&&(e=d.p.lastpage);1>e&&(e=1);d.p.page=e;d.grid.bDiv.scrollTop=d.grid.prevRowHeight?(e-1)*d.grid.prevRowHeight*d.p.rowNum:0}d.grid.prevRowHeight&&d.p.scroll?(delete d.p.lastpage,d.grid.populateVisible()):d.grid.populate();!0===d.p._inlinenav&&a(d).jqGrid("showAddEditButtons");return!1}).dblclick(function(b){J=b.target;H=a(J,d.rows).closest("tr.jqgrow");if(0!==a(H).length){T=H[0].rowIndex;aa=a.jgrid.getCellIndex(J);var c=a(d).triggerHandler("jqGridDblClickRow",[a(H).attr("id"),
T,aa,b]);if(null!=c||a.isFunction(d.p.ondblClickRow)&&(c=d.p.ondblClickRow.call(d,a(H).attr("id"),T,aa,b),null!=c))return c}}).bind("contextmenu",function(b){J=b.target;H=a(J,d.rows).closest("tr.jqgrow");if(0!==a(H).length){d.p.multiselect||a(d).jqGrid("setSelection",H[0].id,!0,b);T=H[0].rowIndex;aa=a.jgrid.getCellIndex(J);var c=a(d).triggerHandler("jqGridRightClickRow",[a(H).attr("id"),T,aa,b]);if(null!=c||a.isFunction(d.p.onRightClickRow)&&(c=d.p.onRightClickRow.call(d,a(H).attr("id"),T,aa,b),null!=
c))return c}});h.bDiv=document.createElement("div");c&&"auto"===String(d.p.height).toLowerCase()&&(d.p.height="100%");a(h.bDiv).append(a('<div style="position:relative;'+(c&&8>a.jgrid.msiever()?"height:0.01%;":"")+'"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:d.p.height+(isNaN(d.p.height)?"":"px"),width:h.width+"px"}).scroll(h.scrollGrid);a("table:first",h.bDiv).css({width:d.p.tblwidth+"px"});a.support.tbody||2===a("tbody",this).length&&a("tbody:gt(0)",this).remove();
...
"t_"+this.id).insertBefore(h.hDiv),a(h.ubDiv).addClass("ui-userdata ui-state-default").attr("id","tb_"+this.id).insertAfter(h.hDiv),X&&a(h.ubDiv).hide()):a(h.uDiv).width(h.width).addClass("ui-userdata ui-state-default").attr("id","t_"+this.id),X&&a(h.uDiv).hide());d.p.toppager&&(d.p.toppager=a.jgrid.jqID(d.p.id)+"_toppager",h.topDiv=a("<div id='"+d.p.toppager+"'></div>")[0],d.p.toppager="#"+d.p.toppager,a(h.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(h.width).insertBefore(h.hDiv),
V(d.p.toppager,"_t"));d.p.footerrow&&(h.sDiv=a("<div class='ui-jqgrid-sdiv'></div>")[0],k=a("<div class='ui-jqgrid-hbox"+("rtl"===l?"-rtl":"")+"'></div>"),a(h.sDiv).append(k).width(h.width).insertAfter(h.hDiv),a(k).append(fa),h.footers=a(".ui-jqgrid-ftable",h.sDiv)[0].rows[0].cells,d.p.rownumbers&&(h.footers[0].className="ui-state-default jqgrid-rownum"),X&&a(h.sDiv).hide());k=null;if(d.p.caption){var na=d.p.datatype;!0===d.p.hidegrid&&(a(".ui-jqgrid-titlebar-close",h.cDiv).click(function(b){var c=
a.isFunction(d.p.onHeaderClick),e=".ui-jqgrid-bdiv,.ui-jqgrid-hdiv,.ui-jqgrid-pager,.ui-jqgrid-sdiv",f,g=this;!0===d.p.toolbar[0]&&("both"===d.p.toolbar[1]&&(e+=",#"+a.jgrid.jqID(a(h.ubDiv).attr("id"))),e+=",#"+a.jgrid.jqID(a(h.uDiv).attr("id")));f=a(e,"#gview_"+a.jgrid.jqID(d.p.id)).length;d.p.toppager&&(e+=","+d.p.toppager);"visible"===d.p.gridstate?a(e,"#gbox_"+a.jgrid.jqID(d.p.id)).slideUp("fast",function(){f--;0===f&&(a("span",g).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s"),
d.p.gridstate="hidden",a("#gbox_"+a.jgrid.jqID(d.p.id)).hasClass("ui-resizable")&&a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(d.p.id)).hide(),a(d.grid.cDiv).addClass("ui-corner-bottom"),a(d).triggerHandler("jqGridHeaderClick",[d.p.gridstate,b]),c&&(X||d.p.onHeaderClick.call(d,d.p.gridstate,b)))}):"hidden"===d.p.gridstate&&(a(d.grid.cDiv).removeClass("ui-corner-bottom"),a(e,"#gbox_"+a.jgrid.jqID(d.p.id)).slideDown("fast",function(){f--;0===f&&(a("span",g).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n"),
X&&(d.p.datatype=na,L(),X=!1),d.p.gridstate="visible",a("#gbox_"+a.jgrid.jqID(d.p.id)).hasClass("ui-resizable")&&a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(d.p.id)).show(),a(d).triggerHandler("jqGridHeaderClick",[d.p.gridstate,b]),c&&(X||d.p.onHeaderClick.call(d,d.p.gridstate,b)))}));return!1}),X&&(d.p.datatype="local",a(".ui-jqgrid-titlebar-close",h.cDiv).trigger("click")))}else a(h.cDiv).hide(),a(h.cDiv).nextAll("div:visible").filter(":first").addClass("ui-corner-top");a(h.hDiv).after(h.bDiv).mousemove(function(a){if(h.resizing)return h.dragMove(a),
!1});a(".ui-jqgrid-labels",h.hDiv).bind("selectstart",function(){return!1});a(document).bind("mouseup.jqGrid"+d.p.id,function(){return h.resizing?(h.dragEnd(),!1):!0});d.formatCol=q;d.sortData=I;d.updatepager=function(b,c){var e,f,h,g,k,l,p,m="",n=d.p.pager?"_"+a.jgrid.jqID(d.p.pager.substr(1)):"",q=d.p.toppager?"_"+d.p.toppager.substr(1):"";h=parseInt(d.p.page,10)-1;0>h&&(h=0);h*=parseInt(d.p.rowNum,10);k=h+d.p.reccount;if(d.p.scroll){e=a("tbody:first > tr:gt(0)",d.grid.bDiv);h=k-e.length;d.p.reccount=
e.length;if(e=e.outerHeight()||d.grid.prevRowHeight)f=h*e,p=parseInt(d.p.records,10)*e,a(">div:first",d.grid.bDiv).css({height:p}).children("div:first").css({height:f,display:f?"":"none"}),0===d.grid.bDiv.scrollTop&&1<d.p.page&&(d.grid.bDiv.scrollTop=d.p.rowNum*(d.p.page-1)*e);d.grid.bDiv.scrollLeft=d.grid.hDiv.scrollLeft}m=d.p.pager||"";if(m+=d.p.toppager?m?","+d.p.toppager:d.p.toppager:"")p=a.jgrid.formatter.integer||{},e=r(d.p.page),f=r(d.p.lastpage),a(".selbox",m)[d.p.useProp?"prop":"attr"]("disabled",
!1),!0===d.p.pginput&&(a(".ui-pg-input",m).val(d.p.page),g=d.p.toppager?"#sp_1"+n+",#sp_1"+q:"#sp_1"+n,a(g).html(a.fmatter?a.fmatter.util.NumberFormat(d.p.lastpage,p):d.p.lastpage)),d.p.viewrecords&&(0===d.p.reccount?a(".ui-paging-info",m).html(d.p.emptyrecords):(g=h+1,l=d.p.records,a.fmatter&&(g=a.fmatter.util.NumberFormat(g,p),k=a.fmatter.util.NumberFormat(k,p),l=a.fmatter.util.NumberFormat(l,p)),a(".ui-paging-info",m).html(a.jgrid.format(d.p.recordtext,g,k,l)))),!0===d.p.pgbuttons&&(0>=e&&(e=f=
...
a.jgrid.jqID(this.p.id)).toggle(e);break;case "block":a("#lui_"+a.jgrid.jqID(this.p.id)).toggle(e),a("#load_"+a.jgrid.jqID(this.p.id)).toggle(e)}})}})})(jQuery);
...
g+"'></th>");k.append(g);if(!0===this.p.ruleButtons){var l=a("<select class='opsel'></select>");g.append(l);var k="",u;for(e=0;e<f.groupOps.length;e++)u=b.groupOp===d.p.groupOps[e].op?" selected='selected'":"",k+="<option value='"+d.p.groupOps[e].op+"'"+u+">"+d.p.groupOps[e].text+"</option>";l.append(k).bind("change",function(){b.groupOp=a(l).val();d.onchange()})}k="<span></span>";this.p.groupButton&&(k=a("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>"),k.bind("click",
...
0;e<b.groups.length;e++)g=a("<tr></tr>"),h.append(g),k=a("<td class='first'></td>"),g.append(k),k=a("<td colspan='4'></td>"),k.append(this.createTableForGroup(b.groups[e],b)),g.append(k);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)h.append(this.createTableRowForRule(b.rules[e],b));return h};this.createTableRowForRule=function(b,c){var d=this,e=a("#"+a.jgrid.jqID(f.id))[0]||null,g=a("<tr></tr>"),h,l,x,u,y="",C;g.append("<td class='first'></td>");
var w=a("<td class='columns'></td>");g.append(w);var E=a("<select></select>"),A,D=[];w.append(E);E.bind("change",function(){b.field=a(E).val();x=a(this).parents("tr:first");for(h=0;h<d.p.columns.length;h++)if(d.p.columns[h].name===b.field){u=d.p.columns[h];break}if(u){u.searchoptions.id=a.jgrid.randId();k&&"text"===u.inputtype&&!u.searchoptions.size&&(u.searchoptions.size=10);var c=a.jgrid.createEl.call(e,u.inputtype,u.searchoptions,"",!0,d.p.ajaxSelectOptions||{},!0);a(c).addClass("input-elm");l=
u.searchoptions.sopt?u.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(u.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;var f="",g=0;D=[];a.each(d.p.ops,function(){D.push(this.oper)});for(h=0;h<l.length;h++)A=a.inArray(l[h],D),-1!==A&&(0===g&&(b.op=d.p.ops[A].oper),f+="<option value='"+d.p.ops[A].oper+"'>"+d.p.ops[A].text+"</option>",g++);a(".selectopts",x).empty().append(f);a(".selectopts",x)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(f=parseInt(a("select.selectopts",x)[0].offsetWidth,
10)+1,a(".selectopts",x).width(f),a(".selectopts",x).css("width","auto"));a(".data",x).empty().append(c);a.jgrid.bindEv.call(e,c,u.searchoptions);a(".input-elm",x).bind("change",function(c){c=c.target;b.data="SPAN"===c.nodeName.toUpperCase()&&u.searchoptions&&a.isFunction(u.searchoptions.custom_value)?u.searchoptions.custom_value.call(e,a(c).children(".customelement:first"),"get"):c.value;d.onchange()});setTimeout(function(){b.data=a(c).val();d.onchange()},0)}});for(h=w=0;h<d.p.columns.length;h++){C=
void 0===d.p.columns[h].search?!0:d.p.columns[h].search;var F=!0===d.p.columns[h].hidden;if(!0===d.p.columns[h].searchoptions.searchhidden&&C||C&&!F)C="",b.field===d.p.columns[h].name&&(C=" selected='selected'",w=h),y+="<option value='"+d.p.columns[h].name+"'"+C+">"+d.p.columns[h].label+"</option>"}E.append(y);y=a("<td class='operators'></td>");g.append(y);u=f.columns[w];u.searchoptions.id=a.jgrid.randId();k&&"text"===u.inputtype&&!u.searchoptions.size&&(u.searchoptions.size=10);w=a.jgrid.createEl.call(e,
u.inputtype,u.searchoptions,b.data,!0,d.p.ajaxSelectOptions||{},!0);if("nu"===b.op||"nn"===b.op)a(w).attr("readonly","true"),a(w).attr("disabled","true");var G=a("<select class='selectopts'></select>");y.append(G);G.bind("change",function(){b.op=a(G).val();x=a(this).parents("tr:first");var c=a(".input-elm",x)[0];"nu"===b.op||"nn"===b.op?(b.data="","SELECT"!==c.tagName.toUpperCase()&&(c.value=""),c.setAttribute("readonly","true"),c.setAttribute("disabled","true")):("SELECT"===c.tagName.toUpperCase()&&
(b.data=c.value),c.removeAttribute("readonly"),c.removeAttribute("disabled"));d.onchange()});l=u.searchoptions.sopt?u.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(u.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;y="";a.each(d.p.ops,function(){D.push(this.oper)});for(h=0;h<l.length;h++)A=a.inArray(l[h],D),-1!==A&&(C=b.op===d.p.ops[A].oper?" selected='selected'":"",y+="<option value='"+d.p.ops[A].oper+"'"+C+">"+d.p.ops[A].text+"</option>");G.append(y);y=a("<td class='data'></td>");g.append(y);
y.append(w);a.jgrid.bindEv.call(e,w,u.searchoptions);a(w).addClass("input-elm").bind("change",function(){b.data="custom"===u.inputtype?u.searchoptions.custom_value.call(e,a(this).children(".customelement:first"),"get"):a(this).val();d.onchange()});y=a("<td></td>");g.append(y);!0===this.p.ruleButtons&&(w=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),y.append(w),w.bind("click",function(){for(h=0;h<c.rules.length;h++)if(c.rules[h]===b){c.rules.splice(h,1);break}d.reDraw();
...
""}var D=a.extend({},this.editoptions||{},{id:h,name:h,rowId:c}),x=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),C=parseInt(x.rowpos,10)||l+1,A=parseInt(2*(parseInt(x.colpos,10)||1),10);"_empty"===c&&D.defaultValue&&(m=a.isFunction(D.defaultValue)?D.defaultValue.call(n):D.defaultValue);this.edittype||(this.edittype="text");n.p.autoencode&&(m=a.jgrid.htmlDecode(m));q=a.jgrid.createEl.call(n,this.edittype,D,m,!1,a.extend({},a.jgrid.ajaxOptions,d.p.ajaxSelectOptions||
{}));if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)b[n.p.id]._savedData[h]=m;a(q).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(q).addClass("ui-widget-content ui-corner-all");k=a(e).find("tr[rowpos="+C+"]");if(x.rowabove){var z=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+x.rowcontent+"</td></tr>");a(e).append(z);z[0].rp=C}0===k.length&&(k=a("<tr "+p+" rowpos='"+C+"'></tr>").addClass("FormData").attr("id","tr_"+h),a(k).append(u),a(e).append(k),
k[0].rp=C);a("td:eq("+(A-2)+")",k[0]).html(void 0===x.label?d.p.colNames[w]:x.label);a("td:eq("+(A-1)+")",k[0]).append(x.elmprefix).append(q).append(x.elmsuffix);"custom"===this.edittype&&a.isFunction(D.custom_value)&&D.custom_value.call(n,a("#"+h,"#"+v),"set",m);a.jgrid.bindEv.call(n,q,D);r[l]=w;l++}});0<l&&(w=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+d.p.id+"_id' value='"+
...
b[n.p.id].checkOnUpdate)&&(b[n.p.id]._savedData[f]=m)}),a("#id_g","#"+e).val(c);else{var r=a(d).jqGrid("getInd",c,!0);r&&(a('td[role="gridcell"]',r).each(function(k){f=q[k].name;if("cb"!==f&&"subgrid"!==f&&"rn"!==f&&!0===q[k].editable){if(f===d.p.ExpandColumn&&!0===d.p.treeGrid)g=a(this).text();else try{g=a.unformat.call(d,a(this),{rowId:c,colModel:q[k]},k)}catch(l){g="textarea"===q[k].edittype?a(this).text():a(this).html()}n.p.autoencode&&(g=a.jgrid.htmlDecode(g));if(!0===b[n.p.id].checkOnSubmit||
b[n.p.id].checkOnUpdate)b[n.p.id]._savedData[f]=g;f=a.jgrid.jqID(f);switch(q[k].edittype){case "password":case "text":case "button":case "image":case "textarea":if("&nbsp;"===g||"&#160;"===g||1===g.length&&160===g.charCodeAt(0))g="";a("#"+f,"#"+e).val(g);break;case "select":var m=g.split(","),m=a.map(m,function(b){return a.trim(b)});a("#"+f+" option","#"+e).each(function(){q[k].editoptions.multiple||a.trim(g)!==a.trim(a(this).text())&&m[0]!==a.trim(a(this).text())&&m[0]!==a.trim(a(this).val())?q[k].editoptions.multiple?
-1<a.inArray(a.trim(a(this).text()),m)||-1<a.inArray(a.trim(a(this).val()),m)?this.selected=!0:this.selected=!1:this.selected=!1:this.selected=!0});break;case "checkbox":g=String(g);if(q[k].editoptions&&q[k].editoptions.value)if(q[k].editoptions.value.split(":")[0]===g)a("#"+f,"#"+e)[n.p.useProp?"prop":"attr"]({checked:!0,defaultChecked:!0});else a("#"+f,"#"+e)[n.p.useProp?"prop":"attr"]({checked:!1,defaultChecked:!1});else g=g.toLowerCase(),0>g.search(/(false|f|0|no|n|off|undefined)/i)&&""!==g?(a("#"+
f,"#"+e)[n.p.useProp?"prop":"attr"]("checked",!0),a("#"+f,"#"+e)[n.p.useProp?"prop":"attr"]("defaultChecked",!0)):(a("#"+f,"#"+e)[n.p.useProp?"prop":"attr"]("checked",!1),a("#"+f,"#"+e)[n.p.useProp?"prop":"attr"]("defaultChecked",!1));break;case "custom":try{if(q[k].editoptions&&a.isFunction(q[k].editoptions.custom_value))q[k].editoptions.custom_value.call(n,a("#"+f,"#"+e),"set",g);else throw"e1";}catch(p){"e1"===p?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,p.message,a.jgrid.edit.bClose)}}h++}}),0<h&&a("#id_g",u).val(c))}}function h(){a.each(n.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&z.hasOwnProperty(b.name)&&""===z[b.name]&&(z[b.name]="null")})}function k(){var e,f=[!0,"",""],g={},k=n.p.prmNames,l,m,p,q,r,w=a(n).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+v),B]);w&&"object"===typeof w&&(z=w);a.isFunction(b[n.p.id].beforeCheckValues)&&(w=b[n.p.id].beforeCheckValues.call(n,
...
b[n.p.id].beforeInitData:!1,A=a.isFunction(b[n.p.id].onInitializeForm)?b[n.p.id].onInitializeForm:!1,D=!0,F=1,G=0,z,P,B,v=a.jgrid.jqID(v);"new"===e?(e="_empty",B="add",c.caption=b[n.p.id].addCaption):(c.caption=b[n.p.id].editCaption,B="edit");c.recreateForm||a(n).data("formProp")&&a.extend(b[a(this)[0].p.id],a(n).data("formProp"));var L=!0;c.checkOnUpdate&&c.jqModal&&!c.modal&&(L=!1);var S=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",D=isNaN(b[a(this)[0].p.id].datawidth)?
b[a(this)[0].p.id].datawidth:b[a(this)[0].p.id].datawidth+"px",S=a("<form name='FormPost' id='"+v+"' class='FormGrid' onSubmit='return false;' style='width:"+D+";overflow:auto;position:relative;height:"+S+";'></form>").data("disabled",!1),V=a("<table id='"+x+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>");a(n.p.colModel).each(function(){var a=this.formoptions;F=Math.max(F,a?a.colpos||0:0);G=Math.max(G,a?a.rowpos||0:0)});a(S).append(V);D=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+
2*F+"'></td></tr>");D[0].rp=0;a(V).append(D);D=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*F+"'>"+b[n.p.id].topinfo+"</td></tr>");D[0].rp=0;a(V).append(D);D=a(n).triggerHandler("jqGridAddEditBeforeInitData",[S,B]);void 0===D&&(D=!0);D&&E&&(D=E.call(n,S,B));if(!1!==D){m();var D=(E="rtl"===n.p.direction?!0:!1)?"nData":"pData",Y=E?"pData":"nData";g(e,n,V,F);var D="<a id='"+D+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
...
(E?Y+D:D+Y)+"</td><td class='EditButton'>"+I+ba+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+b[n.p.id].bottominfo+"</td></tr>"),x=x+"</tbody></table>";if(0<G){var W=[];a.each(a(V)[0].rows,function(a,b){W[a]=b});W.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(W,function(b,c){a("tbody",V).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(t);var M=!1;!0===c.closeOnEscape&&(c.closeOnEscape=!1,M=!0);x=a("<div></div>").append(S).append(x);a.jgrid.createModal(y,
...
"left","ui-icon-close"],c.closeicon);!0===c.saveicon[0]&&a("#sData",u+"_2").addClass("right"===c.saveicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+c.saveicon[2]+"'></span>");!0===c.closeicon[0]&&a("#cData",u+"_2").addClass("right"===c.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+c.closeicon[2]+"'></span>");if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)I="<a id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+
c.bYes+"</a>",Y="<a id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bNo+"</a>",ba="<a id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bExit+"</a>",x=c.zIndex||999,x++,a("<div class='"+c.overlayClass+" jqgrid-overlay confirm' style='z-index:"+x+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(x+1)+"'>"+c.saveData+"<br/><br/>"+I+Y+ba+"</div>").insertAfter("#"+v),a("#sNew","#"+a.jgrid.jqID(y.themodal)).click(function(){k();
...
beforeInitData:null,viewPagerButtons:!0,recreateForm:!1,removemodal:!0,form:"view"},a.jgrid.view,c||{});b[a(this)[0].p.id]=c;return this.each(function(){function f(){!0!==b[l.p.id].closeOnEscape&&!0!==b[l.p.id].navkeys[0]||setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(t.modalhead)).attr("tabindex","-1").focus()},0)}function g(b,d,e,f){var g,h,k,l=0,m,n,p=[],q,r,t="<td class='CaptionTD form-view-label ui-widget-content' width='"+c.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",
...
r+'"><td style="padding-left:'+12*w.idx+'px;" colspan="'+(!1===k.groupColumnShow[w.idx]?e-1:e)+'">'+p+a.jgrid.template(k.groupText[w.idx],n,w.cnt,w.summary)+"</td></tr>";if(v-1===w.idx){var A=k.groups[g+1],D,F=0;D=w.startRow;var G=void 0!==A?A.startRow:k.groups[g].startRow+k.groups[g].cnt;k._locgr&&(F=(c-1)*f,F>w.startRow&&(D=F));for(;D<G&&b[D-F];D++)l+=b[D-F].join("");if("header"!==k.groupSummaryPos[w.idx]){var z;if(void 0!==A){for(z=0;z<k.groupField.length&&A.dataIndex!==k.groupField[z];z++);x=
...
1;g=0===c?Y:V+E;if(a.level-1===(m.rowTotals?1:0)&&0<c){var h=p[a.level-1].groupHeaders[c-1].numberOfColumns;h&&(g=h+1+m.aggregates.length)}p[a.level-1].groupHeaders[c].startColumnName=f[g].name;p[a.level-1].groupHeaders[c].numberOfColumns=f.length-g;V=f.length}S[a.level]=a.text}if(a.level===w&&"level"===d&&0<w)if(1<E){c=1;for(b in a.fields)a.fields.hasOwnProperty(b)&&(1===c&&p[w-1].groupHeaders.push({startColumnName:b,numberOfColumns:1,titleText:a.text}),c++);p[w-1].groupHeaders[p[w-1].groupHeaders.length-

...
!0===d.p.forceFit)for(k=d.p.colModel.length-1;0<=k;k--)if(!0!==d.p.colModel[k].hidden){d.p.colModel[k].resizable=!1;break}"horizontal"===d.p.viewsortcols[1]&&(ga=" ui-i-asc",ca=" ui-i-desc");K=c?"class='ui-th-div-ie'":"";ga="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+ga+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+l+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ca+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+
...
a("tr:first",M),ha="<tr class='jqgfirstrow' role='row' style='height:auto'>";d.p.disableClick=!1;a("th",p).each(function(b){Z=d.p.colModel[b].width;void 0===d.p.colModel[b].resizable&&(d.p.colModel[b].resizable=!0);d.p.colModel[b].resizable?(U=document.createElement("span"),a(U).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+l).css("cursor","col-resize"),a(this).addClass(d.p.resizeclass)):U="";a(this).css("width",Z+"px").prepend(U);U=null;var c="";!0===d.p.colModel[b].hidden&&(a(this).css("display",

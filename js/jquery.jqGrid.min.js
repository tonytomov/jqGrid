...
(l+=" "+n+"="+g[n])}return'<tr role="row" id="'+b+'" tabindex="'+k+'" class="'+e+'"'+(""===c?"":' style="'+c+'"')+l+">"},F=function(b,c,e,f,h){var g=new Date,k="local"!==d.p.datatype&&d.p.loadonce||"xmlstring"===d.p.datatype,l=d.p.xmlReader,n="local"===d.p.datatype?"local":"xml";k&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;if(a.isXMLDoc(b)){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(w.call(d,!1,!0),e=1);var p=a(d),m,q,t=0,A,M=!0===d.p.multiselect?1:0,z=0,Q,F=!0===d.p.rownumbers?
1:0,E,I=[],N,B={},H,K,J=[],P=!0===d.p.altRows?d.p.altclass:"",ia;!0===d.p.subGrid&&(z=1,Q=a.jgrid.getMethod("addSubGridCell"));l.repeatitems||(I=y(n));E=!1===d.p.keyName?a.isFunction(l.id)?l.id.call(d,b):l.id:d.p.keyName;n=-1===String(E).indexOf("[")?I.length?function(b,d){return a(E,b).text()||d}:function(b,d){return a(l.cell,b).eq(E).text()||d}:function(a,b){return a.getAttribute(E.replace(/[\[\]]/g,""))||b};d.p.userData={};d.p.page=r(a.jgrid.getXmlData(b,l.page),d.p.page);d.p.lastpage=r(a.jgrid.getXmlData(b,
l.total),1);d.p.records=r(a.jgrid.getXmlData(b,l.records));a.isFunction(l.userdata)?d.p.userData=l.userdata.call(d,b)||{}:a.jgrid.getXmlData(b,l.userdata,!0).each(function(){d.p.userData[this.getAttribute("name")]=a(this).text()});b=a.jgrid.getXmlData(b,l.root,!0);(b=a.jgrid.getXmlData(b,l.row,!0))||(b=[]);var G=b.length,R=0,L=[],V=parseInt(d.p.rowNum,10),O=d.p.scroll?a.jgrid.randId():1;0<G&&0>=d.p.page&&(d.p.page=1);if(b&&G){h&&(V*=h+1);h=a.isFunction(d.p.afterInsertRow);var Z=!1,U;d.p.grouping&&
(Z=!0===d.p.groupingView.groupCollapse,U=a.jgrid.getMethod("groupingPrepare"));for(;R<G;){H=b[R];K=n(H,O+R);K=d.p.idPrefix+K;m=0===e?0:e+1;ia=1===(m+R)%2?P:"";var ca=J.length;J.push("");F&&J.push(u(0,R,d.p.page,d.p.rowNum));M&&J.push(x(K,F,R,!1));z&&J.push(Q.call(p,M+F,R+e));if(l.repeatitems){N||(N=C(M+z+F));var ea=a.jgrid.getXmlData(H,l.cell,!0);a.each(N,function(a){var b=ea[this];if(!b)return!1;A=b.textContent||b.text;B[d.p.colModel[a+M+z+F].name]=A;J.push(v(K,A,a+M+z+F,R+e,H,B))})}else for(m=0;m<
I.length;m++)A=a.jgrid.getXmlData(H,I[m]),B[d.p.colModel[m+M+z+F].name]=A,J.push(v(K,A,m+M+z+F,R+e,H,B));J[ca]=D(K,Z,ia,B,H,!1);J.push("</tr>");d.p.grouping&&(L.push(J),d.p.groupingView._locgr||U.call(p,B,R),J=[]);if(k||!0===d.p.treeGrid)B._id_=a.jgrid.stripPref(d.p.idPrefix,K),d.p.data.push(B),d.p._index[B._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("tbody:first",c).append(J.join("")),p.triggerHandler("jqGridAfterInsertRow",[K,B,H]),h&&d.p.afterInsertRow.call(d,K,B,H),J=[]);B={};t++;R++;if(t===
V)break}}!0===d.p.gridview&&(q=-1<d.p.treeANode?d.p.treeANode:0,d.p.grouping?k||(p.jqGrid("groupingRender",L,d.p.colModel.length,d.p.page,V),L=null):!0===d.p.treeGrid&&0<q?a(d.rows[q]).after(J.join("")):(d.firstElementChild.innerHTML+=J.join(""),d.grid.cols=d.rows[0].cells));if(!0===d.p.subGrid)try{p.jqGrid("addSubGrid",M+F)}catch(da){}d.p.totaltime=new Date-g;0<t&&0===d.p.records&&(d.p.records=G);J=null;if(!0===d.p.treeGrid)try{p.jqGrid("setTreeNode",q+1,t+q+1)}catch(S){}d.p.reccount=t;d.p.treeANode=
-1;d.p.userDataOnFooter&&p.jqGrid("footerData","set",d.p.userData,!0);k&&(d.p.records=G,d.p.lastpage=Math.ceil(G/V));f||d.updatepager(!1,!0);if(k){for(;t<G;){H=b[t];K=n(H,t+O);K=d.p.idPrefix+K;if(l.repeatitems){N||(N=C(M+z+F));var ba=a.jgrid.getXmlData(H,l.cell,!0);a.each(N,function(a){var b=ba[this];if(!b)return!1;A=b.textContent||b.text;B[d.p.colModel[a+M+z+F].name]=A})}else for(m=0;m<I.length;m++)A=a.jgrid.getXmlData(H,I[m]),B[d.p.colModel[m+M+z+F].name]=A;B._id_=a.jgrid.stripPref(d.p.idPrefix,
K);d.p.grouping&&U.call(p,B,t);d.p.data.push(B);d.p._index[B._id_]=d.p.data.length-1;B={};t++}d.p.grouping&&(d.p.groupingView._locgr=!0,p.jqGrid("groupingRender",L,d.p.colModel.length,d.p.page,V),L=null)}}},H=function(b,c,e,f,h){var g=new Date;if(b){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(w.call(d,!1,!0),e=1);var k,l="local"!==d.p.datatype&&d.p.loadonce||"jsonstring"===d.p.datatype;l&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;"local"===d.p.datatype?(c=d.p.localReader,
k="local"):(c=d.p.jsonReader,k="json");var n=a(d),p,m,q,t,M=d.p.multiselect?1:0,A=!0===d.p.subGrid?1:0,z,Q=!0===d.p.rownumbers?1:0,F=C(M+A+Q);k=y(k);var E,I,B,H,K={},N,J=[],R=!0===d.p.altRows?d.p.altclass:"",ia;d.p.page=r(a.jgrid.getAccessor(b,c.page),d.p.page);d.p.lastpage=r(a.jgrid.getAccessor(b,c.total),1);d.p.records=r(a.jgrid.getAccessor(b,c.records));d.p.userData=a.jgrid.getAccessor(b,c.userdata)||{};A&&(z=a.jgrid.getMethod("addSubGridCell"));B=!1===d.p.keyName?a.isFunction(c.id)?c.id.call(d,
b):c.id:d.p.keyName;isNaN(B)||(H=Number(B));for(m=0;m<d.p.colModel.length;m++)if(d.p.colModel[m].name===B){H=m;break}I=a.jgrid.getAccessor(b,c.root);null==I&&a.isArray(b)&&(I=b);I||(I=[]);b=I.length;0<b&&0>=d.p.page&&(d.p.page=1);var G=parseInt(d.p.rowNum,10),V=d.p.scroll?a.jgrid.randId():1,L=!1,P;h&&(G*=h+1);"local"!==d.p.datatype||d.p.deselectAfterSort||(L=!0);var O=a.isFunction(d.p.afterInsertRow),U=[],Z=!1,ca,ea;d.p.grouping&&(Z=!0===d.p.groupingView.groupCollapse,ca=a.jgrid.getMethod("groupingPrepare"));
for(m=0;m<b&&m<G;m++){t=I[m];h=c.repeatitems&&c.cell?a.jgrid.getAccessor(t,c.cell)||t:t;E=c.repeatitems&&a.isArray(h)?F:k;t=!1===d.p.keyName?a.jgrid.getAccessor(t,B):a.jgrid.getAccessor(h,E[H]);void 0===t&&(isNaN(B)||null==d.p.colModel[Number(B)+M+A+Q]||(t=a.jgrid.getAccessor(h,E[Number(B)])),void 0===t&&(t=V+m));t=d.p.idPrefix+t;q=1===e?0:e;ia=1===(q+m)%2?R:"";L&&(P=d.p.multiselect?-1!==a.inArray(t,d.p.selarrrow):t===d.p.selrow);ea=J.length;J.push("");Q&&J.push(u(0,m,d.p.page,d.p.rowNum));M&&J.push(x(t,
Q,m,P));A&&J.push(z.call(n,M+Q,m+e));for(q=0;q<E.length;q++)p=a.jgrid.getAccessor(h,E[q]),K[d.p.colModel[q+M+A+Q].name]=p,J.push(v(t,p,q+M+A+Q,m+e,h,K));J[ea]=D(t,Z,ia,K,h,P);J.push("</tr>");d.p.grouping&&(U.push(J),d.p.groupingView._locgr||ca.call(n,K,m),J=[]);if(l||!0===d.p.treeGrid)K._id_=a.jgrid.stripPref(d.p.idPrefix,t),d.p.data.push(K),d.p._index[K._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("#"+a.jgrid.jqID(d.p.id)+" tbody:first").append(J.join("")),n.triggerHandler("jqGridAfterInsertRow",
[t,K,h]),O&&d.p.afterInsertRow.call(d,t,K,h),J=[]);K={}}!0===d.p.gridview&&(N=-1<d.p.treeANode?d.p.treeANode:0,d.p.grouping?l||(n.jqGrid("groupingRender",U,d.p.colModel.length,d.p.page,G),U=null):!0===d.p.treeGrid&&0<N?a(d.rows[N]).after(J.join("")):(d.firstElementChild.innerHTML+=J.join(""),d.grid.cols=d.rows[0].cells));if(!0===d.p.subGrid)try{n.jqGrid("addSubGrid",M+Q)}catch(ba){}d.p.totaltime=new Date-g;0<m&&0===d.p.records&&(d.p.records=b);if(!0===d.p.treeGrid)try{n.jqGrid("setTreeNode",N+1,m+
N+1)}catch(da){}d.p.reccount=m;d.p.treeANode=-1;d.p.userDataOnFooter&&n.jqGrid("footerData","set",d.p.userData,!0);l&&(d.p.records=b,d.p.lastpage=Math.ceil(b/G));f||d.updatepager(!1,!0);if(l){for(e=m;e<b&&I[e];e++)if(t=I[e],h=c.repeatitems&&c.cell?a.jgrid.getAccessor(t,c.cell)||t:t,E=c.repeatitems&&a.isArray(h)?F:k,t=!1===d.p.keyName?a.jgrid.getAccessor(t,B):a.jgrid.getAccessor(h,E[H]),void 0===t&&(isNaN(B)||null==d.p.colModel[Number(B)+M+A+Q]||(t=a.jgrid.getAccessor(h,E[Number(B)])),void 0===t&&
(t=V+e)),h){for(q=0;q<E.length;q++)K[d.p.colModel[q+M+A+Q].name]=a.jgrid.getAccessor(h,E[q]);K._id_=a.jgrid.stripPref(d.p.idPrefix,t);d.p.grouping&&ca.call(n,K,e);d.p.data.push(K);d.p._index[K._id_]=d.p.data.length-1;K={}}d.p.grouping&&(d.p.groupingView._locgr=!0,n.jqGrid("groupingRender",U,d.p.colModel.length,d.p.page,G))}}},z=function(){function b(a){var d=0,c,e,f,g,k;if(null!=a.groups){(e=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&v.orBegin();for(c=0;c<a.groups.length;c++){0<
...
a.andNot().equals},"in":function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,b){return"OR"===b?a.orNot().isNull:a.andNot().isNull}},v=a.jgrid.from(d.p.data);d.p.ignoreCase&&(v=v.ignoreCase());if(!0===d.p.search){var u=d.p.postData.filters;if(u)"string"===typeof u&&(u=a.jgrid.parse(u)),b(u);else try{v=t[d.p.postData.searchOper](v)(d.p.postData.searchField,d.p.postData.searchString,h[d.p.postData.searchField])}catch(w){}}if(d.p.grouping)for(q=0;q<r;q++)v.orderBy(k[q],p.groupOrder[q],
g[q].stype,g[q].srcfmt);d.p.multiSort?a.each(c,function(a){v.orderBy(this,e[a],h[this].stype,h[this].srcfmt,h[this].sfunc)}):c&&d.p.sortorder&&f&&("DESC"===d.p.sortorder.toUpperCase()?v.orderBy(d.p.sortname,"d",h[c].stype,h[c].srcfmt,h[c].sfunc):v.orderBy(d.p.sortname,"a",h[c].stype,h[c].srcfmt,h[c].sfunc));var u=v.select(),y=parseInt(d.p.rowNum,10),x=u.length,D=parseInt(d.p.page,10),C=Math.ceil(x/y),M={};if((d.p.search||d.p.resetsearch)&&d.p.grouping&&d.p.groupingView._locgr){d.p.groupingView.groups=
[];var A,z=a.jgrid.getMethod("groupingPrepare"),Q,F;if(d.p.footerrow&&d.p.userDataOnFooter){for(Q in d.p.userData)d.p.userData.hasOwnProperty(Q)&&(d.p.userData[Q]=0);F=!0}for(A=0;A<x;A++){if(F)for(Q in d.p.userData)d.p.userData[Q]+=parseFloat(u[A][Q]||0);z.call(a(d),u[A],A,y)}}u=u.slice((D-1)*y,D*y);h=v=null;M[d.p.localReader.total]=C;M[d.p.localReader.page]=D;M[d.p.localReader.records]=x;M[d.p.localReader.root]=u;M[d.p.localReader.userdata]=d.p.userData;u=null;return M}}},P=function(){d.grid.hDiv.loading=
!0;d.p.hiddengrid||a(d).jqGrid("progressBar",{method:"show",loadtype:d.p.loadui,htmlcontent:d.p.loadtext})},B=function(){d.grid.hDiv.loading=!1;a(d).jqGrid("progressBar",{method:"hide",loadtype:d.p.loadui})},O=function(b){if(!d.grid.hDiv.loading){var c=d.p.scroll&&!1===b,e={},f,h=d.p.prmNames;0>=d.p.page&&(d.p.page=Math.min(1,d.p.lastpage));null!==h.search&&(e[h.search]=d.p.search);null!==h.nd&&(e[h.nd]=(new Date).getTime());null!==h.rows&&(e[h.rows]=d.p.rowNum);null!==h.page&&(e[h.page]=d.p.page);
null!==h.sort&&(e[h.sort]=d.p.sortname);null!==h.order&&(e[h.order]=d.p.sortorder);null!==d.p.rowTotal&&null!==h.totalrows&&(e[h.totalrows]=d.p.rowTotal);var g=a.isFunction(d.p.loadComplete),k=g?d.p.loadComplete:null,l=0;b=b||1;1<b?null!==h.npage?(e[h.npage]=b,l=b-1,b=1):k=function(a){d.p.page++;d.grid.hDiv.loading=!1;g&&d.p.loadComplete.call(d,a);O(b-1)}:null!==h.npage&&delete d.p.postData[h.npage];if(d.p.grouping){a(d).jqGrid("groupingSetup");var n=d.p.groupingView,m,p="";for(m=0;m<n.groupField.length;m++){var r=
...
Math.floor((d.p.width-f)/2):Math.floor(d.p.width/3);d.p._nvtd[1]=0;f=null;a(".ui-pg-selbox",g).bind("change",function(){if(!p("records"))return!1;d.p.page=Math.round(d.p.rowNum*(d.p.page-1)/this.value-.5)+1;d.p.rowNum=this.value;d.p.pager&&a(".ui-pg-selbox",d.p.pager).val(this.value);d.p.toppager&&a(".ui-pg-selbox",d.p.toppager).val(this.value);O();return!1});!0===d.p.pgbuttons&&(a(".ui-pg-button",g).hover(function(){a(this).hasClass("ui-state-disabled")?this.style.cursor="default":(a(this).addClass("ui-state-hover"),
...
this.id==="first"+c&&h&&(d.p.page=1,f=!0);this.id==="prev"+c&&g&&(d.p.page=b-1,f=!0);this.id==="next"+c&&k&&(d.p.page=b+1,f=!0);this.id==="last"+c&&l&&(d.p.page=e,f=!0);f&&O();return!1}));!0===d.p.pginput&&a("input.ui-pg-input",g).keypress(function(b){if(13===(b.charCode||b.keyCode||0)){if(!p("user"))return!1;a(this).val(r(a(this).val(),1));d.p.page=0<a(this).val()?a(this).val():d.p.page;O();return!1}return this})},Y=function(b,c){var e,f="",h=d.p.colModel,g=!1,k;k=d.p.frozenColumns?c:d.grid.headers[b].el;
...
d.p.datatype?d.p.deselectAfterSort&&a(d).jqGrid("resetSelection"):(d.p.selrow=null,d.p.multiselect&&S(!1),d.p.selarrrow=[],d.p.savedRow=[]),d.p.scroll&&(h=d.grid.bDiv.scrollLeft,w.call(d,!0,!1),d.grid.hDiv.scrollLeft=h),d.p.subGrid&&"local"===d.p.datatype&&a("td.sgexpanded","#"+a.jgrid.jqID(d.p.id)).each(function(){a(this).trigger("click")}),O(),d.p.lastsort=c,d.p.sortname!==b&&c&&(d.p.lastsort=c))}},ba=function(b){b=a(d.grid.headers[b].el);b=[b.position().left+b.outerWidth()];"rtl"===d.p.direction&&
(b[0]=d.p.width-b[0]);b[0]-=d.grid.bDiv.scrollLeft;b.push(a(d.grid.hDiv).position().top);b.push(a(d.grid.bDiv).offset().top-a(d.grid.hDiv).offset().top+a(d.grid.bDiv).height());return b},U=function(b){var c,e=d.grid.headers,f=a.jgrid.getCellIndex(b);for(c=0;c<e.length;c++)if(b===e[c].el){f=c;break}return f},G;this.p.id=this.id;-1===a.inArray(d.p.multikey,["shiftKey","altKey","ctrlKey"])&&(d.p.multikey=!1);d.p.keyName=!1;for(k=0;k<d.p.colModel.length;k++)G="string"===typeof d.p.colModel[k].template?
null!=a.jgrid.cmTemplate&&"object"===typeof a.jgrid.cmTemplate[d.p.colModel[k].template]?a.jgrid.cmTemplate[d.p.colModel[k].template]:{}:d.p.colModel[k].template,d.p.colModel[k]=a.extend(!0,{},d.p.cmTemplate,G||{},d.p.colModel[k]),!1===d.p.keyName&&!0===d.p.colModel[k].key&&(d.p.keyName=d.p.colModel[k].name);d.p.sortorder=d.p.sortorder.toLowerCase();a.jgrid.cell_width=a.jgrid.cellWidth();!0===d.p.grouping&&(d.p.scroll=!1,d.p.rownumbers=!1,d.p.treeGrid=!1,d.p.gridview=!0);if(!0===this.p.treeGrid){try{a(this).jqGrid("setTreeGrid")}catch(M){}"local"!==
d.p.datatype&&(d.p.localReader={id:"_id_"})}if(this.p.subGrid)try{a(d).jqGrid("setSubGrid")}catch(Q){}this.p.multiselect&&(this.p.colNames.unshift("<input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox'/>"),this.p.colModel.unshift({name:"cb",width:a.jgrid.cell_width?d.p.multiselectWidth+d.p.cellLayout:d.p.multiselectWidth,sortable:!1,resizable:!1,hidedlg:!0,search:!1,align:"center",fixed:!0}));this.p.rownumbers&&(this.p.colNames.unshift(""),this.p.colModel.unshift({name:"rn",width:d.p.rownumWidth,
...
d.p.jsonReader);d.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},d.p.localReader);d.p.scroll&&(d.p.pgbuttons=!1,d.p.pginput=!1,d.p.rowList=[]);d.p.data.length&&(E(),A());G="<thead><tr class='ui-jqgrid-labels' role='row'>";var K,N,Z,V,R,L,I,ga,ca=ga="",ja=[],ea=[];N=[];if(!0===d.p.shrinkToFit&&!0===d.p.forceFit)for(k=d.p.colModel.length-1;0<=k;k--)if(!0!==d.p.colModel[k].hidden){d.p.colModel[k].resizable=
!1;break}"horizontal"===d.p.viewsortcols[1]&&(ga=" ui-i-asc",ca=" ui-i-desc");K=c?"class='ui-th-div-ie'":"";ga="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+ga+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+l+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ca+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+l+"'></span></span>");if(d.p.multiSort)for(ja=d.p.sortname.split(","),k=0;k<ja.length;k++)N=a.trim(ja[k]).split(" "),
ja[k]=a.trim(N[0]),ea[k]=N[1]?a.trim(N[1]):d.p.sortorder||"asc";for(k=0;k<this.p.colNames.length;k++)N=d.p.headertitles?' title="'+a.jgrid.stripHtml(d.p.colNames[k])+'"':"",G+="<th id='"+d.p.id+"_"+d.p.colModel[k].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+l+"'"+N+">",N=d.p.colModel[k].index||d.p.colModel[k].name,G+="<div id='jqgh_"+d.p.id+"_"+d.p.colModel[k].name+"' "+K+">"+d.p.colNames[k],d.p.colModel[k].width=d.p.colModel[k].width?parseInt(d.p.colModel[k].width,10):
150,"boolean"!==typeof d.p.colModel[k].title&&(d.p.colModel[k].title=!0),d.p.colModel[k].lso="",N===d.p.sortname&&(d.p.lastsort=k),d.p.multiSort&&(N=a.inArray(N,ja),-1!==N&&(d.p.colModel[k].lso=ea[N])),G+=ga+"</div></th>";G+="</tr></thead>";ga=null;a(this).append(G);a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});if(this.p.multiselect){var ka=[],da;a("#cb_"+a.jgrid.jqID(d.p.id),this).bind("click",function(){d.p.selarrrow=
...
d.grid.fbDiv)[d.p.useProp?"prop":"attr"]("checked",!0),a("#"+a.jgrid.jqID(this.id),d.grid.fbDiv).addClass("ui-state-highlight")))}),da=!0,ka=[]):(a(d.rows).each(function(c){0<c&&!(a(this).hasClass("ui-subgrid")||a(this).hasClass("jqgroup")||a(this).hasClass("ui-state-disabled")||a(this).hasClass("jqfoot"))&&(a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id))[d.p.useProp?"prop":"attr"]("checked",!1),a(this).removeClass("ui-state-highlight").attr("aria-selected","false"),ka.push(this.id),b&&
(a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id),d.grid.fbDiv)[d.p.useProp?"prop":"attr"]("checked",!1),a("#"+a.jgrid.jqID(this.id),d.grid.fbDiv).removeClass("ui-state-highlight")))}),d.p.selrow=null,da=!1);a(d).triggerHandler("jqGridSelectAll",[da?d.p.selarrrow:ka,da]);a.isFunction(d.p.onSelectAll)&&d.p.onSelectAll.call(d,da?d.p.selarrrow:ka,da)})}!0===d.p.autowidth&&(G=a(m).innerWidth(),d.p.width=0<G?G:"nw");(function(){var b=0,c=a.jgrid.cell_width?0:r(d.p.cellLayout,0),e=0,f,g=r(d.p.scrollOffset,
...
a(m).css("width",h.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+d.p.id+"'>&#160;</div>");a(p).css("width",h.width+"px");G=a("thead:first",d).get(0);var fa="";d.p.footerrow&&(fa+="<table role='presentation' style='width:"+d.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+l+"'>");var p=a("tr:first",G),ha="<tr class='jqgfirstrow' role='row' style='height:auto'>";d.p.disableClick=!1;
a("th",p).each(function(b){Z=d.p.colModel[b].width;void 0===d.p.colModel[b].resizable&&(d.p.colModel[b].resizable=!0);d.p.colModel[b].resizable?(V=document.createElement("span"),a(V).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+l).css("cursor","col-resize"),a(this).addClass(d.p.resizeclass)):V="";a(this).css("width",Z+"px").prepend(V);V=null;var c="";!0===d.p.colModel[b].hidden&&(a(this).css("display","none"),c="display:none;");ha+="<td role='gridcell' style='height:0px;width:"+Z+
"px;"+c+"'></td>";h.headers[b]={width:Z,el:this};R=d.p.colModel[b].sortable;"boolean"!==typeof R&&(R=d.p.colModel[b].sortable=!0);c=d.p.colModel[b].name;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&d.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");R&&(d.p.multiSort?d.p.viewsortcols[0]?(a("div span.s-ico",this).show(),d.p.colModel[b].lso&&a("div span.ui-icon-"+d.p.colModel[b].lso,this).removeClass("ui-state-disabled")):d.p.colModel[b].lso&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+
d.p.colModel[b].lso,this).removeClass("ui-state-disabled")):d.p.viewsortcols[0]?(a("div span.s-ico",this).show(),b===d.p.lastsort&&a("div span.ui-icon-"+d.p.sortorder,this).removeClass("ui-state-disabled")):b===d.p.lastsort&&""!==d.p.sortname&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+d.p.sortorder,this).removeClass("ui-state-disabled")));d.p.footerrow&&(fa+="<td role='gridcell' "+q(b,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(b){if(1===a(b.target).closest("th>span.ui-jqgrid-resize").length){var c=
U(this);if(!0===d.p.forceFit){var e=d.p,f=c,g;for(g=c+1;g<d.p.colModel.length;g++)if(!0!==d.p.colModel[g].hidden){f=g;break}e.nv=f-c}h.dragStart(c,b,ba(c));return!1}}).click(function(b){if(d.p.disableClick)return d.p.disableClick=!1;var c="th>div.ui-jqgrid-sortable",e,f;d.p.viewsortcols[2]||(c="th>div>span>span.ui-grid-ico-sort");b=a(b.target).closest(c);if(1===b.length){var h;if(d.p.frozenColumns){var g=a(this)[0].id.substring(d.p.id.length+1);a(d.p.colModel).each(function(a){if(this.name===g)return h=
a,!1})}else h=U(this);d.p.viewsortcols[2]||(e=!0,f=b.attr("sort"));null!=h&&J(a("div",this)[0].id,h,e,f,this);return!1}});if(d.p.sortable&&a.fn.sortable)try{a(d).jqGrid("sortableColumns",p)}catch(oa){}d.p.footerrow&&(fa+="</tr></tbody></table>");ha+="</tr>";p=document.createElement("tbody");this.appendChild(p);a(this).addClass("ui-jqgrid-btable").append(ha);var ha=null,p=a("<table class='ui-jqgrid-htable' style='width:"+d.p.tblwidth+"px' role='presentation' aria-labelledby='gbox_"+this.id+"' cellspacing='0' cellpadding='0' border='0'></table>").append(G),
X=d.p.caption&&!0===d.p.hiddengrid?!0:!1;k=a("<div class='ui-jqgrid-hbox"+("rtl"===l?"-rtl":"")+"'></div>");G=null;h.hDiv=document.createElement("div");a(h.hDiv).css({width:h.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(k);a(k).append(p);p=null;X&&a(h.hDiv).hide();d.p.pager&&("string"===typeof d.p.pager&&"#"!==d.p.pager.substr(0,1)?(p=d.p.pager,G=a("#"+a.jgrid.jqID(d.p.pager))):(G=a(d.p.pager),p=G.attr("id")),0<G.length?(G.css({width:h.width+"px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(m),
X&&G.hide(),W(p,""),d.p.pager="#"+a.jgrid.jqID(p)):d.p.pager="");!1===d.p.cellEdit&&!0===d.p.hoverrows&&a(d).bind("mouseover",function(b){I=a(b.target).closest("tr.jqgrow");"ui-subgrid"!==a(I).attr("class")&&a(I).addClass("ui-state-hover")}).bind("mouseout",function(b){I=a(b.target).closest("tr.jqgrow");a(I).removeClass("ui-state-hover")});var T,aa,la;a(d).before(h.hDiv).click(function(b){L=b.target;I=a(L,d.rows).closest("tr.jqgrow");if(0===a(I).length||-1<I[0].className.indexOf("ui-state-disabled")||
(a(L,d).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==d.id)return this;var c=a(L).hasClass("cbox"),e=a(d).triggerHandler("jqGridBeforeSelectRow",[I[0].id,b]),e=!1===e||"stop"===e?!1:!0;if(a.isFunction(d.p.beforeSelectRow)){var f=d.p.beforeSelectRow.call(d,I[0].id,b);if(!1===f||"stop"===f)e=!1}if("A"!==L.tagName&&("INPUT"!==L.tagName&&"TEXTAREA"!==L.tagName&&"OPTION"!==L.tagName&&"SELECT"!==L.tagName||c))if(T=I[0].id,L=a(L).closest("tr.jqgrow>td"),0<L.length&&(aa=a.jgrid.getCellIndex(L),
la=a(L).closest("td,th").html(),a(d).triggerHandler("jqGridCellSelect",[T,aa,la,b]),a.isFunction(d.p.onCellSelect)&&d.p.onCellSelect.call(d,T,aa,la,b)),!0===d.p.cellEdit)if(d.p.multiselect&&c&&e)a(d).jqGrid("setSelection",T,!0,b);else{if(0<L.length){T=I[0].rowIndex;try{a(d).jqGrid("editCell",T,aa,!0)}catch(h){}}}else if(e)if(d.p.multikey)b[d.p.multikey]?a(d).jqGrid("setSelection",T,!0,b):d.p.multiselect&&c&&(c=a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+T).is(":checked"),a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+
T)[d.p.useProp?"prop":"attr"]("checked",c));else{if(d.p.multiselect&&d.p.multiboxonly&&!c){var g=d.p.frozenColumns?d.p.id+"_frozen":"";a(d.p.selarrrow).each(function(b,c){var e=a(d).jqGrid("getGridRowById",c);e&&a(e).removeClass("ui-state-highlight");a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(c))[d.p.useProp?"prop":"attr"]("checked",!1);g&&(a("#"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(g)).removeClass("ui-state-highlight"),a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(g))[d.p.useProp?
"prop":"attr"]("checked",!1))});d.p.selarrrow=[]}a(d).jqGrid("setSelection",T,!0,b)}}).bind("reloadGrid",function(b,c){!0===d.p.treeGrid&&(d.p.datatype=d.p.treedatatype);c&&c.current&&d.grid.selectionPreserver(d);"local"===d.p.datatype?(a(d).jqGrid("resetSelection"),d.p.data.length&&(E(),A())):d.p.treeGrid||(d.p.selrow=null,d.p.multiselect&&(d.p.selarrrow=[],S(!1)),d.p.savedRow=[]);d.p.scroll&&w.call(d,!0,!1);if(c&&c.page){var e=c.page;e>d.p.lastpage&&(e=d.p.lastpage);1>e&&(e=1);d.p.page=e;d.grid.bDiv.scrollTop=
d.grid.prevRowHeight?(e-1)*d.grid.prevRowHeight*d.p.rowNum:0}d.grid.prevRowHeight&&d.p.scroll?(delete d.p.lastpage,d.grid.populateVisible()):d.grid.populate();!0===d.p._inlinenav&&a(d).jqGrid("showAddEditButtons");return!1}).dblclick(function(b){L=b.target;I=a(L,d.rows).closest("tr.jqgrow");if(0!==a(I).length){T=I[0].rowIndex;aa=a.jgrid.getCellIndex(L);var c=a(d).triggerHandler("jqGridDblClickRow",[a(I).attr("id"),T,aa,b]);if(null!=c||a.isFunction(d.p.ondblClickRow)&&(c=d.p.ondblClickRow.call(d,a(I).attr("id"),
T,aa,b),null!=c))return c}}).bind("contextmenu",function(b){L=b.target;I=a(L,d.rows).closest("tr.jqgrow");if(0!==a(I).length){d.p.multiselect||a(d).jqGrid("setSelection",I[0].id,!0,b);T=I[0].rowIndex;aa=a.jgrid.getCellIndex(L);var c=a(d).triggerHandler("jqGridRightClickRow",[a(I).attr("id"),T,aa,b]);if(null!=c||a.isFunction(d.p.onRightClickRow)&&(c=d.p.onRightClickRow.call(d,a(I).attr("id"),T,aa,b),null!=c))return c}});h.bDiv=document.createElement("div");c&&"auto"===String(d.p.height).toLowerCase()&&
...
k===h.p.ExpandColumn)e[k]=a.jgrid.htmlDecode(a("span:first",this).html());else try{e[k]=a.unformat.call(h,this,{rowId:l.id,colModel:h.p.colModel[b]},b)}catch(c){e[k]=a.jgrid.htmlDecode(a(this).html())}}),f&&(c.push(e),e={})),d++});return c||e},delRowData:function(b){var e=!1,c,f,g;this.each(function(){c=a(this).jqGrid("getGridRowById",b);if(!c)return!1;this.p.subGrid&&(g=a(c).next(),g.hasClass("ui-subgrid")&&g.remove());a(c).remove();this.p.records--;this.p.reccount--;this.updatepager(!0,!1);e=!0;
this.p.multiselect&&(f=a.inArray(b,this.p.selarrrow),-1!==f&&this.p.selarrrow.splice(f,1));this.p.selrow=this.p.multiselect&&0<this.p.selarrrow.length?this.p.selarrrow[this.p.selarrrow.length-1]:null;if("local"===this.p.datatype){var d=a.jgrid.stripPref(this.p.idPrefix,b),d=this.p._index[d];void 0!==d&&(this.p.data.splice(d,1),this.refreshIndex())}if(!0===this.p.altRows&&e){var h=this.p.altclass;a(this.rows).each(function(b){1===b%2?a(this).addClass(h):a(this).removeClass(h)})}});return e},setRowData:function(b,
e,c){var f,g=!0,d;this.each(function(){if(!this.grid)return!1;var h=this,k,l,p=typeof c,m={};l=a(this).jqGrid("getGridRowById",b);if(!l)return!1;if(e)try{if(a(this.p.colModel).each(function(c){f=this.name;var g=a.jgrid.getAccessor(e,f);void 0!==g&&(m[f]=this.formatter&&"string"===typeof this.formatter&&"date"===this.formatter?a.unformat.date.call(h,g,this):g,k=h.formatter(b,m[f],c,e,"edit"),d=this.title?{title:a.jgrid.stripHtml(k)}:{},!0===h.p.treeGrid&&f===h.p.ExpandColumn?a("td[role='gridcell']:eq("+
c+") > span:first",l).html(k).attr(d):a("td[role='gridcell']:eq("+c+")",l).html(k).attr(d))}),"local"===h.p.datatype){var r=a.jgrid.stripPref(h.p.idPrefix,b),q=h.p._index[r],n;if(h.p.treeGrid)for(n in h.p.treeReader)h.p.treeReader.hasOwnProperty(n)&&delete m[h.p.treeReader[n]];void 0!==q&&(h.p.data[q]=a.extend(!0,h.p.data[q],m));m=null}}catch(t){g=!1}g&&("string"===p?a(l).addClass(c):null!==c&&"object"===p&&a(l).css(c),a(h).triggerHandler("jqGridAfterGridComplete"))});return g},addRowData:function(b,
e,c,f){-1===["first","last","before","after"].indexOf(c)&&(c="last");var g=!1,d,h,k,l,p,m,r,q,n="",t,v,x,u,y,C;e&&(a.isArray(e)?(t=!0,v=b):(e=[e],t=!1),this.each(function(){var w=e.length;p=!0===this.p.rownumbers?1:0;k=!0===this.p.multiselect?1:0;l=!0===this.p.subGrid?1:0;t||(void 0!==b?b=String(b):(b=a.jgrid.randId(),!1!==this.p.keyName&&(v=this.p.keyName,void 0!==e[0][v]&&(b=e[0][v]))));x=this.p.altclass;for(var E=0,A="",D={},F=a.isFunction(this.p.afterInsertRow)?!0:!1;E<w;){u=e[E];h=[];if(t){try{b=
u[v],void 0===b&&(b=a.jgrid.randId())}catch(H){b=a.jgrid.randId()}A=!0===this.p.altRows?0===(this.rows.length-1)%2?x:"":""}C=b;b=this.p.idPrefix+b;p&&(n=this.formatCol(0,1,"",null,b,!0),h.push('<td role="gridcell" class="ui-state-default jqgrid-rownum" '+n+">0</td>"));k&&(q='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+b+'" class="cbox"/>',n=this.formatCol(p,1,"",null,b,!0),h.push('<td role="gridcell" '+n+">"+q+"</td>"));l&&h.push(a(this).jqGrid("addSubGridCell",k+p,1));for(r=k+
l+p;r<this.p.colModel.length;r++)y=this.p.colModel[r],d=y.name,D[d]=u[d],q=this.formatter(b,a.jgrid.getAccessor(u,d),r,u),n=this.formatCol(r,1,q,u,b,D),h.push('<td role="gridcell" '+n+">"+q+"</td>");h.unshift(this.constructTr(b,!1,A,D,u,!1));h.push("</tr>");h=h.join("");if(0===this.rows.length)a("table:first",this.grid.bDiv).append(h);else switch(c){case "last":a(this.rows[this.rows.length-1]).after(h);m=this.rows.length-1;break;case "first":a(this.rows[0]).after(h);m=1;break;case "after":if(m=a(this).jqGrid("getGridRowById",
f))a(this.rows[m.rowIndex+1]).hasClass("ui-subgrid")?(a(this.rows[m.rowIndex+1]).after(h),m=m.rowIndex+2):(a(m).after(h),m=m.rowIndex+1);break;case "before":if(m=a(this).jqGrid("getGridRowById",f))a(m).before(h),m=m.rowIndex-1}!0===this.p.subGrid&&a(this).jqGrid("addSubGrid",k+p,m);this.p.records++;this.p.reccount++;a(this).triggerHandler("jqGridAfterInsertRow",[b,u,u]);F&&this.p.afterInsertRow.call(this,b,u,u);E++;"local"===this.p.datatype&&(D[this.p.localReader.id]=C,this.p._index[C]=this.p.data.length,
this.p.data.push(D),D={})}!0!==this.p.altRows||t||("last"===c?1===(this.rows.length-1)%2&&a(this.rows[this.rows.length-1]).addClass(x):a(this.rows).each(function(b){1===b%2?a(this).addClass(x):a(this).removeClass(x)}));this.updatepager(!0,!0);g=!0}));return g},footerData:function(b,e,c){function f(a){for(var b in a)if(a.hasOwnProperty(b))return!1;return!0}var g,d=!1,h={},k;void 0==b&&(b="get");"boolean"!==typeof c&&(c=!0);b=b.toLowerCase();this.each(function(){var l=this,p;if(!l.grid||!l.p.footerrow||
"set"===b&&f(e))return!1;d=!0;a(this.p.colModel).each(function(f){g=this.name;"set"===b?void 0!==e[g]&&(p=c?l.formatter("",e[g],f,e,"edit"):e[g],k=this.title?{title:a.jgrid.stripHtml(p)}:{},a("tr.footrow td:eq("+f+")",l.grid.sDiv).html(p).attr(k),d=!0):"get"===b&&(h[g]=a("tr.footrow td:eq("+f+")",l.grid.sDiv).html())})});return"get"===b?h:d},showHideCol:function(b,e){return this.each(function(){var c=this,f=!1,g=a.jgrid.cell_width?0:c.p.cellLayout,d;if(c.grid){"string"===typeof b&&(b=[b]);e="none"!==
e?"":"none";var h=""===e?!0:!1,k=c.p.groupHeader&&("object"===typeof c.p.groupHeader||a.isFunction(c.p.groupHeader));k&&a(c).jqGrid("destroyGroupHeader",!1);a(this.p.colModel).each(function(k){if(-1!==a.inArray(this.name,b)&&this.hidden===h){if(!0===c.p.frozenColumns&&!0===this.frozen)return!0;a("tr[role=row]",c.grid.hDiv).each(function(){a(this.cells[k]).css("display",e)});a(c.rows).each(function(){a(this).hasClass("jqgroup")||a(this.cells[k]).css("display",e)});c.p.footerrow&&a("tr.footrow td:eq("+
k+")",c.grid.sDiv).css("display",e);d=parseInt(this.width,10);c.p.tblwidth="none"===e?c.p.tblwidth-(d+g):c.p.tblwidth+(d+g);this.hidden=!h;f=!0;a(c).triggerHandler("jqGridShowHideCol",[h,this.name,k])}});!0===f&&(!0!==c.p.shrinkToFit||isNaN(c.p.height)||(c.p.tblwidth+=parseInt(c.p.scrollOffset,10)),a(c).jqGrid("setGridWidth",!0===c.p.shrinkToFit?c.p.tblwidth:c.p.width));k&&a(c).jqGrid("setGroupHeaders",c.p.groupHeader)}})},hideCol:function(b){return this.each(function(){a(this).jqGrid("showHideCol",
...
k.name});l.attr&&a("select",n).attr(l.attr);a("select",n).css({width:"100%"});a.jgrid.bindEv.call(e,a("select",n)[0],l);!0===b.autosearch&&a("select",n).change(function(){c();return!1});d=null}},a.jgrid.ajaxOptions,e.p.ajaxSelectOptions||{}));else{var v,x,u;k.searchoptions?(v=void 0===k.searchoptions.value?"":k.searchoptions.value,x=void 0===k.searchoptions.separator?":":k.searchoptions.separator,u=void 0===k.searchoptions.delimiter?";":k.searchoptions.delimiter):k.editoptions&&(v=void 0===k.editoptions.value?
"":k.editoptions.value,x=void 0===k.editoptions.separator?":":k.editoptions.separator,u=void 0===k.editoptions.delimiter?";":k.editoptions.delimiter);if(v){var y=document.createElement("select");y.style.width="100%";a(y).attr({name:k.index||k.name,id:"gs_"+k.name});var C;if("string"===typeof v)for(p=v.split(u),C=0;C<p.length;C++)v=p[C].split(x),u=document.createElement("option"),u.value=v[0],u.innerHTML=v[1],y.appendChild(u);else if("object"===typeof v)for(C in v)v.hasOwnProperty(C)&&(u=document.createElement("option"),
u.value=C,u.innerHTML=v[C],y.appendChild(u));void 0!==l.defaultValue&&a(y).val(l.defaultValue);l.attr&&a(y).attr(l.attr);a(n).append(t);a.jgrid.bindEv.call(e,y,l);a("td:eq(1)",t).append(y);!0===b.autosearch&&a(y).change(function(){c();return!1})}}break;case "text":x=void 0!==l.defaultValue?l.defaultValue:"";a("td:eq(1)",t).append("<input type='text' style='width:100%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+k.name+"' value='"+x+"'/>");a(n).append(t);l.attr&&a("input",n).attr(l.attr);a.jgrid.bindEv.call(e,
...
function(){void 0===b.groups&&(b.groups=[]);b.groups.push({groupOp:f.groupOps[0].op,rules:[],groups:[]});d.reDraw();d.onchange();return!1}));h.append(k);if(!0===this.p.ruleButtons){var k=a("<input type='button' value='+' title='Add rule' class='add-rule ui-add'/>"),y;k.bind("click",function(){void 0===b.rules&&(b.rules=[]);for(e=0;e<d.p.columns.length;e++){var c=void 0===d.p.columns[e].search?!0:d.p.columns[e].search,f=!0===d.p.columns[e].hidden;if(!0===d.p.columns[e].searchoptions.searchhidden&&
c||c&&!f){y=d.p.columns[e];break}}c=y.searchoptions.sopt?y.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(y.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;b.rules.push({field:y.name,op:c[0],data:""});d.reDraw();return!1});h.append(k)}null!==c&&(k=a("<input type='button' value='-' title='Delete group' class='delete-group'/>"),h.append(k),k.bind("click",function(){for(e=0;e<c.groups.length;e++)if(c.groups[e]===b){c.groups.splice(e,1);break}d.reDraw();d.onchange();return!1}));if(void 0!==b.groups)for(e=
0;e<b.groups.length;e++)h=a("<tr></tr>"),g.append(h),k=a("<td class='first'></td>"),h.append(k),k=a("<td colspan='4'></td>"),k.append(this.createTableForGroup(b.groups[e],b)),h.append(k);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)g.append(this.createTableRowForRule(b.rules[e],b));return g};this.createTableRowForRule=function(b,c){var d=this,e=a("#"+a.jgrid.jqID(f.id))[0]||null,h=a("<tr></tr>"),g,l,x,u,y="",C;h.append("<td class='first'></td>");
var w=a("<td class='columns'></td>");h.append(w);var E=a("<select></select>"),A,D=[];w.append(E);E.bind("change",function(){b.field=a(E).val();x=a(this).parents("tr:first");for(g=0;g<d.p.columns.length;g++)if(d.p.columns[g].name===b.field){u=d.p.columns[g];break}if(u){u.searchoptions.id=a.jgrid.randId();k&&"text"===u.inputtype&&!u.searchoptions.size&&(u.searchoptions.size=10);var c=a.jgrid.createEl.call(e,u.inputtype,u.searchoptions,"",!0,d.p.ajaxSelectOptions||{},!0);a(c).addClass("input-elm");l=
u.searchoptions.sopt?u.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(u.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;var f="",h=0;D=[];a.each(d.p.ops,function(){D.push(this.oper)});for(g=0;g<l.length;g++)A=a.inArray(l[g],D),-1!==A&&(0===h&&(b.op=d.p.ops[A].oper),f+="<option value='"+d.p.ops[A].oper+"'>"+d.p.ops[A].text+"</option>",h++);a(".selectopts",x).empty().append(f);a(".selectopts",x)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(f=parseInt(a("select.selectopts",x)[0].offsetWidth,
10)+1,a(".selectopts",x).width(f),a(".selectopts",x).css("width","auto"));a(".data",x).empty().append(c);a.jgrid.bindEv.call(e,c,u.searchoptions);a(".input-elm",x).bind("change",function(c){c=c.target;b.data="SPAN"===c.nodeName.toUpperCase()&&u.searchoptions&&a.isFunction(u.searchoptions.custom_value)?u.searchoptions.custom_value.call(e,a(c).children(".customelement:first"),"get"):c.value;d.onchange()});setTimeout(function(){b.data=a(c).val();d.onchange()},0)}});for(g=w=0;g<d.p.columns.length;g++){C=
void 0===d.p.columns[g].search?!0:d.p.columns[g].search;var F=!0===d.p.columns[g].hidden;if(!0===d.p.columns[g].searchoptions.searchhidden&&C||C&&!F)C="",b.field===d.p.columns[g].name&&(C=" selected='selected'",w=g),y+="<option value='"+d.p.columns[g].name+"'"+C+">"+d.p.columns[g].label+"</option>"}E.append(y);y=a("<td class='operators'></td>");h.append(y);u=f.columns[w];u.searchoptions.id=a.jgrid.randId();k&&"text"===u.inputtype&&!u.searchoptions.size&&(u.searchoptions.size=10);w=a.jgrid.createEl.call(e,
u.inputtype,u.searchoptions,b.data,!0,d.p.ajaxSelectOptions||{},!0);if("nu"===b.op||"nn"===b.op)a(w).attr("readonly","true"),a(w).attr("disabled","true");var H=a("<select class='selectopts'></select>");y.append(H);H.bind("change",function(){b.op=a(H).val();x=a(this).parents("tr:first");var c=a(".input-elm",x)[0];"nu"===b.op||"nn"===b.op?(b.data="","SELECT"!==c.tagName.toUpperCase()&&(c.value=""),c.setAttribute("readonly","true"),c.setAttribute("disabled","true")):("SELECT"===c.tagName.toUpperCase()&&
(b.data=c.value),c.removeAttribute("readonly"),c.removeAttribute("disabled"));d.onchange()});l=u.searchoptions.sopt?u.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(u.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;y="";a.each(d.p.ops,function(){D.push(this.oper)});for(g=0;g<l.length;g++)A=a.inArray(l[g],D),-1!==A&&(C=b.op===d.p.ops[A].oper?" selected='selected'":"",y+="<option value='"+d.p.ops[A].oper+"'"+C+">"+d.p.ops[A].text+"</option>");H.append(y);y=a("<td class='data'></td>");h.append(y);
y.append(w);a.jgrid.bindEv.call(e,w,u.searchoptions);a(w).addClass("input-elm").bind("change",function(){b.data="custom"===u.inputtype?u.searchoptions.custom_value.call(e,a(this).children(".customelement:first"),"get"):a(this).val();d.onchange()});y=a("<td></td>");h.append(y);!0===this.p.ruleButtons&&(w=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),y.append(w),w.bind("click",function(){for(g=0;g<c.rules.length;g++)if(c.rules[g]===b){c.rules.splice(g,1);break}d.reDraw();
...
b.Find+"</a>",v="<a id='"+g+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+b.Reset+"</a>",x="",u="",y,C=!1,w=-1;b.showQuery&&(x="<a id='"+g+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");b.columns.length?(n=b.columns,w=0,y=n[0].index||n[0].name):a.each(n,function(a,b){b.label||(b.label=f.p.colNames[a]);if(!C){var c=
void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&!0===b.searchoptions.searchhidden&&c||c&&!d)C=!0,y=b.index||b.name,w=a}});if(!l&&y||!1===b.multipleSearch){var E="eq";0<=w&&n[w].searchoptions&&n[w].searchoptions.sopt?E=n[w].searchoptions.sopt[0]:b.sopt&&b.sopt.length&&(E=b.sopt[0]);l={groupOp:"AND",rules:[{field:y,op:E,data:""}]}}C=!1;b.tmplNames&&b.tmplNames.length&&(C=!0,u=b.tmplLabel,u+="<select class='ui-template'>",u+="<option value='default'>Default</option>",a.each(b.tmplNames,
function(a,b){u+="<option value='"+a+"'>"+b+"</option>"}),u+="</select>");r="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+g+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+r+"'>"+v+u+"</td><td class='EditButton' "+q+">"+x+t+"</td></tr></tbody></table>";g=a.jgrid.jqID(g);a("#"+g).jqFilter({columns:n,filter:b.loadDefaults?l:null,showQuery:b.showQuery,errorcheck:b.errorcheck,sopt:b.sopt,
groupButton:b.multipleGroup,ruleButtons:b.multipleSearch,afterRedraw:b.afterRedraw,ops:b.odata,operands:b.operands,ajaxSelectOptions:f.p.ajaxSelectOptions,groupOps:b.groupOps,onChange:function(){this.p.showQuery&&a(".query",this).html(this.toUserFriendlyString());a.isFunction(b.afterChange)&&b.afterChange.call(f,a("#"+g),b)},direction:f.p.direction,id:f.p.id});m.append(r);C&&b.tmplFilters&&b.tmplFilters.length&&a(".ui-template",m).bind("change",function(){var c=a(this).val();"default"===c?a("#"+g).jqFilter("addFilter",
...
""}var D=a.extend({},this.editoptions||{},{id:g,name:g,rowId:c}),x=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),C=parseInt(x.rowpos,10)||l+1,A=parseInt(2*(parseInt(x.colpos,10)||1),10);"_empty"===c&&D.defaultValue&&(m=a.isFunction(D.defaultValue)?D.defaultValue.call(n):D.defaultValue);this.edittype||(this.edittype="text");n.p.autoencode&&(m=a.jgrid.htmlDecode(m));q=a.jgrid.createEl.call(n,this.edittype,D,m,!1,a.extend({},a.jgrid.ajaxOptions,d.p.ajaxSelectOptions||
{}));if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)b[n.p.id]._savedData[g]=m;a(q).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(q).addClass("ui-widget-content ui-corner-all");k=a(e).find("tr[rowpos="+C+"]");if(x.rowabove){var z=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+x.rowcontent+"</td></tr>");a(e).append(z);z[0].rp=C}0===k.length&&(k=a("<tr "+p+" rowpos='"+C+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(k).append(u),a(e).append(k),
k[0].rp=C);a("td:eq("+(A-2)+")",k[0]).html(void 0===x.label?d.p.colNames[w]:x.label);a("td:eq("+(A-1)+")",k[0]).append(x.elmprefix).append(q).append(x.elmsuffix);"custom"===this.edittype&&a.isFunction(D.custom_value)&&D.custom_value.call(n,a("#"+g,"#"+v),"set",m);a.jgrid.bindEv.call(n,q,D);r[l]=w;l++}});0<l&&(w=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+d.p.id+"_id' value='"+
...
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,p.message,a.jgrid.edit.bClose)}}g++}}),0<g&&a("#id_g",u).val(c))}}function h(){a.each(n.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&z.hasOwnProperty(b.name)&&""===z[b.name]&&(z[b.name]="null")})}function k(){var e,f=[!0,"",""],g={},k=n.p.prmNames,l,m,p,q,r,w=a(n).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+v),B]);w&&"object"===typeof w&&(z=w);a.isFunction(b[n.p.id].beforeCheckValues)&&(w=b[n.p.id].beforeCheckValues.call(n,
z,a("#"+v),B))&&"object"===typeof w&&(z=w);for(p in z)if(z.hasOwnProperty(p)&&(f=a.jgrid.checkValues.call(n,z[p],p),!1===f[0]))break;h();f[0]&&(g=a(n).triggerHandler("jqGridAddEditClickSubmit",[b[n.p.id],z,B]),void 0===g&&a.isFunction(b[n.p.id].onclickSubmit)&&(g=b[n.p.id].onclickSubmit.call(n,b[n.p.id],z,B)||{}),f=a(n).triggerHandler("jqGridAddEditBeforeSubmit",[z,a("#"+v),B]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].beforeSubmit)&&(f=b[n.p.id].beforeSubmit.call(n,z,a("#"+v),B)));
if(f[0]&&!b[n.p.id].processing){b[n.p.id].processing=!0;a("#sData",u+"_2").addClass("ui-state-active");p=b[n.p.id].url||a(n).jqGrid("getGridParam","editurl");m=k.oper;l="clientArray"===p?n.p.keyName:k.id;z[m]="_empty"===a.trim(z[n.p.id+"_id"])?k.addoper:k.editoper;z[m]!==k.addoper?z[l]=z[n.p.id+"_id"]:void 0===z[l]&&(z[l]=z[n.p.id+"_id"]);delete z[n.p.id+"_id"];z=a.extend(z,b[n.p.id].editData,g);if(!0===n.p.treeGrid)for(r in z[m]===k.addoper&&(q=a(n).jqGrid("getGridParam","selrow"),z["adjacency"===
n.p.treeGridModel?n.p.treeReader.parent_id_field:"parent_id"]=q),n.p.treeReader)n.p.treeReader.hasOwnProperty(r)&&(g=n.p.treeReader[r],!z.hasOwnProperty(g)||z[m]===k.addoper&&"parent_id_field"===r||delete z[g]);z[l]=a.jgrid.stripPref(n.p.idPrefix,z[l]);r=a.extend({url:p,type:b[n.p.id].mtype,data:a.isFunction(b[n.p.id].serializeEditData)?b[n.p.id].serializeEditData.call(n,z):z,complete:function(g,h){var p;a("#sData",u+"_2").removeClass("ui-state-active");z[l]=n.p.idPrefix+z[l];300<=g.status&&304!==
g.status?(f[0]=!1,f[1]=a(n).triggerHandler("jqGridAddEditErrorTextFormat",[g,B]),a.isFunction(b[n.p.id].errorTextFormat)?f[1]=b[n.p.id].errorTextFormat.call(n,g,B):f[1]=h+" Status: '"+g.statusText+"'. Error code: "+g.status):(f=a(n).triggerHandler("jqGridAddEditAfterSubmit",[g,z,B]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].afterSubmit)&&(f=b[n.p.id].afterSubmit.call(n,g,z,B)));if(!1===f[0])a("#FormError>td",u).html(f[1]),a("#FormError",u).show();else if(n.p.autoencode&&a.each(z,function(b,
c){z[b]=a.jgrid.htmlDecode(c)}),z[m]===k.addoper?(f[2]||(f[2]=a.jgrid.randId()),null==z[l]||"_empty"===z[l]?z[l]=f[2]:f[2]=z[l],b[n.p.id].reloadAfterSubmit?a(n).trigger("reloadGrid"):!0===n.p.treeGrid?a(n).jqGrid("addChildNode",f[2],q,z):a(n).jqGrid("addRowData",f[2],z,c.addedrow),b[n.p.id].closeAfterAdd?(!0!==n.p.treeGrid&&a(n).jqGrid("setSelection",f[2]),a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,
formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form})):b[n.p.id].clearAfterAdd&&d("_empty",n,v)):(b[n.p.id].reloadAfterSubmit?(a(n).trigger("reloadGrid"),b[n.p.id].closeAfterEdit||setTimeout(function(){a(n).jqGrid("setSelection",z[l])},1E3)):!0===n.p.treeGrid?a(n).jqGrid("setTreeRow",z[l],z):a(n).jqGrid("setRowData",z[l],z),b[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,
formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form})),a.isFunction(b[n.p.id].afterComplete)&&(e=g,setTimeout(function(){a(n).triggerHandler("jqGridAddEditAfterComplete",[e,z,a("#"+v),B]);b[n.p.id].afterComplete.call(n,e,z,a("#"+v),B);e=null},500)),b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)if(a("#"+v).data("disabled",!1),"_empty"!==b[n.p.id]._savedData[n.p.id+"_id"])for(p in b[n.p.id]._savedData)b[n.p.id]._savedData.hasOwnProperty(p)&&z[p]&&(b[n.p.id]._savedData[p]=z[p]);b[n.p.id].processing=
...
"")):a.ajax(r))}!1===f[0]&&(a("#FormError>td",u).html(f[1]),a("#FormError",u).show())}function l(a,b){var c=!1,d;for(d in a)if(a.hasOwnProperty(d)&&a[d]!=b[d]){c=!0;break}return c}function p(){var c=!0;a("#FormError",u).hide();b[n.p.id].checkOnUpdate&&(z={},f(),P=l(z,b[n.p.id]._savedData))&&(a("#"+v).data("disabled",!0),a(".confirm","#"+y.themodal).show(),c=!1);return c}function m(){var b;if("_empty"!==e&&void 0!==n.p.savedRow&&0<n.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(b=0;b<
...
u+"_2").addClass("ui-state-disabled"):a("#nData",u+"_2").removeClass("ui-state-disabled")}function q(){var b=a(n).jqGrid("getDataIDs"),c=a("#id_g",u).val();return[a.inArray(c,b),b]}var n=this;if(n.grid&&e){var t=n.p.id,v="FrmGrid_"+t,x="TblGrid_"+t,u="#"+a.jgrid.jqID(x),y={themodal:"editmod"+t,modalhead:"edithd"+t,modalcontent:"editcnt"+t,scrollelm:v},C=a.isFunction(b[n.p.id].beforeShowForm)?b[n.p.id].beforeShowForm:!1,w=a.isFunction(b[n.p.id].afterShowForm)?b[n.p.id].afterShowForm:!1,E=a.isFunction(b[n.p.id].beforeInitData)?
b[n.p.id].beforeInitData:!1,A=a.isFunction(b[n.p.id].onInitializeForm)?b[n.p.id].onInitializeForm:!1,D=!0,F=1,H=0,z,P,B,v=a.jgrid.jqID(v);"new"===e?(e="_empty",B="add",c.caption=b[n.p.id].addCaption):(c.caption=b[n.p.id].editCaption,B="edit");c.recreateForm||a(n).data("formProp")&&a.extend(b[a(this)[0].p.id],a(n).data("formProp"));var O=!0;c.checkOnUpdate&&c.jqModal&&!c.modal&&(O=!1);var S=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",D=isNaN(b[a(this)[0].p.id].datawidth)?
b[a(this)[0].p.id].datawidth:b[a(this)[0].p.id].datawidth+"px",S=a("<form name='FormPost' id='"+v+"' class='FormGrid' onSubmit='return false;' style='width:"+D+";overflow:auto;position:relative;height:"+S+";'></form>").data("disabled",!1),W=a("<table id='"+x+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>");a(n.p.colModel).each(function(){var a=this.formoptions;F=Math.max(F,a?a.colpos||0:0);H=Math.max(H,a?a.rowpos||0:0)});a(S).append(W);D=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+
2*F+"'></td></tr>");D[0].rp=0;a(W).append(D);D=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*F+"'>"+b[n.p.id].topinfo+"</td></tr>");D[0].rp=0;a(W).append(D);D=a(n).triggerHandler("jqGridAddEditBeforeInitData",[S,B]);void 0===D&&(D=!0);D&&E&&(D=E.call(n,S,B));if(!1!==D){m();var D=(E="rtl"===n.p.direction?!0:!1)?"nData":"pData",Y=E?"pData":"nData";g(e,n,W,F);var D="<a id='"+D+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
Y="<a id='"+Y+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",J="<a id='sData' class='fm-button ui-state-default ui-corner-all'>"+c.bSubmit+"</a>",ba="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+c.bCancel+"</a>",x="<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"+x+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+
(E?Y+D:D+Y)+"</td><td class='EditButton'>"+J+ba+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+b[n.p.id].bottominfo+"</td></tr>"),x=x+"</tbody></table>";if(0<H){var U=[];a.each(a(W)[0].rows,function(a,b){U[a]=b});U.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(U,function(b,c){a("tbody",W).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(t);var G=!1;!0===c.closeOnEscape&&(c.closeOnEscape=!1,G=!0);x=a("<div></div>").append(S).append(x);a.jgrid.createModal(y,
x,b[a(this)[0].p.id],"#gview_"+a.jgrid.jqID(n.p.id),a("#gbox_"+a.jgrid.jqID(n.p.id))[0]);E&&(a("#pData, #nData",u+"_2").css("float","right"),a(".EditButton",u+"_2").css("text-align","left"));b[n.p.id].topinfo&&a(".tinfo",u).show();b[n.p.id].bottominfo&&a(".binfo",u+"_2").show();x=x=null;a("#"+a.jgrid.jqID(y.themodal)).keydown(function(d){var e=d.target;if(!0===a("#"+v).data("disabled"))return!1;if(!0===b[n.p.id].savekey[0]&&d.which===b[n.p.id].savekey[1]&&"TEXTAREA"!==e.tagName)return a("#sData",
u+"_2").trigger("click"),!1;if(27===d.which){if(!p())return!1;G&&a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:c.gbox,jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1}if(!0===b[n.p.id].navkeys[0]){if("_empty"===a("#id_g",u).val())return!0;if(d.which===b[n.p.id].navkeys[1])return a("#pData",u+"_2").trigger("click"),!1;if(d.which===b[n.p.id].navkeys[2])return a("#nData",u+"_2").trigger("click"),!1}});c.checkOnUpdate&&
...
c.bYes+"</a>",Y="<a id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bNo+"</a>",ba="<a id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bExit+"</a>",x=c.zIndex||999,x++,a("<div class='"+c.overlayClass+" jqgrid-overlay confirm' style='z-index:"+x+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(x+1)+"'>"+c.saveData+"<br/><br/>"+J+Y+ba+"</div>").insertAfter("#"+v),a("#sNew","#"+a.jgrid.jqID(y.themodal)).click(function(){k();
a("#"+v).data("disabled",!1);a(".confirm","#"+a.jgrid.jqID(y.themodal)).hide();return!1}),a("#nNew","#"+a.jgrid.jqID(y.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(y.themodal)).hide();a("#"+v).data("disabled",!1);setTimeout(function(){a(":input:visible","#"+v)[0].focus()},0);return!1}),a("#cNew","#"+a.jgrid.jqID(y.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(y.themodal)).hide();a("#"+v).data("disabled",!1);a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),
jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a(n).triggerHandler("jqGridAddEditInitializeForm",[a("#"+v),B]);A&&A.call(n,a("#"+v),B);"_empty"!==e&&b[n.p.id].viewPagerButtons?a("#pData,#nData",u+"_2").show():a("#pData,#nData",u+"_2").hide();a(n).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+v),B]);C&&C.call(n,a("#"+v),B);a("#"+a.jgrid.jqID(y.themodal)).data("onClose",b[n.p.id].onClose);a.jgrid.viewModal("#"+
a.jgrid.jqID(y.themodal),{gbox:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,overlay:c.overlay,modal:c.modal,overlayClass:c.overlayClass,onHide:function(b){var c=a("#editmod"+t)[0].style.height;-1<c.indexOf("px")&&(c=parseFloat(c));a(n).data("formProp",{top:parseFloat(a(b.w).css("top")),left:parseFloat(a(b.w).css("left")),width:a(b.w).width(),height:c,dataheight:a("#"+v).height(),datawidth:a("#"+v).width()});b.w.remove();b.o&&b.o.remove()}});O||a("."+a.jgrid.jqID(c.overlayClass)).click(function(){if(!p())return!1;
a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a(".fm-button","#"+a.jgrid.jqID(y.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",u+"_2").click(function(){z={};a("#FormError",u).hide();f();"_empty"===z[n.p.id+"_id"]?k():!0===c.checkOnSubmit?(P=l(z,b[n.p.id]._savedData))?
(a("#"+v).data("disabled",!0),a(".confirm","#"+a.jgrid.jqID(y.themodal)).show()):k():k();return!1});a("#cData",u+"_2").click(function(){if(!p())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a("#nData",u+"_2").click(function(){if(!p())return!1;a("#FormError",u).hide();var b=q();b[0]=parseInt(b[0],10);if(-1!==b[0]&&b[1][b[0]+
...
["prev",a("#"+v),b[1][b[0]]]);a.isFunction(c.afterclickPgButtons)&&c.afterclickPgButtons.call(n,"prev",a("#"+v),b[1][b[0]-1]);r(b[0]-1,b)}return!1});a(n).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+v),B]);w&&w.call(n,a("#"+v),B);C=q();r(C[0],C)}}})},viewGridRow:function(e,c){c=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,jqModal:!0,closeOnEscape:!1,labelswidth:"30%",closeicon:[],navkeys:[!1,38,40],onClose:null,beforeShowForm:null,
...
p,n="ViewTbl_"+p,t={themodal:"viewmod"+p,modalhead:"viewhd"+p,modalcontent:"viewcnt"+p,scrollelm:m},v=a.isFunction(b[l.p.id].beforeInitData)?b[l.p.id].beforeInitData:!1,x=!0,u=1,y=0;c.recreateForm||a(l).data("viewProp")&&a.extend(b[a(this)[0].p.id],a(l).data("viewProp"));var C=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",w=isNaN(b[a(this)[0].p.id].datawidth)?b[a(this)[0].p.id].datawidth:b[a(this)[0].p.id].datawidth+"px",q=a("<form name='FormPost' id='"+
q+"' class='FormGrid' style='width:"+w+";overflow:auto;position:relative;height:"+C+";'></form>"),E=a("<table id='"+n+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");a(l.p.colModel).each(function(){var a=this.formoptions;u=Math.max(u,a?a.colpos||0:0);y=Math.max(y,a?a.rowpos||0:0)});a(q).append(E);v&&(x=v.call(l,q),void 0===x&&(x=!0));if(!1!==x){g(e,l,E,u);n="rtl"===l.p.direction?!0:!1;v="<a id='"+(n?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
x="<a id='"+(n?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";C="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+c.bClose+"</a>";if(0<y){var A=[];a.each(a(E)[0].rows,function(a,b){A[a]=b});A.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(A,function(b,c){a("tbody",E).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(p);q=a("<div></div>").append(q).append("<table border='0' class='EditTable' id='"+
r+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+c.labelswidth+"'>"+(n?x+v:v+x)+"</td><td class='EditButton'>"+C+"</td></tr></tbody></table>");a.jgrid.createModal(t,q,c,"#gview_"+a.jgrid.jqID(l.p.id),a("#gview_"+a.jgrid.jqID(l.p.id))[0]);n&&(a("#pData, #nData","#"+r+"_2").css("float","right"),a(".EditButton","#"+r+"_2").css("text-align","left"));c.viewPagerButtons||a("#pData, #nData","#"+r+"_2").hide();q=null;a("#"+t.themodal).keydown(function(d){if(27===d.which)return b[l.p.id].closeOnEscape&&
...
modal:b[f.p.id].modal})}else{var u=isNaN(b[f.p.id].dataheight)?b[f.p.id].dataheight:b[f.p.id].dataheight+"px",y=isNaN(c.datawidth)?c.datawidth:c.datawidth+"px",v="<div id='"+v+"' class='formdata' style='width:"+y+";overflow:auto;position:relative;height:"+u+";'><table class='DelTable'><tbody>",v=v+"<tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>",v=v+("<tr id='DelData' style='display:none'><td >"+e+"</td></tr>"),v=v+('<tr><td class="delmsg" style="white-space:pre;">'+
...
"<td "+h.formatCol(p,1,"")+">"+a.jgrid.format(r,n)+"</td>";return!1}});b+=q}return b}var h=this,k=h.p.groupingView,l="",p="",m,r,q=k.groupCollapse?k.plusicon:k.minusicon,n,t=[],v=k.groupField.length,q=q+(" tree-wrap-"+h.p.direction);a.each(h.p.colModel,function(a,b){var c;for(c=0;c<v;c++)if(k.groupField[c]===b.name){t[c]=a;break}});var x=0,u=a.makeArray(k.groupSummary),y;u.reverse();y=h.p.multiselect?' colspan="2"':"";a.each(k.groups,function(g,w){if(k._locgr&&!(w.startRow+w.cnt>(c-1)*f&&w.startRow<
c*f))return!0;x++;r=h.p.id+"ghead_"+w.idx;m=r+"_"+g;p="<span style='cursor:pointer;' class='ui-icon "+q+"' onclick=\"jQuery('#"+a.jgrid.jqID(h.p.id)+"').jqGrid('groupingToggle','"+m+"');return false;\"></span>";try{a.isArray(k.formatDisplayField)&&a.isFunction(k.formatDisplayField[w.idx])?(w.displayValue=k.formatDisplayField[w.idx].call(h,w.displayValue,w.value,h.p.colModel[t[w.idx]],w.idx,k),n=w.displayValue):n=h.formatter(m,w.displayValue,t[w.idx],w.value)}catch(E){n=w.displayValue}"header"===k.groupSummaryPos[w.idx]?
...
r+'"><td style="padding-left:'+12*w.idx+'px;" colspan="'+(!1===k.groupColumnShow[w.idx]?e-1:e)+'">'+p+a.jgrid.template(k.groupText[w.idx],n,w.cnt,w.summary)+"</td></tr>";if(v-1===w.idx){var A=k.groups[g+1],D,F=0;D=w.startRow;var H=void 0!==A?A.startRow:k.groups[g].startRow+k.groups[g].cnt;k._locgr&&(F=(c-1)*f,F>w.startRow&&(D=F));for(;D<H&&b[D-F];D++)l+=b[D-F].join("");if("header"!==k.groupSummaryPos[w.idx]){var z;if(void 0!==A){for(z=0;z<k.groupField.length&&A.dataIndex!==k.groupField[z];z++);x=
k.groupField.length-z}for(A=0;A<x;A++)u[A]&&(F="",k.groupCollapse&&!k.showSummaryOnHide&&(F=' style="display:none;"'),l+="<tr"+F+' jqfootlevel="'+(w.idx-A)+'" role="row" class="ui-widget-content jqfoot ui-row-'+h.p.direction+'">',l+=d(g,A,k.groups,0),l+="</tr>");x=z}}});a("#"+a.jgrid.jqID(h.p.id)+" tbody:first").append(l);l=null})},groupingGroupBy:function(b,e){return this.each(function(){"string"===typeof b&&(b=[b]);var c=this.p.groupingView;this.p.grouping=!0;c._locgr=!1;void 0===c.visibiltyOnNextGrouping&&
...
afterrestorefunc:null,restoreAfterError:!0,mtype:"POST",saveui:"enable",savetext:a.jgrid.defaults.savetext||"Saving..."},a.jgrid.inlineEdit,l),p=!1,m=this[0],r,q={},n={},t={},v,x,u;if(!m.grid)return p;u=a(m).jqGrid("getInd",b,!0);if(!1===u)return p;k=a.isFunction(l.beforeSaveRow)?l.beforeSaveRow.call(m,l,b):void 0;void 0===k&&(k=!0);if(k){k=a(u).attr("editable");l.url=l.url||m.p.editurl;if("1"===k){var y;a('td[role="gridcell"]',u).each(function(b){y=m.p.colModel[b];r=y.name;if("cb"!==r&&"subgrid"!==
...
"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}x=a.jgrid.checkValues.call(m,q[r],b);if(!1===x[0])return!1;m.p.autoencode&&(q[r]=a.jgrid.htmlEncode(q[r]));"clientArray"!==l.url&&y.editoptions&&!0===y.editoptions.NullIfEmpty&&""===q[r]&&(t[r]="null")}});if(!1===x[0]){try{var C=a(m).jqGrid("getGridRowById",b),w=a.jgrid.findPos(C);a.jgrid.info_dialog(a.jgrid.errors.errcap,x[1],a.jgrid.edit.bClose,{left:w[0],
top:w[1]+a(C).outerHeight()})}catch(E){alert(x[1])}return p}k=m.p.prmNames;C=b;w=!1===m.p.keyName?k.id:m.p.keyName;q&&(q[k.oper]=k.editoper,void 0===q[w]||""===q[w]?q[w]=b:u.id!==m.p.idPrefix+q[w]&&(k=a.jgrid.stripPref(m.p.idPrefix,b),void 0!==m.p._index[k]&&(m.p._index[q[w]]=m.p._index[k],delete m.p._index[k]),b=m.p.idPrefix+q[w],a(u).attr("id",b),m.p.selrow===C&&(m.p.selrow=b),a.isArray(m.p.selarrrow)&&(k=a.inArray(C,m.p.selarrrow),0<=k&&(m.p.selarrrow[k]=b)),m.p.multiselect&&(k="jqg_"+m.p.id+"_"+
b,a("input.cbox",u).attr("id",k).attr("name",k))),void 0===m.p.inlineData&&(m.p.inlineData={}),q=a.extend({},q,m.p.inlineData,l.extraparam));if("clientArray"===l.url){q=a.extend({},q,n);m.p.autoencode&&a.each(q,function(b,c){q[b]=a.jgrid.htmlDecode(c)});k=a(m).jqGrid("setRowData",b,q);a(u).attr("editable","0");for(w=0;w<m.p.savedRow.length;w++)if(String(m.p.savedRow[w].id)===String(C)){v=w;break}0<=v&&m.p.savedRow.splice(v,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[b,k,q,l]);a.isFunction(l.aftersavefunc)&&
l.aftersavefunc.call(m,b,k,q,l);p=!0;a(u).removeClass("jqgrid-new-row").unbind("keydown")}else a(m).jqGrid("progressBar",{method:"show",loadtype:l.saveui,htmlcontent:l.savetext}),t=a.extend({},q,t),t[w]=a.jgrid.stripPref(m.p.idPrefix,t[w]),a.ajax(a.extend({url:l.url,data:a.isFunction(m.p.serializeRowData)?m.p.serializeRowData.call(m,t):t,type:l.mtype,async:!1,complete:function(c,d){a(m).jqGrid("progressBar",{method:"hide",loadtype:l.saveui,htmlcontent:l.savetext});if("success"===d){var e=!0,f;f=a(m).triggerHandler("jqGridInlineSuccessSaveRow",
...
c[g].aggregator,q[0]=u;else{u=d[m].replace(/\s+/g,"");try{l=1===f?p+u:p+u+"_"+c[g].aggregator+"_"+String(g)}catch(t){}}var v=l=isNaN(parseInt(l,10))?l:l+" ",w=r,y=l,x=e[l],z=c[g].member,A=b,C=void 0;switch(c[g].aggregator){case "sum":C=parseFloat(x||0)+parseFloat(A[z]||0);break;case "count":if(""===x||null==x)x=0;C=A.hasOwnProperty(z)?x+1:0;break;case "min":C=""===x||null==x?parseFloat(A[z]||0):Math.min(parseFloat(x),parseFloat(A[z]||0));break;case "max":C=""===x||null==x?parseFloat(A[z]||0):Math.max(parseFloat(x),
parseFloat(A[z]||0))}e[v]=w[y]=C;1>=m&&"_r_Totals"!==u&&""===p&&(p=u)}h[l]=r;k[l]=q[m]}return e}function t(a){var b,c,d,e,g;for(d in a)if(a.hasOwnProperty(d)){if("object"!==typeof a[d]){if("level"===d){void 0===S[a.level]&&(S[a.level]="",0<a.level&&"_r_Totals"!==a.text&&(p[a.level-1]={useColSpanStyle:!1,groupHeaders:[]}));if(S[a.level]!==a.text&&a.children.length&&"_r_Totals"!==a.text&&0<a.level){p[a.level-1].groupHeaders.push({titleText:a.label,numberOfColumns:0});c=p[a.level-1].groupHeaders.length-
1;g=0===c?Y:W+E;if(a.level-1===(m.rowTotals?1:0)&&0<c){var h=p[a.level-1].groupHeaders[c-1].numberOfColumns;h&&(g=h+1+m.aggregates.length)}p[a.level-1].groupHeaders[c].startColumnName=f[g].name;p[a.level-1].groupHeaders[c].numberOfColumns=f.length-g;W=f.length}S[a.level]=a.text}if(a.level===w&&"level"===d&&0<w)if(1<E){c=1;for(b in a.fields)a.fields.hasOwnProperty(b)&&(1===c&&p[w-1].groupHeaders.push({startColumnName:b,numberOfColumns:1,titleText:a.text}),c++);p[w-1].groupHeaders[p[w-1].groupHeaders.length-
1].numberOfColumns=c-1}else p.splice(w-1,1)}null!=a[d]&&"object"===typeof a[d]&&t(a[d]);if("level"===d&&0<a.level)for(b in c=0,a.fields)if(a.fields.hasOwnProperty(b)){g={};for(e in m.aggregates[c])if(m.aggregates[c].hasOwnProperty(e))switch(e){case "member":case "label":case "aggregator":break;default:g[e]=m.aggregates[c][e]}1<E?(g.name=b,g.label=m.aggregates[c].label||a.label):(g.name=a.text,g.label="_r_Totals"===a.text?m.rowTotalsText:a.label);f.push(g);c++}}}var v,x,u,y=e.length,C,w,E,A,D=0;m.rowTotals&&
0<m.yDimension.length&&(m.yDimension.splice(0,0,{dataName:m.yDimension[0].dataName}),m.yDimension[0].converter=function(){return"_r_Totals"});C=a.isArray(m.xDimension)?m.xDimension.length:0;w=m.yDimension.length;E=a.isArray(m.aggregates)?m.aggregates.length:0;if(0===C||0===E)throw"xDimension or aggregates optiona are not set!";var F;for(u=0;u<C;u++)F={name:m.xDimension[u].dataName,frozen:m.frozenStaticCols},null==m.xDimension[u].isGroupField&&(m.xDimension[u].isGroupField=!0),F=a.extend(!0,F,m.xDimension[u]),
f.push(F);F=C-1;for(var H={};D<y;){v=e[D];var z=[],P=[];A={};u=0;do z[u]=a.trim(v[m.xDimension[u].dataName]),A[m.xDimension[u].dataName]=z[u],u++;while(u<C);var B=0;x=-1;u=c(g,q,z);if(!u){B=0;if(1<=w){for(B=0;B<w;B++)P[B]=a.trim(v[m.yDimension[B].dataName]),m.yDimension[B].converter&&a.isFunction(m.yDimension[B].converter)&&(P[B]=m.yDimension[B].converter.call(this,P[B],z,P));A=n(v,m.aggregates,P,A)}else 0===w&&(A=n(v,m.aggregates,null,A));g.push(A)}else if(0<=x){B=0;if(1<=w){for(B=0;B<w;B++)P[B]=
a.trim(v[m.yDimension[B].dataName]),m.yDimension[B].converter&&a.isFunction(m.yDimension[B].converter)&&(P[B]=m.yDimension[B].converter.call(this,P[B],z,P));u=n(v,m.aggregates,P,u)}else 0===w&&(u=n(v,m.aggregates,null,u));g[x]=u}v=0;var z=A=null,O;for(O in h)if(h.hasOwnProperty(O)){if(0===v)H.children&&void 0!==H.children||(H={text:O,level:0,children:[],label:O}),A=H.children;else{z=null;for(u=0;u<A.length;u++)if(A[u].text===O){z=A[u];break}z?A=z.children:(A.push({children:[],text:O,level:v,fields:h[O],
label:k[O]}),A=A[A.length-1].children)}v++}D++}var S=[],W=f.length,Y=W;0<w&&(p[w-1]={useColSpanStyle:!1,groupHeaders:[]});t(H);if(m.colTotals)for(D=g.length;D--;)for(u=C;u<f.length;u++)y=f[u].name,d[y]=d[y]?d[y]+parseFloat(g[D][y]||0):parseFloat(g[D][y]||0);if(0<F)for(u=0;u<F;u++)f[u].isGroupField&&(l.groupingView.groupField.push(f[u].name),l.groupingView.groupSummary.push(m.groupSummary),l.groupingView.groupSummaryPos.push(m.groupSummaryPos));else l.grouping=!1;l.sortname=f[F].name;l.groupingView.hideFirstGroupCol=
...
if(e.length)for(k in e)e.hasOwnProperty(k)&&(e[k][g]=parseInt(e[k][g],10)-h)}}})},addChildNode:function(b,e,c,f){var g=this[0];if(c){var d=g.p.treeReader.expanded_field,h=g.p.treeReader.leaf_field,k=g.p.treeReader.level_field,l=g.p.treeReader.parent_id_field,p=g.p.treeReader.left_field,m=g.p.treeReader.right_field,r=g.p.treeReader.loaded,q,n,t,v,x;q=0;var u=e,y;void 0===f&&(f=!1);if(null==b){x=g.p.data.length-1;if(0<=x)for(;0<=x;)q=Math.max(q,parseInt(g.p.data[x][g.p.localReader.id],10)),x--;b=q+
1}var C=a(g).jqGrid("getInd",e);y=!1;void 0===e||null===e||""===e?(u=e=null,q="last",v=g.p.tree_root_level,x=g.p.data.length+1):(q="after",n=g.p._index[e],t=g.p.data[n],e=t[g.p.localReader.id],v=parseInt(t[k],10)+1,x=a(g).jqGrid("getFullTreeNode",t),x.length?(u=x=x[x.length-1][g.p.localReader.id],x=a(g).jqGrid("getInd",u)+1):x=a(g).jqGrid("getInd",e)+1,t[h]&&(y=!0,t[d]=!0,a(g.rows[C]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(g.p.treeIcons.leaf+
" tree-leaf").addClass(g.p.treeIcons.minus+" tree-minus"),g.p.data[n][h]=!1,t[r]=!0));n=x+1;void 0===c[d]&&(c[d]=!1);void 0===c[r]&&(c[r]=!1);c[k]=v;void 0===c[h]&&(c[h]=!0);"adjacency"===g.p.treeGridModel&&(c[l]=e);if("nested"===g.p.treeGridModel){var w;if(null!==e){h=parseInt(t[m],10);k=a.jgrid.from(g.p.data);k=k.greaterOrEquals(m,h,{stype:"integer"});k=k.select();if(k.length)for(w in k)k.hasOwnProperty(w)&&(k[w][p]=k[w][p]>h?parseInt(k[w][p],10)+2:k[w][p],k[w][m]=k[w][m]>=h?parseInt(k[w][m],10)+
2:k[w][m]);c[p]=h;c[m]=h+1}else{h=parseInt(a(g).jqGrid("getCol",m,!1,"max"),10);k=a.jgrid.from(g.p.data).greater(p,h,{stype:"integer"}).select();if(k.length)for(w in k)k.hasOwnProperty(w)&&(k[w][p]=parseInt(k[w][p],10)+2);k=a.jgrid.from(g.p.data).greater(m,h,{stype:"integer"}).select();if(k.length)for(w in k)k.hasOwnProperty(w)&&(k[w][m]=parseInt(k[w][m],10)+2);c[p]=h+1;c[m]=h+2}}if(null===e||a(g).jqGrid("isNodeLoaded",t)||y)a(g).jqGrid("addRowData",b,c,q,u),a(g).jqGrid("setTreeNode",x,n);t&&!t[d]&&
f&&a(g.rows[C]).find("div.treeclick").click()}}})})(jQuery);

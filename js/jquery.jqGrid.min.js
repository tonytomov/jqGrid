...
null!=a.jgrid.cmTemplate&&"object"===typeof a.jgrid.cmTemplate[d.p.colModel[k].template]?a.jgrid.cmTemplate[d.p.colModel[k].template]:{}:d.p.colModel[k].template,d.p.colModel[k]=a.extend(!0,{},d.p.cmTemplate,M||{},d.p.colModel[k]),!1===d.p.keyName&&!0===d.p.colModel[k].key&&(d.p.keyName=d.p.colModel[k].name);d.p.sortorder=d.p.sortorder.toLowerCase();a.jgrid.cell_width=a.jgrid.cellWidth();!0===d.p.grouping&&(d.p.scroll=!1,d.p.rownumbers=!1,d.p.treeGrid=!1,d.p.gridview=!0);if(!0===this.p.treeGrid){try{a(this).jqGrid("setTreeGrid")}catch(N){}"local"!==
...
d.p.jsonReader);d.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},d.p.localReader);d.p.scroll&&(d.p.pgbuttons=!1,d.p.pginput=!1,d.p.rowList=[]);d.p.data.length&&(E(),A());M="<thead><tr class='ui-jqgrid-labels' role='row'>";var K,O,Z,U,R,J,H,ga,ca=ga="",ja=[],ea=[];O=[];if(!0===d.p.shrinkToFit&&!0===d.p.forceFit)for(k=d.p.colModel.length-1;0<=k;k--)if(!d.p.colModel[k].hidden){d.p.colModel[k].resizable=
!1;break}"horizontal"===d.p.viewsortcols[1]&&(ga=" ui-i-asc",ca=" ui-i-desc");K=c?"class='ui-th-div-ie'":"";ga="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+ga+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+l+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ca+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+l+"'></span></span>");if(d.p.multiSort)for(ja=d.p.sortname.split(","),k=0;k<ja.length;k++)O=a.trim(ja[k]).split(" "),
ja[k]=a.trim(O[0]),ea[k]=O[1]?a.trim(O[1]):d.p.sortorder||"asc";for(k=0;k<this.p.colNames.length;k++)O=d.p.headertitles?' title="'+a.jgrid.stripHtml(d.p.colNames[k])+'"':"",M+="<th id='"+d.p.id+"_"+d.p.colModel[k].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+l+"'"+O+">",O=d.p.colModel[k].index||d.p.colModel[k].name,M+="<div id='jqgh_"+d.p.id+"_"+d.p.colModel[k].name+"' "+K+">"+d.p.colNames[k],d.p.colModel[k].width=d.p.colModel[k].width?parseInt(d.p.colModel[k].width,10):
150,"boolean"!==typeof d.p.colModel[k].title&&(d.p.colModel[k].title=!0),d.p.colModel[k].lso="",O===d.p.sortname&&(d.p.lastsort=k),d.p.multiSort&&(O=a.inArray(O,ja),-1!==O&&(d.p.colModel[k].lso=ea[O])),M+=ga+"</div></th>";M+="</tr></thead>";ga=null;a(this).append(M);a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});if(this.p.multiselect){var ka=[],da;a("#cb_"+a.jgrid.jqID(d.p.id),this).bind("click",function(){d.p.selarrrow=
...
(a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id),d.grid.fbDiv)[d.p.useProp?"prop":"attr"]("checked",!1),a("#"+a.jgrid.jqID(this.id),d.grid.fbDiv).removeClass("ui-state-highlight")))}),d.p.selrow=null,da=!1);a(d).triggerHandler("jqGridSelectAll",[da?d.p.selarrrow:ka,da]);a.isFunction(d.p.onSelectAll)&&d.p.onSelectAll.call(d,da?d.p.selarrrow:ka,da)})}!0===d.p.autowidth&&(M=a(m).innerWidth(),d.p.width=0<M?M:"nw");(function(){var b=0,c=a.jgrid.cell_width?0:r(d.p.cellLayout,0),e=0,f,g=r(d.p.scrollOffset,
...
a(m).css("width",h.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+d.p.id+"'>&#160;</div>");a(p).css("width",h.width+"px");M=a("thead:first",d).get(0);var fa="";d.p.footerrow&&(fa+="<table role='presentation' style='width:"+d.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+l+"'>");var p=a("tr:first",M),ha="<tr class='jqgfirstrow' role='row' style='height:auto'>";d.p.disableClick=!1;
...
X&&a(d.p.pager).hide(),V(d.p.pager,""));!1===d.p.cellEdit&&!0===d.p.hoverrows&&a(d).bind("mouseover",function(b){H=a(b.target).closest("tr.jqgrow");"ui-subgrid"!==a(H).attr("class")&&a(H).addClass("ui-state-hover")}).bind("mouseout",function(b){H=a(b.target).closest("tr.jqgrow");a(H).removeClass("ui-state-hover")});var T,aa,la;a(d).before(h.hDiv).click(function(b){J=b.target;H=a(J,d.rows).closest("tr.jqgrow");if(0===a(H).length||-1<H[0].className.indexOf("ui-state-disabled")||(a(J,d).closest("table.ui-jqgrid-btable").attr("id")||
"").replace("_frozen","")!==d.id)return this;var c=a(J).hasClass("cbox"),e=a(d).triggerHandler("jqGridBeforeSelectRow",[H[0].id,b]),e=!1===e||"stop"===e?!1:!0;if(a.isFunction(d.p.beforeSelectRow)){var f=d.p.beforeSelectRow.call(d,H[0].id,b);if(!1===f||"stop"===f)e=!1}if("A"!==J.tagName&&("INPUT"!==J.tagName&&"TEXTAREA"!==J.tagName&&"OPTION"!==J.tagName&&"SELECT"!==J.tagName||c))if(T=H[0].id,J=a(J).closest("tr.jqgrow>td"),0<J.length&&(aa=a.jgrid.getCellIndex(J),la=a(J).closest("td,th").html(),a(d).triggerHandler("jqGridCellSelect",
[T,aa,la,b]),a.isFunction(d.p.onCellSelect)&&d.p.onCellSelect.call(d,T,aa,la,b)),!0===d.p.cellEdit)if(d.p.multiselect&&c&&e)a(d).jqGrid("setSelection",T,!0,b);else{if(0<J.length){T=H[0].rowIndex;try{a(d).jqGrid("editCell",T,aa,!0)}catch(h){}}}else if(e)if(d.p.multikey)b[d.p.multikey]?a(d).jqGrid("setSelection",T,!0,b):d.p.multiselect&&c&&(c=a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+T).is(":checked"),a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+T)[d.p.useProp?"prop":"attr"]("checked",c));else{if(d.p.multiselect&&d.p.multiboxonly&&
!c){var g=d.p.frozenColumns?d.p.id+"_frozen":"";a(d.p.selarrrow).each(function(b,c){var e=a(d).jqGrid("getGridRowById",c);e&&a(e).removeClass("ui-state-highlight");a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(c))[d.p.useProp?"prop":"attr"]("checked",!1);g&&(a("#"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(g)).removeClass("ui-state-highlight"),a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(g))[d.p.useProp?"prop":"attr"]("checked",!1))});d.p.selarrrow=[]}a(d).jqGrid("setSelection",T,!0,
...
("both"===d.p.toolbar[1]&&(e+=",#"+a.jgrid.jqID(a(h.ubDiv).attr("id"))),e+=",#"+a.jgrid.jqID(a(h.uDiv).attr("id")));f=a(e,"#gview_"+a.jgrid.jqID(d.p.id)).length;d.p.toppager&&(e+=","+d.p.toppager);"visible"===d.p.gridstate?a(e,"#gbox_"+a.jgrid.jqID(d.p.id)).slideUp("fast",function(){f--;0===f&&(a("span",g).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s"),d.p.gridstate="hidden",a("#gbox_"+a.jgrid.jqID(d.p.id)).hasClass("ui-resizable")&&a(".ui-resizable-handle","#gbox_"+
a.jgrid.jqID(d.p.id)).hide(),a(d.grid.cDiv).addClass("ui-corner-bottom"),a(d).triggerHandler("jqGridHeaderClick",[d.p.gridstate,b]),c&&(X||d.p.onHeaderClick.call(d,d.p.gridstate,b)))}):"hidden"===d.p.gridstate&&(a(d.grid.cDiv).removeClass("ui-corner-bottom"),a(e,"#gbox_"+a.jgrid.jqID(d.p.id)).slideDown("fast",function(){f--;0===f&&(a("span",g).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n"),X&&(d.p.datatype=na,L(),X=!1),d.p.gridstate="visible",a("#gbox_"+a.jgrid.jqID(d.p.id)).hasClass("ui-resizable")&&
...
function(){return!1});a(document).bind("mouseup.jqGrid"+d.p.id,function(){return h.resizing?(h.dragEnd(),!1):!0});d.formatCol=q;d.sortData=I;d.updatepager=function(b,c){var e,f,h,g,k,l,p,m="",n=d.p.pager?"_"+a.jgrid.jqID(d.p.pager.substr(1)):"",q=d.p.toppager?"_"+d.p.toppager.substr(1):"";h=parseInt(d.p.page,10)-1;0>h&&(h=0);h*=parseInt(d.p.rowNum,10);k=h+d.p.reccount;if(d.p.scroll){e=a("tbody:first > tr:gt(0)",d.grid.bDiv);h=k-e.length;d.p.reccount=e.length;if(e=e.outerHeight()||d.grid.prevRowHeight)f=
h*e,p=parseInt(d.p.records,10)*e,a(">div:first",d.grid.bDiv).css({height:p}).children("div:first").css({height:f,display:f?"":"none"}),0===d.grid.bDiv.scrollTop&&1<d.p.page&&(d.grid.bDiv.scrollTop=d.p.rowNum*(d.p.page-1)*e);d.grid.bDiv.scrollLeft=d.grid.hDiv.scrollLeft}m=d.p.pager||"";if(m+=d.p.toppager?m?","+d.p.toppager:d.p.toppager:"")p=a.jgrid.formatter.integer||{},e=r(d.p.page),f=r(d.p.lastpage),a(".selbox",m)[d.p.useProp?"prop":"attr"]("disabled",!1),!0===d.p.pginput&&(a(".ui-pg-input",m).val(d.p.page),
g=d.p.toppager?"#sp_1"+n+",#sp_1"+q:"#sp_1"+n,a(g).html(a.fmatter?a.fmatter.util.NumberFormat(d.p.lastpage,p):d.p.lastpage)),d.p.viewrecords&&(0===d.p.reccount?a(".ui-paging-info",m).html(d.p.emptyrecords):(g=h+1,l=d.p.records,a.fmatter&&(g=a.fmatter.util.NumberFormat(g,p),k=a.fmatter.util.NumberFormat(k,p),l=a.fmatter.util.NumberFormat(l,p)),a(".ui-paging-info",m).html(a.jgrid.format(d.p.recordtext,g,k,l)))),!0===d.p.pgbuttons&&(0>=e&&(e=f=0),1===e||0===e?(a("#first"+n+", #prev"+n).addClass("ui-state-disabled").removeClass("ui-state-hover"),
d.p.toppager&&a("#first_t"+q+", #prev_t"+q).addClass("ui-state-disabled").removeClass("ui-state-hover")):(a("#first"+n+", #prev"+n).removeClass("ui-state-disabled"),d.p.toppager&&a("#first_t"+q+", #prev_t"+q).removeClass("ui-state-disabled")),e===f||0===e?(a("#next"+n+", #last"+n).addClass("ui-state-disabled").removeClass("ui-state-hover"),d.p.toppager&&a("#next_t"+q+", #last_t"+q).addClass("ui-state-disabled").removeClass("ui-state-hover")):(a("#next"+n+", #last"+n).removeClass("ui-state-disabled"),
d.p.toppager&&a("#next_t"+q+", #last_t"+q).removeClass("ui-state-disabled")));!0===b&&!0===d.p.rownumbers&&a(">td.jqgrid-rownum",d.rows).each(function(b){a(this).html(h+1+b)});c&&d.p.jqgdnd&&a(d).jqGrid("gridDnD","updateDnD");a(d).triggerHandler("jqGridGridComplete");a.isFunction(d.p.gridComplete)&&d.p.gridComplete.call(d);a(d).triggerHandler("jqGridAfterGridComplete")};d.refreshIndex=A;d.setHeadCheckBox=S;d.constructTr=D;d.formatter=function(a,b,c,d,e){return t(a,b,c,d,e)};a.extend(h,{populate:L,

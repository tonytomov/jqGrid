...
a(b);if(b.is("tr"))return-1;b=(b.is("td")||b.is("th")?b:b.closest("td,th"))[0];return a.jgrid.msie?a.inArray(b,b.parentNode.cells):b.cellIndex},stripHtml:function(a){a=String(a);var e=/<("[^"]*"|'[^']*'|[^'">])*>/gi;return a?(a=a.replace(e,""))&&"&nbsp;"!==a&&"&#160;"!==a?a.replace(/\"/g,"'"):"":a},stripPref:function(b,e){var c=a.type(b);if("string"===c||"number"===c)b=String(b),e=""!==b?String(e).replace(String(b),""):e;return e},parse:function(b){"while(1);"===b.substr(0,9)&&(b=b.substr(9));"/*"===
b.substr(0,2)&&(b=b.substr(2,b.length-4));b||(b="{}");return!0===a.jgrid.useJSON&&"object"===typeof JSON&&"function"===typeof JSON.parse?JSON.parse(b):eval("("+b+")")},parseDate:function(b,e,c,f){var g=/^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/,d="string"===typeof e?e.match(g):null,g=function(a,d){a=String(a);for(d=parseInt(d,10)||2;a.length<d;)a="0"+a;return a},h={m:1,d:1,y:1970,h:0,i:0,s:0,u:0},k=0,l,p,k=function(a,d){0===a?12===d&&(d=0):12!==d&&(d+=12);return d},m=0;void 0===
f&&(f=a.jgrid.formatter.date);void 0===f.parseRe&&(f.parseRe=/[#%\\\/:_;.,\t\s-]/);f.masks.hasOwnProperty(b)&&(b=f.masks[b]);if(e&&null!=e)if(isNaN(e-0)||"u"!==String(b).toLowerCase())if(e.constructor===Date)k=e;else if(null!==d)k=new Date(parseInt(d[1],10)),d[3]&&(m=60*Number(d[5])+Number(d[6]),m*="-"===d[4]?1:-1,m-=k.getTimezoneOffset(),k.setTime(Number(Number(k)+6E4*m)));else{"ISO8601Long"===f.srcformat&&"Z"===e.charAt(e.length-1)&&(m-=(new Date).getTimezoneOffset());e=String(e).replace(/\T/g,
"#").replace(/\t/,"%").split(f.parseRe);b=b.replace(/\T/g,"#").replace(/\t/,"%").split(f.parseRe);l=0;for(p=b.length;l<p;l++)"M"===b[l]&&(d=a.inArray(e[l],f.monthNames),-1!==d&&12>d&&(e[l]=d+1,h.m=e[l])),"F"===b[l]&&(d=a.inArray(e[l],f.monthNames,12),-1!==d&&11<d&&(e[l]=d+1-12,h.m=e[l])),"a"===b[l]&&(d=a.inArray(e[l],f.AmPm),-1!==d&&2>d&&e[l]===f.AmPm[d]&&(e[l]=d,h.h=k(e[l],h.h))),"A"===b[l]&&(d=a.inArray(e[l],f.AmPm),-1!==d&&1<d&&e[l]===f.AmPm[d]&&(e[l]=d-2,h.h=k(e[l],h.h))),"g"===b[l]&&(h.h=parseInt(e[l],
10)),void 0!==e[l]&&(h[b[l].toLowerCase()]=parseInt(e[l],10));h.f&&(h.m=h.f);if(0===h.m&&0===h.y&&0===h.d)return"&#160;";h.m=parseInt(h.m,10)-1;k=h.y;70<=k&&99>=k?h.y=1900+h.y:0<=k&&69>=k&&(h.y=2E3+h.y);k=new Date(h.y,h.m,h.d,h.h,h.i,h.s,h.u);0<m&&k.setTime(Number(Number(k)+6E4*m))}else k=new Date(1E3*parseFloat(e));else k=new Date(h.y,h.m,h.d,h.h,h.i,h.s,h.u);f.userLocalTime&&0===m&&(m-=(new Date).getTimezoneOffset(),0<m&&k.setTime(Number(Number(k)+6E4*m)));if(void 0===c)return k;f.masks.hasOwnProperty(c)?
c=f.masks[c]:c||(c="Y-m-d");b=k.getHours();e=k.getMinutes();h=k.getDate();m=k.getMonth()+1;d=k.getTimezoneOffset();l=k.getSeconds();p=k.getMilliseconds();var r=k.getDay(),q=k.getFullYear(),n=(r+6)%7+1,t=(new Date(q,m-1,h)-new Date(q,0,1))/864E5,v={d:g(h),D:f.dayNames[r],j:h,l:f.dayNames[r+7],N:n,S:f.S(h),w:r,z:t,W:5>n?Math.floor((t+n-1)/7)+1:Math.floor((t+n-1)/7)||(4>((new Date(q-1,0,1)).getDay()+6)%7?53:52),F:f.monthNames[m-1+12],m:g(m),M:f.monthNames[m-1],n:m,t:"?",L:"?",o:"?",Y:q,y:String(q).substring(2),
a:12>b?f.AmPm[0]:f.AmPm[1],A:12>b?f.AmPm[2]:f.AmPm[3],B:"?",g:b%12||12,G:b,h:g(b%12||12),H:g(b),i:g(e),s:g(l),u:p,e:"?",I:"?",O:(0<d?"-":"+")+g(100*Math.floor(Math.abs(d)/60)+Math.abs(d)%60,4),P:"?",T:(String(k).match(/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g)||[""]).pop().replace(/[^-+\dA-Z]/g,""),Z:"?",c:"?",r:"?",U:Math.floor(k/1E3)};return c.replace(/\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g,function(a){return v.hasOwnProperty(a)?
v[a]:a.substring(1)})},jqID:function(a){return String(a).replace(/[!"#$%&'()*+,.\/:; <=>?@\[\\\]\^`{|}~]/g,"\\$&")},guid:1,uidPref:"jqg",randId:function(b){return(b||a.jgrid.uidPref)+a.jgrid.guid++},getAccessor:function(a,e){var c,f,g=[],d;if("function"===typeof e)return e(a);c=a[e];if(void 0===c)try{if("string"===typeof e&&(g=e.split(".")),d=g.length)for(c=a;c&&d--;)f=g.shift(),c=c[f]}catch(h){}return c},getXmlData:function(b,e,c){var f="string"===typeof e?e.match(/^(.*)\[(\w+)\]$/):null;if("function"===
typeof e)return e(b);if(f&&f[2])return f[1]?a(f[1],b).attr(f[2]):a(b).attr(f[2]);b=a(e,b);return c?b:0<b.length?a(b).text():void 0},cellWidth:function(){var b=a("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'></td></tr></table></div>"),e=b.appendTo("body").find("td").width();b.remove();return.1<Math.abs(e-5)},cell_width:!0,ajaxOptions:{},from:function(b){return new function(b,c){"string"===typeof b&&
(b=a.data(b));var f=this,g=b,d=!0,h=!1,k=c,l=/[\$,%]/g,p=null,m=null,r=0,q=!1,n="",t=[],v=!0;if("object"===typeof b&&b.push)0<b.length&&(v="object"!==typeof b[0]?!1:!0);else throw"data provides is not an array";this._hasData=function(){return null===g?!1:0===g.length?!1:!0};this._getStr=function(a){var b=[];h&&b.push("jQuery.trim(");b.push("String("+a+")");h&&b.push(")");d||b.push(".toLowerCase()");return b.join("")};this._strComp=function(a){return"string"===typeof a?".toString()":""};this._group=
function(a,d){return{field:a.toString(),unique:d,items:[]}};this._toStr=function(b){h&&(b=a.trim(b));b=b.toString().replace(/\\/g,"\\\\").replace(/\"/g,'\\"');return d?b:b.toLowerCase()};this._funcLoop=function(d){var b=[];a.each(g,function(a,c){b.push(d(c))});return b};this._append=function(a){var d;k=null===k?"":k+(""===n?" && ":n);for(d=0;d<r;d++)k+="(";q&&(k+="!");k+="("+a+")";q=!1;n="";r=0};this._setCommand=function(a,d){p=a;m=d};this._resetNegate=function(){q=!1};this._repeatCommand=function(a,
d){return null===p?f:null!==a&&null!==d?p(a,d):null!==m&&v?p(m,a):p(a)};this._equals=function(a,d){return 0===f._compare(a,d,1)};this._compare=function(a,b,c){var e=Object.prototype.toString;void 0===c&&(c=1);void 0===a&&(a=null);void 0===b&&(b=null);if(null===a&&null===b)return 0;if(null===a&&null!==b)return 1;if(null!==a&&null===b)return-1;if("[object Date]"===e.call(a)&&"[object Date]"===e.call(b))return a<b?-c:a>b?c:0;d||"number"===typeof a||"number"===typeof b||(a=String(a),b=String(b));return a<
b?-c:a>b?c:0};this._performSort=function(){0!==t.length&&(g=f._doSort(g,0))};this._doSort=function(a,d){var b=t[d].by,c=t[d].dir,e=t[d].type,h=t[d].datefmt,g=t[d].sfunc;if(d===t.length-1)return f._getOrder(a,b,c,e,h,g);d++;b=f._getGroup(a,b,c,e,h);c=[];for(e=0;e<b.length;e++)for(g=f._doSort(b[e].items,d),h=0;h<g.length;h++)c.push(g[h]);return c};this._getOrder=function(b,c,e,h,g,k){var p=[],n=[],m="a"===e?1:-1,r,q;void 0===h&&(h="text");q="float"===h||"number"===h||"currency"===h||"numeric"===h?function(a){a=
parseFloat(String(a).replace(l,""));return isNaN(a)?Number.NEGATIVE_INFINITY:a}:"int"===h||"integer"===h?function(a){return a?parseFloat(String(a).replace(l,"")):Number.NEGATIVE_INFINITY}:"date"===h||"datetime"===h?function(d){return a.jgrid.parseDate(g,d).getTime()}:a.isFunction(h)?h:function(b){b=b?a.trim(String(b)):"";return d?b:b.toLowerCase()};a.each(b,function(d,b){r=""!==c?a.jgrid.getAccessor(b,c):b;void 0===r&&(r="");r=q(r,b);n.push({vSort:r,index:d})});a.isFunction(k)?n.sort(function(a,d){a=
a.vSort;d=d.vSort;return k.call(this,a,d,m)}):n.sort(function(a,d){a=a.vSort;d=d.vSort;return f._compare(a,d,m)});h=0;for(var v=b.length;h<v;)e=n[h].index,p.push(b[e]),h++;return p};this._getGroup=function(d,b,c,e,h){var g=[],k=null,l=null,p;a.each(f._getOrder(d,b,c,e,h),function(d,c){p=a.jgrid.getAccessor(c,b);null==p&&(p="");f._equals(l,p)||(l=p,null!==k&&g.push(k),k=f._group(b,p));k.items.push(c)});null!==k&&g.push(k);return g};this.ignoreCase=function(){d=!1;return f};this.useCase=function(){d=
...
else{a(this).empty().attr("tabindex","0");this.p=e;this.p.useProp=!!a.fn.prop;var k,l;if(0===this.p.colNames.length)for(k=0;k<this.p.colModel.length;k++)this.p.colNames[k]=this.p.colModel[k].label||this.p.colModel[k].name;if(this.p.colNames.length!==this.p.colModel.length)alert(a.jgrid.errors.model);else{var p=a("<div class='ui-jqgrid-view' role='grid'></div>");c=a.jgrid.msie;d.p.direction=a.trim(d.p.direction.toLowerCase());-1===a.inArray(d.p.direction,["ltr","rtl"])&&(d.p.direction="ltr");l=d.p.direction;
a(p).insertBefore(this);a(this).removeClass("scroll").appendTo(p);var m=a("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");a(m).attr({id:"gbox_"+this.id,dir:l}).insertBefore(p);a(p).attr("id","gview_"+this.id).appendTo(m);a("<div class='ui-widget-overlay jqgrid-overlay' id='lui_"+this.id+"'></div>").insertBefore(p);a("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'>"+this.p.loadtext+"</div>").insertBefore(p);a(this).attr({cellspacing:"0",cellpadding:"0",
...
1:0,H,G=[],I,F={},D,P,J=[],L=!0===d.p.altRows?d.p.altclass:"",ia;!0===d.p.subGrid&&(S=1,B=a.jgrid.getMethod("addSubGridCell"));l.repeatitems||(G=x(n));H=!1===d.p.keyName?a.isFunction(l.id)?l.id.call(d,b):l.id:d.p.keyName;n=-1===String(H).indexOf("[")?G.length?function(b,d){return a(H,b).text()||d}:function(b,d){return a(l.cell,b).eq(H).text()||d}:function(a,b){return a.getAttribute(H.replace(/[\[\]]/g,""))||b};d.p.userData={};d.p.page=r(a.jgrid.getXmlData(b,l.page),d.p.page);d.p.lastpage=r(a.jgrid.getXmlData(b,
...
[e]),c&&d.grid.populateVisible(),D()}}}},Q=function(b){a("#cb_"+a.jgrid.jqID(d.p.id),d.grid.hDiv)[d.p.useProp?"prop":"attr"]("checked",b);if(d.p.frozenColumns&&d.p.id+"_frozen")a("#cb_"+a.jgrid.jqID(d.p.id),d.grid.fhDiv)[d.p.useProp?"prop":"attr"]("checked",b)},V=function(b,c){var e="",f="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",h="",g,k,n,m,p=function(b){var c;a.isFunction(d.p.onPaging)&&(c=d.p.onPaging.call(d,b));if("stop"===c)return!1;
d.p.selrow=null;d.p.multiselect&&(d.p.selarrrow=[],Q(!1));d.p.savedRow=[];return!0};c+="_"+b;g="pg_"+b;k=b+"_left";n=b+"_center";m=b+"_right";a("#"+a.jgrid.jqID(b)).append("<div id='"+g+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;'><tbody><tr><td id='"+k+"' align='left'></td><td id='"+n+"' align='center' style='white-space:pre;'></td><td id='"+m+"' align='right'></td></tr></tbody></table></div>").attr("dir",
...
Math.floor((d.p.width-f)/2):Math.floor(d.p.width/3);d.p._nvtd[1]=0;f=null;a(".ui-pg-selbox",g).bind("change",function(){if(!p("records"))return!1;d.p.page=Math.round(d.p.rowNum*(d.p.page-1)/this.value-.5)+1;d.p.rowNum=this.value;d.p.pager&&a(".ui-pg-selbox",d.p.pager).val(this.value);d.p.toppager&&a(".ui-pg-selbox",d.p.toppager).val(this.value);M();return!1});!0===d.p.pgbuttons&&(a(".ui-pg-button",g).hover(function(){a(this).hasClass("ui-state-disabled")?this.style.cursor="default":(a(this).addClass("ui-state-hover"),
this.style.cursor="pointer")},function(){a(this).hasClass("ui-state-disabled")||(a(this).removeClass("ui-state-hover"),this.style.cursor="default")}),a("#first"+a.jgrid.jqID(c)+", #prev"+a.jgrid.jqID(c)+", #next"+a.jgrid.jqID(c)+", #last"+a.jgrid.jqID(c)).click(function(){if(a(this).hasClass("ui-state-disabled"))return!1;var b=r(d.p.page,1),e=r(d.p.lastpage,1),f=!1,h=!0,g=!0,k=!0,l=!0;0===e||1===e?l=k=g=h=!1:1<e&&1<=b?1===b?g=h=!1:b===e&&(l=k=!1):1<e&&0===b&&(l=k=!1,b=e-1);if(!p(this.id))return!1;
this.id==="first"+c&&h&&(d.p.page=1,f=!0);this.id==="prev"+c&&g&&(d.p.page=b-1,f=!0);this.id==="next"+c&&k&&(d.p.page=b+1,f=!0);this.id==="last"+c&&l&&(d.p.page=e,f=!0);f&&M();return!1}));!0===d.p.pginput&&a("input.ui-pg-input",g).keypress(function(b){if(13===(b.charCode||b.keyCode||0)){if(!p("user"))return!1;a(this).val(r(a(this).val(),1));d.p.page=0<a(this).val()?a(this).val():d.p.page;M();return!1}return this})},Y=function(b,c){var e,f="",h=d.p.colModel,g=!1,k;k=d.p.frozenColumns?c:d.grid.headers[b].el;
...
!1;break}"horizontal"===d.p.viewsortcols[1]&&(ga=" ui-i-asc",ba=" ui-i-desc");P=c?"class='ui-th-div-ie'":"";ga="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+ga+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+l+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ba+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+l+"'></span></span>");if(d.p.multiSort)for(ja=d.p.sortname.split(","),k=0;k<ja.length;k++)F=a.trim(ja[k]).split(" "),
...
(d.p.forceFit=!1);!0===d.p.shrinkToFit&&0<e&&(n=h.width-c*e-m,isNaN(d.p.height)||(n-=g,l=!0),b=0,a.each(d.p.colModel,function(a){!1!==this.hidden||this.fixed||(this.width=k=Math.round(n*this.width/(d.p.tblwidth-c*e-m)),b+=k,f=a)}),p=0,l?h.width-m-(b+c*e)!==g&&(p=h.width-m-(b+c*e)-g):l||1===Math.abs(h.width-m-(b+c*e))||(p=h.width-m-(b+c*e)),d.p.colModel[f].width+=p,d.p.tblwidth=b+p+c*e+m,d.p.tblwidth>d.p.width&&(d.p.colModel[f].width-=d.p.tblwidth-parseInt(d.p.width,10),d.p.tblwidth=d.p.width))})();
a(m).css("width",h.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+d.p.id+"'>&#160;</div>");a(p).css("width",h.width+"px");L=a("thead:first",d).get(0);var ea="";d.p.footerrow&&(ea+="<table role='presentation' style='width:"+d.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+l+"'>");var p=a("tr:first",L),ha="<tr class='jqgfirstrow' role='row' style='height:auto'>";d.p.disableClick=!1;
a("th",p).each(function(b){aa=d.p.colModel[b].width;void 0===d.p.colModel[b].resizable&&(d.p.colModel[b].resizable=!0);d.p.colModel[b].resizable?(U=document.createElement("span"),a(U).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+l).css("cursor","col-resize"),a(this).addClass(d.p.resizeclass)):U="";a(this).css("width",aa+"px").prepend(U);U=null;var c="";!0===d.p.colModel[b].hidden&&(a(this).css("display","none"),c="display:none;");ha+="<td role='gridcell' style='height:0px;width:"+
...
a(".ui-jqgrid-labels",h.hDiv).bind("selectstart",function(){return!1});a(document).bind("mouseup.jqGrid"+d.p.id,function(){return h.resizing?(h.dragEnd(),!1):!0});d.formatCol=q;d.sortData=J;d.updatepager=function(b,c){var e,f,h,g,k,l,n,m=d.p.pager||"",p=d.p.pager?"_"+d.p.pager.substr(1):"",q=d.p.toppager?"_"+d.p.toppager.substr(1):"";h=parseInt(d.p.page,10)-1;0>h&&(h=0);h*=parseInt(d.p.rowNum,10);k=h+d.p.reccount;if(d.p.scroll){e=a("tbody:first > tr:gt(0)",d.grid.bDiv);h=k-e.length;d.p.reccount=e.length;
if(e=e.outerHeight()||d.grid.prevRowHeight)f=h*e,n=parseInt(d.p.records,10)*e,a(">div:first",d.grid.bDiv).css({height:n}).children("div:first").css({height:f,display:f?"":"none"}),0===d.grid.bDiv.scrollTop&&1<d.p.page&&(d.grid.bDiv.scrollTop=d.p.rowNum*(d.p.page-1)*e);d.grid.bDiv.scrollLeft=d.grid.hDiv.scrollLeft}if(m+=d.p.toppager?(m?",":"")+d.p.toppager:"")n=a.jgrid.formatter.integer||{},e=r(d.p.page),f=r(d.p.lastpage),a(".selbox",m)[d.p.useProp?"prop":"attr"]("disabled",!1),!0===d.p.pginput&&(a(".ui-pg-input",
m).val(d.p.page),g=d.p.toppager?"#sp_1"+p+",#sp_1"+q:"#sp_1"+p,a(g).html(a.fmatter?a.fmatter.util.NumberFormat(d.p.lastpage,n):d.p.lastpage)),d.p.viewrecords&&(0===d.p.reccount?a(".ui-paging-info",m).html(d.p.emptyrecords):(g=h+1,l=d.p.records,a.fmatter&&(g=a.fmatter.util.NumberFormat(g,n),k=a.fmatter.util.NumberFormat(k,n),l=a.fmatter.util.NumberFormat(l,n)),a(".ui-paging-info",m).html(a.jgrid.format(d.p.recordtext,g,k,l)))),!0===d.p.pgbuttons&&(0>=e&&(e=f=0),1===e||0===e?(a("#first"+p+", #prev"+
p).addClass("ui-state-disabled").removeClass("ui-state-hover"),d.p.toppager&&a("#first_t"+q+", #prev_t"+q).addClass("ui-state-disabled").removeClass("ui-state-hover")):(a("#first"+p+", #prev"+p).removeClass("ui-state-disabled"),d.p.toppager&&a("#first_t"+q+", #prev_t"+q).removeClass("ui-state-disabled")),e===f||0===e?(a("#next"+p+", #last"+p).addClass("ui-state-disabled").removeClass("ui-state-hover"),d.p.toppager&&a("#next_t"+q+", #last_t"+q).addClass("ui-state-disabled").removeClass("ui-state-hover")):
...
a.jgrid.jqID(g.id))[this.p.useProp?"prop":"attr"]("checked",f),l&&(-1===h?a("#"+a.jgrid.jqID(b),"#"+a.jgrid.jqID(l)).addClass("ui-state-highlight"):a("#"+a.jgrid.jqID(b),"#"+a.jgrid.jqID(l)).removeClass("ui-state-highlight"),a("#jqg_"+a.jgrid.jqID(this.p.id)+"_"+a.jgrid.jqID(b),"#"+a.jgrid.jqID(l))[this.p.useProp?"prop":"attr"]("checked",f)),e&&(a(this).triggerHandler("jqGridSelectRow",[g.id,f,c]),this.p.onSelectRow&&this.p.onSelectRow.call(this,g.id,f,c))):"ui-subgrid"!==g.className&&(this.p.selrow!==
g.id?((f=a(this).jqGrid("getGridRowById",this.p.selrow))&&a(f).removeClass("ui-state-highlight").attr({"aria-selected":"false",tabindex:"-1"}),a(g).addClass("ui-state-highlight").attr({"aria-selected":"true",tabindex:"0"}),l&&(a("#"+a.jgrid.jqID(this.p.selrow),"#"+a.jgrid.jqID(l)).removeClass("ui-state-highlight"),a("#"+a.jgrid.jqID(b),"#"+a.jgrid.jqID(l)).addClass("ui-state-highlight")),f=!0):f=!1,this.p.selrow=g.id,e&&(a(this).triggerHandler("jqGridSelectRow",[g.id,f,c]),this.p.onSelectRow&&this.p.onSelectRow.call(this,
g.id,f,c)))))})},resetSelection:function(b){return this.each(function(){var e=this,c,f;!0===e.p.frozenColumns&&(f=e.p.id+"_frozen");if(void 0!==b){c=b===e.p.selrow?e.p.selrow:b;a("#"+a.jgrid.jqID(e.p.id)+" tbody:first tr#"+a.jgrid.jqID(c)).removeClass("ui-state-highlight").attr("aria-selected","false");f&&a("#"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(f)).removeClass("ui-state-highlight");if(e.p.multiselect){a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(e.p.id))[e.p.useProp?"prop":"attr"]("checked",
!1);if(f)a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(f))[e.p.useProp?"prop":"attr"]("checked",!1);e.setHeadCheckBox(!1);c=a.inArray(a.jgrid.jqID(c),e.p.selarrrow);-1!==c&&e.p.selarrrow.splice(c,1)}c=null}else e.p.multiselect?(a(e.p.selarrrow).each(function(b,c){a(a(e).jqGrid("getGridRowById",c)).removeClass("ui-state-highlight").attr("aria-selected","false");a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(c))[e.p.useProp?"prop":"attr"]("checked",!1);f&&(a("#"+a.jgrid.jqID(c),
"#"+a.jgrid.jqID(f)).removeClass("ui-state-highlight"),a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(f))[e.p.useProp?"prop":"attr"]("checked",!1))}),e.setHeadCheckBox(!1),e.p.selarrrow=[],e.p.selrow=null):e.p.selrow&&(a("#"+a.jgrid.jqID(e.p.id)+" tbody:first tr#"+a.jgrid.jqID(e.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected","false"),f&&a("#"+a.jgrid.jqID(e.p.selrow),"#"+a.jgrid.jqID(f)).removeClass("ui-state-highlight"),e.p.selrow=null);!0===e.p.cellEdit&&
...
a(this).removeClass(h)})}});return e},setRowData:function(b,e,c){var f,g=!0,d;this.each(function(){if(!this.grid)return!1;var h=this,k,l,p=typeof c,m={};l=a(this).jqGrid("getGridRowById",b);if(!l)return!1;if(e)try{if(a(this.p.colModel).each(function(c){f=this.name;var g=a.jgrid.getAccessor(e,f);void 0!==g&&(m[f]=this.formatter&&"string"===typeof this.formatter&&"date"===this.formatter?a.unformat.date.call(h,g,this):g,k=h.formatter(b,m[f],c,e,"edit"),d=this.title?{title:a.jgrid.stripHtml(k)}:{},!0===
h.p.treeGrid&&f===h.p.ExpandColumn?a("td[role='gridcell']:eq("+c+") > span:first",l).html(k).attr(d):a("td[role='gridcell']:eq("+c+")",l).html(k).attr(d))}),"local"===h.p.datatype){var r=a.jgrid.stripPref(h.p.idPrefix,b),q=h.p._index[r],n;if(h.p.treeGrid)for(n in h.p.treeReader)h.p.treeReader.hasOwnProperty(n)&&delete m[h.p.treeReader[n]];void 0!==q&&(h.p.data[q]=a.extend(!0,h.p.data[q],m));m=null}}catch(t){g=!1}g&&("string"===p?a(l).addClass(c):null!==c&&"object"===p&&a(l).css(c),a(h).triggerHandler("jqGridAfterGridComplete"))});
return g},addRowData:function(b,e,c,f){-1===["first","last","before","after"].indexOf(c)&&(c="last");var g=!1,d,h,k,l,p,m,r,q,n="",t,v,w,u,x,z;e&&(a.isArray(e)?(t=!0,v=b):(e=[e],t=!1),this.each(function(){var y=e.length;p=!0===this.p.rownumbers?1:0;k=!0===this.p.multiselect?1:0;l=!0===this.p.subGrid?1:0;t||(void 0!==b?b=String(b):(b=a.jgrid.randId(),!1!==this.p.keyName&&(v=this.p.keyName,void 0!==e[0][v]&&(b=e[0][v]))));w=this.p.altclass;for(var C=0,A="",E={},H=a.isFunction(this.p.afterInsertRow)?
!0:!1;C<y;){u=e[C];h=[];if(t){try{b=u[v],void 0===b&&(b=a.jgrid.randId())}catch(I){b=a.jgrid.randId()}A=!0===this.p.altRows?0===(this.rows.length-1)%2?w:"":""}z=b;b=this.p.idPrefix+b;p&&(n=this.formatCol(0,1,"",null,b,!0),h.push('<td role="gridcell" class="ui-state-default jqgrid-rownum" '+n+">0</td>"));k&&(q='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+b+'" class="cbox"/>',n=this.formatCol(p,1,"",null,b,!0),h.push('<td role="gridcell" '+n+">"+q+"</td>"));l&&h.push(a(this).jqGrid("addSubGridCell",
k+p,1));for(r=k+l+p;r<this.p.colModel.length;r++)x=this.p.colModel[r],d=x.name,E[d]=u[d],q=this.formatter(b,a.jgrid.getAccessor(u,d),r,u),n=this.formatCol(r,1,q,u,b,E),h.push('<td role="gridcell" '+n+">"+q+"</td>");h.unshift(this.constructTr(b,!1,A,E,u,!1));h.push("</tr>");h=h.join("");if(0===this.rows.length)a("table:first",this.grid.bDiv).append(h);else switch(c){case "last":a(this.rows[this.rows.length-1]).after(h);m=this.rows.length-1;break;case "first":a(this.rows[0]).after(h);m=1;break;case "after":if(m=
a(this).jqGrid("getGridRowById",f))a(this.rows[m.rowIndex+1]).hasClass("ui-subgrid")?(a(this.rows[m.rowIndex+1]).after(h),m=m.rowIndex+2):(a(m).after(h),m=m.rowIndex+1);break;case "before":if(m=a(this).jqGrid("getGridRowById",f))a(m).before(h),m=m.rowIndex-1}!0===this.p.subGrid&&a(this).jqGrid("addSubGrid",k+p,m);this.p.records++;this.p.reccount++;a(this).triggerHandler("jqGridAfterInsertRow",[b,u,u]);H&&this.p.afterInsertRow.call(this,b,u,u);C++;"local"===this.p.datatype&&(E[this.p.localReader.id]=
...
this,p;if(!l.grid||!l.p.footerrow||"set"===b&&f(e))return!1;d=!0;a(this.p.colModel).each(function(f){g=this.name;"set"===b?void 0!==e[g]&&(p=c?l.formatter("",e[g],f,e,"edit"):e[g],k=this.title?{title:a.jgrid.stripHtml(p)}:{},a("tr.footrow td:eq("+f+")",l.grid.sDiv).html(p).attr(k),d=!0):"get"===b&&(h[g]=a("tr.footrow td:eq("+f+")",l.grid.sDiv).html())})});return"get"===b?h:d},showHideCol:function(b,e){return this.each(function(){var c=this,f=!1,g=a.jgrid.cell_width?0:c.p.cellLayout,d;if(c.grid){"string"===
typeof b&&(b=[b]);e="none"!==e?"":"none";var h=""===e?!0:!1,k=c.p.groupHeader&&("object"===typeof c.p.groupHeader||a.isFunction(c.p.groupHeader));k&&a(c).jqGrid("destroyGroupHeader",!1);a(this.p.colModel).each(function(k){if(-1!==a.inArray(this.name,b)&&this.hidden===h){if(!0===c.p.frozenColumns&&!0===this.frozen)return!0;a("tr[role=row]",c.grid.hDiv).each(function(){a(this.cells[k]).css("display",e)});a(c.rows).each(function(){a(this).hasClass("jqgroup")||a(this.cells[k]).css("display",e)});c.p.footerrow&&
a("tr.footrow td:eq("+k+")",c.grid.sDiv).css("display",e);d=parseInt(this.width,10);c.p.tblwidth="none"===e?c.p.tblwidth-(d+g):c.p.tblwidth+(d+g);this.hidden=!h;f=!0;a(c).triggerHandler("jqGridShowHideCol",[h,this.name,k])}});!0===f&&(!0!==c.p.shrinkToFit||isNaN(c.p.height)||(c.p.tblwidth+=parseInt(c.p.scrollOffset,10)),a(c).jqGrid("setGridWidth",!0===c.p.shrinkToFit?c.p.tblwidth:c.p.width));k&&a(c).jqGrid("setGroupHeaders",c.p.groupHeader)}})},hideCol:function(b){return this.each(function(){a(this).jqGrid("showHideCol",
b,"none")})},showCol:function(b){return this.each(function(){a(this).jqGrid("showHideCol",b,"")})},remapColumns:function(b,e,c){function f(c){var d;d=c.length?a.makeArray(c):a.extend({},c);a.each(b,function(a){c[a]=d[this]})}function g(c,d){a(">tr"+(d||""),c).each(function(){var c=this,d=a.makeArray(c.cells);a.each(b,function(){var a=d[this];a&&c.appendChild(a)})})}var d=this.get(0);f(d.p.colModel);f(d.p.colNames);f(d.grid.headers);g(a("thead:first",d.grid.hDiv),c&&":not(.ui-jqgrid-labels)");e&&g(a("#"+
a.jgrid.jqID(d.p.id)+" tbody:first"),".jqgfirstrow, tr.jqgrow, tr.jqfoot");d.p.footerrow&&g(a("tbody:first",d.grid.sDiv));d.p.remapColumns&&(d.p.remapColumns.length?f(d.p.remapColumns):d.p.remapColumns=a.makeArray(b));d.p.lastsort=a.inArray(d.p.lastsort,b);d.p.treeGrid&&(d.p.expColInd=a.inArray(d.p.expColInd,b));a(d).triggerHandler("jqGridRemapColumns",[b,e,c])},setGridWidth:function(b,e){return this.each(function(){if(this.grid){var c=this,f,g=0,d=a.jgrid.cell_width?0:c.p.cellLayout,h,k=0,l=!1,p=
c.p.scrollOffset,m,r=0,q;"boolean"!==typeof e&&(e=c.p.shrinkToFit);if(!isNaN(b)){b=parseInt(b,10);c.grid.width=c.p.width=b;a("#gbox_"+a.jgrid.jqID(c.p.id)).css("width",b+"px");a("#gview_"+a.jgrid.jqID(c.p.id)).css("width",b+"px");a(c.grid.bDiv).css("width",b+"px");a(c.grid.hDiv).css("width",b+"px");c.p.pager&&a(c.p.pager).css("width",b+"px");c.p.toppager&&a(c.p.toppager).css("width",b+"px");!0===c.p.toolbar[0]&&(a(c.grid.uDiv).css("width",b+"px"),"both"===c.p.toolbar[1]&&a(c.grid.ubDiv).css("width",
b+"px"));c.p.footerrow&&a(c.grid.sDiv).css("width",b+"px");!1===e&&!0===c.p.forceFit&&(c.p.forceFit=!1);if(!0===e){a.each(c.p.colModel,function(){!1===this.hidden&&(f=this.widthOrg,g+=f+d,this.fixed?r+=f+d:k++)});if(0===k)return;c.p.tblwidth=g;m=b-d*k-r;!isNaN(c.p.height)&&(a(c.grid.bDiv)[0].clientHeight<a(c.grid.bDiv)[0].scrollHeight||1===c.rows.length)&&(l=!0,m-=p);var g=0,n=0<c.grid.cols.length;a.each(c.p.colModel,function(a){!1!==this.hidden||this.fixed||(f=this.widthOrg,f=Math.round(m*f/(c.p.tblwidth-
d*k-r)),0>f||(this.width=f,g+=f,c.grid.headers[a].width=f,c.grid.headers[a].el.style.width=f+"px",c.p.footerrow&&(c.grid.footers[a].style.width=f+"px"),n&&(c.grid.cols[a].style.width=f+"px"),h=a))});if(!h)return;q=0;l?b-r-(g+d*k)!==p&&(q=b-r-(g+d*k)-p):1!==Math.abs(b-r-(g+d*k))&&(q=b-r-(g+d*k));c.p.colModel[h].width+=q;c.p.tblwidth=g+q+d*k+r;c.p.tblwidth>b?(l=c.p.tblwidth-parseInt(b,10),c.p.tblwidth=b,f=c.p.colModel[h].width-=l):f=c.p.colModel[h].width;c.grid.headers[h].width=f;c.grid.headers[h].el.style.width=
f+"px";n&&(c.grid.cols[h].style.width=f+"px");c.p.footerrow&&(c.grid.footers[h].style.width=f+"px")}c.p.tblwidth&&(a("table:first",c.grid.bDiv).css("width",c.p.tblwidth+"px"),a("table:first",c.grid.hDiv).css("width",c.p.tblwidth+"px"),c.grid.hDiv.scrollLeft=c.grid.bDiv.scrollLeft,c.p.footerrow&&a("table:first",c.grid.sDiv).css("width",c.p.tblwidth+"px"))}}})},setGridHeight:function(b){return this.each(function(){if(this.grid){var e=a(this.grid.bDiv);e.css({height:b+(isNaN(b)?"":"px")});!0===this.p.frozenColumns&&
a("#"+a.jgrid.jqID(this.p.id)+"_frozen").parent().height(e.height()-16);this.p.height=b;this.p.scroll&&this.grid.populateVisible()}})},setCaption:function(b){return this.each(function(){this.p.caption=b;a("span.ui-jqgrid-title, span.ui-jqgrid-title-rtl",this.grid.cDiv).html(b);a(this.grid.cDiv).show();a(grid.cDiv).nextAll("div").removeClass("ui-corner-top")})},setLabel:function(b,e,c,f){return this.each(function(){var g=-1;if(this.grid&&void 0!==b&&(a(this.p.colModel).each(function(a){if(this.name===
b)return g=a,!1}),0<=g)){var d=a("tr.ui-jqgrid-labels th:eq("+g+")",this.grid.hDiv);if(e){var h=a(".s-ico",d);a("[id^=jqgh_]",d).empty().html(e).append(h);this.p.colNames[g]=e}c&&("string"===typeof c?a(d).addClass(c):a(d).css(c));"object"===typeof f&&a(d).attr(f)}})},setCell:function(b,e,c,f,g,d){return this.each(function(){var h=-1,k,l;if(this.grid&&(isNaN(e)?a(this.p.colModel).each(function(a){if(this.name===e)return h=a,!1}):h=parseInt(e,10),0<=h&&(k=a(this).jqGrid("getGridRowById",b)))){var p=
a("td:eq("+h+")",k);l=0;var m=[];if(""!==c||!0===d){for(;l<k.cells.length;)m.push(k.cells[l].innerHTML),l++;k=this.formatter(b,c,h,m,"edit");l=this.p.colModel[h].title?{title:a.jgrid.stripHtml(k)}:{};this.p.treeGrid&&0<a(".tree-wrap",a(p)).length?a("span",a(p)).html(k).attr(l):a(p).html(k).attr(l);"local"===this.p.datatype&&(k=this.p.colModel[h],c=k.formatter&&"string"===typeof k.formatter&&"date"===k.formatter?a.unformat.date.call(this,c,k):c,l=this.p._index[a.jgrid.stripPref(this.p.idPrefix,b)],
void 0!==l&&(this.p.data[l][k.name]=c))}"string"===typeof f?a(p).addClass(f):f&&a(p).css(f);"object"===typeof g&&a(p).attr(g)}})},getCell:function(b,e){var c=!1;this.each(function(){var f=-1;if(this.grid&&(isNaN(e)?a(this.p.colModel).each(function(a){if(this.name===e)return f=a,!1}):f=parseInt(e,10),0<=f)){var g=a(this).jqGrid("getGridRowById",b);if(g)try{c=a.unformat.call(this,a("td:eq("+f+")",g),{rowId:g.id,colModel:this.p.colModel[f]},f)}catch(d){c=a.jgrid.htmlDecode(a("td:eq("+f+")",g).html())}}});
return c},getCol:function(b,e,c){var f=[],g,d=0,h,k,l;e="boolean"!==typeof e?!1:e;void 0===c&&(c=!1);this.each(function(){var p=-1;if(this.grid&&(isNaN(b)?a(this.p.colModel).each(function(a){if(this.name===b)return p=a,!1}):p=parseInt(b,10),0<=p)){var m=this.rows.length,r=0,q=0;if(m&&0<m){for(;r<m;){if(a(this.rows[r]).hasClass("jqgrow")){try{g=a.unformat.call(this,a(this.rows[r].cells[p]),{rowId:this.rows[r].id,colModel:this.p.colModel[p]},p)}catch(n){g=a.jgrid.htmlDecode(this.rows[r].cells[p].innerHTML)}c?
...
a(h).html()}f.p.autoencode&&(d=a.jgrid.htmlDecode(d));k.edittype||(k.edittype="text");f.p.savedRow.push({id:b,ic:e,name:g,v:d});if("&nbsp;"===d||"&#160;"===d||1===d.length&&160===d.charCodeAt(0))d="";if(a.isFunction(f.p.formatCell)){var p=f.p.formatCell.call(f,f.rows[b].id,g,d,b,e);void 0!==p&&(d=p)}a(f).triggerHandler("jqGridBeforeEditCell",[f.rows[b].id,g,d,b,e]);a.isFunction(f.p.beforeEditCell)&&f.p.beforeEditCell.call(f,f.rows[b].id,g,d,b,e);var p=a.extend({},k.editoptions||{},{id:b+"_"+g,name:g,
...
c.keyCode&&!c.shiftKey)return a(f).jqGrid("saveCell",b,e),!1;if(9===c.keyCode){if(f.grid.hDiv.loading)return!1;c.shiftKey?a(f).jqGrid("prevCell",b,e):a(f).jqGrid("nextCell",b,e)}c.stopPropagation()});a(f).triggerHandler("jqGridAfterEditCell",[f.rows[b].id,g,d,b,e]);a.isFunction(f.p.afterEditCell)&&f.p.afterEditCell.call(f,f.rows[b].id,g,d,b,e)}f.p.iCol=e;f.p.iRow=b}}})},saveCell:function(b,e){return this.each(function(){var c=this,f;if(c.grid&&!0===c.p.cellEdit){f=1<=c.p.savedRow.length?0:null;if(null!==
f){var g=a("td:eq("+e+")",c.rows[b]),d,h,k=c.p.colModel[e],l=k.name,p=a.jgrid.jqID(l);switch(k.edittype){case "select":if(k.editoptions.multiple){var p=a("#"+b+"_"+p,c.rows[b]),m=[];(d=a(p).val())?d.join(","):d="";a("option:selected",p).each(function(b,c){m[b]=a(c).text()});h=m.join(",")}else d=a("#"+b+"_"+p+" option:selected",c.rows[b]).val(),h=a("#"+b+"_"+p+" option:selected",c.rows[b]).text();k.formatter&&(h=d);break;case "checkbox":var r=["Yes","No"];k.editoptions&&(r=k.editoptions.value.split(":"));
h=d=a("#"+b+"_"+p,c.rows[b]).is(":checked")?r[0]:r[1];break;case "password":case "text":case "textarea":case "button":h=d=a("#"+b+"_"+p,c.rows[b]).val();break;case "custom":try{if(k.editoptions&&a.isFunction(k.editoptions.custom_value)){d=k.editoptions.custom_value.call(c,a(".customelement",g),"get");if(void 0===d)throw"e2";h=d}else throw"e1";}catch(q){"e1"===q&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===q?a.jgrid.info_dialog(a.jgrid.errors.errcap,
"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,q.message,a.jgrid.edit.bClose)}}if(h!==c.p.savedRow[f].v){if(f=a(c).triggerHandler("jqGridBeforeSaveCell",[c.rows[b].id,l,d,b,e]))h=d=f;a.isFunction(c.p.beforeSaveCell)&&(f=c.p.beforeSaveCell.call(c,c.rows[b].id,l,d,b,e))&&(h=d=f);var n=a.jgrid.checkValues.call(c,d,e);if(!0===n[0]){f=a(c).triggerHandler("jqGridBeforeSubmitCell",[c.rows[b].id,l,d,b,e])||{};a.isFunction(c.p.beforeSubmitCell)&&
...
c);var v;e.p.searchurl&&(v=e.p.url,a(e).jqGrid("setGridParam",{url:e.p.searchurl}));var w="stop"===a(e).triggerHandler("jqGridToolbarBeforeSearch")?!0:!1;!w&&a.isFunction(b.beforeSearch)&&(w=b.beforeSearch.call(e));w||a(e).jqGrid("setGridParam",{search:q}).trigger("reloadGrid",[{page:1}]);v&&a(e).jqGrid("setGridParam",{url:v});a(e).triggerHandler("jqGridToolbarAfterSearch");a.isFunction(b.afterSearch)&&b.afterSearch.call(e)},f=function(d,f,g){a("#sopt_menu").remove();f=parseInt(f,10);g=parseInt(g,
...
a("#sopt_menu > li > a").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}).click(function(){var f=a(this).attr("value"),g=a(this).attr("oper");a(e).triggerHandler("jqGridToolbarSelectOper",[f,g,d]);a("#sopt_menu").hide();a(d).text(g).attr("soper",f);!0===b.autosearch&&(g=a(d).parent().next().children()[0],(a(g).val()||"nu"===f||"nn"===f)&&c())})},g=a("<tr class='ui-search-toolbar' role='row'></tr>"),d;a.each(e.p.colModel,function(f){var k=this,
...
k.name});l.attr&&a("select",n).attr(l.attr);a("select",n).css({width:"100%"});a.jgrid.bindEv.call(e,a("select",n)[0],l);!0===b.autosearch&&a("select",n).change(function(){c();return!1});d=null}},a.jgrid.ajaxOptions,e.p.ajaxSelectOptions||{}));else{var v,w,u;k.searchoptions?(v=void 0===k.searchoptions.value?"":k.searchoptions.value,w=void 0===k.searchoptions.separator?":":k.searchoptions.separator,u=void 0===k.searchoptions.delimiter?";":k.searchoptions.delimiter):k.editoptions&&(v=void 0===k.editoptions.value?
"":k.editoptions.value,w=void 0===k.editoptions.separator?":":k.editoptions.separator,u=void 0===k.editoptions.delimiter?";":k.editoptions.delimiter);if(v){var x=document.createElement("select");x.style.width="100%";a(x).attr({name:k.index||k.name,id:"gs_"+k.name});var z;if("string"===typeof v)for(p=v.split(u),z=0;z<p.length;z++)v=p[z].split(w),u=document.createElement("option"),u.value=v[0],u.innerHTML=v[1],x.appendChild(u);else if("object"===typeof v)for(z in v)v.hasOwnProperty(z)&&(u=document.createElement("option"),
u.value=z,u.innerHTML=v[z],x.appendChild(u));void 0!==l.defaultValue&&a(x).val(l.defaultValue);l.attr&&a(x).attr(l.attr);a(n).append(t);a.jgrid.bindEv.call(e,x,l);a("td:eq(1)",t).append(x);!0===b.autosearch&&a(x).change(function(){c();return!1})}}break;case "text":w=void 0!==l.defaultValue?l.defaultValue:"";a("td:eq(1)",t).append("<input type='text' style='width:100%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+k.name+"' value='"+w+"'/>");a(n).append(t);l.attr&&a("input",n).attr(l.attr);a.jgrid.bindEv.call(e,
...
l.custom_element.call(e,void 0!==l.defaultValue?l.defaultValue:"",l))x=a(x).addClass("customelement"),a(n).find("span[name='"+(k.index||k.name)+"']").append(x);else throw"e2";else throw"e1";}catch(y){"e1"===y&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===y?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===
...
null);a(this).append(b);a.isFunction(this.p.afterRedraw)&&this.p.afterRedraw.call(this,this.p)};this.createTableForGroup=function(b,c){var d=this,e,g=a("<table class='group ui-widget ui-widget-content' style='border:0px none;'><tbody></tbody></table>"),h="left";"rtl"===this.p.direction&&(h="right",g.attr("dir","rtl"));null===c&&g.append("<tr class='error' style='display:none;'><th colspan='5' class='ui-state-error' align='"+h+"'></th></tr>");var k=a("<tr></tr>");g.append(k);h=a("<th colspan='5' align='"+
h+"'></th>");k.append(h);if(!0===this.p.ruleButtons){var l=a("<select class='opsel'></select>");h.append(l);var k="",u;for(e=0;e<f.groupOps.length;e++)u=b.groupOp===d.p.groupOps[e].op?" selected='selected'":"",k+="<option value='"+d.p.groupOps[e].op+"'"+u+">"+d.p.groupOps[e].text+"</option>";l.append(k).bind("change",function(){b.groupOp=a(l).val();d.onchange()})}k="<span></span>";this.p.groupButton&&(k=a("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>"),k.bind("click",
function(){void 0===b.groups&&(b.groups=[]);b.groups.push({groupOp:f.groupOps[0].op,rules:[],groups:[]});d.reDraw();d.onchange();return!1}));h.append(k);if(!0===this.p.ruleButtons){var k=a("<input type='button' value='+' title='Add rule' class='add-rule ui-add'/>"),x;k.bind("click",function(){void 0===b.rules&&(b.rules=[]);for(e=0;e<d.p.columns.length;e++){var c=void 0===d.p.columns[e].search?!0:d.p.columns[e].search,f=!0===d.p.columns[e].hidden;if(!0===d.p.columns[e].searchoptions.searchhidden&&
c||c&&!f){x=d.p.columns[e];break}}c=x.searchoptions.sopt?x.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(x.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;b.rules.push({field:x.name,op:c[0],data:""});d.reDraw();return!1});h.append(k)}null!==c&&(k=a("<input type='button' value='-' title='Delete group' class='delete-group'/>"),h.append(k),k.bind("click",function(){for(e=0;e<c.groups.length;e++)if(c.groups[e]===b){c.groups.splice(e,1);break}d.reDraw();d.onchange();return!1}));if(void 0!==b.groups)for(e=
0;e<b.groups.length;e++)h=a("<tr></tr>"),g.append(h),k=a("<td class='first'></td>"),h.append(k),k=a("<td colspan='4'></td>"),k.append(this.createTableForGroup(b.groups[e],b)),h.append(k);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)g.append(this.createTableRowForRule(b.rules[e],b));return g};this.createTableRowForRule=function(b,c){var d=this,e=a("#"+a.jgrid.jqID(f.id))[0]||null,h=a("<tr></tr>"),g,l,w,u,x="",z;h.append("<td class='first'></td>");
var y=a("<td class='columns'></td>");h.append(y);var C=a("<select></select>"),A,E=[];y.append(C);C.bind("change",function(){b.field=a(C).val();w=a(this).parents("tr:first");for(g=0;g<d.p.columns.length;g++)if(d.p.columns[g].name===b.field){u=d.p.columns[g];break}if(u){u.searchoptions.id=a.jgrid.randId();k&&"text"===u.inputtype&&!u.searchoptions.size&&(u.searchoptions.size=10);var c=a.jgrid.createEl.call(e,u.inputtype,u.searchoptions,"",!0,d.p.ajaxSelectOptions||{},!0);a(c).addClass("input-elm");l=
u.searchoptions.sopt?u.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(u.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;var f="",h=0;E=[];a.each(d.p.ops,function(){E.push(this.oper)});for(g=0;g<l.length;g++)A=a.inArray(l[g],E),-1!==A&&(0===h&&(b.op=d.p.ops[A].oper),f+="<option value='"+d.p.ops[A].oper+"'>"+d.p.ops[A].text+"</option>",h++);a(".selectopts",w).empty().append(f);a(".selectopts",w)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(f=parseInt(a("select.selectopts",w)[0].offsetWidth,
10)+1,a(".selectopts",w).width(f),a(".selectopts",w).css("width","auto"));a(".data",w).empty().append(c);a.jgrid.bindEv.call(e,c,u.searchoptions);a(".input-elm",w).bind("change",function(c){c=c.target;b.data="SPAN"===c.nodeName.toUpperCase()&&u.searchoptions&&a.isFunction(u.searchoptions.custom_value)?u.searchoptions.custom_value.call(e,a(c).children(".customelement:first"),"get"):c.value;d.onchange()});setTimeout(function(){b.data=a(c).val();d.onchange()},0)}});for(g=y=0;g<d.p.columns.length;g++){z=
void 0===d.p.columns[g].search?!0:d.p.columns[g].search;var H=!0===d.p.columns[g].hidden;if(!0===d.p.columns[g].searchoptions.searchhidden&&z||z&&!H)z="",b.field===d.p.columns[g].name&&(z=" selected='selected'",y=g),x+="<option value='"+d.p.columns[g].name+"'"+z+">"+d.p.columns[g].label+"</option>"}C.append(x);x=a("<td class='operators'></td>");h.append(x);u=f.columns[y];u.searchoptions.id=a.jgrid.randId();k&&"text"===u.inputtype&&!u.searchoptions.size&&(u.searchoptions.size=10);y=a.jgrid.createEl.call(e,
u.inputtype,u.searchoptions,b.data,!0,d.p.ajaxSelectOptions||{},!0);if("nu"===b.op||"nn"===b.op)a(y).attr("readonly","true"),a(y).attr("disabled","true");var I=a("<select class='selectopts'></select>");x.append(I);I.bind("change",function(){b.op=a(I).val();w=a(this).parents("tr:first");var c=a(".input-elm",w)[0];"nu"===b.op||"nn"===b.op?(b.data="","SELECT"!==c.tagName.toUpperCase()&&(c.value=""),c.setAttribute("readonly","true"),c.setAttribute("disabled","true")):("SELECT"===c.tagName.toUpperCase()&&
(b.data=c.value),c.removeAttribute("readonly"),c.removeAttribute("disabled"));d.onchange()});l=u.searchoptions.sopt?u.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(u.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;x="";a.each(d.p.ops,function(){E.push(this.oper)});for(g=0;g<l.length;g++)A=a.inArray(l[g],E),-1!==A&&(z=b.op===d.p.ops[A].oper?" selected='selected'":"",x+="<option value='"+d.p.ops[A].oper+"'"+z+">"+d.p.ops[A].text+"</option>");I.append(x);x=a("<td class='data'></td>");h.append(x);
x.append(y);a.jgrid.bindEv.call(e,y,u.searchoptions);a(y).addClass("input-elm").bind("change",function(){b.data="custom"===u.inputtype?u.searchoptions.custom_value.call(e,a(this).children(".customelement:first"),"get"):a(this).val();d.onchange()});x=a("<td></td>");h.append(x);!0===this.p.ruleButtons&&(y=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),x.append(y),y.bind("click",function(){for(g=0;g<c.rules.length;g++)if(c.rules[g]===b){c.rules.splice(g,1);break}d.reDraw();
...
b.Find+"</a>",v="<a id='"+g+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+b.Reset+"</a>",w="",u="",x,z=!1,y=-1;b.showQuery&&(w="<a id='"+g+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");b.columns.length?(n=b.columns,y=0,x=n[0].index||n[0].name):a.each(n,function(a,b){b.label||(b.label=f.p.colNames[a]);if(!z){var c=
void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&!0===b.searchoptions.searchhidden&&c||c&&!d)z=!0,x=b.index||b.name,y=a}});if(!l&&x||!1===b.multipleSearch){var C="eq";0<=y&&n[y].searchoptions&&n[y].searchoptions.sopt?C=n[y].searchoptions.sopt[0]:b.sopt&&b.sopt.length&&(C=b.sopt[0]);l={groupOp:"AND",rules:[{field:x,op:C,data:""}]}}z=!1;b.tmplNames&&b.tmplNames.length&&(z=!0,u=b.tmplLabel,u+="<select class='ui-template'>",u+="<option value='default'>Default</option>",a.each(b.tmplNames,
function(a,b){u+="<option value='"+a+"'>"+b+"</option>"}),u+="</select>");r="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+g+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+r+"'>"+v+u+"</td><td class='EditButton' "+q+">"+w+t+"</td></tr></tbody></table>";g=a.jgrid.jqID(g);a("#"+g).jqFilter({columns:n,filter:b.loadDefaults?l:null,showQuery:b.showQuery,errorcheck:b.errorcheck,sopt:b.sopt,
groupButton:b.multipleGroup,ruleButtons:b.multipleSearch,afterRedraw:b.afterRedraw,ops:b.odata,operands:b.operands,ajaxSelectOptions:f.p.ajaxSelectOptions,groupOps:b.groupOps,onChange:function(){this.p.showQuery&&a(".query",this).html(this.toUserFriendlyString());a.isFunction(b.afterChange)&&b.afterChange.call(f,a("#"+g),b)},direction:f.p.direction,id:f.p.id});m.append(r);z&&b.tmplFilters&&b.tmplFilters.length&&a(".ui-template",m).bind("change",function(){var c=a(this).val();"default"===c?a("#"+g).jqFilter("addFilter",
...
form:"edit"},a.jgrid.edit,c||{});b[a(this)[0].p.id]=c;return this.each(function(){function f(){a(u+" > tbody > tr > td .FormElement").each(function(){var b=a(".customelement",this);if(b.length){var c=a(b[0]).attr("name");a.each(n.p.colModel,function(){if(this.name===c&&this.editoptions&&a.isFunction(this.editoptions.custom_value)){try{if(B[c]=this.editoptions.custom_value.call(n,a("#"+a.jgrid.jqID(c),u),"get"),void 0===B[c])throw"e1";}catch(b){"e1"===b?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+
a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,b.message,a.jgrid.edit.bClose)}return!0}})}else{switch(a(this).get(0).type){case "checkbox":a(this).is(":checked")?B[this.name]=a(this).val():(b=a(this).attr("offval"),B[this.name]=b);break;case "select-one":B[this.name]=a("option:selected",this).val();break;case "select-multiple":B[this.name]=a(this).val();B[this.name]=B[this.name]?B[this.name].join(","):"";a("option:selected",this).each(function(b,c){a(c).text()});
break;case "password":case "text":case "textarea":case "button":B[this.name]=a(this).val()}n.p.autoencode&&(B[this.name]=a.jgrid.htmlEncode(B[this.name]))}});return!0}function g(c,d,e,f){var g,h,k,l=0,m,p,q,r=[],t=!1,u="",x;for(x=1;x<=f;x++)u+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==c&&(t=a(d).jqGrid("getInd",c));a(d.p.colModel).each(function(x){g=this.name;p=(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";
if("cb"!==g&&"subgrid"!==g&&!0===this.editable&&"rn"!==g){if(!1===t)m="";else if(g===d.p.ExpandColumn&&!0===d.p.treeGrid)m=a("td[role='gridcell']:eq("+x+")",d.rows[t]).text();else{try{m=a.unformat.call(d,a("td[role='gridcell']:eq("+x+")",d.rows[t]),{rowId:c,colModel:this},x)}catch(E){m=this.edittype&&"textarea"===this.edittype?a("td[role='gridcell']:eq("+x+")",d.rows[t]).text():a("td[role='gridcell']:eq("+x+")",d.rows[t]).html()}if(!m||"&nbsp;"===m||"&#160;"===m||1===m.length&&160===m.charCodeAt(0))m=
""}var y=a.extend({},this.editoptions||{},{id:g,name:g,rowId:c}),w=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),z=parseInt(w.rowpos,10)||l+1,A=parseInt(2*(parseInt(w.colpos,10)||1),10);"_empty"===c&&y.defaultValue&&(m=a.isFunction(y.defaultValue)?y.defaultValue.call(n):y.defaultValue);this.edittype||(this.edittype="text");n.p.autoencode&&(m=a.jgrid.htmlDecode(m));q=a.jgrid.createEl.call(n,this.edittype,y,m,!1,a.extend({},a.jgrid.ajaxOptions,d.p.ajaxSelectOptions||
{}));if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)b[n.p.id]._savedData[g]=m;a(q).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(q).addClass("ui-widget-content ui-corner-all");k=a(e).find("tr[rowpos="+z+"]");if(w.rowabove){var C=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+w.rowcontent+"</td></tr>");a(e).append(C);C[0].rp=z}0===k.length&&(k=a("<tr "+p+" rowpos='"+z+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(k).append(u),a(e).append(k),
k[0].rp=z);a("td:eq("+(A-2)+")",k[0]).html(void 0===w.label?d.p.colNames[x]:w.label);a("td:eq("+(A-1)+")",k[0]).append(w.elmprefix).append(q).append(w.elmsuffix);"custom"===this.edittype&&a.isFunction(y.custom_value)&&y.custom_value.call(n,a("#"+g,"#"+v),"set",m);a.jgrid.bindEv.call(n,q,y);r[l]=x;l++}});0<l&&(x=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+d.p.id+"_id' value='"+
c+"'/></td></tr>"),x[0].rp=l+999,a(e).append(x),b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)&&(b[n.p.id]._savedData[d.p.id+"_id"]=c);return r}function d(c,d,e){var f,g=0,h,k,l,m,p;if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)b[n.p.id]._savedData={},b[n.p.id]._savedData[d.p.id+"_id"]=c;var q=d.p.colModel;if("_empty"===c)a(q).each(function(){f=this.name;l=a.extend({},this.editoptions||{});(k=a("#"+a.jgrid.jqID(f),"#"+e))&&k.length&&null!==k[0]&&(m="","custom"===this.edittype&&a.isFunction(l.custom_value)?
...
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,p.message,a.jgrid.edit.bClose)}}g++}}),0<g&&a("#id_g",u).val(c))}}function h(){a.each(n.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&B.hasOwnProperty(b.name)&&""===B[b.name]&&(B[b.name]="null")})}function k(){var e,f=[!0,"",""],g={},k=n.p.prmNames,l,m,p,q,r,y=a(n).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+v),D]);y&&"object"===typeof y&&(B=y);a.isFunction(b[n.p.id].beforeCheckValues)&&(y=b[n.p.id].beforeCheckValues.call(n,
B,a("#"+v),D))&&"object"===typeof y&&(B=y);for(p in B)if(B.hasOwnProperty(p)&&(f=a.jgrid.checkValues.call(n,B[p],p),!1===f[0]))break;h();f[0]&&(g=a(n).triggerHandler("jqGridAddEditClickSubmit",[b[n.p.id],B,D]),void 0===g&&a.isFunction(b[n.p.id].onclickSubmit)&&(g=b[n.p.id].onclickSubmit.call(n,b[n.p.id],B,D)||{}),f=a(n).triggerHandler("jqGridAddEditBeforeSubmit",[B,a("#"+v),D]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].beforeSubmit)&&(f=b[n.p.id].beforeSubmit.call(n,B,a("#"+v),D)));
if(f[0]&&!b[n.p.id].processing){b[n.p.id].processing=!0;a("#sData",u+"_2").addClass("ui-state-active");p=b[n.p.id].url||a(n).jqGrid("getGridParam","editurl");m=k.oper;l="clientArray"===p?n.p.keyName:k.id;B[m]="_empty"===a.trim(B[n.p.id+"_id"])?k.addoper:k.editoper;B[m]!==k.addoper?B[l]=B[n.p.id+"_id"]:void 0===B[l]&&(B[l]=B[n.p.id+"_id"]);delete B[n.p.id+"_id"];B=a.extend(B,b[n.p.id].editData,g);if(!0===n.p.treeGrid)for(r in B[m]===k.addoper&&(q=a(n).jqGrid("getGridParam","selrow"),B["adjacency"===
n.p.treeGridModel?n.p.treeReader.parent_id_field:"parent_id"]=q),n.p.treeReader)n.p.treeReader.hasOwnProperty(r)&&(g=n.p.treeReader[r],!B.hasOwnProperty(g)||B[m]===k.addoper&&"parent_id_field"===r||delete B[g]);B[l]=a.jgrid.stripPref(n.p.idPrefix,B[l]);r=a.extend({url:p,type:b[n.p.id].mtype,data:a.isFunction(b[n.p.id].serializeEditData)?b[n.p.id].serializeEditData.call(n,B):B,complete:function(g,h){var p;a("#sData",u+"_2").removeClass("ui-state-active");B[l]=n.p.idPrefix+B[l];300<=g.status&&304!==
g.status?(f[0]=!1,f[1]=a(n).triggerHandler("jqGridAddEditErrorTextFormat",[g,D]),a.isFunction(b[n.p.id].errorTextFormat)?f[1]=b[n.p.id].errorTextFormat.call(n,g,D):f[1]=h+" Status: '"+g.statusText+"'. Error code: "+g.status):(f=a(n).triggerHandler("jqGridAddEditAfterSubmit",[g,B,D]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].afterSubmit)&&(f=b[n.p.id].afterSubmit.call(n,g,B,D)));if(!1===f[0])a("#FormError>td",u).html(f[1]),a("#FormError",u).show();else if(n.p.autoencode&&a.each(B,function(b,
c){B[b]=a.jgrid.htmlDecode(c)}),B[m]===k.addoper?(f[2]||(f[2]=a.jgrid.randId()),null==B[l]||"_empty"===B[l]?B[l]=f[2]:f[2]=B[l],b[n.p.id].reloadAfterSubmit?a(n).trigger("reloadGrid"):!0===n.p.treeGrid?a(n).jqGrid("addChildNode",f[2],q,B):a(n).jqGrid("addRowData",f[2],B,c.addedrow),b[n.p.id].closeAfterAdd?(!0!==n.p.treeGrid&&a(n).jqGrid("setSelection",f[2]),a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,
formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form})):b[n.p.id].clearAfterAdd&&d("_empty",n,v)):(b[n.p.id].reloadAfterSubmit?(a(n).trigger("reloadGrid"),b[n.p.id].closeAfterEdit||setTimeout(function(){a(n).jqGrid("setSelection",B[l])},1E3)):!0===n.p.treeGrid?a(n).jqGrid("setTreeRow",B[l],B):a(n).jqGrid("setRowData",B[l],B),b[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,
formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form})),a.isFunction(b[n.p.id].afterComplete)&&(e=g,setTimeout(function(){a(n).triggerHandler("jqGridAddEditAfterComplete",[e,B,a("#"+v),D]);b[n.p.id].afterComplete.call(n,e,B,a("#"+v),D);e=null},500)),b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)if(a("#"+v).data("disabled",!1),"_empty"!==b[n.p.id]._savedData[n.p.id+"_id"])for(p in b[n.p.id]._savedData)b[n.p.id]._savedData.hasOwnProperty(p)&&B[p]&&(b[n.p.id]._savedData[p]=B[p]);b[n.p.id].processing=
!1;try{a(":input:visible","#"+v)[0].focus()}catch(r){}}},a.jgrid.ajaxOptions,b[n.p.id].ajaxEditOptions);r.url||b[n.p.id].useDataProxy||(a.isFunction(n.p.dataProxy)?b[n.p.id].useDataProxy=!0:(f[0]=!1,f[1]+=" "+a.jgrid.errors.nourl));f[0]&&(b[n.p.id].useDataProxy?(g=n.p.dataProxy.call(n,r,"set_"+n.p.id),void 0===g&&(g=[!0,""]),!1===g[0]?(f[0]=!1,f[1]=g[1]||"Error deleting the selected row!"):(r.data.oper===k.addoper&&b[n.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+
a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form}),r.data.oper===k.editoper&&b[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form}))):"clientArray"===r.url?(b[n.p.id].reloadAfterSubmit=!1,B=r.data,r.complete({status:200,statusText:""},
"")):a.ajax(r))}!1===f[0]&&(a("#FormError>td",u).html(f[1]),a("#FormError",u).show())}function l(a,b){var c=!1,d;for(d in a)if(a.hasOwnProperty(d)&&a[d]!=b[d]){c=!0;break}return c}function p(){var c=!0;a("#FormError",u).hide();b[n.p.id].checkOnUpdate&&(B={},f(),N=l(B,b[n.p.id]._savedData))&&(a("#"+v).data("disabled",!0),a(".confirm","#"+x.themodal).show(),c=!1);return c}function m(){var b;if("_empty"!==e&&void 0!==n.p.savedRow&&0<n.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(b=0;b<
n.p.savedRow.length;b++)if(n.p.savedRow[b].id==e){a(n).jqGrid("restoreRow",e);break}}function r(b,c){var d=c[1].length-1;0===b?a("#pData",u+"_2").addClass("ui-state-disabled"):void 0!==c[1][b-1]&&a("#"+a.jgrid.jqID(c[1][b-1])).hasClass("ui-state-disabled")?a("#pData",u+"_2").addClass("ui-state-disabled"):a("#pData",u+"_2").removeClass("ui-state-disabled");b===d?a("#nData",u+"_2").addClass("ui-state-disabled"):void 0!==c[1][b+1]&&a("#"+a.jgrid.jqID(c[1][b+1])).hasClass("ui-state-disabled")?a("#nData",
u+"_2").addClass("ui-state-disabled"):a("#nData",u+"_2").removeClass("ui-state-disabled")}function q(){var b=a(n).jqGrid("getDataIDs"),c=a("#id_g",u).val();return[a.inArray(c,b),b]}var n=this;if(n.grid&&e){var t=n.p.id,v="FrmGrid_"+t,w="TblGrid_"+t,u="#"+a.jgrid.jqID(w),x={themodal:"editmod"+t,modalhead:"edithd"+t,modalcontent:"editcnt"+t,scrollelm:v},z=a.isFunction(b[n.p.id].beforeShowForm)?b[n.p.id].beforeShowForm:!1,y=a.isFunction(b[n.p.id].afterShowForm)?b[n.p.id].afterShowForm:!1,C=a.isFunction(b[n.p.id].beforeInitData)?
b[n.p.id].beforeInitData:!1,A=a.isFunction(b[n.p.id].onInitializeForm)?b[n.p.id].onInitializeForm:!1,E=!0,H=1,I=0,B,N,D,v=a.jgrid.jqID(v);"new"===e?(e="_empty",D="add",c.caption=b[n.p.id].addCaption):(c.caption=b[n.p.id].editCaption,D="edit");c.recreateForm||a(n).data("formProp")&&a.extend(b[a(this)[0].p.id],a(n).data("formProp"));var M=!0;c.checkOnUpdate&&c.jqModal&&!c.modal&&(M=!1);var Q=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",E=isNaN(b[a(this)[0].p.id].datawidth)?
b[a(this)[0].p.id].datawidth:b[a(this)[0].p.id].datawidth+"px",Q=a("<form name='FormPost' id='"+v+"' class='FormGrid' onSubmit='return false;' style='width:"+E+";overflow:auto;position:relative;height:"+Q+";'></form>").data("disabled",!1),V=a("<table id='"+w+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>");a(n.p.colModel).each(function(){var a=this.formoptions;H=Math.max(H,a?a.colpos||0:0);I=Math.max(I,a?a.rowpos||0:0)});a(Q).append(V);E=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+
2*H+"'></td></tr>");E[0].rp=0;a(V).append(E);E=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*H+"'>"+b[n.p.id].topinfo+"</td></tr>");E[0].rp=0;a(V).append(E);E=a(n).triggerHandler("jqGridAddEditBeforeInitData",[Q,D]);void 0===E&&(E=!0);E&&C&&(E=C.call(n,Q,D));if(!1!==E){m();var E=(C="rtl"===n.p.direction?!0:!1)?"nData":"pData",Y=C?"pData":"nData";g(e,n,V,H);var E="<a id='"+E+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
...
(C?Y+E:E+Y)+"</td><td class='EditButton'>"+J+fa+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+b[n.p.id].bottominfo+"</td></tr>"),w=w+"</tbody></table>";if(0<I){var W=[];a.each(a(V)[0].rows,function(a,b){W[a]=b});W.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(W,function(b,c){a("tbody",V).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(t);var L=!1;!0===c.closeOnEscape&&(c.closeOnEscape=!1,L=!0);w=a("<div></div>").append(Q).append(w);a.jgrid.createModal(x,
w,b[a(this)[0].p.id],"#gview_"+a.jgrid.jqID(n.p.id),a("#gbox_"+a.jgrid.jqID(n.p.id))[0]);C&&(a("#pData, #nData",u+"_2").css("float","right"),a(".EditButton",u+"_2").css("text-align","left"));b[n.p.id].topinfo&&a(".tinfo",u).show();b[n.p.id].bottominfo&&a(".binfo",u+"_2").show();w=w=null;a("#"+a.jgrid.jqID(x.themodal)).keydown(function(d){var e=d.target;if(!0===a("#"+v).data("disabled"))return!1;if(!0===b[n.p.id].savekey[0]&&d.which===b[n.p.id].savekey[1]&&"TEXTAREA"!==e.tagName)return a("#sData",
u+"_2").trigger("click"),!1;if(27===d.which){if(!p())return!1;L&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:c.gbox,jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1}if(!0===b[n.p.id].navkeys[0]){if("_empty"===a("#id_g",u).val())return!0;if(d.which===b[n.p.id].navkeys[1])return a("#pData",u+"_2").trigger("click"),!1;if(d.which===b[n.p.id].navkeys[2])return a("#nData",u+"_2").trigger("click"),!1}});c.checkOnUpdate&&
...
"left","ui-icon-close"],c.closeicon);!0===c.saveicon[0]&&a("#sData",u+"_2").addClass("right"===c.saveicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+c.saveicon[2]+"'></span>");!0===c.closeicon[0]&&a("#cData",u+"_2").addClass("right"===c.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+c.closeicon[2]+"'></span>");if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)J="<a id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+
c.bYes+"</a>",Y="<a id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bNo+"</a>",fa="<a id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bExit+"</a>",w=c.zIndex||999,w++,a("<div class='"+c.overlayClass+" jqgrid-overlay confirm' style='z-index:"+w+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(w+1)+"'>"+c.saveData+"<br/><br/>"+J+Y+fa+"</div>").insertAfter("#"+v),a("#sNew","#"+a.jgrid.jqID(x.themodal)).click(function(){k();
...
jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a(n).triggerHandler("jqGridAddEditInitializeForm",[a("#"+v),D]);A&&A.call(n,a("#"+v),D);"_empty"!==e&&b[n.p.id].viewPagerButtons?a("#pData,#nData",u+"_2").show():a("#pData,#nData",u+"_2").hide();a(n).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+v),D]);z&&z.call(n,a("#"+v),D);a("#"+a.jgrid.jqID(x.themodal)).data("onClose",b[n.p.id].onClose);a.jgrid.viewModal("#"+
...
a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a(".fm-button","#"+a.jgrid.jqID(x.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",u+"_2").click(function(){B={};a("#FormError",u).hide();f();"_empty"===B[n.p.id+"_id"]?k():!0===c.checkOnSubmit?(N=l(B,b[n.p.id]._savedData))?
(a("#"+v).data("disabled",!0),a(".confirm","#"+a.jgrid.jqID(x.themodal)).show()):k():k();return!1});a("#cData",u+"_2").click(function(){if(!p())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a("#nData",u+"_2").click(function(){if(!p())return!1;a("#FormError",u).hide();var b=q();b[0]=parseInt(b[0],10);if(-1!==b[0]&&b[1][b[0]+
...
p,n="ViewTbl_"+p,t={themodal:"viewmod"+p,modalhead:"viewhd"+p,modalcontent:"viewcnt"+p,scrollelm:m},v=a.isFunction(b[l.p.id].beforeInitData)?b[l.p.id].beforeInitData:!1,w=!0,u=1,x=0;c.recreateForm||a(l).data("viewProp")&&a.extend(b[a(this)[0].p.id],a(l).data("viewProp"));var z=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",y=isNaN(b[a(this)[0].p.id].datawidth)?b[a(this)[0].p.id].datawidth:b[a(this)[0].p.id].datawidth+"px",q=a("<form name='FormPost' id='"+
q+"' class='FormGrid' style='width:"+y+";overflow:auto;position:relative;height:"+z+";'></form>"),C=a("<table id='"+n+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");a(l.p.colModel).each(function(){var a=this.formoptions;u=Math.max(u,a?a.colpos||0:0);x=Math.max(x,a?a.rowpos||0:0)});a(q).append(C);v&&(w=v.call(l,q),void 0===w&&(w=!0));if(!1!==w){g(e,l,C,u);n="rtl"===l.p.direction?!0:!1;v="<a id='"+(n?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
w="<a id='"+(n?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";z="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+c.bClose+"</a>";if(0<x){var A=[];a.each(a(C)[0].rows,function(a,b){A[a]=b});A.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(A,function(b,c){a("tbody",C).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(p);q=a("<div></div>").append(q).append("<table border='0' class='EditTable' id='"+
r+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+c.labelswidth+"'>"+(n?w+v:v+w)+"</td><td class='EditButton'>"+z+"</td></tr></tbody></table>");a.jgrid.createModal(t,q,c,"#gview_"+a.jgrid.jqID(l.p.id),a("#gview_"+a.jgrid.jqID(l.p.id))[0]);n&&(a("#pData, #nData","#"+r+"_2").css("float","right"),a(".EditButton","#"+r+"_2").css("text-align","left"));c.viewPagerButtons||a("#pData, #nData","#"+r+"_2").hide();q=null;a("#"+t.themodal).keydown(function(d){if(27===d.which)return b[l.p.id].closeOnEscape&&
...
modal:b[f.p.id].modal})}else{var u=isNaN(b[f.p.id].dataheight)?b[f.p.id].dataheight:b[f.p.id].dataheight+"px",x=isNaN(c.datawidth)?c.datawidth:c.datawidth+"px",v="<div id='"+v+"' class='formdata' style='width:"+x+";overflow:auto;position:relative;height:"+u+";'><table class='DelTable'><tbody>",v=v+"<tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>",v=v+("<tr id='DelData' style='display:none'><td >"+e+"</td></tr>"),v=v+('<tr><td class="delmsg" style="white-space:pre;">'+
...
a.jgrid.jqID(k);a.jgrid.createModal(w,v,c,"#gview_"+a.jgrid.jqID(f.p.id),a("#gview_"+a.jgrid.jqID(f.p.id))[0]);h&&(p=h.call(f,a(v)),void 0===p&&(p=!0));if(!1===p)return;a(".fm-button","#"+m+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});c.delicon=a.extend([!0,"left","ui-icon-scissors"],b[f.p.id].delicon);c.cancelicon=a.extend([!0,"left","ui-icon-cancel"],b[f.p.id].cancelicon);!0===c.delicon[0]&&a("#dData","#"+m+"_2").addClass("right"===
...
a.jgrid.jqID(p.p.id),a("#gbox_"+a.jgrid.jqID(p.p.id))[0],!0));var r=1,q,n=function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},t=function(){a(this).removeClass("ui-state-hover")};c.cloneToTop&&p.p.toppager&&(r=2);for(q=0;q<r;q++){var v=a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),w,u;0===q?(w=b,u=p.p.id,w===p.p.toppager&&(u+="_top",r=1)):(w=p.p.toppager,u=
p.p.id+"_top");"rtl"===p.p.direction&&a(v).attr("dir","rtl").css("float","right");c.add&&(g=g||{},m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.addicon+"'></span>"+c.addtext+"</div>"),a("tr",v).append(m),a(m,v).attr({title:c.addtitle||"",id:g.id||"add_"+u}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(c.addfunc)?c.addfunc.call(p):a(p).jqGrid("editGridRow","new",g));return!1}).hover(n,t),m=null);c.edit&&(m=
a("<td class='ui-pg-button ui-corner-all'></td>"),f=f||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.editicon+"'></span>"+c.edittext+"</div>"),a("tr",v).append(m),a(m,v).attr({title:c.edittitle||"",id:f.id||"edit_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var b=p.p.selrow;b?a.isFunction(c.editfunc)?c.editfunc.call(p,b):a(p).jqGrid("editGridRow",b,f):(a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+a.jgrid.jqID(p.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,
t),m=null);c.view&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),k=k||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.viewicon+"'></span>"+c.viewtext+"</div>"),a("tr",v).append(m),a(m,v).attr({title:c.viewtitle||"",id:k.id||"view_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var b=p.p.selrow;b?a.isFunction(c.viewfunc)?c.viewfunc.call(p,b):a(p).jqGrid("viewGridRow",b,k):(a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+a.jgrid.jqID(p.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,
t),m=null);c.del&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),d=d||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.delicon+"'></span>"+c.deltext+"</div>"),a("tr",v).append(m),a(m,v).attr({title:c.deltitle||"",id:d.id||"del_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var b;p.p.multiselect?(b=p.p.selarrrow,0===b.length&&(b=null)):b=p.p.selrow;b?a.isFunction(c.delfunc)?c.delfunc.call(p,b):a(p).jqGrid("delGridRow",b,d):(a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+
a.jgrid.jqID(p.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,t),m=null);(c.add||c.edit||c.del||c.view)&&a("tr",v).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");c.search&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),h=h||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.searchicon+"'></span>"+c.searchtext+"</div>"),a("tr",v).append(m),a(m,v).attr({title:c.searchtitle||"",id:h.id||"search_"+u}).click(function(){a(this).hasClass("ui-state-disabled")||
(a.isFunction(c.searchfunc)?c.searchfunc.call(p,h):a(p).jqGrid("searchGrid",h));return!1}).hover(n,t),h.showOnLoad&&!0===h.showOnLoad&&a(m,v).click(),m=null);c.refresh&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.refreshicon+"'></span>"+c.refreshtext+"</div>"),a("tr",v).append(m),a(m,v).attr({title:c.refreshtitle||"",id:"refresh_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){a.isFunction(c.beforeRefresh)&&c.beforeRefresh.call(p);
...
"11px";a("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+m+";visibility:hidden;' ></div>");m=a(v).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(w+"_"+c.position,w).append(v);p.p._nvtd&&(m>p.p._nvtd[0]&&(a(w+"_"+c.position,w).width(m),p.p._nvtd[0]=m),p.p._nvtd[1]=m);v=m=m=null;this.nav=!0}}}})},navButtonAdd:function(b,c){c=a.extend({caption:"newButton",title:"",buttonicon:"ui-icon-newwin",onClickButton:null,position:"last",cursor:"pointer"},
...
(function(a){a.extend(a.jgrid,{template:function(b){var e=a.makeArray(arguments).slice(1),c,f=e.length;null==b&&(b="");return b.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?\}/g,function(b,d){var h,k;if(!isNaN(parseInt(d,10)))return e[parseInt(d,10)];for(c=0;c<f;c++)if(a.isArray(e[c]))for(h=e[c],k=h.length;k--;)if(d===h[k].nm)return h[k].v})}});a.jgrid.extend({groupingSetup:function(){return this.each(function(){var b,e,c=this.p.colModel,f=this.p.groupingView,g=function(){return""};if(null===
f||"object"!==typeof f&&!a.isFunction(f))this.p.grouping=!1;else if(f.groupField.length){void 0===f.visibiltyOnNextGrouping&&(f.visibiltyOnNextGrouping=[]);f.lastvalues=[];f._locgr||(f.groups=[]);f.counters=[];for(b=0;b<f.groupField.length;b++)f.groupOrder[b]||(f.groupOrder[b]="asc"),f.groupText[b]||(f.groupText[b]="{0}"),"boolean"!==typeof f.groupColumnShow[b]&&(f.groupColumnShow[b]=!0),"boolean"!==typeof f.groupSummary[b]&&(f.groupSummary[b]=!1),f.groupSummaryPos[b]||(f.groupSummaryPos[b]="footer"),
!0===f.groupColumnShow[b]?(f.visibiltyOnNextGrouping[b]=!0,a(this).jqGrid("showCol",f.groupField[b])):(f.visibiltyOnNextGrouping[b]=a("#"+a.jgrid.jqID(this.p.id+"_"+f.groupField[b])).is(":visible"),a(this).jqGrid("hideCol",f.groupField[b]));f.summary=[];f.hideFirstGroupCol&&(f.formatDisplayField[0]=function(a){return a});b=0;for(e=c.length;b<e;b++)f.hideFirstGroupCol&&!c[b].hidden&&f.groupField[0]===c[b].name&&(c[b].formatter=g),c[b].summaryType&&(c[b].summaryDivider?f.summary.push({nm:c[b].name,
st:c[b].summaryType,v:"",sd:c[b].summaryDivider,vd:"",sr:c[b].summaryRound,srt:c[b].summaryRoundType||"round"}):f.summary.push({nm:c[b].name,st:c[b].summaryType,v:"",sr:c[b].summaryRound,srt:c[b].summaryRoundType||"round"}))}else this.p.grouping=!1})},groupingPrepare:function(b,e){this.each(function(){var c=this.p.groupingView,f=this,g,d=c.groupField.length,h,k,l,p=0,m=function(){a.isFunction(this.st)?this.v=this.st.call(f,this.v,this.nm,b):(this.v=a(f).jqGrid("groupingCalculations.handler",this.st,
this.v,this.nm,this.sr,this.srt,b),"avg"===this.st.toLowerCase()&&this.sd&&(this.vd=a(f).jqGrid("groupingCalculations.handler",this.st,this.vd,this.sd,this.sr,this.srt,b)))};for(g=0;g<d;g++)h=c.groupField[g],l=c.displayField[g],k=b[h],l=null==l?null:b[l],null==l&&(l=k),void 0!==k&&(0===e?(c.groups.push({idx:g,dataIndex:h,value:k,displayValue:l,startRow:e,cnt:1,summary:[]}),c.lastvalues[g]=k,c.counters[g]={cnt:1,pos:c.groups.length-1,summary:a.extend(!0,[],c.summary)}):"object"===typeof k||(a.isArray(c.isInTheSameGroup)&&
a.isFunction(c.isInTheSameGroup[g])?c.isInTheSameGroup[g].call(f,c.lastvalues[g],k,g,c):c.lastvalues[g]===k)?1===p?(c.groups.push({idx:g,dataIndex:h,value:k,displayValue:l,startRow:e,cnt:1,summary:[]}),c.lastvalues[g]=k,c.counters[g]={cnt:1,pos:c.groups.length-1,summary:a.extend(!0,[],c.summary)}):(c.counters[g].cnt+=1,c.groups[c.counters[g].pos].cnt=c.counters[g].cnt):(c.groups.push({idx:g,dataIndex:h,value:k,displayValue:l,startRow:e,cnt:1,summary:[]}),c.lastvalues[g]=k,p=1,c.counters[g]={cnt:1,
pos:c.groups.length-1,summary:a.extend(!0,[],c.summary)}),a.each(c.counters[g].summary,m),c.groups[c.counters[g].pos].summary=c.counters[g].summary)});return this},groupingToggle:function(b){this.each(function(){var e=this.p.groupingView,c=b.split("_"),f=parseInt(c[c.length-2],10);c.splice(c.length-2,2);var g=c.join("_"),c=e.minusicon,e=e.plusicon,d=a("#"+a.jgrid.jqID(b)),d=d.length?d[0].nextSibling:null,h=a("#"+a.jgrid.jqID(b)+" span.tree-wrap-"+this.p.direction),k=function(b){b=a.map(b.split(" "),
function(a){if(a.substring(0,g.length+1)===g+"_")return parseInt(a.substring(g.length+1),10)});return 0<b.length?b[0]:void 0},l,p,m=!1,r=this.p.frozenColumns?this.p.id+"_frozen":!1,q=(l=r?a("#"+a.jgrid.jqID(b),"#"+a.jgrid.jqID(r)):!1)&&l.length?l[0].nextSibling:null;if(h.hasClass(c)){if(d)for(;d;){l=k(d.className);if(void 0!==l&&l<=f)break;a(d).hide();d=d.nextSibling;r&&(a(q).hide(),q=q.nextSibling)}h.removeClass(c).addClass(e);m=!0}else{if(d)for(p=void 0;d;){l=k(d.className);void 0===p&&(p=void 0===
l);if(void 0!==l){if(l<=f)break;l===f+1&&(a(d).show().find(">td>span.tree-wrap-"+this.p.direction).removeClass(c).addClass(e),r&&a(q).show().find(">td>span.tree-wrap-"+this.p.direction).removeClass(c).addClass(e))}else p&&(a(d).show(),r&&a(q).show());d=d.nextSibling;r&&(q=q.nextSibling)}h.removeClass(e).addClass(c)}a(this).triggerHandler("jqGridGroupingClickGroup",[b,m]);a.isFunction(this.p.onClickGroup)&&this.p.onClickGroup.call(this,b,m)});return!1},groupingRender:function(b,e,c,f){return this.each(function(){function g(a,
b,c){var d=!1;if(0===b)d=c[a];else{var e=c[a].idx;if(0===e)d=c[a];else for(;0<=a;a--)if(c[a].idx===e-b){d=c[a];break}}return d}function d(b,c,d,f){var k=g(b,c,d),l=h.p.colModel,n=k.cnt;b="";var m,p,q;for(m=f;m<e;m++)p="<td "+h.formatCol(m,1,"")+">&#160;</td>",q="{0}",a.each(k.summary,function(){var b;if(this.nm===l[m].name){l[m].summaryTpl&&(q=l[m].summaryTpl);"string"===typeof this.st&&"avg"===this.st.toLowerCase()&&(this.sd&&this.vd?this.v/=this.vd:this.v&&0<n&&(this.v/=n));try{this.groupCount=
k.cnt,this.groupIndex=k.dataIndex,this.groupValue=k.value,b=h.formatter("",this.v,m,this)}catch(c){b=this.v}p="<td "+h.formatCol(m,1,"")+">"+a.jgrid.format(q,b)+"</td>";return!1}}),b+=p;return b}var h=this,k=h.p.groupingView,l="",p="",m,r,q=k.groupCollapse?k.plusicon:k.minusicon,n,t=[],v=k.groupField.length,q=q+(" tree-wrap-"+h.p.direction);a.each(h.p.colModel,function(a,b){var c;for(c=0;c<v;c++)if(k.groupField[c]===b.name){t[c]=a;break}});var w=0,u=a.makeArray(k.groupSummary);u.reverse();a.each(k.groups,
function(g,z){if(k._locgr&&!(z.startRow+z.cnt>(c-1)*f&&z.startRow<c*f))return!0;w++;r=h.p.id+"ghead_"+z.idx;m=r+"_"+g;p="<span style='cursor:pointer;' class='ui-icon "+q+"' onclick=\"jQuery('#"+a.jgrid.jqID(h.p.id).replace("\\","\\\\")+"').jqGrid('groupingToggle','"+m+"');return false;\"></span>";try{a.isArray(k.formatDisplayField)&&a.isFunction(k.formatDisplayField[z.idx])?(z.displayValue=k.formatDisplayField[z.idx].call(h,z.displayValue,z.value,h.p.colModel[t[z.idx]],z.idx,k),n=z.displayValue):
n=h.formatter(m,z.displayValue,t[z.idx],z.value)}catch(y){n=z.displayValue}l+='<tr id="'+m+'"'+(k.groupCollapse&&0<z.idx?' style="display:none;" ':" ")+'role="row" class="ui-widget-content jqgroup ui-row-'+h.p.direction+" "+r+'"><td style="padding-left:'+12*z.idx+'px;"';var C=a.isFunction(k.groupText[z.idx])?k.groupText[z.idx].call(h,n,z.cnt,z.summary):a.jgrid.template(k.groupText[z.idx],n,z.cnt,z.summary);"string"!==typeof C&&"number"!==typeof C&&(C=n);if("header"===k.groupSummaryPos[z.idx]){var A=
h.p.multiselect?' colspan="2"':"";l+=A+">"+p+C+"</td>";l+=d(g,0,k.groups,!1===k.groupColumnShow[z.idx]?""===A?2:3:""===A?1:2)}else l+=' colspan="'+(!1===k.groupColumnShow[z.idx]?e-1:e)+'">'+p+C+"</td>";l+="</tr>";if(v-1===z.idx){var C=k.groups[g+1],E,A=0;E=z.startRow;var H=void 0!==C?C.startRow:k.groups[g].startRow+k.groups[g].cnt;k._locgr&&(A=(c-1)*f,A>z.startRow&&(E=A));for(;E<H&&b[E-A];E++)l+=b[E-A].join("");if("header"!==k.groupSummaryPos[z.idx]){var I;if(void 0!==C){for(I=0;I<k.groupField.length&&
C.dataIndex!==k.groupField[I];I++);w=k.groupField.length-I}for(C=0;C<w;C++)u[C]&&(A="",k.groupCollapse&&!k.showSummaryOnHide&&(A=' style="display:none;"'),l+="<tr"+A+' jqfootlevel="'+(z.idx-C)+'" role="row" class="ui-widget-content jqfoot ui-row-'+h.p.direction+'">',l+=d(g,C,k.groups,0),l+="</tr>");w=I}}});a("#"+a.jgrid.jqID(h.p.id)+" tbody:first").append(l);l=null})},groupingGroupBy:function(b,e){return this.each(function(){"string"===typeof b&&(b=[b]);var c=this.p.groupingView;this.p.grouping=!0;
c._locgr=!1;void 0===c.visibiltyOnNextGrouping&&(c.visibiltyOnNextGrouping=[]);var f;for(f=0;f<c.groupField.length;f++)!c.groupColumnShow[f]&&c.visibiltyOnNextGrouping[f]&&a(this).jqGrid("showCol",c.groupField[f]);for(f=0;f<b.length;f++)c.visibiltyOnNextGrouping[f]=a("#"+a.jgrid.jqID(this.p.id)+"_"+a.jgrid.jqID(b[f])).is(":visible");this.p.groupingView=a.extend(this.p.groupingView,e||{});c.groupField=b;a(this).trigger("reloadGrid")})},groupingRemove:function(b){return this.each(function(){void 0===
b&&(b=!0);this.p.grouping=!1;if(!0===b){var e=this.p.groupingView,c;for(c=0;c<e.groupField.length;c++)!e.groupColumnShow[c]&&e.visibiltyOnNextGrouping[c]&&a(this).jqGrid("showCol",e.groupField);a("tr.jqgroup, tr.jqfoot","#"+a.jgrid.jqID(this.p.id)+" tbody:first").remove();a("tr.jqgrow:hidden","#"+a.jgrid.jqID(this.p.id)+" tbody:first").show()}else a(this).trigger("reloadGrid")})},groupingCalculations:{handler:function(a,e,c,f,g,d){var h={sum:function(){return parseFloat(e||0)+parseFloat(d[c]||0)},
min:function(){return""===e?parseFloat(d[c]||0):Math.min(parseFloat(e),parseFloat(d[c]||0))},max:function(){return""===e?parseFloat(d[c]||0):Math.max(parseFloat(e),parseFloat(d[c]||0))},count:function(){""===e&&(e=0);return d.hasOwnProperty(c)?e+1:0},avg:function(){return h.sum()}};if(!h[a])throw"jqGrid Grouping No such method: "+a;a=h[a]();null!=f&&("fixed"===g?a=a.toFixed(f):(f=Math.pow(10,f),a=Math.round(a*f)/f));return a}}})})(jQuery);
...
afterrestorefunc:null,restoreAfterError:!0,mtype:"POST",saveui:"enable",savetext:a.jgrid.defaults.savetext||"Saving..."},a.jgrid.inlineEdit,l),p=!1,m=this[0],r,q={},n={},t={},v,w,u;if(!m.grid)return p;u=a(m).jqGrid("getInd",b,!0);if(!1===u)return p;k=a.isFunction(l.beforeSaveRow)?l.beforeSaveRow.call(m,l,b):void 0;void 0===k&&(k=!0);if(k){k=a(u).attr("editable");l.url=l.url||m.p.editurl;if("1"===k){var x;a('td[role="gridcell"]',u).each(function(b){x=m.p.colModel[b];r=x.name;if("cb"!==r&&"subgrid"!==
...
"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}w=a.jgrid.checkValues.call(m,q[r],b);if(!1===w[0])return!1;m.p.autoencode&&(q[r]=a.jgrid.htmlEncode(q[r]));"clientArray"!==l.url&&x.editoptions&&!0===x.editoptions.NullIfEmpty&&""===q[r]&&(t[r]="null")}});if(!1===w[0]){try{var z=a(m).jqGrid("getGridRowById",b),y=a.jgrid.findPos(z);a.jgrid.info_dialog(a.jgrid.errors.errcap,w[1],a.jgrid.edit.bClose,{left:y[0],
top:y[1]+a(z).outerHeight()})}catch(C){alert(w[1])}return p}k=m.p.prmNames;z=b;y=!1===m.p.keyName?k.id:m.p.keyName;q&&(q[k.oper]=k.editoper,void 0===q[y]||""===q[y]?q[y]=b:u.id!==m.p.idPrefix+q[y]&&(k=a.jgrid.stripPref(m.p.idPrefix,b),void 0!==m.p._index[k]&&(m.p._index[q[y]]=m.p._index[k],delete m.p._index[k]),b=m.p.idPrefix+q[y],a(u).attr("id",b),m.p.selrow===z&&(m.p.selrow=b),a.isArray(m.p.selarrrow)&&(k=a.inArray(z,m.p.selarrrow),0<=k&&(m.p.selarrrow[k]=b)),m.p.multiselect&&(k="jqg_"+m.p.id+"_"+
b,a("input.cbox",u).attr("id",k).attr("name",k))),void 0===m.p.inlineData&&(m.p.inlineData={}),q=a.extend({},q,m.p.inlineData,l.extraparam));if("clientArray"===l.url){q=a.extend({},q,n);m.p.autoencode&&a.each(q,function(b,c){q[b]=a.jgrid.htmlDecode(c)});k=a(m).jqGrid("setRowData",b,q);a(u).attr("editable","0");for(y=0;y<m.p.savedRow.length;y++)if(String(m.p.savedRow[y].id)===String(z)){v=y;break}0<=v&&m.p.savedRow.splice(v,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[b,k,q,l]);a.isFunction(l.aftersavefunc)&&
l.aftersavefunc.call(m,b,k,q,l);p=!0;a(u).removeClass("jqgrid-new-row").unbind("keydown")}else a(m).jqGrid("progressBar",{method:"show",loadtype:l.saveui,htmlcontent:l.savetext}),t=a.extend({},q,t),t[y]=a.jgrid.stripPref(m.p.idPrefix,t[y]),a.ajax(a.extend({url:l.url,data:a.isFunction(m.p.serializeRowData)?m.p.serializeRowData.call(m,t):t,type:l.mtype,async:!1,complete:function(c,d){a(m).jqGrid("progressBar",{method:"hide",loadtype:l.saveui,htmlcontent:l.savetext});if("success"===d){var e=!0,f;f=a(m).triggerHandler("jqGridInlineSuccessSaveRow",
[c,b,l]);a.isArray(f)||(f=[!0,q]);f[0]&&a.isFunction(l.successfunc)&&(f=l.successfunc.call(m,c));a.isArray(f)?(e=f[0],q=f[1]||q):e=f;if(!0===e){m.p.autoencode&&a.each(q,function(b,c){q[b]=a.jgrid.htmlDecode(c)});q=a.extend({},q,n);a(m).jqGrid("setRowData",b,q);a(u).attr("editable","0");for(e=0;e<m.p.savedRow.length;e++)if(String(m.p.savedRow[e].id)===String(b)){v=e;break}0<=v&&m.p.savedRow.splice(v,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[b,c,q,l]);a.isFunction(l.aftersavefunc)&&l.aftersavefunc.call(m,
b,c,q,l);p=!0;a(u).removeClass("jqgrid-new-row").unbind("keydown")}else a(m).triggerHandler("jqGridInlineErrorSaveRow",[b,c,d,null,l]),a.isFunction(l.errorfunc)&&l.errorfunc.call(m,b,c,d,null),!0===l.restoreAfterError&&a(m).jqGrid("restoreRow",b,l.afterrestorefunc)}},error:function(c,d,e){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();a(m).triggerHandler("jqGridInlineErrorSaveRow",[b,c,d,e,l]);if(a.isFunction(l.errorfunc))l.errorfunc.call(m,b,c,d,e);else{c=c.responseText||c.statusText;try{a.jgrid.info_dialog(a.jgrid.errors.errcap,
...
1+(parseInt(c.p.page,10)-1)*parseInt(c.p.rowNum,10))});b._update_&&b._update_.apply(this,[f,g])},a("tbody:first",c).sortable(b),a.isFunction(a.fn.disableSelection)&&a("tbody:first>.jqgrow",c).disableSelection())})},gridDnD:function(b){return this.each(function(){function c(){var b=a.data(f,"dnd");a("tr.jqgrow:not(.ui-draggable)",f).draggable(a.isFunction(b.drag)?b.drag.call(a(f),b):b.drag)}var f=this,g,d;if(f.grid&&!f.p.treeGrid&&a.fn.draggable&&a.fn.droppable)if(void 0===a("#jqgrid_dnd")[0]&&a("body").append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>"),
...
if(e.length)for(k in e)e.hasOwnProperty(k)&&(e[k][g]=parseInt(e[k][g],10)-h)}}})},addChildNode:function(b,e,c,f){var g=this[0];if(c){var d=g.p.treeReader.expanded_field,h=g.p.treeReader.leaf_field,k=g.p.treeReader.level_field,l=g.p.treeReader.parent_id_field,p=g.p.treeReader.left_field,m=g.p.treeReader.right_field,r=g.p.treeReader.loaded,q,n,t,v,w;q=0;var u=e,x;void 0===f&&(f=!1);if(null==b){w=g.p.data.length-1;if(0<=w)for(;0<=w;)q=Math.max(q,parseInt(g.p.data[w][g.p.localReader.id],10)),w--;b=q+
1}var z=a(g).jqGrid("getInd",e);x=!1;void 0===e||null===e||""===e?(u=e=null,q="last",v=g.p.tree_root_level,w=g.p.data.length+1):(q="after",n=g.p._index[e],t=g.p.data[n],e=t[g.p.localReader.id],v=parseInt(t[k],10)+1,w=a(g).jqGrid("getFullTreeNode",t),w.length?(u=w=w[w.length-1][g.p.localReader.id],w=a(g).jqGrid("getInd",u)+1):w=a(g).jqGrid("getInd",e)+1,t[h]&&(x=!0,t[d]=!0,a(g.rows[z]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(g.p.treeIcons.leaf+
" tree-leaf").addClass(g.p.treeIcons.minus+" tree-minus"),g.p.data[n][h]=!1,t[r]=!0));n=w+1;void 0===c[d]&&(c[d]=!1);void 0===c[r]&&(c[r]=!1);c[k]=v;void 0===c[h]&&(c[h]=!0);"adjacency"===g.p.treeGridModel&&(c[l]=e);if("nested"===g.p.treeGridModel){var y;if(null!==e){h=parseInt(t[m],10);k=a.jgrid.from(g.p.data);k=k.greaterOrEquals(m,h,{stype:"integer"});k=k.select();if(k.length)for(y in k)k.hasOwnProperty(y)&&(k[y][p]=k[y][p]>h?parseInt(k[y][p],10)+2:k[y][p],k[y][m]=k[y][m]>=h?parseInt(k[y][m],10)+
2:k[y][m]);c[p]=h;c[m]=h+1}else{h=parseInt(a(g).jqGrid("getCol",m,!1,"max"),10);k=a.jgrid.from(g.p.data).greater(p,h,{stype:"integer"}).select();if(k.length)for(y in k)k.hasOwnProperty(y)&&(k[y][p]=parseInt(k[y][p],10)+2);k=a.jgrid.from(g.p.data).greater(m,h,{stype:"integer"}).select();if(k.length)for(y in k)k.hasOwnProperty(y)&&(k[y][m]=parseInt(k[y][m],10)+2);c[p]=h+1;c[m]=h+2}}if(null===e||a(g).jqGrid("isNodeLoaded",t)||x)a(g).jqGrid("addRowData",b,c,q,u),a(g).jqGrid("setTreeNode",w,n);t&&!t[d]&&

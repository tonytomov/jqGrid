...
function(g,z){if(k._locgr&&!(z.startRow+z.cnt>(c-1)*f&&z.startRow<c*f))return!0;w++;r=h.p.id+"ghead_"+z.idx;m=r+"_"+g;p="<span style='cursor:pointer;' class='ui-icon "+q+"' onclick=\"jQuery('#"+a.jgrid.jqID(h.p.id)+"').jqGrid('groupingToggle','"+m+"');return false;\"></span>";try{a.isArray(k.formatDisplayField)&&a.isFunction(k.formatDisplayField[z.idx])?(z.displayValue=k.formatDisplayField[z.idx].call(h,z.displayValue,z.value,h.p.colModel[t[z.idx]],z.idx,k),n=z.displayValue):n=h.formatter(m,z.displayValue,
t[z.idx],z.value)}catch(y){n=z.displayValue}l+='<tr id="'+m+'"'+(k.groupCollapse&&0<z.idx?' style="display:none;" ':" ")+'role="row" class="ui-widget-content jqgroup ui-row-'+h.p.direction+" "+r+'"><td style="padding-left:'+12*z.idx+'px;"';var C=a.isFunction(k.groupText[z.idx])?k.groupText[z.idx].call(h,n,z.cnt,z.summary):a.jgrid.template(k.groupText[z.idx],n,z.cnt,z.summary);"string"!==typeof C&&"number"!==typeof C&&(C=n);if("header"===k.groupSummaryPos[z.idx]){var A=h.p.multiselect?' colspan="2"':
"";l+=A+">"+p+C+"</td>";l+=d(g,0,k.groups,!1===k.groupColumnShow[z.idx]?""===A?2:3:""===A?1:2)}else l+=' colspan="'+(!1===k.groupColumnShow[z.idx]?e-1:e)+'">'+p+C+"</td>";l+="</tr>";if(v-1===z.idx){var C=k.groups[g+1],E,A=0;E=z.startRow;var H=void 0!==C?C.startRow:k.groups[g].startRow+k.groups[g].cnt;k._locgr&&(A=(c-1)*f,A>z.startRow&&(E=A));for(;E<H&&b[E-A];E++)l+=b[E-A].join("");if("header"!==k.groupSummaryPos[z.idx]){var I;if(void 0!==C){for(I=0;I<k.groupField.length&&C.dataIndex!==k.groupField[I];I++);
w=k.groupField.length-I}for(C=0;C<w;C++)u[C]&&(A="",k.groupCollapse&&!k.showSummaryOnHide&&(A=' style="display:none;"'),l+="<tr"+A+' jqfootlevel="'+(z.idx-C)+'" role="row" class="ui-widget-content jqfoot ui-row-'+h.p.direction+'">',l+=d(g,C,k.groups,0),l+="</tr>");w=I}}});a("#"+a.jgrid.jqID(h.p.id)+" tbody:first").append(l);l=null})},groupingGroupBy:function(b,e){return this.each(function(){"string"===typeof b&&(b=[b]);var c=this.p.groupingView;this.p.grouping=!0;c._locgr=!1;void 0===c.visibiltyOnNextGrouping&&

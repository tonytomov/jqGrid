...
return c};this._getOrder=function(b,c,e,h,g,k){var n=[],p=[],m="a"===e?1:-1,r,q;void 0===h&&(h="text");q="float"===h||"number"===h||"currency"===h||"numeric"===h?function(a){a=parseFloat(String(a).replace(l,""));return isNaN(a)?Number.NEGATIVE_INFINITY:a}:"int"===h||"integer"===h?function(a){return a?parseFloat(String(a).replace(l,"")):Number.NEGATIVE_INFINITY}:"date"===h||"datetime"===h?function(d){return a.jgrid.parseDate(g,d).getTime()}:a.isFunction(h)?h:function(b){b=b?a.trim(String(b)):"";return d?
b:b.toLowerCase()};a.each(b,function(d,b){r=""!==c?a.jgrid.getAccessor(b,c):b;void 0===r&&(r="");r=q(r,b);p.push({vSort:r,index:d})});a.isFunction(k)?p.sort(function(a,d){a=a.vSort;d=d.vSort;return k.call(this,a,d,m)}):p.sort(function(a,d){a=a.vSort;d=d.vSort;return f._compare(a,d,m)});h=0;for(var u=b.length;h<u;)e=p[h].index,n.push(b[e]),h++;return n};this._getGroup=function(d,b,c,e,h){var g=[],k=null,l=null,p;a.each(f._getOrder(d,b,c,e,h),function(d,c){p=a.jgrid.getAccessor(c,b);null==p&&(p="");
f._equals(l,p)||(l=p,null!==k&&g.push(k),k=f._group(b,p));k.items.push(c)});null!==k&&g.push(k);return g};this.ignoreCase=function(){d=!1;return f};this.useCase=function(){d=!0;return f};this.trim=function(){h=!0;return f};this.noTrim=function(){h=!1;return f};this.execute=function(){var d=k,b=[];if(null===d)return f;a.each(g,function(){eval(d)&&b.push(this)});g=b;return f};this.data=function(){return g};this.select=function(d){f._performSort();if(!f._hasData())return[];f.execute();if(a.isFunction(d)){var b=
...
a(c).outerHeight()||h.prevRowHeight:h.prevRowHeight}catch(k){f=h.prevRowHeight}if(f){h.prevRowHeight=f;var l=e.rowNum;c=h.scrollTop=h.bDiv.scrollTop;var p=Math.round(b.position().top)-c,n=p+b.height();f*=l;var m,r,q;n<d&&0>=p&&(void 0===e.lastpage||(parseInt((n+c+f-1)/f,10)||0)<=e.lastpage)&&(r=parseInt((d-n+f-1)/f,10)||1,0<=n||2>r||!0===e.scroll?(m=(Math.round((n+c)/f)||0)+1,p=-1):p=1);0<p&&(m=(parseInt(c/f,10)||0)+1,r=(parseInt((c+d)/f,10)||0)+2-m,q=!0);!r||e.lastpage&&(m>e.lastpage||1===e.lastpage||
...
a(this.rows).slice(1).remove():(c=0<this.rows.length?this.rows[0]:null,a(this.firstChild).empty().append(c));d&&this.p.scroll&&(a(this.grid.bDiv.firstChild).css({height:"auto"}),a(this.grid.bDiv.firstChild.firstChild).css({height:0,display:"none"}),0!==this.grid.bDiv.scrollTop&&(this.grid.bDiv.scrollTop=0));!0===b&&this.p.treeGrid&&(this.p.data=[],this.p._index={})},H=function(){var b=d.p,c=b.data,e=c.length,f,h,k,g,l,n=b.localReader,p=b.colModel,m=n.cell,r=(!0===b.multiselect?1:0)+(!0===b.subGrid?
1:0)+(!0===b.rownumbers?1:0),q=b.scroll?a.jgrid.randId():1,u,s,t;if("local"===b.datatype&&!0===n.repeatitems)for(u=B(r),s=x("local"),k=!1===b.keyIndex?a.isFunction(n.id)?n.id.call(d,c):n.id:b.keyIndex,b=0;b<e;b++){h=c[b];f=a.jgrid.getAccessor(h,k);void 0===f&&("number"===typeof k&&null!=p[k+r]&&(f=a.jgrid.getAccessor(h,p[k+r].name)),void 0===f&&(f=q+b,m&&(g=a.jgrid.getAccessor(h,m)||h,f=null!=g&&void 0!==g[k]?g[k]:f)));g={};g[n.id]=f;m&&(h=a.jgrid.getAccessor(h,m)||h);t=a.isArray(h)?u:s;for(f=0;f<
t.length;f++)l=a.jgrid.getAccessor(h,t[f]),g[p[f+r].name]=l;a.extend(!0,c[b],g)}},z=function(){var b=d.p.data.length,c,e,f;c=!1===d.p.keyName||!0===d.p.loadonce?d.p.localReader.id:d.p.keyName;d.p._index=[];for(e=0;e<b;e++)f=a.jgrid.getAccessor(d.p.data[e],c),void 0===f&&(f=String(e+1)),d.p._index[f]=e},D=function(b,c,e,f,h,k){var g="-1",l="",n;c=c?"display:none;":"";e="ui-widget-content jqgrow ui-row-"+d.p.direction+(e?" "+e:"")+(k?" ui-state-highlight":"");k=a(d).triggerHandler("jqGridRowAttr",[f,
h,b]);"object"!==typeof k&&(k=a.isFunction(d.p.rowattr)?d.p.rowattr.call(d,f,h,b):"string"===typeof d.p.rowattr&&null!=a.jgrid.rowattr&&a.isFunction(a.jgrid.rowattr[d.p.rowattr])?a.jgrid.rowattr[d.p.rowattr].call(d,f,h,b):{});if(!a.isEmptyObject(k)){k.hasOwnProperty("id")&&(b=k.id,delete k.id);k.hasOwnProperty("tabindex")&&(g=k.tabindex,delete k.tabindex);k.hasOwnProperty("style")&&(c+=k.style,delete k.style);k.hasOwnProperty("class")&&(e+=" "+k["class"],delete k["class"]);try{delete k.role}catch(p){}for(n in k)k.hasOwnProperty(n)&&
(l+=" "+n+"="+k[n])}return'<tr role="row" id="'+b+'" tabindex="'+g+'" class="'+e+'"'+(""===c?"":' style="'+c+'"')+l+">"},C=function(b,c,e,f,h){var k=new Date,g="local"!==d.p.datatype&&d.p.loadonce||"xmlstring"===d.p.datatype,l=d.p.xmlReader,n="local"===d.p.datatype?"local":"xml";g&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;if(a.isXMLDoc(b)){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(v.call(d,!1,!0),e=1);var p=a(d),m,q,t=0,z,K=!0===d.p.multiselect?1:0,y=0,Z,C=!0===d.p.rownumbers?
1:0,H,I=[],O,A={},F,J,E=[],M=!0===d.p.altRows?d.p.altclass:"",ha;!0===d.p.subGrid&&(y=1,Z=a.jgrid.getMethod("addSubGridCell"));l.repeatitems||(I=x(n));H=!1===d.p.keyName?a.isFunction(l.id)?l.id.call(d,b):l.id:d.p.keyName;n=-1===String(H).indexOf("[")?I.length?function(b,d){return a(H,b).text()||d}:function(b,d){return a(l.cell,b).eq(H).text()||d}:function(a,b){return a.getAttribute(H.replace(/[\[\]]/g,""))||b};d.p.userData={};d.p.page=r(a.jgrid.getXmlData(b,l.page),d.p.page);d.p.lastpage=r(a.jgrid.getXmlData(b,
...
(V=!0===d.p.groupingView.groupCollapse,S=a.jgrid.getMethod("groupingPrepare"));for(;G<R;){F=b[G];J=n(F,N+G);J=d.p.idPrefix+J;m=0===e?0:e+1;ha=1===(m+G)%2?M:"";var ca=E.length;E.push("");C&&E.push(s(0,G,d.p.page,d.p.rowNum));K&&E.push(w(J,C,G,!1));y&&E.push(Z.call(p,K+C,G+e));if(l.repeatitems){O||(O=B(K+y+C));var ba=a.jgrid.getXmlData(F,l.cell,!0);a.each(O,function(a){var b=ba[this];if(!b)return!1;z=b.textContent||b.text;A[d.p.colModel[a+K+y+C].name]=z;E.push(u(J,z,a+K+y+C,G+e,F,A))})}else for(m=0;m<
I.length;m++)z=a.jgrid.getXmlData(F,I[m]),A[d.p.colModel[m+K+y+C].name]=z,E.push(u(J,z,m+K+y+C,G+e,F,A));E[ca]=D(J,V,ha,A,F,!1);E.push("</tr>");d.p.grouping&&(T.push(E),d.p.groupingView._locgr||S.call(p,A,G),E=[]);if(g||!0===d.p.treeGrid)A._id_=a.jgrid.stripPref(d.p.idPrefix,J),d.p.data.push(A),d.p._index[A._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("tbody:first",c).append(E.join("")),p.triggerHandler("jqGridAfterInsertRow",[J,A,F]),h&&d.p.afterInsertRow.call(d,J,A,F),E=[]);A={};t++;G++;if(t===
L)break}}!0===d.p.gridview&&(q=-1<d.p.treeANode?d.p.treeANode:0,d.p.grouping?g||(p.jqGrid("groupingRender",T,d.p.colModel.length,d.p.page,L),T=null):!0===d.p.treeGrid&&0<q?a(d.rows[q]).after(E.join("")):(d.firstElementChild.innerHTML+=E.join(""),d.grid.cols=d.rows[0].cells));if(!0===d.p.subGrid)try{p.jqGrid("addSubGrid",K+C)}catch($){}d.p.totaltime=new Date-k;0<t&&0===d.p.records&&(d.p.records=R);E=null;if(!0===d.p.treeGrid)try{p.jqGrid("setTreeNode",q+1,t+q+1)}catch(P){}d.p.reccount=t;d.p.treeANode=
-1;d.p.userDataOnFooter&&p.jqGrid("footerData","set",d.p.userData,!0);g&&(d.p.records=R,d.p.lastpage=Math.ceil(R/L));f||d.updatepager(!1,!0);if(g){for(;t<R;){F=b[t];J=n(F,t+N);J=d.p.idPrefix+J;if(l.repeatitems){O||(O=B(K+y+C));var aa=a.jgrid.getXmlData(F,l.cell,!0);a.each(O,function(a){var b=aa[this];if(!b)return!1;z=b.textContent||b.text;A[d.p.colModel[a+K+y+C].name]=z})}else for(m=0;m<I.length;m++)z=a.jgrid.getXmlData(F,I[m]),A[d.p.colModel[m+K+y+C].name]=z;A._id_=a.jgrid.stripPref(d.p.idPrefix,
J);d.p.grouping&&S.call(p,A,t);d.p.data.push(A);d.p._index[A._id_]=d.p.data.length-1;A={};t++}d.p.grouping&&(d.p.groupingView._locgr=!0,p.jqGrid("groupingRender",T,d.p.colModel.length,d.p.page,L),T=null)}}},F=function(b,c,e,f,h){var k=new Date;if(b){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(v.call(d,!1,!0),e=1);var g,l="local"!==d.p.datatype&&d.p.loadonce||"jsonstring"===d.p.datatype;l&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;"local"===d.p.datatype?(c=d.p.localReader,
g="local"):(c=d.p.jsonReader,g="json");var n=a(d),p=0,m,q,t,z=[],K=d.p.multiselect?1:0,y=!0===d.p.subGrid?1:0,Z,C=!0===d.p.rownumbers?1:0,H=B(K+y+C);g=x(g);var I,A,F,J={},O,E,G=[],ha=!0===d.p.altRows?d.p.altclass:"",R;d.p.page=r(a.jgrid.getAccessor(b,c.page),d.p.page);d.p.lastpage=r(a.jgrid.getAccessor(b,c.total),1);d.p.records=r(a.jgrid.getAccessor(b,c.records));d.p.userData=a.jgrid.getAccessor(b,c.userdata)||{};y&&(Z=a.jgrid.getMethod("addSubGridCell"));F=!1===d.p.keyName?a.isFunction(c.id)?c.id.call(d,
b):c.id:d.p.keyName;A=a.jgrid.getAccessor(b,c.root);null==A&&a.isArray(b)&&(A=b);A||(A=[]);b=A.length;q=0;0<b&&0>=d.p.page&&(d.p.page=1);var M=parseInt(d.p.rowNum,10),T=d.p.scroll?a.jgrid.randId():1,L=!1,S;h&&(M*=h+1);"local"!==d.p.datatype||d.p.deselectAfterSort||(L=!0);var N=a.isFunction(d.p.afterInsertRow),V=[],ca=!1,ba;d.p.grouping&&(ca=!0===d.p.groupingView.groupCollapse,ba=a.jgrid.getMethod("groupingPrepare"));for(;q<b;){h=A[q];E=a.jgrid.getAccessor(h,F);void 0===E&&("number"===typeof F&&null!=
d.p.colModel[F+K+y+C]&&(E=a.jgrid.getAccessor(h,d.p.colModel[F+K+y+C].name)),void 0===E&&(E=T+q,0===z.length&&c.cell&&(m=a.jgrid.getAccessor(h,c.cell)||h,E=null!=m&&void 0!==m[F]?m[F]:E)));E=d.p.idPrefix+E;m=1===e?0:e;R=1===(m+q)%2?ha:"";L&&(S=d.p.multiselect?-1!==a.inArray(E,d.p.selarrrow):E===d.p.selrow);var $=G.length;G.push("");C&&G.push(s(0,q,d.p.page,d.p.rowNum));K&&G.push(w(E,C,q,S));y&&G.push(Z.call(n,K+C,q+e));I=g;c.repeatitems&&(c.cell&&(h=a.jgrid.getAccessor(h,c.cell)||h),a.isArray(h)&&
(I=H));for(t=0;t<I.length;t++)m=a.jgrid.getAccessor(h,I[t]),J[d.p.colModel[t+K+y+C].name]=m,G.push(u(E,m,t+K+y+C,q+e,h,J));G[$]=D(E,ca,R,J,h,S);G.push("</tr>");d.p.grouping&&(V.push(G),d.p.groupingView._locgr||ba.call(n,J,q),G=[]);if(l||!0===d.p.treeGrid)J._id_=a.jgrid.stripPref(d.p.idPrefix,E),d.p.data.push(J),d.p._index[J._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("#"+a.jgrid.jqID(d.p.id)+" tbody:first").append(G.join("")),n.triggerHandler("jqGridAfterInsertRow",[E,J,h]),N&&d.p.afterInsertRow.call(d,
E,J,h),G=[]);J={};p++;q++;if(p===M)break}!0===d.p.gridview&&(O=-1<d.p.treeANode?d.p.treeANode:0,d.p.grouping?l||(n.jqGrid("groupingRender",V,d.p.colModel.length,d.p.page,M),V=null):!0===d.p.treeGrid&&0<O?a(d.rows[O]).after(G.join("")):(d.firstElementChild.innerHTML+=G.join(""),d.grid.cols=d.rows[0].cells));if(!0===d.p.subGrid)try{n.jqGrid("addSubGrid",K+C)}catch(P){}d.p.totaltime=new Date-k;0<p&&0===d.p.records&&(d.p.records=b);if(!0===d.p.treeGrid)try{n.jqGrid("setTreeNode",O+1,p+O+1)}catch(aa){}d.p.reccount=
p;d.p.treeANode=-1;d.p.userDataOnFooter&&n.jqGrid("footerData","set",d.p.userData,!0);l&&(d.p.records=b,d.p.lastpage=Math.ceil(b/M));f||d.updatepager(!1,!0);if(l){for(;p<b&&A[p];){h=A[p];E=a.jgrid.getAccessor(h,F);void 0===E&&("number"===typeof F&&null!=d.p.colModel[F+K+y+C]&&(E=a.jgrid.getAccessor(h,d.p.colModel[F+K+y+C].name)),void 0===E&&(E=T+p,0===z.length&&c.cell&&(e=a.jgrid.getAccessor(h,c.cell)||h,E=null!=e&&void 0!==e[F]?e[F]:E)));if(h){E=d.p.idPrefix+E;I=g;c.repeatitems&&(c.cell&&(h=a.jgrid.getAccessor(h,
c.cell)||h),a.isArray(h)&&(I=H));for(t=0;t<I.length;t++)J[d.p.colModel[t+K+y+C].name]=a.jgrid.getAccessor(h,I[t]);J._id_=a.jgrid.stripPref(d.p.idPrefix,E);d.p.grouping&&ba.call(n,J,p);d.p.data.push(J);d.p._index[J._id_]=d.p.data.length-1;J={}}p++}d.p.grouping&&(d.p.groupingView._locgr=!0,n.jqGrid("groupingRender",V,d.p.colModel.length,d.p.page,M))}}},y=function(){function b(a){var d=0,c,e,f,k,g;if(null!=a.groups){(e=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&u.orBegin();for(c=0;c<
a.groups.length;c++){0<d&&e&&u.or();try{b(a.groups[c])}catch(l){alert(l)}d++}e&&u.orEnd()}if(null!=a.rules)try{(f=a.rules.length&&"OR"===a.groupOp.toString().toUpperCase())&&u.orBegin();for(c=0;c<a.rules.length;c++)g=a.rules[c],k=a.groupOp.toString().toUpperCase(),t[g.op]&&g.field&&(0<d&&k&&"OR"===k&&(u=u.or()),u=t[g.op](u,k)(g.field,g.data,h[g.field])),d++;f&&u.orEnd()}catch(n){alert(n)}}var c=d.p.multiSort?[]:"",e=[],f=!1,h={},k=[],g=[],l,n,p;if(a.isArray(d.p.data)){var m=d.p.grouping?d.p.groupingView:
!1,r,q;a.each(d.p.colModel,function(){n=this.sorttype||"text";"date"===n||"datetime"===n?(this.formatter&&"string"===typeof this.formatter&&"date"===this.formatter?(l=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:a.jgrid.formatter.date.srcformat,p=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:a.jgrid.formatter.date.newformat):l=p=this.datefmt||"Y-m-d",h[this.name]={stype:n,srcfmt:l,newfmt:p,sfunc:this.sortfunc||null}):h[this.name]={stype:n,
...
a.andNot().equals},"in":function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,b){return"OR"===b?a.orNot().isNull:a.andNot().isNull}},u=a.jgrid.from(d.p.data);d.p.ignoreCase&&(u=u.ignoreCase());if(!0===d.p.search){var s=d.p.postData.filters;if(s)"string"===typeof s&&(s=a.jgrid.parse(s)),b(s);else try{u=t[d.p.postData.searchOper](u)(d.p.postData.searchField,d.p.postData.searchString,h[d.p.postData.searchField])}catch(v){}}if(d.p.grouping)for(q=0;q<r;q++)u.orderBy(g[q],m.groupOrder[q],
k[q].stype,k[q].srcfmt);d.p.multiSort?a.each(c,function(a){u.orderBy(this,e[a],h[this].stype,h[this].srcfmt,h[this].sfunc)}):c&&d.p.sortorder&&f&&("DESC"===d.p.sortorder.toUpperCase()?u.orderBy(d.p.sortname,"d",h[c].stype,h[c].srcfmt,h[c].sfunc):u.orderBy(d.p.sortname,"a",h[c].stype,h[c].srcfmt,h[c].sfunc));var s=u.select(),x=parseInt(d.p.rowNum,10),w=s.length,D=parseInt(d.p.page,10),B=Math.ceil(w/x),K={};if((d.p.search||d.p.resetsearch)&&d.p.grouping&&d.p.groupingView._locgr){d.p.groupingView.groups=
[];var z,y=a.jgrid.getMethod("groupingPrepare"),C,Z;if(d.p.footerrow&&d.p.userDataOnFooter){for(C in d.p.userData)d.p.userData.hasOwnProperty(C)&&(d.p.userData[C]=0);Z=!0}for(z=0;z<w;z++){if(Z)for(C in d.p.userData)d.p.userData[C]+=parseFloat(s[z][C]||0);y.call(a(d),s[z],z,x)}}s=s.slice((D-1)*x,D*x);h=u=null;K[d.p.localReader.total]=B;K[d.p.localReader.page]=D;K[d.p.localReader.records]=w;K[d.p.localReader.root]=s;K[d.p.localReader.userdata]=d.p.userData;s=null;return K}}},M=function(){d.grid.hDiv.loading=
...
a("span.s-ico",g).hide();d.p.sortorder="";a.each(h,function(a){this.lso&&(0<a&&k&&(f+=", "),e=this.lso.split("-"),f+=h[a].index||h[a].name,f+=" "+e[e.length-1],k=!0,d.p.sortorder=e[e.length-1])});g=f.lastIndexOf(d.p.sortorder);f=f.substring(0,g);d.p.sortname=f},E=function(b,c,e,f,h){if(d.p.colModel[c].sortable&&!(0<d.p.savedRow.length)){e||(d.p.lastsort===c&&""!==d.p.sortname?"asc"===d.p.sortorder?d.p.sortorder="desc":"desc"===d.p.sortorder&&(d.p.sortorder="asc"):d.p.sortorder=d.p.colModel[c].firstsortorder||
...
d.p.jsonReader);d.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},d.p.localReader);d.p.scroll&&(d.p.pgbuttons=!1,d.p.pginput=!1,d.p.rowList=[]);d.p.data.length&&(H(),z());N="<thead><tr class='ui-jqgrid-labels' role='row'>";var J,O,V,T,R,G,I,ea,ca=ea="",ga=[],ba=[];O=[];if(!0===d.p.shrinkToFit&&!0===d.p.forceFit)for(k=d.p.colModel.length-1;0<=k;k--)if(!d.p.colModel[k].hidden){d.p.colModel[k].resizable=
...
a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id),d.grid.fbDiv)[d.p.useProp?"prop":"attr"]("checked",!1),a("#"+a.jgrid.jqID(this.id),d.grid.fbDiv).removeClass("ui-state-highlight")))}),d.p.selrow=null,$=!1);a(d).triggerHandler("jqGridSelectAll",[$?d.p.selarrrow:ia,$]);a.isFunction(d.p.onSelectAll)&&d.p.onSelectAll.call(d,$?d.p.selarrrow:ia,$)})}!0===d.p.autowidth&&(N=a(m).innerWidth(),d.p.width=0<N?N:"nw");(function(){var b=0,c=a.jgrid.cell_width?0:r(d.p.cellLayout,0),e=0,f,k=r(d.p.scrollOffset,0),g,
l=!1,n,p=0,m;a.each(d.p.colModel,function(){void 0===this.hidden&&(this.hidden=!1);if(d.p.grouping&&d.p.autowidth){var f=a.inArray(this.name,d.p.groupingView.groupField);0<=f&&d.p.groupingView.groupColumnShow.length>f&&(this.hidden=!d.p.groupingView.groupColumnShow[f])}this.widthOrg=g=r(this.width,0);!1===this.hidden&&(b+=g+c,this.fixed?p+=g+c:e++)});isNaN(d.p.width)&&(d.p.width=b+(!1!==d.p.shrinkToFit||isNaN(d.p.height)?0:k));h.width=d.p.width;d.p.tblwidth=b;!1===d.p.shrinkToFit&&!0===d.p.forceFit&&
...
S(this);if(!0===d.p.forceFit){var e=d.p,f=c,k;for(k=c+1;k<d.p.colModel.length;k++)if(!0!==d.p.colModel[k].hidden){f=k;break}e.nv=f-c}h.dragStart(c,b,aa(c));return!1}}).click(function(b){if(d.p.disableClick)return d.p.disableClick=!1;var c="th>div.ui-jqgrid-sortable",e,f;d.p.viewsortcols[2]||(c="th>div>span>span.ui-grid-ico-sort");b=a(b.target).closest(c);if(1===b.length){var h;if(d.p.frozenColumns){var k=a(this)[0].id.substring(d.p.id.length+1);a(d.p.colModel).each(function(a){if(this.name===k)return h=
...
l?"-rtl":"")+"'></div>"),a(h.sDiv).append(k).width(h.width).insertAfter(h.hDiv),a(k).append(da),h.footers=a(".ui-jqgrid-ftable",h.sDiv)[0].rows[0].cells,d.p.rownumbers&&(h.footers[0].className="ui-state-default jqgrid-rownum"),W&&a(h.sDiv).hide());k=null;if(d.p.caption){var la=d.p.datatype;!0===d.p.hidegrid&&(a(".ui-jqgrid-titlebar-close",h.cDiv).click(function(b){var c=a.isFunction(d.p.onHeaderClick),e=".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv",f,k=this;!0===d.p.toolbar[0]&&
...
function(b,c){var e,f,h,k,g,l,n,p="",m=d.p.pager?"_"+a.jgrid.jqID(d.p.pager.substr(1)):"",q=d.p.toppager?"_"+d.p.toppager.substr(1):"";h=parseInt(d.p.page,10)-1;0>h&&(h=0);h*=parseInt(d.p.rowNum,10);g=h+d.p.reccount;if(d.p.scroll){e=a("tbody:first > tr:gt(0)",d.grid.bDiv);h=g-e.length;d.p.reccount=e.length;if(e=e.outerHeight()||d.grid.prevRowHeight)f=h*e,n=parseInt(d.p.records,10)*e,a(">div:first",d.grid.bDiv).css({height:n}).children("div:first").css({height:f,display:f?"":"none"}),0==d.grid.bDiv.scrollTop&&
1<d.p.page&&(d.grid.bDiv.scrollTop=d.p.rowNum*(d.p.page-1)*e);d.grid.bDiv.scrollLeft=d.grid.hDiv.scrollLeft}p=d.p.pager||"";if(p+=d.p.toppager?p?","+d.p.toppager:d.p.toppager:"")n=a.jgrid.formatter.integer||{},e=r(d.p.page),f=r(d.p.lastpage),a(".selbox",p)[this.p.useProp?"prop":"attr"]("disabled",!1),!0===d.p.pginput&&(a(".ui-pg-input",p).val(d.p.page),k=d.p.toppager?"#sp_1"+m+",#sp_1"+q:"#sp_1"+m,a(k).html(a.fmatter?a.fmatter.util.NumberFormat(d.p.lastpage,n):d.p.lastpage)),d.p.viewrecords&&(0===
d.p.reccount?a(".ui-paging-info",p).html(d.p.emptyrecords):(k=h+1,l=d.p.records,a.fmatter&&(k=a.fmatter.util.NumberFormat(k,n),g=a.fmatter.util.NumberFormat(g,n),l=a.fmatter.util.NumberFormat(l,n)),a(".ui-paging-info",p).html(a.jgrid.format(d.p.recordtext,k,g,l)))),!0===d.p.pgbuttons&&(0>=e&&(e=f=0),1===e||0===e?(a("#first"+m+", #prev"+m).addClass("ui-state-disabled").removeClass("ui-state-hover"),d.p.toppager&&a("#first_t"+q+", #prev_t"+q).addClass("ui-state-disabled").removeClass("ui-state-hover")):
...
"nu"===r||"nn"===r)c[g]=f,m[g]=r,d++;else try{delete e.p.postData[g]}catch(q){}});var q=0<d?!0:!1;if(!0===b.stringResult||"local"===e.p.datatype||!0===b.searchOperators){var n='{"groupOp":"'+b.groupOp+'","rules":[',t=0;a.each(c,function(a,b){0<t&&(n+=",");n+='{"field":"'+a+'",';n+='"op":"'+m[a]+'",';n+='"data":"'+(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}';t++});n+="]}";a.extend(e.p.postData,{filters:n});a.each(["searchField","searchString","searchOper"],function(a,b){e.p.postData.hasOwnProperty(b)&&
delete e.p.postData[b]})}else a.extend(e.p.postData,c);var u;e.p.searchurl&&(u=e.p.url,a(e).jqGrid("setGridParam",{url:e.p.searchurl}));var w="stop"===a(e).triggerHandler("jqGridToolbarBeforeSearch")?!0:!1;!w&&a.isFunction(b.beforeSearch)&&(w=b.beforeSearch.call(e));w||a(e).jqGrid("setGridParam",{search:q}).trigger("reloadGrid",[{page:1}]);u&&a(e).jqGrid("setGridParam",{url:u});a(e).triggerHandler("jqGridToolbarAfterSearch");a.isFunction(b.afterSearch)&&b.afterSearch.call(e)},f=function(d,f,g){a("#sopt_menu").remove();
...
l,p;p="";var m="=",r,q=a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"+e.p.direction+"' id='gsh_"+e.p.id+"_"+k.name+"' ></th>"),n=a("<div style='position:relative;height:auto;padding-right:0.3em;padding-left:0.3em;'></div>"),t=a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper' headers=''></td><td class='ui-search-input' headers=''></td><td class='ui-search-clear' headers=''></td></tr></table>");!0===this.hidden&&a(q).css("display","none");this.search=
!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");l=a.extend({},this.searchoptions||{});if(this.search){if(b.searchOperators){p=l.sopt?l.sopt[0]:"select"===k.stype?"eq":b.defaultSearch;for(r=0;r<b.odata.length;r++)if(b.odata[r].oper===p){m=b.operands[p]||"";break}p="<a title='"+(null!=l.searchtitle?l.searchtitle:b.operandTitle)+"' style='padding-right: 0.5em;' soper='"+p+"' class='soptclass' colname='"+this.name+"'>"+m+"</a>"}a("td:eq(0)",t).attr("colindex",f).append(p);void 0===l.clearSearch&&
(l.clearSearch=!0);l.clearSearch?(p=b.resetTitle||"Clear Search Value",a("td:eq(2)",t).append("<a title='"+p+"' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>"+b.resetIcon+"</a>")):a("td:eq(2)",t).hide();switch(this.stype){case "select":if(p=this.surl||l.dataUrl)a(n).append(t),a.ajax(a.extend({url:p,dataType:"html",success:function(d){void 0!==l.buildSelect?(d=l.buildSelect(d))&&a("td:eq(1)",t).append(d):a("td:eq(1)",t).append(d);void 0!==l.defaultValue&&a("select",n).val(l.defaultValue);
a("select",n).attr({name:k.index||k.name,id:"gs_"+e.p.idPrefix+k.name});l.attr&&a("select",n).attr(l.attr);a("select",n).css({width:"100%"});a.jgrid.bindEv.call(e,a("select",n)[0],l);!0===b.autosearch&&a("select",n).change(function(){c();return!1});d=null}},a.jgrid.ajaxOptions,e.p.ajaxSelectOptions||{}));else{var u,w,s;k.searchoptions?(u=void 0===k.searchoptions.value?"":k.searchoptions.value,w=void 0===k.searchoptions.separator?":":k.searchoptions.separator,s=void 0===k.searchoptions.delimiter?";":
k.searchoptions.delimiter):k.editoptions&&(u=void 0===k.editoptions.value?"":k.editoptions.value,w=void 0===k.editoptions.separator?":":k.editoptions.separator,s=void 0===k.editoptions.delimiter?";":k.editoptions.delimiter);if(u){var x=document.createElement("select");x.style.width="100%";a(x).attr({name:k.index||k.name,id:"gs_"+e.p.idPrefix+k.name});var B;if("string"===typeof u)for(p=u.split(s),B=0;B<p.length;B++)u=p[B].split(w),s=document.createElement("option"),s.value=u[0],s.innerHTML=u[1],x.appendChild(s);
else if("object"===typeof u)for(B in u)u.hasOwnProperty(B)&&(s=document.createElement("option"),s.value=B,s.innerHTML=u[B],x.appendChild(s));void 0!==l.defaultValue&&a(x).val(l.defaultValue);l.attr&&a(x).attr(l.attr);a(n).append(t);a.jgrid.bindEv.call(e,x,l);a("td:eq(1)",t).append(x);!0===b.autosearch&&a(x).change(function(){c();return!1})}}break;case "text":w=void 0!==l.defaultValue?l.defaultValue:"";a("td:eq(1)",t).append("<input type='text' style='width:100%;padding:0px;' name='"+(k.index||k.name)+
"' id='gs_"+e.p.idPrefix+k.name+"' value='"+w+"'/>");a(n).append(t);l.attr&&a("input",n).attr(l.attr);a.jgrid.bindEv.call(e,a("input",n)[0],l);!0===b.autosearch&&(b.searchOnEnter?a("input",n).keypress(function(a){return 13===(a.charCode||a.keyCode||0)?(c(),!1):this}):a("input",n).keydown(function(a){switch(a.which){case 13:return!1;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:d&&clearTimeout(d),d=setTimeout(function(){c()},b.autosearchDelay)}}));break;case "custom":a("td:eq(1)",
t).append("<span style='width:95%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+e.p.idPrefix+k.name+"'/>");a(n).append(t);try{if(a.isFunction(l.custom_element))if(x=l.custom_element.call(e,void 0!==l.defaultValue?l.defaultValue:"",l))x=a(x).addClass("customelement"),a(n).find("span[name='"+(k.index||k.name)+"']").append(x);else throw"e2";else throw"e1";}catch(v){"e1"===v&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===
v?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof v?v:v.message,a.jgrid.edit.bClose)}}}a(q).append(n);a(g).append(q);b.searchOperators||a("td:eq(0)",t).hide()});a("table thead",e.grid.hDiv).append(g);b.searchOperators&&(a(".soptclass",g).click(function(b){var c=a(this).offset();f(this,c.left,c.top);b.stopPropagation()}),a("body").on("click",function(b){"soptclass"!==b.target.className&&
...
r+='"data":"'+(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}';q++});r+="]}";a.extend(e.p.postData,{filters:r});a.each(["searchField","searchString","searchOper"],function(a,b){e.p.postData.hasOwnProperty(b)&&delete e.p.postData[b]})}else a.extend(e.p.postData,d);var n;e.p.searchurl&&(n=e.p.url,a(e).jqGrid("setGridParam",{url:e.p.searchurl}));var t="stop"===a(e).triggerHandler("jqGridToolbarBeforeClear")?!0:!1;!t&&a.isFunction(b.beforeClear)&&(t=b.beforeClear.call(e));t||c&&a(e).jqGrid("setGridParam",
...
0;e<b.groups.length;e++)g=a("<tr></tr>"),h.append(g),k=a("<td class='first'></td>"),g.append(k),k=a("<td colspan='4'></td>"),k.append(this.createTableForGroup(b.groups[e],b)),g.append(k);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)h.append(this.createTableRowForRule(b.rules[e],b));return h};this.createTableRowForRule=function(b,c){var d=this,e=a("#"+a.jgrid.jqID(f.id))[0]||null,h=a("<tr></tr>"),g,l,w,s,x="",B;h.append("<td class='first'></td>");
var v=a("<td class='columns'></td>");h.append(v);var H=a("<select></select>"),z,D=[];v.append(H);H.bind("change",function(){b.field=a(H).val();w=a(this).parents("tr:first");for(g=0;g<d.p.columns.length;g++)if(d.p.columns[g].name===b.field){s=d.p.columns[g];break}if(s){s.searchoptions.id=a.jgrid.randId();k&&"text"===s.inputtype&&!s.searchoptions.size&&(s.searchoptions.size=10);var c=a.jgrid.createEl.call(e,s.inputtype,s.searchoptions,"",!0,d.p.ajaxSelectOptions||{},!0);a(c).addClass("input-elm");l=
s.searchoptions.sopt?s.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(s.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;var f="",h=0;D=[];a.each(d.p.ops,function(){D.push(this.oper)});for(g=0;g<l.length;g++)z=a.inArray(l[g],D),-1!==z&&(0===h&&(b.op=d.p.ops[z].oper),f+="<option value='"+d.p.ops[z].oper+"'>"+d.p.ops[z].text+"</option>",h++);a(".selectopts",w).empty().append(f);a(".selectopts",w)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(f=parseInt(a("select.selectopts",w)[0].offsetWidth,
10)+1,a(".selectopts",w).width(f),a(".selectopts",w).css("width","auto"));a(".data",w).empty().append(c);a.jgrid.bindEv.call(e,c,s.searchoptions);a(".input-elm",w).bind("change",function(c){c=c.target;b.data="SPAN"===c.nodeName.toUpperCase()&&s.searchoptions&&a.isFunction(s.searchoptions.custom_value)?s.searchoptions.custom_value.call(e,a(c).children(".customelement:first"),"get"):c.value;d.onchange()});setTimeout(function(){b.data=a(c).val();d.onchange()},0)}});for(g=v=0;g<d.p.columns.length;g++){B=
void 0===d.p.columns[g].search?!0:d.p.columns[g].search;var C=!0===d.p.columns[g].hidden;if(!0===d.p.columns[g].searchoptions.searchhidden&&B||B&&!C)B="",b.field===d.p.columns[g].name&&(B=" selected='selected'",v=g),x+="<option value='"+d.p.columns[g].name+"'"+B+">"+d.p.columns[g].label+"</option>"}H.append(x);x=a("<td class='operators'></td>");h.append(x);s=f.columns[v];s.searchoptions.id=a.jgrid.randId();k&&"text"===s.inputtype&&!s.searchoptions.size&&(s.searchoptions.size=10);v=a.jgrid.createEl.call(e,
...
(b.data=c.value),c.removeAttribute("readonly"),c.removeAttribute("disabled"));d.onchange()});l=s.searchoptions.sopt?s.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(s.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;x="";a.each(d.p.ops,function(){D.push(this.oper)});for(g=0;g<l.length;g++)z=a.inArray(l[g],D),-1!==z&&(B=b.op===d.p.ops[z].oper?" selected='selected'":"",x+="<option value='"+d.p.ops[z].oper+"'"+B+">"+d.p.ops[z].text+"</option>");F.append(x);x=a("<td class='data'></td>");h.append(x);
...
b.Find+"</a>",u="<a id='"+g+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+b.Reset+"</a>",w="",s="",x,B=!1,v=-1;b.showQuery&&(w="<a id='"+g+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");b.columns.length?(n=b.columns,v=0,x=n[0].index||n[0].name):a.each(n,function(a,b){b.label||(b.label=f.p.colNames[a]);if(!B){var c=
void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&!0===b.searchoptions.searchhidden&&c||c&&!d)B=!0,x=b.index||b.name,v=a}});if(!l&&x||!1===b.multipleSearch){var H="eq";0<=v&&n[v].searchoptions&&n[v].searchoptions.sopt?H=n[v].searchoptions.sopt[0]:b.sopt&&b.sopt.length&&(H=b.sopt[0]);l={groupOp:"AND",rules:[{field:x,op:H,data:""}]}}B=!1;b.tmplNames&&b.tmplNames.length&&(B=!0,s=b.tmplLabel,s+="<select class='ui-template'>",s+="<option value='default'>Default</option>",a.each(b.tmplNames,
...
break;case "password":case "text":case "textarea":case "button":y[this.name]=a(this).val()}n.p.autoencode&&(y[this.name]=a.jgrid.htmlEncode(y[this.name]))}});return!0}function g(c,d,e,f){var h,g,k,l=0,m,p,q,r=[],s=!1,t="",v;for(v=1;v<=f;v++)t+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==c&&(s=a(d).jqGrid("getInd",c));a(d.p.colModel).each(function(v){h=this.name;p=(g=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";
...
""}var D=a.extend({},this.editoptions||{},{id:h,name:h,rowId:c}),w=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),B=parseInt(w.rowpos,10)||l+1,C=parseInt(2*(parseInt(w.colpos,10)||1),10);"_empty"===c&&D.defaultValue&&(m=a.isFunction(D.defaultValue)?D.defaultValue.call(n):D.defaultValue);this.edittype||(this.edittype="text");n.p.autoencode&&(m=a.jgrid.htmlDecode(m));q=a.jgrid.createEl.call(n,this.edittype,D,m,!1,a.extend({},a.jgrid.ajaxOptions,d.p.ajaxSelectOptions||
{}));if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)b[n.p.id]._savedData[h]=m;a(q).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(q).addClass("ui-widget-content ui-corner-all");k=a(e).find("tr[rowpos="+B+"]");if(w.rowabove){var y=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+w.rowcontent+"</td></tr>");a(e).append(y);y[0].rp=B}0===k.length&&(k=a("<tr "+p+" rowpos='"+B+"'></tr>").addClass("FormData").attr("id","tr_"+h),a(k).append(t),a(e).append(k),
k[0].rp=B);a("td:eq("+(C-2)+")",k[0]).html(void 0===w.label?d.p.colNames[v]:w.label);a("td:eq("+(C-1)+")",k[0]).append(w.elmprefix).append(q).append(w.elmsuffix);"custom"===this.edittype&&a.isFunction(D.custom_value)&&D.custom_value.call(n,a("#"+h,"#"+u),"set",m);a.jgrid.bindEv.call(n,q,D);r[l]=v;l++}});0<l&&(v=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+d.p.id+"_id' value='"+
...
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,p.message,a.jgrid.edit.bClose)}}h++}}),0<h&&a("#id_g",s).val(c))}}function h(){a.each(n.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&y.hasOwnProperty(b.name)&&""===y[b.name]&&(y[b.name]="null")})}function k(){var e,f=[!0,"",""],g={},k=n.p.prmNames,l,m,p,q,r,v=a(n).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+u),A]);v&&"object"===typeof v&&(y=v);a.isFunction(b[n.p.id].beforeCheckValues)&&(v=b[n.p.id].beforeCheckValues.call(n,
y,a("#"+u),A))&&"object"===typeof v&&(y=v);for(p in y)if(y.hasOwnProperty(p)&&(f=a.jgrid.checkValues.call(n,y[p],p),!1===f[0]))break;h();f[0]&&(g=a(n).triggerHandler("jqGridAddEditClickSubmit",[b[n.p.id],y,A]),void 0===g&&a.isFunction(b[n.p.id].onclickSubmit)&&(g=b[n.p.id].onclickSubmit.call(n,b[n.p.id],y,A)||{}),f=a(n).triggerHandler("jqGridAddEditBeforeSubmit",[y,a("#"+u),A]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].beforeSubmit)&&(f=b[n.p.id].beforeSubmit.call(n,y,a("#"+u),A)));
...
g.status?(f[0]=!1,f[1]=a(n).triggerHandler("jqGridAddEditErrorTextFormat",[g,A]),a.isFunction(b[n.p.id].errorTextFormat)?f[1]=b[n.p.id].errorTextFormat.call(n,g,A):f[1]=h+" Status: '"+g.statusText+"'. Error code: "+g.status):(f=a(n).triggerHandler("jqGridAddEditAfterSubmit",[g,y,A]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].afterSubmit)&&(f=b[n.p.id].afterSubmit.call(n,g,y,A)));if(!1===f[0])a("#FormError>td",s).html(f[1]),a("#FormError",s).show();else if(n.p.autoencode&&a.each(y,function(b,
c){y[b]=a.jgrid.htmlDecode(c)}),y[m]===k.addoper?(f[2]||(f[2]=a.jgrid.randId()),null==y[l]||"_empty"===y[l]?y[l]=f[2]:f[2]=y[l],b[n.p.id].reloadAfterSubmit?a(n).trigger("reloadGrid"):!0===n.p.treeGrid?a(n).jqGrid("addChildNode",f[2],q,y):a(n).jqGrid("addRowData",f[2],y,c.addedrow),b[n.p.id].closeAfterAdd?(!0!==n.p.treeGrid&&a(n).jqGrid("setSelection",f[2]),a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,
formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form})):b[n.p.id].clearAfterAdd&&d("_empty",n,u)):(b[n.p.id].reloadAfterSubmit?(a(n).trigger("reloadGrid"),b[n.p.id].closeAfterEdit||setTimeout(function(){a(n).jqGrid("setSelection",y[l])},1E3)):!0===n.p.treeGrid?a(n).jqGrid("setTreeRow",y[l],y):a(n).jqGrid("setRowData",y[l],y),b[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,
formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form})),a.isFunction(b[n.p.id].afterComplete)&&(e=g,setTimeout(function(){a(n).triggerHandler("jqGridAddEditAfterComplete",[e,y,a("#"+u),A]);b[n.p.id].afterComplete.call(n,e,y,a("#"+u),A);e=null},500)),b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)if(a("#"+u).data("disabled",!1),"_empty"!==b[n.p.id]._savedData[n.p.id+"_id"])for(p in b[n.p.id]._savedData)b[n.p.id]._savedData.hasOwnProperty(p)&&y[p]&&(b[n.p.id]._savedData[p]=y[p]);b[n.p.id].processing=
...
"")):a.ajax(r))}!1===f[0]&&(a("#FormError>td",s).html(f[1]),a("#FormError",s).show())}function l(a,b){var c=!1,d;for(d in a)if(a.hasOwnProperty(d)&&a[d]!=b[d]){c=!0;break}return c}function p(){var c=!0;a("#FormError",s).hide();b[n.p.id].checkOnUpdate&&(y={},f(),M=l(y,b[n.p.id]._savedData))&&(a("#"+u).data("disabled",!0),a(".confirm","#"+x.themodal).show(),c=!1);return c}function m(){var b;if("_empty"!==e&&void 0!==n.p.savedRow&&0<n.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(b=0;b<
...
s+"_2").addClass("ui-state-disabled"):a("#nData",s+"_2").removeClass("ui-state-disabled")}function q(){var b=a(n).jqGrid("getDataIDs"),c=a("#id_g",s).val();return[a.inArray(c,b),b]}var n=this;if(n.grid&&e){var t=n.p.id,u="FrmGrid_"+t,w="TblGrid_"+t,s="#"+a.jgrid.jqID(w),x={themodal:"editmod"+t,modalhead:"edithd"+t,modalcontent:"editcnt"+t,scrollelm:u},B=a.isFunction(b[n.p.id].beforeShowForm)?b[n.p.id].beforeShowForm:!1,v=a.isFunction(b[n.p.id].afterShowForm)?b[n.p.id].afterShowForm:!1,H=a.isFunction(b[n.p.id].beforeInitData)?
b[n.p.id].beforeInitData:!1,z=a.isFunction(b[n.p.id].onInitializeForm)?b[n.p.id].onInitializeForm:!1,D=!0,C=1,F=0,y,M,A,u=a.jgrid.jqID(u);"new"===e?(e="_empty",A="add",c.caption=b[n.p.id].addCaption):(c.caption=b[n.p.id].editCaption,A="edit");c.recreateForm||a(n).data("formProp")&&a.extend(b[a(this)[0].p.id],a(n).data("formProp"));var L=!0;c.checkOnUpdate&&c.jqModal&&!c.modal&&(L=!1);var P=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",D=isNaN(b[a(this)[0].p.id].datawidth)?
...
2*C+"'></td></tr>");D[0].rp=0;a(U).append(D);D=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*C+"'>"+b[n.p.id].topinfo+"</td></tr>");D[0].rp=0;a(U).append(D);D=a(n).triggerHandler("jqGridAddEditBeforeInitData",[P,A]);void 0===D&&(D=!0);D&&H&&(D=H.call(n,P,A));if(!1!==D){m();var D=(H="rtl"===n.p.direction?!0:!1)?"nData":"pData",X=H?"pData":"nData";g(e,n,U,C);var D="<a id='"+D+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
...
(H?X+D:D+X)+"</td><td class='EditButton'>"+E+aa+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+b[n.p.id].bottominfo+"</td></tr>"),w=w+"</tbody></table>";if(0<F){var S=[];a.each(a(U)[0].rows,function(a,b){S[a]=b});S.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(S,function(b,c){a("tbody",U).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(t);var N=!1;!0===c.closeOnEscape&&(c.closeOnEscape=!1,N=!0);w=a("<div></div>").append(P).append(w);a.jgrid.createModal(x,
...
jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a(n).triggerHandler("jqGridAddEditInitializeForm",[a("#"+u),A]);z&&z.call(n,a("#"+u),A);"_empty"!==e&&b[n.p.id].viewPagerButtons?a("#pData,#nData",s+"_2").show():a("#pData,#nData",s+"_2").hide();a(n).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+u),A]);B&&B.call(n,a("#"+u),A);a("#"+a.jgrid.jqID(x.themodal)).data("onClose",b[n.p.id].onClose);a.jgrid.viewModal("#"+
...
["prev",a("#"+u),b[1][b[0]]]);a.isFunction(c.afterclickPgButtons)&&c.afterclickPgButtons.call(n,"prev",a("#"+u),b[1][b[0]-1]);r(b[0]-1,b)}return!1});a(n).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+u),A]);v&&v.call(n,a("#"+u),A);B=q();r(B[0],B)}}})},viewGridRow:function(e,c){c=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,jqModal:!0,closeOnEscape:!1,labelswidth:"30%",closeicon:[],navkeys:[!1,38,40],onClose:null,beforeShowForm:null,
...
t="",u=["integer","number","currency"],v=0,x=0,w,B,z;for(r=1;r<=f;r++)t+=1===r?s:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(d.p.colModel).each(function(){(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,u)?v=Math.max(v,parseInt(this.width,10)):x=Math.max(x,parseInt(this.width,10)))});w=0!==v?v:0!==x?x:0;q=a(d).jqGrid("getInd",
b);a(d.p.colModel).each(function(b){g=this.name;B=!1;m=(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";z="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&z){n=!1===q?"":g===d.p.ExpandColumn&&!0===d.p.treeGrid?a("td:eq("+b+")",d.rows[q]).text():a("td:eq("+b+")",d.rows[q]).html();B="right"===this.align&&0!==w?!0:!1;var c=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),r=parseInt(c.rowpos,10)||
...
c*f))return!0;w++;r=h.p.id+"ghead_"+v.idx;m=r+"_"+g;p="<span style='cursor:pointer;' class='ui-icon "+q+"' onclick=\"jQuery('#"+a.jgrid.jqID(h.p.id)+"').jqGrid('groupingToggle','"+m+"');return false;\"></span>";try{a.isArray(k.formatDisplayField)&&a.isFunction(k.formatDisplayField[v.idx])?(v.displayValue=k.formatDisplayField[v.idx].call(h,v.displayValue,v.value,h.p.colModel[t[v.idx]],v.idx,k),n=v.displayValue):n=h.formatter(m,v.displayValue,t[v.idx],v.value)}catch(H){n=v.displayValue}var z="",z=a.isFunction(k.groupText[v.idx])?
k.groupText[v.idx].call(h,n,v.cnt,v.summary):a.jgrid.template(k.groupText[v.idx],n,v.cnt,v.summary);"string"!==typeof z&&"number"!==typeof z&&(z=n);"header"===k.groupSummaryPos[v.idx]?(l+='<tr id="'+m+'"'+(k.groupCollapse&&0<v.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+h.p.direction+" "+r+'"><td style="padding-left:'+12*v.idx+'px;"'+x+">"+p+z+"</td>",l+=d(g,0,k.groups,!1===k.groupColumnShow[v.idx]?""===x?2:3:""===x?1:2),l+="</tr>"):l+='<tr id="'+m+'"'+
(k.groupCollapse&&0<v.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+h.p.direction+" "+r+'"><td style="padding-left:'+12*v.idx+'px;" colspan="'+(!1===k.groupColumnShow[v.idx]?e-1:e)+'">'+p+z+"</td></tr>";if(u-1===v.idx){var z=k.groups[g+1],D,C=0;D=v.startRow;var F=void 0!==z?z.startRow:k.groups[g].startRow+k.groups[g].cnt;k._locgr&&(C=(c-1)*f,C>v.startRow&&(D=C));for(;D<F&&b[D-C];D++)l+=b[D-C].join("");if("header"!==k.groupSummaryPos[v.idx]){var y;if(void 0!==
z){for(y=0;y<k.groupField.length&&z.dataIndex!==k.groupField[y];y++);w=k.groupField.length-y}for(z=0;z<w;z++)s[z]&&(C="",k.groupCollapse&&!k.showSummaryOnHide&&(C=' style="display:none;"'),l+="<tr"+C+' jqfootlevel="'+(v.idx-z)+'" role="row" class="ui-widget-content jqfoot ui-row-'+h.p.direction+'">',l+=d(g,z,k.groups,0),l+="</tr>");w=y}}});a("#"+a.jgrid.jqID(h.p.id)+" tbody:first").append(l);l=null})},groupingGroupBy:function(b,e){return this.each(function(){"string"===typeof b&&(b=[b]);var c=this.p.groupingView;
this.p.grouping=!0;c._locgr=!1;void 0===c.visibiltyOnNextGrouping&&(c.visibiltyOnNextGrouping=[]);var f;for(f=0;f<c.groupField.length;f++)!c.groupColumnShow[f]&&c.visibiltyOnNextGrouping[f]&&a(this).jqGrid("showCol",c.groupField[f]);for(f=0;f<b.length;f++)c.visibiltyOnNextGrouping[f]=a("#"+a.jgrid.jqID(this.p.id)+"_"+a.jgrid.jqID(b[f])).is(":visible");this.p.groupingView=a.extend(this.p.groupingView,e||{});c.groupField=b;a(this).trigger("reloadGrid")})},groupingRemove:function(b){return this.each(function(){void 0===
...
"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}w=a.jgrid.checkValues.call(m,q[r],b);if(!1===w[0])return!1;m.p.autoencode&&(q[r]=a.jgrid.htmlEncode(q[r]));"clientArray"!==l.url&&x.editoptions&&!0===x.editoptions.NullIfEmpty&&""===q[r]&&(t[r]="null")}});if(!1===w[0]){try{var B=a(m).jqGrid("getGridRowById",b),v=a.jgrid.findPos(B);a.jgrid.info_dialog(a.jgrid.errors.errcap,w[1],a.jgrid.edit.bClose,{left:v[0],
top:v[1]+a(B).outerHeight()})}catch(H){alert(w[1])}return p}k=m.p.prmNames;B=b;v=!1===m.p.keyName?k.id:m.p.keyName;q&&(q[k.oper]=k.editoper,void 0===q[v]||""===q[v]?q[v]=b:s.id!==m.p.idPrefix+q[v]&&(k=a.jgrid.stripPref(m.p.idPrefix,b),void 0!==m.p._index[k]&&(m.p._index[q[v]]=m.p._index[k],delete m.p._index[k]),b=m.p.idPrefix+q[v],a(s).attr("id",b),m.p.selrow===B&&(m.p.selrow=b),a.isArray(m.p.selarrrow)&&(k=a.inArray(B,m.p.selarrrow),0<=k&&(m.p.selarrrow[k]=b)),m.p.multiselect&&(k="jqg_"+m.p.id+"_"+
b,a("input.cbox",s).attr("id",k).attr("name",k))),void 0===m.p.inlineData&&(m.p.inlineData={}),q=a.extend({},q,m.p.inlineData,l.extraparam));if("clientArray"===l.url){q=a.extend({},q,n);m.p.autoencode&&a.each(q,function(b,c){q[b]=a.jgrid.htmlDecode(c)});k=a(m).jqGrid("setRowData",b,q);a(s).attr("editable","0");for(v=0;v<m.p.savedRow.length;v++)if(String(m.p.savedRow[v].id)===String(B)){u=v;break}0<=u&&m.p.savedRow.splice(u,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[b,k,q,l]);a.isFunction(l.aftersavefunc)&&
...
1,1)}null!=a[d]&&"object"===typeof a[d]&&t(a[d]);if("level"===d&&0<a.level)for(b in c=0,a.fields)if(a.fields.hasOwnProperty(b)){g={};for(e in m.aggregates[c])if(m.aggregates[c].hasOwnProperty(e))switch(e){case "member":case "label":case "aggregator":break;default:g[e]=m.aggregates[c][e]}1<H?(g.name=b,g.label=m.aggregates[c].label||a.label):(g.name=a.text,g.label="_r_Totals"===a.text?m.rowTotalsText:a.label);f.push(g);c++}}}var u,w,s,x=e.length,B,v,H,z,D=0;m.rowTotals&&0<m.yDimension.length&&(m.yDimension.splice(0,
0,{dataName:m.yDimension[0].dataName}),m.yDimension[0].converter=function(){return"_r_Totals"});B=a.isArray(m.xDimension)?m.xDimension.length:0;v=m.yDimension.length;H=a.isArray(m.aggregates)?m.aggregates.length:0;if(0===B||0===H)throw"xDimension or aggregates optiona are not set!";var C;for(s=0;s<B;s++)C={name:m.xDimension[s].dataName,frozen:m.frozenStaticCols},null==m.xDimension[s].isGroupField&&(m.xDimension[s].isGroupField=!0),C=a.extend(!0,C,m.xDimension[s]),f.push(C);C=B-1;for(var F={};D<x;){u=
e[D];var y=[],M=[];z={};s=0;do y[s]=a.trim(u[m.xDimension[s].dataName]),z[m.xDimension[s].dataName]=y[s],s++;while(s<B);var A=0;w=-1;s=c(g,q,y);if(!s){A=0;if(1<=v){for(A=0;A<v;A++)M[A]=a.trim(u[m.yDimension[A].dataName]),m.yDimension[A].converter&&a.isFunction(m.yDimension[A].converter)&&(M[A]=m.yDimension[A].converter.call(this,M[A],y,M));z=n(u,m.aggregates,M,z)}else 0===v&&(z=n(u,m.aggregates,null,z));g.push(z)}else if(0<=w){A=0;if(1<=v){for(A=0;A<v;A++)M[A]=a.trim(u[m.yDimension[A].dataName]),
m.yDimension[A].converter&&a.isFunction(m.yDimension[A].converter)&&(M[A]=m.yDimension[A].converter.call(this,M[A],y,M));s=n(u,m.aggregates,M,s)}else 0===v&&(s=n(u,m.aggregates,null,s));g[w]=s}u=0;var y=z=null,L;for(L in h)if(h.hasOwnProperty(L)){if(0===u)F.children&&void 0!==F.children||(F={text:L,level:0,children:[],label:L}),z=F.children;else{y=null;for(s=0;s<z.length;s++)if(z[s].text===L){y=z[s];break}y?z=y.children:(z.push({children:[],text:L,level:u,fields:h[L],label:k[L]}),z=z[z.length-1].children)}u++}D++}var P=
[],U=f.length,X=U;0<v&&(p[v-1]={useColSpanStyle:!1,groupHeaders:[]});t(F);if(m.colTotals)for(D=g.length;D--;)for(s=B;s<f.length;s++)x=f[s].name,d[x]=d[x]?d[x]+parseFloat(g[D][x]||0):parseFloat(g[D][x]||0);if(0<C)for(s=0;s<C;s++)f[s].isGroupField&&(l.groupingView.groupField.push(f[s].name),l.groupingView.groupSummary.push(m.groupSummary),l.groupingView.groupSummaryPos.push(m.groupSummaryPos));else l.grouping=!1;l.sortname=f[C].name;l.groupingView.hideFirstGroupCol=!0});return{colModel:f,rows:g,groupOptions:l,
...
if(e.length)for(k in e)e.hasOwnProperty(k)&&(e[k][g]=parseInt(e[k][g],10)-h)}}})},addChildNode:function(b,e,c,f){var g=this[0];if(c){var d=g.p.treeReader.expanded_field,h=g.p.treeReader.leaf_field,k=g.p.treeReader.level_field,l=g.p.treeReader.parent_id_field,p=g.p.treeReader.left_field,m=g.p.treeReader.right_field,r=g.p.treeReader.loaded,q,n,t,u,w;q=0;var s=e,x;void 0===f&&(f=!1);if(null==b){w=g.p.data.length-1;if(0<=w)for(;0<=w;)q=Math.max(q,parseInt(g.p.data[w][g.p.localReader.id],10)),w--;b=q+
1}var B=a(g).jqGrid("getInd",e);x=!1;void 0===e||null===e||""===e?(s=e=null,q="last",u=g.p.tree_root_level,w=g.p.data.length+1):(q="after",n=g.p._index[e],t=g.p.data[n],e=t[g.p.localReader.id],u=parseInt(t[k],10)+1,w=a(g).jqGrid("getFullTreeNode",t),w.length?(s=w=w[w.length-1][g.p.localReader.id],w=a(g).jqGrid("getInd",s)+1):w=a(g).jqGrid("getInd",e)+1,t[h]&&(x=!0,t[d]=!0,a(g.rows[B]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(g.p.treeIcons.leaf+

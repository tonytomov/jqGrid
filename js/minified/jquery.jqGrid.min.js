...
*/
(function(a){a.jgrid=a.jgrid||{};a.extend(a.jgrid,{version:"4.7.1",htmlDecode:function(a){return a&&("&nbsp;"===a||"&#160;"===a||1===a.length&&160===a.charCodeAt(0))?"":a?String(a).replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/&quot;/g,'"').replace(/&amp;/g,"&"):a},htmlEncode:function(a){return a?String(a).replace(/&/g,"&amp;").replace(/\"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):a},template:function(b){var e=a.makeArray(arguments).slice(1),c,f=e.length;null==b&&(b="");return b.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?\}/g,
function(b,d){if(!isNaN(parseInt(d,10)))return e[parseInt(d,10)];for(c=0;c<f;c++)if(a.isArray(e[c]))for(var h=e[c],k=h.length;k--;)if(d===h[k].nm)return h[k].v})},msie:"Microsoft Internet Explorer"===navigator.appName,msiever:function(){var a=-1;null!=/MSIE ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent)&&(a=parseFloat(RegExp.$1));return a},getCellIndex:function(b){b=a(b);if(b.is("tr"))return-1;b=(b.is("td")||b.is("th")?b:b.closest("td,th"))[0];return a.jgrid.msie?a.inArray(b,b.parentNode.cells):
b.cellIndex},stripHtml:function(a){a=String(a);var e=/<("[^"]*"|'[^']*'|[^'">])*>/gi;return a?(a=a.replace(e,""))&&"&nbsp;"!==a&&"&#160;"!==a?a.replace(/\"/g,"'"):"":a},stripPref:function(b,e){var c=a.type(b);if("string"===c||"number"===c)b=String(b),e=""!==b?String(e).replace(String(b),""):e;return e},parse:function(b){"while(1);"===b.substr(0,9)&&(b=b.substr(9));"/*"===b.substr(0,2)&&(b=b.substr(2,b.length-4));b||(b="{}");return!0===a.jgrid.useJSON&&"object"===typeof JSON&&"function"===typeof JSON.parse?
JSON.parse(b):eval("("+b+")")},parseDate:function(b,e,c,f){var g=/^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/,d="string"===typeof e?e.match(g):null,g=function(a,d){a=String(a);for(d=parseInt(d,10)||2;a.length<d;)a="0"+a;return a},h={m:1,d:1,y:1970,h:0,i:0,s:0,u:0},k=0,l,p,k=function(a,d){0===a?12===d&&(d=0):12!==d&&(d+=12);return d},m=0;void 0===f&&(f=a.jgrid.formatter.date);void 0===f.parseRe&&(f.parseRe=/[#%\\\/:_;.,\t\s-]/);f.masks.hasOwnProperty(b)&&(b=f.masks[b]);if(e&&null!=
e)if(isNaN(e-0)||"u"!==String(b).toLowerCase())if(e.constructor===Date)k=e;else if(null!==d)k=new Date(parseInt(d[1],10)),d[3]&&(m=60*Number(d[5])+Number(d[6]),m*="-"===d[4]?1:-1,m-=k.getTimezoneOffset(),k.setTime(Number(Number(k)+6E4*m)));else{"ISO8601Long"===f.srcformat&&"Z"===e.charAt(e.length-1)&&(m-=(new Date).getTimezoneOffset());e=String(e).replace(/\T/g,"#").replace(/\t/,"%").split(f.parseRe);b=b.replace(/\T/g,"#").replace(/\t/,"%").split(f.parseRe);l=0;for(p=b.length;l<p;l++)"M"===b[l]&&
(d=a.inArray(e[l],f.monthNames),-1!==d&&12>d&&(e[l]=d+1,h.m=e[l])),"F"===b[l]&&(d=a.inArray(e[l],f.monthNames,12),-1!==d&&11<d&&(e[l]=d+1-12,h.m=e[l])),"a"===b[l]&&(d=a.inArray(e[l],f.AmPm),-1!==d&&2>d&&e[l]===f.AmPm[d]&&(e[l]=d,h.h=k(e[l],h.h))),"A"===b[l]&&(d=a.inArray(e[l],f.AmPm),-1!==d&&1<d&&e[l]===f.AmPm[d]&&(e[l]=d-2,h.h=k(e[l],h.h))),"g"===b[l]&&(h.h=parseInt(e[l],10)),void 0!==e[l]&&(h[b[l].toLowerCase()]=parseInt(e[l],10));h.f&&(h.m=h.f);if(0===h.m&&0===h.y&&0===h.d)return"&#160;";h.m=parseInt(h.m,
...
p=k.getMilliseconds();var r=k.getDay(),q=k.getFullYear(),n=(r+6)%7+1,s=(new Date(q,m-1,h)-new Date(q,0,1))/864E5,u={d:g(h),D:f.dayNames[r],j:h,l:f.dayNames[r+7],N:n,S:f.S(h),w:r,z:s,W:5>n?Math.floor((s+n-1)/7)+1:Math.floor((s+n-1)/7)||(4>((new Date(q-1,0,1)).getDay()+6)%7?53:52),F:f.monthNames[m-1+12],m:g(m),M:f.monthNames[m-1],n:m,t:"?",L:"?",o:"?",Y:q,y:String(q).substring(2),a:12>b?f.AmPm[0]:f.AmPm[1],A:12>b?f.AmPm[2]:f.AmPm[3],B:"?",g:b%12||12,G:b,h:g(b%12||12),H:g(b),i:g(e),s:g(l),u:p,e:"?",
I:"?",O:(0<d?"-":"+")+g(100*Math.floor(Math.abs(d)/60)+Math.abs(d)%60,4),P:"?",T:(String(k).match(/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g)||[""]).pop().replace(/[^-+\dA-Z]/g,""),Z:"?",c:"?",r:"?",U:Math.floor(k/1E3)};return c.replace(/\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g,function(a){return u.hasOwnProperty(a)?u[a]:a.substring(1)})},jqID:function(a){return String(a).replace(/[!"#$%&'()*+,.\/:; <=>?@\[\\\]\^`{|}~]/g,
"\\$&")},guid:1,uidPref:"jqg",randId:function(b){return(b||a.jgrid.uidPref)+a.jgrid.guid++},getAccessor:function(a,e){var c,f,g=[],d;if("function"===typeof e)return e(a);c=a[e];if(void 0===c)try{if("string"===typeof e&&(g=e.split(".")),d=g.length)for(c=a;c&&d--;)f=g.shift(),c=c[f]}catch(h){}return c},getXmlData:function(b,e,c){var f="string"===typeof e?e.match(/^(.*)\[(\w+)\]$/):null;if("function"===typeof e)return e(b);if(f&&f[2])return f[1]?a(f[1],b).attr(f[2]):a(b).attr(f[2]);b=a(e,b);return c?
b:0<b.length?a(b).text():void 0},cellWidth:function(){var b=a("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'></td></tr></table></div>"),e=b.appendTo("body").find("td").width();b.remove();return.1<Math.abs(e-5)},cell_width:!0,ajaxOptions:{},from:function(b){return new function(b,c){"string"===typeof b&&(b=a.data(b));var f=this,g=b,d=!0,h=!1,k=c,l=/[\$,%]/g,p=null,m=null,r=0,q=!1,n="",s=[],u=!0;
if("object"===typeof b&&b.push)0<b.length&&(u="object"!==typeof b[0]?!1:!0);else throw"data provides is not an array";this._hasData=function(){return null===g?!1:0===g.length?!1:!0};this._getStr=function(a){var b=[];h&&b.push("jQuery.trim(");b.push("String("+a+")");h&&b.push(")");d||b.push(".toLowerCase()");return b.join("")};this._strComp=function(a){return"string"===typeof a?".toString()":""};this._group=function(a,d){return{field:a.toString(),unique:d,items:[]}};this._toStr=function(b){h&&(b=a.trim(b));
...
a,d,">=",b)};this.lessOrEquals=function(a,d,b){return f._compareValues(f.lessOrEquals,a,d,"<=",b)};this.startsWith=function(d,b){var c=null==b?d:b,c=h?a.trim(c.toString()).length:c.toString().length;u?f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+d+"')")+".substr(0,"+c+") == "+f._getStr('"'+f._toStr(b)+'"')):(null!=b&&(c=h?a.trim(b.toString()).length:b.toString().length),f._append(f._getStr("this")+".substr(0,"+c+") == "+f._getStr('"'+f._toStr(d)+'"')));f._setCommand(f.startsWith,d);f._resetNegate();
return f};this.endsWith=function(d,b){var c=null==b?d:b,c=h?a.trim(c.toString()).length:c.toString().length;u?f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+d+"')")+".substr("+f._getStr("jQuery.jgrid.getAccessor(this,'"+d+"')")+".length-"+c+","+c+') == "'+f._toStr(b)+'"'):f._append(f._getStr("this")+".substr("+f._getStr("this")+'.length-"'+f._toStr(d)+'".length,"'+f._toStr(d)+'".length) == "'+f._toStr(d)+'"');f._setCommand(f.endsWith,d);f._resetNegate();return f};this.contains=function(a,d){u?
...
if(this.resizing){var b=this.resizing.idx,c=this.headers[b].newWidth||this.headers[b].width,c=parseInt(c,10);this.resizing=!1;a("#rs_m"+a.jgrid.jqID(e.id)).css("display","none");e.colModel[b].width=c;this.headers[b].width=c;this.headers[b].el.style.width=c+"px";this.cols[b].style.width=c+"px";0<this.footers.length&&(this.footers[b].style.width=c+"px");!0===e.forceFit?(c=this.headers[b+e.nv].newWidth||this.headers[b+e.nv].width,this.headers[b+e.nv].width=c,this.headers[b+e.nv].el.style.width=c+"px",
this.cols[b+e.nv].style.width=c+"px",0<this.footers.length&&(this.footers[b+e.nv].style.width=c+"px"),e.colModel[b+e.nv].width=c):(e.tblwidth=this.newWidth||e.tblwidth,a("table:first",this.bDiv).css("width",e.tblwidth+"px"),a("table:first",this.hDiv).css("width",e.tblwidth+"px"),this.hDiv.scrollLeft=this.bDiv.scrollLeft,e.footerrow&&(a("table:first",this.sDiv).css("width",e.tblwidth+"px"),this.sDiv.scrollLeft=this.bDiv.scrollLeft));a(d).triggerHandler("jqGridResizeStop",[c,b]);a.isFunction(e.resizeStop)&&
e.resizeStop.call(d,c,b)}this.curGbox=null;document.onselectstart=function(){return!0}},populateVisible:function(){h.timer&&clearTimeout(h.timer);h.timer=null;var d=a(h.bDiv).height();if(d){var b=a("table:first",h.bDiv),c,f;if(b[0].rows.length)try{f=(c=b[0].rows[1])?a(c).outerHeight()||h.prevRowHeight:h.prevRowHeight}catch(k){f=h.prevRowHeight}if(f){h.prevRowHeight=f;var l=e.rowNum;c=h.scrollTop=h.bDiv.scrollTop;var p=Math.round(b.position().top)-c,n=p+b.height();f*=l;var m,r,q;n<d&&0>=p&&(void 0===
e.lastpage||(parseInt((n+c+f-1)/f,10)||0)<=e.lastpage)&&(r=parseInt((d-n+f-1)/f,10)||1,0<=n||2>r||!0===e.scroll?(m=(Math.round((n+c)/f)||0)+1,p=-1):p=1);0<p&&(m=(parseInt(c/f,10)||0)+1,r=(parseInt((c+d)/f,10)||0)+2-m,q=!0);!r||e.lastpage&&(m>e.lastpage||1===e.lastpage||m===e.page&&m===e.lastpage)||(h.hDiv.loading?h.timer=setTimeout(h.populateVisible,e.scrollTimeout):(e.page=m,q&&(h.selectionPreserver(b[0]),h.emptyRows.call(b[0],!1,!1)),h.populate(r)))}}},scrollGrid:function(a){if(e.scroll){var d=
h.bDiv.scrollTop;void 0===h.scrollTop&&(h.scrollTop=0);d!==h.scrollTop&&(h.scrollTop=d,h.timer&&clearTimeout(h.timer),h.timer=setTimeout(h.populateVisible,e.scrollTimeout))}h.hDiv.scrollLeft=h.bDiv.scrollLeft;e.footerrow&&(h.sDiv.scrollLeft=h.bDiv.scrollLeft);a&&a.stopPropagation()},selectionPreserver:function(d){var b=d.p,c=b.selrow,e=b.selarrrow?a.makeArray(b.selarrrow):null,f=d.grid.bDiv.scrollLeft,h=function(){var k;b.selrow=null;b.selarrrow=[];if(b.multiselect&&e&&0<e.length)for(k=0;k<e.length;k++)e[k]!==
c&&a(d).jqGrid("setSelection",e[k],!1,null);c&&a(d).jqGrid("setSelection",c,!1,null);d.grid.bDiv.scrollLeft=f;a(d).unbind(".selectionPreserver",h)};a(d).bind("jqGridGridComplete.selectionPreserver",h)}};if("TABLE"!==this.tagName.toUpperCase()||null==this.id)alert("Element is not a table or has no id!");else if(void 0!==document.documentMode&&5>=document.documentMode)alert("Grid can not be used in this ('quirks') mode!");else{a(this).empty().attr("tabindex","0");this.p=e;this.p.useProp=!!a.fn.prop;
var k,l;if(0===this.p.colNames.length)for(k=0;k<this.p.colModel.length;k++)this.p.colNames[k]=this.p.colModel[k].label||this.p.colModel[k].name;if(this.p.colNames.length!==this.p.colModel.length)alert(a.jgrid.errors.model);else{var p=a("<div class='ui-jqgrid-view' role='grid'></div>");c=a.jgrid.msie;d.p.direction=a.trim(d.p.direction.toLowerCase());-1===a.inArray(d.p.direction,["ltr","rtl"])&&(d.p.direction="ltr");l=d.p.direction;a(p).insertBefore(this);a(this).removeClass("scroll").appendTo(p);var m=
a("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");a(m).attr({id:"gbox_"+this.id,dir:l}).insertBefore(p);a(p).attr("id","gview_"+this.id).appendTo(m);a("<div class='ui-widget-overlay jqgrid-overlay' id='lui_"+this.id+"'></div>").insertBefore(p);a("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'>"+this.p.loadtext+"</div>").insertBefore(p);a(this).attr({cellspacing:"0",cellpadding:"0",border:"0",role:"presentation","aria-multiselectable":!!this.p.multiselect,
"aria-labelledby":"gbox_"+this.id});var r=function(a,d){a=parseInt(a,10);return isNaN(a)?d||0:a},q=function(b,c,e,f,k,g){var l=d.p.colModel[b],p=l.align,n='style="',m=l.classes,r=l.name,q=[];p&&(n+="text-align:"+p+";");!0===l.hidden&&(n+="display:none;");if(0===c)n+="width: "+h.headers[b].width+"px;";else if(a.isFunction(l.cellattr)||"string"===typeof l.cellattr&&null!=a.jgrid.cellattr&&a.isFunction(a.jgrid.cellattr[l.cellattr]))if(b=a.isFunction(l.cellattr)?l.cellattr:a.jgrid.cellattr[l.cellattr],
(f=b.call(d,k,e,f,l,g))&&"string"===typeof f)if(f=f.replace(/style/i,"style").replace(/title/i,"title"),-1<f.indexOf("title")&&(l.title=!1),-1<f.indexOf("class")&&(m=void 0),q=f.replace(/\-style/g,"-sti").split(/style/),2===q.length){q[1]=a.trim(q[1].replace(/\-sti/g,"-style").replace("=",""));if(0===q[1].indexOf("'")||0===q[1].indexOf('"'))q[1]=q[1].substring(1);n+=q[1].replace(/'/gi,'"')}else n+='"';q.length||(q[0]="",n+='"');n+=(void 0!==m?' class="'+m+'"':"")+(l.title&&e?' title="'+a.jgrid.stripHtml(e)+
'"':"");n+=' aria-describedby="'+d.p.id+"_"+r+'"';return n+q[0]},n=function(b){return null==b||""===b?"&#160;":d.p.autoencode?a.jgrid.htmlEncode(b):String(b)},s=function(b,c,e,f,h){var k=d.p.colModel[e];void 0!==k.formatter?(b=""!==String(d.p.idPrefix)?a.jgrid.stripPref(d.p.idPrefix,b):b,b={rowId:b,colModel:k,gid:d.p.id,pos:e},c=a.isFunction(k.formatter)?k.formatter.call(d,c,b,f,h):a.fmatter?a.fn.fmatter.call(d,k.formatter,c,b,f,h):n(c)):c=n(c);return c},u=function(a,d,b,c,e,f){d=s(a,d,b,e,"add");
return'<td role="gridcell" '+q(b,c,d,e,a,f)+">"+d+"</td>"},y=function(a,b,c,e){e='<input role="checkbox" type="checkbox" id="jqg_'+d.p.id+"_"+a+'" class="cbox" name="jqg_'+d.p.id+"_"+a+'"'+(e?'checked="checked"':"")+"/>";return'<td role="gridcell" '+q(b,c,"",null,a,!0)+">"+e+"</td>"},t=function(a,d,b,c){b=(parseInt(b,10)-1)*parseInt(c,10)+1+d;return'<td role="gridcell" class="ui-state-default jqgrid-rownum" '+q(a,d,b,null,d,!0)+">"+b+"</td>"},x=function(a){var b,c=[],e=0,f;for(f=0;f<d.p.colModel.length;f++)b=
d.p.colModel[f],"cb"!==b.name&&"subgrid"!==b.name&&"rn"!==b.name&&(c[e]="local"===a?b.name:"xml"===a||"xmlstring"===a?b.xmlmap||b.name:b.jsonmap||b.name,!1!==d.p.keyName&&!0===b.key&&(d.p.keyName=c[e]),e++);return c},A=function(b){var c=d.p.remapColumns;c&&c.length||(c=a.map(d.p.colModel,function(a,d){return d}));b&&(c=a.map(c,function(a){return a<b?null:a-b}));return c},w=function(d,b){var c;this.p.deepempty?a(this.rows).slice(1).remove():(c=0<this.rows.length?this.rows[0]:null,a(this.firstChild).empty().append(c));
d&&this.p.scroll&&(a(this.grid.bDiv.firstChild).css({height:"auto"}),a(this.grid.bDiv.firstChild.firstChild).css({height:0,display:"none"}),0!==this.grid.bDiv.scrollTop&&(this.grid.bDiv.scrollTop=0));!0===b&&this.p.treeGrid&&(this.p.data=[],this.p._index={})},z=function(){var b=d.p,c=b.data,e=c.length,f,h,k,g,l,n=b.localReader,p=b.colModel,m=n.cell,r=(!0===b.multiselect?1:0)+(!0===b.subGrid?1:0)+(!0===b.rownumbers?1:0),q=b.scroll?a.jgrid.randId():1,u,s,t;if("local"===b.datatype&&!0===n.repeatitems)for(u=
A(r),s=x("local"),k=!1===b.keyIndex?a.isFunction(n.id)?n.id.call(d,c):n.id:b.keyIndex,b=0;b<e;b++){h=c[b];f=a.jgrid.getAccessor(h,k);void 0===f&&("number"===typeof k&&null!=p[k+r]&&(f=a.jgrid.getAccessor(h,p[k+r].name)),void 0===f&&(f=q+b,m&&(g=a.jgrid.getAccessor(h,m)||h,f=null!=g&&void 0!==g[k]?g[k]:f)));g={};g[n.id]=f;m&&(h=a.jgrid.getAccessor(h,m)||h);t=a.isArray(h)?u:s;for(f=0;f<t.length;f++)l=a.jgrid.getAccessor(h,t[f]),g[p[f+r].name]=l;a.extend(!0,c[b],g)}},v=function(){var b=d.p.data.length,
c,e,f;c=!1===d.p.keyName||!0===d.p.loadonce?d.p.localReader.id:d.p.keyName;d.p._index=[];for(e=0;e<b;e++)f=a.jgrid.getAccessor(d.p.data[e],c),void 0===f&&(f=String(e+1)),d.p._index[f]=e},D=function(b,c,e,f,h,k){var g="-1",l="",n;c=c?"display:none;":"";e="ui-widget-content jqgrow ui-row-"+d.p.direction+(e?" "+e:"")+(k?" ui-state-highlight":"");k=a(d).triggerHandler("jqGridRowAttr",[f,h,b]);"object"!==typeof k&&(k=a.isFunction(d.p.rowattr)?d.p.rowattr.call(d,f,h,b):"string"===typeof d.p.rowattr&&null!=
a.jgrid.rowattr&&a.isFunction(a.jgrid.rowattr[d.p.rowattr])?a.jgrid.rowattr[d.p.rowattr].call(d,f,h,b):{});if(!a.isEmptyObject(k)){k.hasOwnProperty("id")&&(b=k.id,delete k.id);k.hasOwnProperty("tabindex")&&(g=k.tabindex,delete k.tabindex);k.hasOwnProperty("style")&&(c+=k.style,delete k.style);k.hasOwnProperty("class")&&(e+=" "+k["class"],delete k["class"]);try{delete k.role}catch(p){}for(n in k)k.hasOwnProperty(n)&&(l+=" "+n+"="+k[n])}return'<tr role="row" id="'+b+'" tabindex="'+g+'" class="'+e+'"'+
(""===c?"":' style="'+c+'"')+l+">"},C=function(b,c,e,f,h){var k=new Date,g="local"!==d.p.datatype&&d.p.loadonce||"xmlstring"===d.p.datatype,l=d.p.xmlReader,n="local"===d.p.datatype?"local":"xml";g&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;if(a.isXMLDoc(b)){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(w.call(d,!1,!0),e=1);var p=a(d),m,q,s=0,v,J=!0===d.p.multiselect?1:0,P=0,C,z=!0===d.p.rownumbers?1:0,N,G=[],B,I={},K,E,H=[],Y=!0===d.p.altRows?d.p.altclass:"",ia;!0===d.p.subGrid&&
(P=1,C=a.jgrid.getMethod("addSubGridCell"));l.repeatitems||(G=x(n));N=!1===d.p.keyName?a.isFunction(l.id)?l.id.call(d,b):l.id:d.p.keyName;n=-1===String(N).indexOf("[")?G.length?function(b,d){return a(N,b).text()||d}:function(b,d){return a(l.cell,b).eq(N).text()||d}:function(a,b){return a.getAttribute(N.replace(/[\[\]]/g,""))||b};d.p.userData={};d.p.page=r(a.jgrid.getXmlData(b,l.page),d.p.page);d.p.lastpage=r(a.jgrid.getXmlData(b,l.total),1);d.p.records=r(a.jgrid.getXmlData(b,l.records));a.isFunction(l.userdata)?
d.p.userData=l.userdata.call(d,b)||{}:a.jgrid.getXmlData(b,l.userdata,!0).each(function(){d.p.userData[this.getAttribute("name")]=a(this).text()});b=a.jgrid.getXmlData(b,l.root,!0);(b=a.jgrid.getXmlData(b,l.row,!0))||(b=[]);var S=b.length,O=0,U=[],F=parseInt(d.p.rowNum,10),M=d.p.scroll?a.jgrid.randId():1;0<S&&0>=d.p.page&&(d.p.page=1);if(b&&S){h&&(F*=h+1);h=a.isFunction(d.p.afterInsertRow);var L=!1,T;d.p.grouping&&(L=!0===d.p.groupingView.groupCollapse,T=a.jgrid.getMethod("groupingPrepare"));for(;O<
S;){K=b[O];E=n(K,M+O);E=d.p.idPrefix+E;m=0===e?0:e+1;ia=1===(m+O)%2?Y:"";var V=H.length;H.push("");z&&H.push(t(0,O,d.p.page,d.p.rowNum));J&&H.push(y(E,z,O,!1));P&&H.push(C.call(p,J+z,O+e));if(l.repeatitems){B||(B=A(J+P+z));var ba=a.jgrid.getXmlData(K,l.cell,!0);a.each(B,function(a){var b=ba[this];if(!b)return!1;v=b.textContent||b.text;I[d.p.colModel[a+J+P+z].name]=v;H.push(u(E,v,a+J+P+z,O+e,K,I))})}else for(m=0;m<G.length;m++)v=a.jgrid.getXmlData(K,G[m]),I[d.p.colModel[m+J+P+z].name]=v,H.push(u(E,
v,m+J+P+z,O+e,K,I));H[V]=D(E,L,ia,I,K,!1);H.push("</tr>");d.p.grouping&&(U.push(H),d.p.groupingView._locgr||T.call(p,I,O),H=[]);if(g||!0===d.p.treeGrid)I._id_=a.jgrid.stripPref(d.p.idPrefix,E),d.p.data.push(I),d.p._index[I._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("tbody:first",c).append(H.join("")),p.triggerHandler("jqGridAfterInsertRow",[E,I,K]),h&&d.p.afterInsertRow.call(d,E,I,K),H=[]);I={};s++;O++;if(s===F)break}}!0===d.p.gridview&&(q=-1<d.p.treeANode?d.p.treeANode:0,d.p.grouping?g||(p.jqGrid("groupingRender",
U,d.p.colModel.length,d.p.page,F),U=null):!0===d.p.treeGrid&&0<q?a(d.rows[q]).after(H.join("")):(d.firstElementChild.innerHTML+=H.join(""),d.grid.cols=d.rows[0].cells));if(!0===d.p.subGrid)try{p.jqGrid("addSubGrid",J+z)}catch(Z){}d.p.totaltime=new Date-k;0<s&&0===d.p.records&&(d.p.records=S);H=null;if(!0===d.p.treeGrid)try{p.jqGrid("setTreeNode",q+1,s+q+1)}catch(Q){}d.p.reccount=s;d.p.treeANode=-1;d.p.userDataOnFooter&&p.jqGrid("footerData","set",d.p.userData,!0);g&&(d.p.records=S,d.p.lastpage=Math.ceil(S/
F));f||d.updatepager(!1,!0);if(g){for(;s<S;){K=b[s];E=n(K,s+M);E=d.p.idPrefix+E;if(l.repeatitems){B||(B=A(J+P+z));var $=a.jgrid.getXmlData(K,l.cell,!0);a.each(B,function(a){var b=$[this];if(!b)return!1;v=b.textContent||b.text;I[d.p.colModel[a+J+P+z].name]=v})}else for(m=0;m<G.length;m++)v=a.jgrid.getXmlData(K,G[m]),I[d.p.colModel[m+J+P+z].name]=v;I._id_=a.jgrid.stripPref(d.p.idPrefix,E);d.p.grouping&&T.call(p,I,s);d.p.data.push(I);d.p._index[I._id_]=d.p.data.length-1;I={};s++}d.p.grouping&&(d.p.groupingView._locgr=
!0,p.jqGrid("groupingRender",U,d.p.colModel.length,d.p.page,F),U=null)}}},B=function(b,c,e,f,h){var k=new Date;if(b){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(w.call(d,!1,!0),e=1);var g,l="local"!==d.p.datatype&&d.p.loadonce||"jsonstring"===d.p.datatype;l&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;"local"===d.p.datatype?(c=d.p.localReader,g="local"):(c=d.p.jsonReader,g="json");var n=a(d),p=0,m,q,s,v=[],J=d.p.multiselect?1:0,P=!0===d.p.subGrid?1:0,C,z=!0===d.p.rownumbers?
1:0,N=A(J+P+z);g=x(g);var I,G,E,K={},H,B,O=[],S=!0===d.p.altRows?d.p.altclass:"",U;d.p.page=r(a.jgrid.getAccessor(b,c.page),d.p.page);d.p.lastpage=r(a.jgrid.getAccessor(b,c.total),1);d.p.records=r(a.jgrid.getAccessor(b,c.records));d.p.userData=a.jgrid.getAccessor(b,c.userdata)||{};P&&(C=a.jgrid.getMethod("addSubGridCell"));E=!1===d.p.keyName?a.isFunction(c.id)?c.id.call(d,b):c.id:d.p.keyName;G=a.jgrid.getAccessor(b,c.root);null==G&&a.isArray(b)&&(G=b);G||(G=[]);b=G.length;q=0;0<b&&0>=d.p.page&&(d.p.page=
1);var F=parseInt(d.p.rowNum,10),Y=d.p.scroll?a.jgrid.randId():1,M=!1,L;h&&(F*=h+1);"local"!==d.p.datatype||d.p.deselectAfterSort||(M=!0);var T=a.isFunction(d.p.afterInsertRow),V=[],ba=!1,Z;d.p.grouping&&(ba=!0===d.p.groupingView.groupCollapse,Z=a.jgrid.getMethod("groupingPrepare"));for(;q<b;){h=G[q];B=a.jgrid.getAccessor(h,E);void 0===B&&("number"===typeof E&&null!=d.p.colModel[E+J+P+z]&&(B=a.jgrid.getAccessor(h,d.p.colModel[E+J+P+z].name)),void 0===B&&(B=Y+q,0===v.length&&c.cell&&(m=a.jgrid.getAccessor(h,
c.cell)||h,B=null!=m&&void 0!==m[E]?m[E]:B)));B=d.p.idPrefix+B;m=1===e?0:e;U=1===(m+q)%2?S:"";M&&(L=d.p.multiselect?-1!==a.inArray(B,d.p.selarrrow):B===d.p.selrow);var Q=O.length;O.push("");z&&O.push(t(0,q,d.p.page,d.p.rowNum));J&&O.push(y(B,z,q,L));P&&O.push(C.call(n,J+z,q+e));I=g;c.repeatitems&&(c.cell&&(h=a.jgrid.getAccessor(h,c.cell)||h),a.isArray(h)&&(I=N));for(s=0;s<I.length;s++)m=a.jgrid.getAccessor(h,I[s]),K[d.p.colModel[s+J+P+z].name]=m,O.push(u(B,m,s+J+P+z,q+e,h,K));O[Q]=D(B,ba,U,K,h,L);
O.push("</tr>");d.p.grouping&&(V.push(O),d.p.groupingView._locgr||Z.call(n,K,q),O=[]);if(l||!0===d.p.treeGrid)K._id_=a.jgrid.stripPref(d.p.idPrefix,B),d.p.data.push(K),d.p._index[K._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("#"+a.jgrid.jqID(d.p.id)+" tbody:first").append(O.join("")),n.triggerHandler("jqGridAfterInsertRow",[B,K,h]),T&&d.p.afterInsertRow.call(d,B,K,h),O=[]);K={};p++;q++;if(p===F)break}!0===d.p.gridview&&(H=-1<d.p.treeANode?d.p.treeANode:0,d.p.grouping?l||(n.jqGrid("groupingRender",
V,d.p.colModel.length,d.p.page,F),V=null):!0===d.p.treeGrid&&0<H?a(d.rows[H]).after(O.join("")):(d.firstElementChild.innerHTML+=O.join(""),d.grid.cols=d.rows[0].cells));if(!0===d.p.subGrid)try{n.jqGrid("addSubGrid",J+z)}catch($){}d.p.totaltime=new Date-k;0<p&&0===d.p.records&&(d.p.records=b);if(!0===d.p.treeGrid)try{n.jqGrid("setTreeNode",H+1,p+H+1)}catch(da){}d.p.reccount=p;d.p.treeANode=-1;d.p.userDataOnFooter&&n.jqGrid("footerData","set",d.p.userData,!0);l&&(d.p.records=b,d.p.lastpage=Math.ceil(b/
F));f||d.updatepager(!1,!0);if(l){for(;p<b&&G[p];){h=G[p];B=a.jgrid.getAccessor(h,E);void 0===B&&("number"===typeof E&&null!=d.p.colModel[E+J+P+z]&&(B=a.jgrid.getAccessor(h,d.p.colModel[E+J+P+z].name)),void 0===B&&(B=Y+p,0===v.length&&c.cell&&(e=a.jgrid.getAccessor(h,c.cell)||h,B=null!=e&&void 0!==e[E]?e[E]:B)));if(h){B=d.p.idPrefix+B;I=g;c.repeatitems&&(c.cell&&(h=a.jgrid.getAccessor(h,c.cell)||h),a.isArray(h)&&(I=N));for(s=0;s<I.length;s++)K[d.p.colModel[s+J+P+z].name]=a.jgrid.getAccessor(h,I[s]);
K._id_=a.jgrid.stripPref(d.p.idPrefix,B);d.p.grouping&&Z.call(n,K,p);d.p.data.push(K);d.p._index[K._id_]=d.p.data.length-1;K={}}p++}d.p.grouping&&(d.p.groupingView._locgr=!0,n.jqGrid("groupingRender",V,d.p.colModel.length,d.p.page,F))}}},G=function(){function b(a){var d=0,c,e,f,k,g;if(null!=a.groups){(e=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&s.orBegin();for(c=0;c<a.groups.length;c++){0<d&&e&&s.or();try{b(a.groups[c])}catch(l){alert(l)}d++}e&&s.orEnd()}if(null!=a.rules)try{(f=
a.rules.length&&"OR"===a.groupOp.toString().toUpperCase())&&s.orBegin();for(c=0;c<a.rules.length;c++)g=a.rules[c],k=a.groupOp.toString().toUpperCase(),u[g.op]&&g.field&&(0<d&&k&&"OR"===k&&(s=s.or()),s=u[g.op](s,k)(g.field,g.data,h[g.field])),d++;f&&s.orEnd()}catch(n){alert(n)}}var c=d.p.multiSort?[]:"",e=[],f=!1,h={},k=[],g=[],l,n,p;if(a.isArray(d.p.data)){var m=d.p.grouping?d.p.groupingView:!1,r,q;a.each(d.p.colModel,function(){n=this.sorttype||"text";"date"===n||"datetime"===n?(this.formatter&&
"string"===typeof this.formatter&&"date"===this.formatter?(l=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:a.jgrid.formatter.date.srcformat,p=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:a.jgrid.formatter.date.newformat):l=p=this.datefmt||"Y-m-d",h[this.name]={stype:n,srcfmt:l,newfmt:p,sfunc:this.sortfunc||null}):h[this.name]={stype:n,srcfmt:"",newfmt:"",sfunc:this.sortfunc||null};if(d.p.grouping)for(q=0,r=m.groupField.length;q<r;q++)if(this.name===
m.groupField[q]){var b=this.name;this.index&&(b=this.index);k[q]=h[b];g[q]=b}d.p.multiSort?this.lso&&(c.push(this.name),b=this.lso.split("-"),e.push(b[b.length-1])):f||this.index!==d.p.sortname&&this.name!==d.p.sortname||(c=this.name,f=!0)});if(d.p.treeGrid)a(d).jqGrid("SortTree",c,d.p.sortorder,h[c].stype||"text",h[c].srcfmt||"");else{var u={eq:function(a){return a.equals},ne:function(a){return a.notEquals},lt:function(a){return a.less},le:function(a){return a.lessOrEquals},gt:function(a){return a.greater},
...
b){return"OR"===b?a.orNot().isNull:a.andNot().isNull}},s=a.jgrid.from(d.p.data);d.p.ignoreCase&&(s=s.ignoreCase());if(!0===d.p.search){var t=d.p.postData.filters;if(t)"string"===typeof t&&(t=a.jgrid.parse(t)),b(t);else try{s=u[d.p.postData.searchOper](s)(d.p.postData.searchField,d.p.postData.searchString,h[d.p.postData.searchField])}catch(v){}}if(d.p.grouping)for(q=0;q<r;q++)s.orderBy(g[q],m.groupOrder[q],k[q].stype,k[q].srcfmt);d.p.multiSort?a.each(c,function(a){s.orderBy(this,e[a],h[this].stype,
h[this].srcfmt,h[this].sfunc)}):c&&d.p.sortorder&&f&&("DESC"===d.p.sortorder.toUpperCase()?s.orderBy(d.p.sortname,"d",h[c].stype,h[c].srcfmt,h[c].sfunc):s.orderBy(d.p.sortname,"a",h[c].stype,h[c].srcfmt,h[c].sfunc));var t=s.select(),w=parseInt(d.p.rowNum,10),x=t.length,y=parseInt(d.p.page,10),A=Math.ceil(x/w),D={};if((d.p.search||d.p.resetsearch)&&d.p.grouping&&d.p.groupingView._locgr){d.p.groupingView.groups=[];var J,P=a.jgrid.getMethod("groupingPrepare"),z,C;if(d.p.footerrow&&d.p.userDataOnFooter){for(z in d.p.userData)d.p.userData.hasOwnProperty(z)&&
(d.p.userData[z]=0);C=!0}for(J=0;J<x;J++){if(C)for(z in d.p.userData)d.p.userData[z]+=parseFloat(t[J][z]||0);P.call(a(d),t[J],J,w)}}t=t.slice((y-1)*w,y*w);h=s=null;D[d.p.localReader.total]=A;D[d.p.localReader.page]=y;D[d.p.localReader.records]=x;D[d.p.localReader.root]=t;D[d.p.localReader.userdata]=d.p.userData;t=null;return D}}},H=function(){d.grid.hDiv.loading=!0;d.p.hiddengrid||a(d).jqGrid("progressBar",{method:"show",loadtype:d.p.loadui,htmlcontent:d.p.loadtext})},F=function(){d.grid.hDiv.loading=
!1;a(d).jqGrid("progressBar",{method:"hide",loadtype:d.p.loadui})},L=function(b){if(!d.grid.hDiv.loading){var c=d.p.scroll&&!1===b,e={},f,h=d.p.prmNames;0>=d.p.page&&(d.p.page=Math.min(1,d.p.lastpage));null!==h.search&&(e[h.search]=d.p.search);null!==h.nd&&(e[h.nd]=(new Date).getTime());null!==h.rows&&(e[h.rows]=d.p.rowNum);null!==h.page&&(e[h.page]=d.p.page);null!==h.sort&&(e[h.sort]=d.p.sortname);null!==h.order&&(e[h.order]=d.p.sortorder);null!==d.p.rowTotal&&null!==h.totalrows&&(e[h.totalrows]=
d.p.rowTotal);var k=a.isFunction(d.p.loadComplete),g=k?d.p.loadComplete:null,l=0;b=b||1;1<b?null!==h.npage?(e[h.npage]=b,l=b-1,b=1):g=function(a){d.p.page++;d.grid.hDiv.loading=!1;k&&d.p.loadComplete.call(d,a);L(b-1)}:null!==h.npage&&delete d.p.postData[h.npage];if(d.p.grouping){a(d).jqGrid("groupingSetup");var n=d.p.groupingView,p,m="";for(p=0;p<n.groupField.length;p++){var r=n.groupField[p];a.each(d.p.colModel,function(a,b){b.name===r&&b.index&&(r=b.index)});m+=r+" "+n.groupOrder[p]+", "}e[h.sort]=
m+e[h.sort]}a.extend(d.p.postData,e);var q=d.p.scroll?d.rows.length-1:1,e=a(d).triggerHandler("jqGridBeforeRequest");if(!1!==e&&"stop"!==e)if(a.isFunction(d.p.datatype))d.p.datatype.call(d,d.p.postData,"load_"+d.p.id,q,b,l);else{if(a.isFunction(d.p.beforeRequest)&&(e=d.p.beforeRequest.call(d),void 0===e&&(e=!0),!1===e))return;f=d.p.datatype.toLowerCase();switch(f){case "json":case "jsonp":case "xml":case "script":a.ajax(a.extend({url:d.p.url,type:d.p.mtype,dataType:f,data:a.isFunction(d.p.serializeGridData)?
d.p.serializeGridData.call(d,d.p.postData):d.p.postData,success:function(e,h,k){if(a.isFunction(d.p.beforeProcessing)&&!1===d.p.beforeProcessing.call(d,e,h,k))F();else{"xml"===f?C(e,d.grid.bDiv,q,1<b,l):B(e,d.grid.bDiv,q,1<b,l);a(d).triggerHandler("jqGridLoadComplete",[e]);g&&g.call(d,e);a(d).triggerHandler("jqGridAfterLoadComplete",[e]);c&&d.grid.populateVisible();if(d.p.loadonce||d.p.treeGrid)d.p.datatype="local";1===b&&F()}},error:function(c,e,f){a.isFunction(d.p.loadError)&&d.p.loadError.call(d,
c,e,f);1===b&&F()},beforeSend:function(b,c){var e=!0;a.isFunction(d.p.loadBeforeSend)&&(e=d.p.loadBeforeSend.call(d,b,c));void 0===e&&(e=!0);if(!1===e)return!1;H()}},a.jgrid.ajaxOptions,d.p.ajaxGridOptions));break;case "xmlstring":H();e="string"!==typeof d.p.datastr?d.p.datastr:a.parseXML(d.p.datastr);C(e,d.grid.bDiv);a(d).triggerHandler("jqGridLoadComplete",[e]);k&&d.p.loadComplete.call(d,e);a(d).triggerHandler("jqGridAfterLoadComplete",[e]);d.p.datatype="local";d.p.datastr=null;F();break;case "jsonstring":H();
e="string"===typeof d.p.datastr?a.jgrid.parse(d.p.datastr):d.p.datastr;B(e,d.grid.bDiv);a(d).triggerHandler("jqGridLoadComplete",[e]);k&&d.p.loadComplete.call(d,e);a(d).triggerHandler("jqGridAfterLoadComplete",[e]);d.p.datatype="local";d.p.datastr=null;F();break;case "local":case "clientside":H(),d.p.datatype="local",e=G(),B(e,d.grid.bDiv,q,1<b,l),a(d).triggerHandler("jqGridLoadComplete",[e]),g&&g.call(d,e),a(d).triggerHandler("jqGridAfterLoadComplete",[e]),c&&d.grid.populateVisible(),F()}}}},Q=function(b){a("#cb_"+
a.jgrid.jqID(d.p.id),d.grid.hDiv)[d.p.useProp?"prop":"attr"]("checked",b);if(d.p.frozenColumns&&d.p.id+"_frozen")a("#cb_"+a.jgrid.jqID(d.p.id),d.grid.fhDiv)[d.p.useProp?"prop":"attr"]("checked",b)},X=function(b,c){var e="",f="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",h="",k,g,n,p,m=function(b){var c;a.isFunction(d.p.onPaging)&&(c=d.p.onPaging.call(d,b));if("stop"===c)return!1;d.p.selrow=null;d.p.multiselect&&(d.p.selarrrow=[],Q(!1));
d.p.savedRow=[];return!0};b=b.substr(1);c+="_"+b;k="pg_"+b;g=b+"_left";n=b+"_center";p=b+"_right";a("#"+a.jgrid.jqID(b)).append("<div id='"+k+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;'><tbody><tr><td id='"+g+"' align='left'></td><td id='"+n+"' align='center' style='white-space:pre;'></td><td id='"+p+"' align='right'></td></tr></tbody></table></div>").attr("dir","ltr");if(0<d.p.rowList.length){h=
"<td dir='"+l+"'>";h+="<select class='ui-pg-selbox' role='listbox' "+(d.p.pgrecs?"title='"+d.p.pgrecs+"'":"")+">";for(g=0;g<d.p.rowList.length;g++)n=d.p.rowList[g].toString().split(":"),1===n.length&&(n[1]=n[0]),h+='<option role="option" value="'+n[0]+'"'+(r(d.p.rowNum,0)===r(n[0],0)?' selected="selected"':"")+">"+n[1]+"</option>";h+="</select></td>"}"rtl"===l&&(f+=h);!0===d.p.pginput&&(e="<td id='input"+c+"' dir='"+l+"'>"+a.jgrid.template(d.p.pgtext||"","<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>",
...
d.p._nvtd[0]=f?Math.floor((d.p.width-f)/2):Math.floor(d.p.width/3);d.p._nvtd[1]=0;f=null;a(".ui-pg-selbox","#"+k).bind("change",function(){if(!m("records"))return!1;d.p.page=Math.round(d.p.rowNum*(d.p.page-1)/this.value-.5)+1;d.p.rowNum=this.value;d.p.pager&&a(".ui-pg-selbox",d.p.pager).val(this.value);d.p.toppager&&a(".ui-pg-selbox",d.p.toppager).val(this.value);L();return!1});!0===d.p.pgbuttons&&(a(".ui-pg-button","#"+k).hover(function(){a(this).hasClass("ui-state-disabled")?this.style.cursor="default":
...
g=!1,b=e-1);if(!m(this.id))return!1;this.id==="first"+c&&h&&(d.p.page=1,f=!0);this.id==="prev"+c&&k&&(d.p.page=b-1,f=!0);this.id==="next"+c&&g&&(d.p.page=b+1,f=!0);this.id==="last"+c&&l&&(d.p.page=e,f=!0);f&&L();return!1}));!0===d.p.pginput&&a("input.ui-pg-input","#"+k).keypress(function(b){if(13===(b.charCode||b.keyCode||0)){if(!m("user"))return!1;a(this).val(r(a(this).val(),1));d.p.page=0<a(this).val()?a(this).val():d.p.page;L();return!1}return this})},ca=function(b,c){var e,f="",h=d.p.colModel,
...
id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},d.p.jsonReader);d.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},d.p.localReader);d.p.scroll&&(d.p.pgbuttons=!1,d.p.pginput=!1,d.p.rowList=[]);d.p.data.length&&(z(),v());N="<thead><tr class='ui-jqgrid-labels' role='row'>";var U,I,V,Y,ba,E,M,T,ja=T="",Z=[],ka=[];I=[];if(!0===d.p.shrinkToFit&&
!0===d.p.forceFit)for(k=d.p.colModel.length-1;0<=k;k--)if(!d.p.colModel[k].hidden){d.p.colModel[k].resizable=!1;break}"horizontal"===d.p.viewsortcols[1]&&(T=" ui-i-asc",ja=" ui-i-desc");U=c?"class='ui-th-div-ie'":"";T="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+T+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+l+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ja+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+
l+"'></span></span>");if(d.p.multiSort)for(Z=d.p.sortname.split(","),k=0;k<Z.length;k++)I=a.trim(Z[k]).split(" "),Z[k]=a.trim(I[0]),ka[k]=I[1]?a.trim(I[1]):d.p.sortorder||"asc";for(k=0;k<this.p.colNames.length;k++)I=d.p.headertitles?' title="'+a.jgrid.stripHtml(d.p.colNames[k])+'"':"",N+="<th id='"+d.p.id+"_"+d.p.colModel[k].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+l+"'"+I+">",I=d.p.colModel[k].index||d.p.colModel[k].name,N+="<div id='jqgh_"+d.p.id+"_"+d.p.colModel[k].name+
"' "+U+">"+d.p.colNames[k],d.p.colModel[k].width=d.p.colModel[k].width?parseInt(d.p.colModel[k].width,10):150,"boolean"!==typeof d.p.colModel[k].title&&(d.p.colModel[k].title=!0),d.p.colModel[k].lso="",I===d.p.sortname&&(d.p.lastsort=k),d.p.multiSort&&(I=a.inArray(I,Z),-1!==I&&(d.p.colModel[k].lso=ka[I])),N+=T+"</div></th>";N+="</tr></thead>";T=null;a(this).append(N);a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});
if(this.p.multiselect){var fa=[],da;a("#cb_"+a.jgrid.jqID(d.p.id),this).bind("click",function(){d.p.selarrrow=[];var b=!0===d.p.frozenColumns?d.p.id+"_frozen":"";this.checked?(a(d.rows).each(function(c){0<c&&!(a(this).hasClass("ui-subgrid")||a(this).hasClass("jqgroup")||a(this).hasClass("ui-state-disabled")||a(this).hasClass("jqfoot"))&&(a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id))[d.p.useProp?"prop":"attr"]("checked",!0),a(this).addClass("ui-state-highlight").attr("aria-selected","true"),
d.p.selarrrow.push(this.id),d.p.selrow=this.id,b&&(a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id),d.grid.fbDiv)[d.p.useProp?"prop":"attr"]("checked",!0),a("#"+a.jgrid.jqID(this.id),d.grid.fbDiv).addClass("ui-state-highlight")))}),da=!0,fa=[]):(a(d.rows).each(function(c){0<c&&!(a(this).hasClass("ui-subgrid")||a(this).hasClass("jqgroup")||a(this).hasClass("ui-state-disabled")||a(this).hasClass("jqfoot"))&&(a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id))[d.p.useProp?"prop":"attr"]("checked",
!1),a(this).removeClass("ui-state-highlight").attr("aria-selected","false"),fa.push(this.id),b&&(a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id),d.grid.fbDiv)[d.p.useProp?"prop":"attr"]("checked",!1),a("#"+a.jgrid.jqID(this.id),d.grid.fbDiv).removeClass("ui-state-highlight")))}),d.p.selrow=null,da=!1);a(d).triggerHandler("jqGridSelectAll",[da?d.p.selarrrow:fa,da]);a.isFunction(d.p.onSelectAll)&&d.p.onSelectAll.call(d,da?d.p.selarrrow:fa,da)})}!0===d.p.autowidth&&(N=a(m).innerWidth(),d.p.width=
0<N?N:"nw");(function(){var b=0,c=a.jgrid.cell_width?0:r(d.p.cellLayout,0),e=0,f,k=r(d.p.scrollOffset,0),g,l=!1,n,p=0,m;a.each(d.p.colModel,function(){void 0===this.hidden&&(this.hidden=!1);if(d.p.grouping&&d.p.autowidth){var f=a.inArray(this.name,d.p.groupingView.groupField);0<=f&&d.p.groupingView.groupColumnShow.length>f&&(this.hidden=!d.p.groupingView.groupColumnShow[f])}this.widthOrg=g=r(this.width,0);!1===this.hidden&&(b+=g+c,this.fixed?p+=g+c:e++)});isNaN(d.p.width)&&(d.p.width=b+(!1!==d.p.shrinkToFit||
isNaN(d.p.height)?0:k));h.width=d.p.width;d.p.tblwidth=b;!1===d.p.shrinkToFit&&!0===d.p.forceFit&&(d.p.forceFit=!1);!0===d.p.shrinkToFit&&0<e&&(n=h.width-c*e-p,isNaN(d.p.height)||(n-=k,l=!0),b=0,a.each(d.p.colModel,function(a){!1!==this.hidden||this.fixed||(this.width=g=Math.round(n*this.width/(d.p.tblwidth-c*e-p)),b+=g,f=a)}),m=0,l?h.width-p-(b+c*e)!==k&&(m=h.width-p-(b+c*e)-k):l||1===Math.abs(h.width-p-(b+c*e))||(m=h.width-p-(b+c*e)),d.p.colModel[f].width+=m,d.p.tblwidth=b+m+c*e+p,d.p.tblwidth>
d.p.width&&(d.p.colModel[f].width-=d.p.tblwidth-parseInt(d.p.width,10),d.p.tblwidth=d.p.width))})();a(m).css("width",h.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+d.p.id+"'>&#160;</div>");a(p).css("width",h.width+"px");N=a("thead:first",d).get(0);var $="";d.p.footerrow&&($+="<table role='presentation' style='width:"+d.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+l+"'>");var p=
a("tr:first",N),ea="<tr class='jqgfirstrow' role='row' style='height:auto'>";d.p.disableClick=!1;a("th",p).each(function(b){V=d.p.colModel[b].width;void 0===d.p.colModel[b].resizable&&(d.p.colModel[b].resizable=!0);d.p.colModel[b].resizable?(Y=document.createElement("span"),a(Y).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+l).css("cursor","col-resize"),a(this).addClass(d.p.resizeclass)):Y="";a(this).css("width",V+"px").prepend(Y);Y=null;var c="";d.p.colModel[b].hidden&&(a(this).css("display",
"none"),c="display:none;");ea+="<td role='gridcell' style='height:0px;width:"+V+"px;"+c+"'></td>";h.headers[b]={width:V,el:this};ba=d.p.colModel[b].sortable;"boolean"!==typeof ba&&(ba=d.p.colModel[b].sortable=!0);c=d.p.colModel[b].name;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&d.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");ba&&(d.p.multiSort?d.p.viewsortcols[0]?(a("div span.s-ico",this).show(),d.p.colModel[b].lso&&a("div span.ui-icon-"+d.p.colModel[b].lso,this).removeClass("ui-state-disabled")):
d.p.colModel[b].lso&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+d.p.colModel[b].lso,this).removeClass("ui-state-disabled")):d.p.viewsortcols[0]?(a("div span.s-ico",this).show(),b===d.p.lastsort&&a("div span.ui-icon-"+d.p.sortorder,this).removeClass("ui-state-disabled")):b===d.p.lastsort&&""!==d.p.sortname&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+d.p.sortorder,this).removeClass("ui-state-disabled")));d.p.footerrow&&($+="<td role='gridcell' "+q(b,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(b){if(1===
a(b.target).closest("th>span.ui-jqgrid-resize").length){var c=P(this);if(!0===d.p.forceFit){var e=d.p,f=c,k;for(k=c+1;k<d.p.colModel.length;k++)if(!0!==d.p.colModel[k].hidden){f=k;break}e.nv=f-c}h.dragStart(c,b,J(c));return!1}}).click(function(b){if(d.p.disableClick)return d.p.disableClick=!1;var c="th>div.ui-jqgrid-sortable",e,f;d.p.viewsortcols[2]||(c="th>div>span>span.ui-grid-ico-sort");b=a(b.target).closest(c);if(1===b.length){var h;if(d.p.frozenColumns){var k=a(this)[0].id.substring(d.p.id.length+
1);a(d.p.colModel).each(function(a){if(this.name===k)return h=a,!1})}else h=P(this);d.p.viewsortcols[2]||(e=!0,f=b.attr("sort"));null!=h&&S(a("div",this)[0].id,h,e,f,this);return!1}});if(d.p.sortable&&a.fn.sortable)try{a(d).jqGrid("sortableColumns",p)}catch(ma){}d.p.footerrow&&($+="</tr></tbody></table>");ea+="</tr>";p=document.createElement("tbody");this.appendChild(p);a(this).addClass("ui-jqgrid-btable").append(ea);var ea=null,p=a("<table class='ui-jqgrid-htable' style='width:"+d.p.tblwidth+"px' role='presentation' aria-labelledby='gbox_"+
this.id+"' cellspacing='0' cellpadding='0' border='0'></table>").append(N),W=d.p.caption&&!0===d.p.hiddengrid?!0:!1;k=a("<div class='ui-jqgrid-hbox"+("rtl"===l?"-rtl":"")+"'></div>");N=null;h.hDiv=document.createElement("div");a(h.hDiv).css({width:h.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(k);a(k).append(p);p=null;W&&a(h.hDiv).hide();d.p.pager&&("string"===typeof d.p.pager?"#"!==d.p.pager.substr(0,1)&&(d.p.pager="#"+d.p.pager):d.p.pager="#"+a(d.p.pager).attr("id"),a(d.p.pager).css({width:h.width+
"px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(m),W&&a(d.p.pager).hide(),X(d.p.pager,""));!1===d.p.cellEdit&&!0===d.p.hoverrows&&a(d).bind("mouseover",function(b){M=a(b.target).closest("tr.jqgrow");"ui-subgrid"!==a(M).attr("class")&&a(M).addClass("ui-state-hover")}).bind("mouseout",function(b){M=a(b.target).closest("tr.jqgrow");a(M).removeClass("ui-state-hover")});var R,aa,ga;a(d).before(h.hDiv).click(function(b){E=b.target;M=a(E,d.rows).closest("tr.jqgrow");if(0===
a(M).length||-1<M[0].className.indexOf("ui-state-disabled")||(a(E,d).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==d.id)return this;var c=a(E).hasClass("cbox"),e=a(d).triggerHandler("jqGridBeforeSelectRow",[M[0].id,b]),e=!1===e||"stop"===e?!1:!0;if(a.isFunction(d.p.beforeSelectRow)){var f=d.p.beforeSelectRow.call(d,M[0].id,b);if(!1===f||"stop"===f)e=!1}if("A"!==E.tagName&&("INPUT"!==E.tagName&&"TEXTAREA"!==E.tagName&&"OPTION"!==E.tagName&&"SELECT"!==E.tagName||c)){R=M[0].id;
E=a(E).closest("tr.jqgrow>td");0<E.length&&(aa=a.jgrid.getCellIndex(E),ga=a(E).closest("td,th").html(),a(d).triggerHandler("jqGridCellSelect",[R,aa,ga,b]),a.isFunction(d.p.onCellSelect)&&d.p.onCellSelect.call(d,R,aa,ga,b));if(!0===d.p.cellEdit)if(d.p.multiselect&&c&&e)a(d).jqGrid("setSelection",R,!0,b);else if(0<E.length){R=M[0].rowIndex;try{a(d).jqGrid("editCell",R,aa,!0)}catch(h){}}if(e)if(d.p.multikey)b[d.p.multikey]?a(d).jqGrid("setSelection",R,!0,b):d.p.multiselect&&c&&(c=a("#jqg_"+a.jgrid.jqID(d.p.id)+
"_"+R).is(":checked"),a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+R)[d.p.useProp?"prop":"attr"]("checked",c));else{if(d.p.multiselect&&d.p.multiboxonly&&!c){var k=d.p.frozenColumns?d.p.id+"_frozen":"";a(d.p.selarrrow).each(function(b,c){var e=a(d).jqGrid("getGridRowById",c);e&&a(e).removeClass("ui-state-highlight");a("#jqg_"+a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(c))[d.p.useProp?"prop":"attr"]("checked",!1);k&&(a("#"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(k)).removeClass("ui-state-highlight"),a("#jqg_"+a.jgrid.jqID(d.p.id)+
"_"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(k))[d.p.useProp?"prop":"attr"]("checked",!1))});d.p.selarrrow=[]}a(d).jqGrid("setSelection",R,!0,b)}}}).bind("reloadGrid",function(b,c){!0===d.p.treeGrid&&(d.p.datatype=d.p.treedatatype);c&&c.current&&d.grid.selectionPreserver(d);"local"===d.p.datatype?(a(d).jqGrid("resetSelection"),d.p.data.length&&(z(),v())):d.p.treeGrid||(d.p.selrow=null,d.p.multiselect&&(d.p.selarrrow=[],Q(!1)),d.p.savedRow=[]);d.p.scroll&&w.call(d,!0,!1);if(c&&c.page){var e=c.page;e>d.p.lastpage&&
(e=d.p.lastpage);1>e&&(e=1);d.p.page=e;d.grid.bDiv.scrollTop=d.grid.prevRowHeight?(e-1)*d.grid.prevRowHeight*d.p.rowNum:0}d.grid.prevRowHeight&&d.p.scroll?(delete d.p.lastpage,d.grid.populateVisible()):d.grid.populate();!0===d.p._inlinenav&&a(d).jqGrid("showAddEditButtons");return!1}).dblclick(function(b){E=b.target;M=a(E,d.rows).closest("tr.jqgrow");if(0!==a(M).length){R=M[0].rowIndex;aa=a.jgrid.getCellIndex(E);var c=a(d).triggerHandler("jqGridDblClickRow",[a(M).attr("id"),R,aa,b]);if(null!=c||a.isFunction(d.p.ondblClickRow)&&
(c=d.p.ondblClickRow.call(d,a(M).attr("id"),R,aa,b),null!=c))return c}}).bind("contextmenu",function(b){E=b.target;M=a(E,d.rows).closest("tr.jqgrow");if(0!==a(M).length){d.p.multiselect||a(d).jqGrid("setSelection",M[0].id,!0,b);R=M[0].rowIndex;aa=a.jgrid.getCellIndex(E);var c=a(d).triggerHandler("jqGridRightClickRow",[a(M).attr("id"),R,aa,b]);if(null!=c||a.isFunction(d.p.onRightClickRow)&&(c=d.p.onRightClickRow.call(d,a(M).attr("id"),R,aa,b),null!=c))return c}});h.bDiv=document.createElement("div");
c&&"auto"===String(d.p.height).toLowerCase()&&(d.p.height="100%");a(h.bDiv).append(a('<div style="position:relative;'+(c&&8>a.jgrid.msiever()?"height:0.01%;":"")+'"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:d.p.height+(isNaN(d.p.height)?"":"px"),width:h.width+"px"}).scroll(h.scrollGrid);a("table:first",h.bDiv).css({width:d.p.tblwidth+"px"});a.support.tbody||2===a("tbody",this).length&&a("tbody:gt(0)",this).remove();d.p.multikey&&(a.jgrid.msie?a(h.bDiv).bind("selectstart",
function(){return!1}):a(h.bDiv).bind("mousedown",function(){return!1}));W&&a(h.bDiv).hide();h.cDiv=document.createElement("div");var ha=!0===d.p.hidegrid?a("<a role='link' class='ui-jqgrid-titlebar-close ui-corner-all HeaderButton' "+(d.p.showhide?"title='"+d.p.showhide+"'":"")+" />").hover(function(){ha.addClass("ui-state-hover")},function(){ha.removeClass("ui-state-hover")}).append("<span class='ui-icon ui-icon-circle-triangle-n'></span>").css("rtl"===l?"left":"right","0px"):"";a(h.cDiv).append(ha).append("<span class='ui-jqgrid-title'>"+
d.p.caption+"</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===l?"-rtl":"")+" ui-widget-header ui-corner-top ui-helper-clearfix");a(h.cDiv).insertBefore(h.hDiv);d.p.toolbar[0]&&(h.uDiv=document.createElement("div"),"top"===d.p.toolbar[1]?a(h.uDiv).insertBefore(h.hDiv):"bottom"===d.p.toolbar[1]&&a(h.uDiv).insertAfter(h.hDiv),"both"===d.p.toolbar[1]?(h.ubDiv=document.createElement("div"),a(h.uDiv).addClass("ui-userdata ui-state-default").attr("id","t_"+this.id).insertBefore(h.hDiv),
a(h.ubDiv).addClass("ui-userdata ui-state-default").attr("id","tb_"+this.id).insertAfter(h.hDiv),W&&a(h.ubDiv).hide()):a(h.uDiv).width(h.width).addClass("ui-userdata ui-state-default").attr("id","t_"+this.id),W&&a(h.uDiv).hide());d.p.toppager&&(d.p.toppager=a.jgrid.jqID(d.p.id)+"_toppager",h.topDiv=a("<div id='"+d.p.toppager+"'></div>")[0],d.p.toppager="#"+d.p.toppager,a(h.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(h.width).insertBefore(h.hDiv),X(d.p.toppager,"_t"));d.p.footerrow&&
(h.sDiv=a("<div class='ui-jqgrid-sdiv'></div>")[0],k=a("<div class='ui-jqgrid-hbox"+("rtl"===l?"-rtl":"")+"'></div>"),a(h.sDiv).append(k).width(h.width).insertAfter(h.hDiv),a(k).append($),h.footers=a(".ui-jqgrid-ftable",h.sDiv)[0].rows[0].cells,d.p.rownumbers&&(h.footers[0].className="ui-state-default jqgrid-rownum"),W&&a(h.sDiv).hide());k=null;if(d.p.caption){var la=d.p.datatype;!0===d.p.hidegrid&&(a(".ui-jqgrid-titlebar-close",h.cDiv).click(function(b){var c=a.isFunction(d.p.onHeaderClick),e=".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv",
f,k=this;!0===d.p.toolbar[0]&&("both"===d.p.toolbar[1]&&(e+=", #"+a(h.ubDiv).attr("id")),e+=", #"+a(h.uDiv).attr("id"));f=a(e,"#gview_"+a.jgrid.jqID(d.p.id)).length;"visible"===d.p.gridstate?a(e,"#gbox_"+a.jgrid.jqID(d.p.id)).slideUp("fast",function(){f--;0===f&&(a("span",k).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s"),d.p.gridstate="hidden",a("#gbox_"+a.jgrid.jqID(d.p.id)).hasClass("ui-resizable")&&a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(d.p.id)).hide(),a(d).triggerHandler("jqGridHeaderClick",
[d.p.gridstate,b]),c&&(W||d.p.onHeaderClick.call(d,d.p.gridstate,b)))}):"hidden"===d.p.gridstate&&a(e,"#gbox_"+a.jgrid.jqID(d.p.id)).slideDown("fast",function(){f--;0===f&&(a("span",k).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n"),W&&(d.p.datatype=la,L(),W=!1),d.p.gridstate="visible",a("#gbox_"+a.jgrid.jqID(d.p.id)).hasClass("ui-resizable")&&a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(d.p.id)).show(),a(d).triggerHandler("jqGridHeaderClick",[d.p.gridstate,b]),c&&
(W||d.p.onHeaderClick.call(d,d.p.gridstate,b)))});return!1}),W&&(d.p.datatype="local",a(".ui-jqgrid-titlebar-close",h.cDiv).trigger("click")))}else a(h.cDiv).hide(),d.p.toppager||a(h.hDiv).addClass("ui-corner-top");a(h.hDiv).after(h.bDiv).mousemove(function(a){if(h.resizing)return h.dragMove(a),!1});a(".ui-jqgrid-labels",h.hDiv).bind("selectstart",function(){return!1});a(document).bind("mouseup.jqGrid"+d.p.id,function(){return h.resizing?(h.dragEnd(),!1):!0});d.formatCol=q;d.sortData=S;d.updatepager=
function(b,c){var e,f,h,k,g,l,n,p="",m=(k=d.p.pager?a.jgrid.jqID(d.p.pager.substr(1)):"")?"_"+k:"",q=d.p.toppager?"_"+d.p.toppager.substr(1):"";h=parseInt(d.p.page,10)-1;0>h&&(h=0);h*=parseInt(d.p.rowNum,10);g=h+d.p.reccount;if(d.p.scroll){e=a("tbody:first > tr:gt(0)",d.grid.bDiv);h=g-e.length;d.p.reccount=e.length;if(e=e.outerHeight()||d.grid.prevRowHeight)f=h*e,n=parseInt(d.p.records,10)*e,a(">div:first",d.grid.bDiv).css({height:n}).children("div:first").css({height:f,display:f?"":"none"}),0==d.grid.bDiv.scrollTop&&
1<d.p.page&&(d.grid.bDiv.scrollTop=d.p.rowNum*(d.p.page-1)*e);d.grid.bDiv.scrollLeft=d.grid.hDiv.scrollLeft}p=d.p.pager||"";if(p+=d.p.toppager?p?","+d.p.toppager:d.p.toppager:"")n=a.jgrid.formatter.integer||{},e=r(d.p.page),f=r(d.p.lastpage),a(".selbox",p)[this.p.useProp?"prop":"attr"]("disabled",!1),!0===d.p.pginput&&(a("#input"+m).html(a.jgrid.template(d.p.pgtext||"","<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>","<span id='sp_1_"+a.jgrid.jqID(k)+"'></span>")),
d.p.toppager&&a("#input_t"+q).html(a.jgrid.template(d.p.pgtext||"","<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>","<span id='sp_1_"+a.jgrid.jqID(k)+"_toppager'></span>")),a(".ui-pg-input",p).val(d.p.page),k=d.p.toppager?"#sp_1"+m+",#sp_1"+q:"#sp_1"+m,a(k).html(a.fmatter?a.fmatter.util.NumberFormat(d.p.lastpage,n):d.p.lastpage)),d.p.viewrecords&&(0===d.p.reccount?a(".ui-paging-info",p).html(d.p.emptyrecords):(k=h+1,l=d.p.records,a.fmatter&&(k=a.fmatter.util.NumberFormat(k,
n),g=a.fmatter.util.NumberFormat(g,n),l=a.fmatter.util.NumberFormat(l,n)),a(".ui-paging-info",p).html(a.jgrid.template(d.p.recordtext,k,g,l)))),!0===d.p.pgbuttons&&(0>=e&&(e=f=0),1===e||0===e?(a("#first"+m+", #prev"+m).addClass("ui-state-disabled").removeClass("ui-state-hover"),d.p.toppager&&a("#first_t"+q+", #prev_t"+q).addClass("ui-state-disabled").removeClass("ui-state-hover")):(a("#first"+m+", #prev"+m).removeClass("ui-state-disabled"),d.p.toppager&&a("#first_t"+q+", #prev_t"+q).removeClass("ui-state-disabled")),
e===f||0===e?(a("#next"+m+", #last"+m).addClass("ui-state-disabled").removeClass("ui-state-hover"),d.p.toppager&&a("#next_t"+q+", #last_t"+q).addClass("ui-state-disabled").removeClass("ui-state-hover")):(a("#next"+m+", #last"+m).removeClass("ui-state-disabled"),d.p.toppager&&a("#next_t"+q+", #last_t"+q).removeClass("ui-state-disabled")));!0===b&&!0===d.p.rownumbers&&a(">td.jqgrid-rownum",d.rows).each(function(b){a(this).html(h+1+b)});c&&d.p.jqgdnd&&a(d).jqGrid("gridDnD","updateDnD");a(d).triggerHandler("jqGridGridComplete");
a.isFunction(d.p.gridComplete)&&d.p.gridComplete.call(d);a(d).triggerHandler("jqGridAfterGridComplete")};d.refreshIndex=v;d.setHeadCheckBox=Q;d.constructTr=D;d.formatter=function(a,b,c,d,e){return s(a,b,c,d,e)};a.extend(h,{populate:L,emptyRows:w,beginReq:H,endReq:F});this.grid=h;d.addXmlData=function(a){C(a,d.grid.bDiv)};d.addJSONData=function(a){B(a,d.grid.bDiv)};this.grid.cols=this.rows[0].cells;a(d).triggerHandler("jqGridInitGrid");a.isFunction(d.p.onInitGrid)&&d.p.onInitGrid.call(d);L();d.p.hiddengrid=
!1}}}})};a.jgrid.extend({getGridParam:function(a){var e=this[0];if(e&&e.grid)return a?void 0!==e.p[a]?e.p[a]:null:e.p},setGridParam:function(b,e){return this.each(function(){null==e&&(e=!1);this.grid&&"object"===typeof b&&(!0===e?this.p=a.extend({},this.p,b):a.extend(!0,this.p,b))})},getGridRowById:function(b){var e;this.each(function(){try{for(var c=this.rows.length;c--;)if(b.toString()===this.rows[c].id){e=this.rows[c];break}}catch(f){e=a(this.grid.bDiv).find("#"+a.jgrid.jqID(b))}});return e},getDataIDs:function(){var b=
[],e=0,c,f=0;this.each(function(){if((c=this.rows.length)&&0<c)for(;e<c;)a(this.rows[e]).hasClass("jqgrow")&&(b[f]=this.rows[e].id,f++),e++});return b},setSelection:function(b,e,c){return this.each(function(){var f,g,d,h,k,l;void 0!==b&&(e=!1===e?!1:!0,!(g=a(this).jqGrid("getGridRowById",b))||!g.className||-1<g.className.indexOf("ui-state-disabled")||(!0===this.p.scrollrows&&(d=a(this).jqGrid("getGridRowById",b).rowIndex,0<=d&&(f=a(this.grid.bDiv)[0].clientHeight,h=a(this.grid.bDiv)[0].scrollTop,
k=a(this.rows[d]).position().top,d=this.rows[d].clientHeight,k+d>=f+h?a(this.grid.bDiv)[0].scrollTop=k-(f+h)+d+h:k<f+h&&k<h&&(a(this.grid.bDiv)[0].scrollTop=k))),!0===this.p.frozenColumns&&(l=this.p.id+"_frozen"),this.p.multiselect?(this.setHeadCheckBox(!1),this.p.selrow=g.id,h=a.inArray(this.p.selrow,this.p.selarrrow),-1===h?("ui-subgrid"!==g.className&&a(g).addClass("ui-state-highlight").attr("aria-selected","true"),f=!0,this.p.selarrrow.push(this.p.selrow)):("ui-subgrid"!==g.className&&a(g).removeClass("ui-state-highlight").attr("aria-selected",
"false"),f=!1,this.p.selarrrow.splice(h,1),k=this.p.selarrrow[0],this.p.selrow=void 0===k?null:k),a("#jqg_"+a.jgrid.jqID(this.p.id)+"_"+a.jgrid.jqID(g.id))[this.p.useProp?"prop":"attr"]("checked",f),l&&(-1===h?a("#"+a.jgrid.jqID(b),"#"+a.jgrid.jqID(l)).addClass("ui-state-highlight"):a("#"+a.jgrid.jqID(b),"#"+a.jgrid.jqID(l)).removeClass("ui-state-highlight"),a("#jqg_"+a.jgrid.jqID(this.p.id)+"_"+a.jgrid.jqID(b),"#"+a.jgrid.jqID(l))[this.p.useProp?"prop":"attr"]("checked",f)),e&&(a(this).triggerHandler("jqGridSelectRow",
[g.id,f,c]),this.p.onSelectRow&&this.p.onSelectRow.call(this,g.id,f,c))):"ui-subgrid"!==g.className&&(this.p.selrow!==g.id?((f=a(this).jqGrid("getGridRowById",this.p.selrow))&&a(f).removeClass("ui-state-highlight").attr({"aria-selected":"false",tabindex:"-1"}),a(g).addClass("ui-state-highlight").attr({"aria-selected":"true",tabindex:"0"}),l&&(a("#"+a.jgrid.jqID(this.p.selrow),"#"+a.jgrid.jqID(l)).removeClass("ui-state-highlight"),a("#"+a.jgrid.jqID(b),"#"+a.jgrid.jqID(l)).addClass("ui-state-highlight")),
f=!0):f=!1,this.p.selrow=g.id,e&&(a(this).triggerHandler("jqGridSelectRow",[g.id,f,c]),this.p.onSelectRow&&this.p.onSelectRow.call(this,g.id,f,c)))))})},resetSelection:function(b){return this.each(function(){var e=this,c,f;!0===e.p.frozenColumns&&(f=e.p.id+"_frozen");if(void 0!==b){c=b===e.p.selrow?e.p.selrow:b;a("#"+a.jgrid.jqID(e.p.id)+" tbody:first tr#"+a.jgrid.jqID(c)).removeClass("ui-state-highlight").attr("aria-selected","false");f&&a("#"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(f)).removeClass("ui-state-highlight");
if(e.p.multiselect){a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(e.p.id))[e.p.useProp?"prop":"attr"]("checked",!1);if(f)a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(f))[e.p.useProp?"prop":"attr"]("checked",!1);e.setHeadCheckBox(!1);c=a.inArray(a.jgrid.jqID(c),e.p.selarrrow);-1!==c&&e.p.selarrrow.splice(c,1)}c=null}else e.p.multiselect?(a(e.p.selarrrow).each(function(b,c){a(a(e).jqGrid("getGridRowById",c)).removeClass("ui-state-highlight").attr("aria-selected",
...
f&&a("#"+a.jgrid.jqID(e.p.selrow),"#"+a.jgrid.jqID(f)).removeClass("ui-state-highlight"),e.p.selrow=null);!0===e.p.cellEdit&&0<=parseInt(e.p.iCol,10)&&0<=parseInt(e.p.iRow,10)&&(a("td:eq("+e.p.iCol+")",e.rows[e.p.iRow]).removeClass("edit-cell ui-state-highlight"),a(e.rows[e.p.iRow]).removeClass("selected-row ui-state-hover"));e.p.savedRow=[]})},getRowData:function(b){var e={},c,f=!1,g,d=0;this.each(function(){var h=this,k,l;if(void 0===b)f=!0,c=[],g=h.rows.length;else{l=a(h).jqGrid("getGridRowById",
b);if(!l)return e;g=2}for(;d<g;)f&&(l=h.rows[d]),a(l).hasClass("jqgrow")&&(a('td[role="gridcell"]',l).each(function(b){k=h.p.colModel[b].name;if("cb"!==k&&"subgrid"!==k&&"rn"!==k)if(!0===h.p.treeGrid&&k===h.p.ExpandColumn)e[k]=a.jgrid.htmlDecode(a("span:first",this).html());else try{e[k]=a.unformat.call(h,this,{rowId:l.id,colModel:h.p.colModel[b]},b)}catch(c){e[k]=a.jgrid.htmlDecode(a(this).html())}}),f&&(c.push(e),e={})),d++});return c||e},delRowData:function(b){var e=!1,c,f,g;this.each(function(){c=
a(this).jqGrid("getGridRowById",b);if(!c)return!1;this.p.subGrid&&(g=a(c).next(),g.hasClass("ui-subgrid")&&g.remove());a(c).remove();this.p.records--;this.p.reccount--;this.updatepager(!0,!1);e=!0;this.p.multiselect&&(f=a.inArray(b,this.p.selarrrow),-1!==f&&this.p.selarrrow.splice(f,1));this.p.selrow=this.p.multiselect&&0<this.p.selarrrow.length?this.p.selarrrow[this.p.selarrrow.length-1]:null;if("local"===this.p.datatype){var d=a.jgrid.stripPref(this.p.idPrefix,b),d=this.p._index[d];void 0!==d&&
(this.p.data.splice(d,1),this.refreshIndex())}if(!0===this.p.altRows&&e){var h=this.p.altclass;a(this.rows).each(function(b){1===b%2?a(this).addClass(h):a(this).removeClass(h)})}});return e},setRowData:function(b,e,c){var f,g=!0,d;this.each(function(){if(!this.grid)return!1;var h=this,k,l,p=typeof c,m={};l=a(this).jqGrid("getGridRowById",b);if(!l)return!1;if(e)try{if(a(this.p.colModel).each(function(c){f=this.name;var g=a.jgrid.getAccessor(e,f);void 0!==g&&(m[f]=this.formatter&&"string"===typeof this.formatter&&
"date"===this.formatter?a.unformat.date.call(h,g,this):g,k=h.formatter(b,m[f],c,e,"edit"),d=this.title?{title:a.jgrid.stripHtml(k)}:{},!0===h.p.treeGrid&&f===h.p.ExpandColumn?a("td[role='gridcell']:eq("+c+") > span:first",l).html(k).attr(d):a("td[role='gridcell']:eq("+c+")",l).html(k).attr(d))}),"local"===h.p.datatype){var r=a.jgrid.stripPref(h.p.idPrefix,b),q=h.p._index[r],n;if(h.p.treeGrid)for(n in h.p.treeReader)h.p.treeReader.hasOwnProperty(n)&&delete m[h.p.treeReader[n]];void 0!==q&&(h.p.data[q]=
a.extend(!0,h.p.data[q],m));m=null}}catch(s){g=!1}g&&("string"===p?a(l).addClass(c):null!==c&&"object"===p&&a(l).css(c),a(h).triggerHandler("jqGridAfterGridComplete"))});return g},addRowData:function(b,e,c,f){-1==["first","last","before","after"].indexOf(c)&&(c="last");var g=!1,d,h,k,l,p,m,r,q,n="",s,u,y,t,x,A;e&&(a.isArray(e)?(s=!0,u=b):(e=[e],s=!1),this.each(function(){var w=e.length;p=!0===this.p.rownumbers?1:0;k=!0===this.p.multiselect?1:0;l=!0===this.p.subGrid?1:0;s||(void 0!==b?b=String(b):
(b=a.jgrid.randId(),!1!==this.p.keyName&&(u=this.p.keyName,void 0!==e[0][u]&&(b=e[0][u]))));y=this.p.altclass;for(var z=0,v="",D={},C=a.isFunction(this.p.afterInsertRow)?!0:!1;z<w;){t=e[z];h=[];if(s){try{b=t[u],void 0===b&&(b=a.jgrid.randId())}catch(B){b=a.jgrid.randId()}v=!0===this.p.altRows?0===(this.rows.length-1)%2?y:"":""}A=b;b=this.p.idPrefix+b;p&&(n=this.formatCol(0,1,"",null,b,!0),h[h.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+n+">0</td>");k&&(q='<input role="checkbox" type="checkbox" id="jqg_'+
this.p.id+"_"+b+'" class="cbox"/>',n=this.formatCol(p,1,"",null,b,!0),h[h.length]='<td role="gridcell" '+n+">"+q+"</td>");l&&(h[h.length]=a(this).jqGrid("addSubGridCell",k+p,1));for(r=k+l+p;r<this.p.colModel.length;r++)x=this.p.colModel[r],d=x.name,D[d]=t[d],q=this.formatter(b,a.jgrid.getAccessor(t,d),r,t),n=this.formatCol(r,1,q,t,b,D),h[h.length]='<td role="gridcell" '+n+">"+q+"</td>";h.unshift(this.constructTr(b,!1,v,D,t,!1));h[h.length]="</tr>";if(0===this.rows.length)a("table:first",this.grid.bDiv).append(h.join(""));
...
this.p.reccount++;a(this).triggerHandler("jqGridAfterInsertRow",[b,t,t]);C&&this.p.afterInsertRow.call(this,b,t,t);z++;"local"===this.p.datatype&&(D[this.p.localReader.id]=A,this.p._index[A]=this.p.data.length,this.p.data.push(D),D={})}!0!==this.p.altRows||s||("last"===c?1===(this.rows.length-1)%2&&a(this.rows[this.rows.length-1]).addClass(y):a(this.rows).each(function(b){1===b%2?a(this).addClass(y):a(this).removeClass(y)}));this.updatepager(!0,!0);g=!0}));return g},footerData:function(b,e,c){function f(a){for(var b in a)if(a.hasOwnProperty(b))return!1;
return!0}var g,d=!1,h={},k;void 0==b&&(b="get");"boolean"!==typeof c&&(c=!0);b=b.toLowerCase();this.each(function(){var l=this,p;if(!l.grid||!l.p.footerrow||"set"===b&&f(e))return!1;d=!0;a(this.p.colModel).each(function(f){g=this.name;"set"===b?void 0!==e[g]&&(p=c?l.formatter("",e[g],f,e,"edit"):e[g],k=this.title?{title:a.jgrid.stripHtml(p)}:{},a("tr.footrow td:eq("+f+")",l.grid.sDiv).html(p).attr(k),d=!0):"get"===b&&(h[g]=a("tr.footrow td:eq("+f+")",l.grid.sDiv).html())})});return"get"===b?h:d},
showHideCol:function(b,e){return this.each(function(){var c=this,f=!1,g=a.jgrid.cell_width?0:c.p.cellLayout,d;if(c.grid){"string"===typeof b&&(b=[b]);e="none"!==e?"":"none";var h=""===e?!0:!1,k=c.p.groupHeader&&("object"===typeof c.p.groupHeader||a.isFunction(c.p.groupHeader));k&&a(c).jqGrid("destroyGroupHeader",!1);a(this.p.colModel).each(function(k){if(-1!==a.inArray(this.name,b)&&this.hidden===h){if(!0===c.p.frozenColumns&&!0===this.frozen)return!0;a("tr[role=row]",c.grid.hDiv).each(function(){a(this.cells[k]).css("display",
e)});a(c.rows).each(function(){a(this).hasClass("jqgroup")||a(this.cells[k]).css("display",e)});c.p.footerrow&&a("tr.footrow td:eq("+k+")",c.grid.sDiv).css("display",e);d=parseInt(this.width,10);c.p.tblwidth="none"===e?c.p.tblwidth-(d+g):c.p.tblwidth+(d+g);this.hidden=!h;f=!0;a(c).triggerHandler("jqGridShowHideCol",[h,this.name,k])}});!0===f&&(!0!==c.p.shrinkToFit||isNaN(c.p.height)||(c.p.tblwidth+=parseInt(c.p.scrollOffset,10)),a(c).jqGrid("setGridWidth",!0===c.p.shrinkToFit?c.p.tblwidth:c.p.width));
k&&a(c).jqGrid("setGroupHeaders",c.p.groupHeader)}})},hideCol:function(b){return this.each(function(){a(this).jqGrid("showHideCol",b,"none")})},showCol:function(b){return this.each(function(){a(this).jqGrid("showHideCol",b,"")})},remapColumns:function(b,e,c){function f(c){var d;d=c.length?a.makeArray(c):a.extend({},c);a.each(b,function(a){c[a]=d[this]})}function g(c,d){a(">tr"+(d||""),c).each(function(){var c=this,d=a.makeArray(c.cells);a.each(b,function(){var a=d[this];a&&c.appendChild(a)})})}var d=
this.get(0);f(d.p.colModel);f(d.p.colNames);f(d.grid.headers);g(a("thead:first",d.grid.hDiv),c&&":not(.ui-jqgrid-labels)");e&&g(a("#"+a.jgrid.jqID(d.p.id)+" tbody:first"),".jqgfirstrow, tr.jqgrow, tr.jqfoot");d.p.footerrow&&g(a("tbody:first",d.grid.sDiv));d.p.remapColumns&&(d.p.remapColumns.length?f(d.p.remapColumns):d.p.remapColumns=a.makeArray(b));d.p.lastsort=a.inArray(d.p.lastsort,b);d.p.treeGrid&&(d.p.expColInd=a.inArray(d.p.expColInd,b));a(d).triggerHandler("jqGridRemapColumns",[b,e,c])},setGridWidth:function(b,
e){return this.each(function(){if(this.grid){var c=this,f,g=0,d=a.jgrid.cell_width?0:c.p.cellLayout,h,k=0,l=!1,p=c.p.scrollOffset,m,r=0,q;"boolean"!==typeof e&&(e=c.p.shrinkToFit);if(!isNaN(b)){b=parseInt(b,10);c.grid.width=c.p.width=b;a("#gbox_"+a.jgrid.jqID(c.p.id)).css("width",b+"px");a("#gview_"+a.jgrid.jqID(c.p.id)).css("width",b+"px");a(c.grid.bDiv).css("width",b+"px");a(c.grid.hDiv).css("width",b+"px");c.p.pager&&a(c.p.pager).css("width",b+"px");c.p.toppager&&a(c.p.toppager).css("width",b+
"px");!0===c.p.toolbar[0]&&(a(c.grid.uDiv).css("width",b+"px"),"both"===c.p.toolbar[1]&&a(c.grid.ubDiv).css("width",b+"px"));c.p.footerrow&&a(c.grid.sDiv).css("width",b+"px");!1===e&&!0===c.p.forceFit&&(c.p.forceFit=!1);if(!0===e){a.each(c.p.colModel,function(){!1===this.hidden&&(f=this.widthOrg,g+=f+d,this.fixed?r+=f+d:k++)});if(0===k)return;c.p.tblwidth=g;m=b-d*k-r;!isNaN(c.p.height)&&(a(c.grid.bDiv)[0].clientHeight<a(c.grid.bDiv)[0].scrollHeight||1===c.rows.length)&&(l=!0,m-=p);var g=0,n=0<c.grid.cols.length;
a.each(c.p.colModel,function(a){!1!==this.hidden||this.fixed||(f=this.widthOrg,f=Math.round(m*f/(c.p.tblwidth-d*k-r)),0>f||(this.width=f,g+=f,c.grid.headers[a].width=f,c.grid.headers[a].el.style.width=f+"px",c.p.footerrow&&(c.grid.footers[a].style.width=f+"px"),n&&(c.grid.cols[a].style.width=f+"px"),h=a))});if(!h)return;q=0;l?b-r-(g+d*k)!==p&&(q=b-r-(g+d*k)-p):1!==Math.abs(b-r-(g+d*k))&&(q=b-r-(g+d*k));c.p.colModel[h].width+=q;c.p.tblwidth=g+q+d*k+r;c.p.tblwidth>b?(l=c.p.tblwidth-parseInt(b,10),c.p.tblwidth=
b,f=c.p.colModel[h].width-=l):f=c.p.colModel[h].width;c.grid.headers[h].width=f;c.grid.headers[h].el.style.width=f+"px";n&&(c.grid.cols[h].style.width=f+"px");c.p.footerrow&&(c.grid.footers[h].style.width=f+"px")}c.p.tblwidth&&(a("table:first",c.grid.bDiv).css("width",c.p.tblwidth+"px"),a("table:first",c.grid.hDiv).css("width",c.p.tblwidth+"px"),c.grid.hDiv.scrollLeft=c.grid.bDiv.scrollLeft,c.p.footerrow&&a("table:first",c.grid.sDiv).css("width",c.p.tblwidth+"px"))}}})},setGridHeight:function(b){return this.each(function(){if(this.grid){var e=
a(this.grid.bDiv);e.css({height:b+(isNaN(b)?"":"px")});!0===this.p.frozenColumns&&a("#"+a.jgrid.jqID(this.p.id)+"_frozen").parent().height(e.height()-16);this.p.height=b;this.p.scroll&&this.grid.populateVisible()}})},setCaption:function(b){return this.each(function(){this.p.caption=b;a("span.ui-jqgrid-title, span.ui-jqgrid-title-rtl",this.grid.cDiv).html(b);a(this.grid.cDiv).show();a(this.grid.hDiv).removeClass("ui-corner-top")})},setLabel:function(b,e,c,f){return this.each(function(){var g=-1;if(this.grid&&
void 0!==b&&(a(this.p.colModel).each(function(a){if(this.name===b)return g=a,!1}),0<=g)){var d=a("tr.ui-jqgrid-labels th:eq("+g+")",this.grid.hDiv);if(e){var h=a(".s-ico",d);a("[id^=jqgh_]",d).empty().html(e).append(h);this.p.colNames[g]=e}c&&("string"===typeof c?a(d).addClass(c):a(d).css(c));"object"===typeof f&&a(d).attr(f)}})},setCell:function(b,e,c,f,g,d){return this.each(function(){var h=-1,k,l;if(this.grid&&(isNaN(e)?a(this.p.colModel).each(function(a){if(this.name===e)return h=a,!1}):h=parseInt(e,
10),0<=h&&(k=a(this).jqGrid("getGridRowById",b)))){var p=a("td:eq("+h+")",k);l=0;var m=[];if(""!==c||!0===d){for(;l<k.cells.length;)m.push(k.cells[l].innerHTML),l++;k=this.formatter(b,c,h,m,"edit");l=this.p.colModel[h].title?{title:a.jgrid.stripHtml(k)}:{};this.p.treeGrid&&0<a(".tree-wrap",a(p)).length?a("span",a(p)).html(k).attr(l):a(p).html(k).attr(l);"local"===this.p.datatype&&(k=this.p.colModel[h],c=k.formatter&&"string"===typeof k.formatter&&"date"===k.formatter?a.unformat.date.call(this,c,k):
c,l=this.p._index[a.jgrid.stripPref(this.p.idPrefix,b)],void 0!==l&&(this.p.data[l][k.name]=c))}"string"===typeof f?a(p).addClass(f):f&&a(p).css(f);"object"===typeof g&&a(p).attr(g)}})},getCell:function(b,e){var c=!1;this.each(function(){var f=-1;if(this.grid&&(isNaN(e)?a(this.p.colModel).each(function(a){if(this.name===e)return f=a,!1}):f=parseInt(e,10),0<=f)){var g=a(this).jqGrid("getGridRowById",b);if(g)try{c=a.unformat.call(this,a("td:eq("+f+")",g),{rowId:g.id,colModel:this.p.colModel[f]},f)}catch(d){c=
a.jgrid.htmlDecode(a("td:eq("+f+")",g).html())}}});return c},getCol:function(b,e,c){var f=[],g,d=0,h,k,l;e="boolean"!==typeof e?!1:e;void 0===c&&(c=!1);this.each(function(){var p=-1;if(this.grid&&(isNaN(b)?a(this.p.colModel).each(function(a){if(this.name===b)return p=a,!1}):p=parseInt(b,10),0<=p)){var m=this.rows.length,r=0,q=0;if(m&&0<m){for(;r<m;){if(a(this.rows[r]).hasClass("jqgrow")){try{g=a.unformat.call(this,a(this.rows[r].cells[p]),{rowId:this.rows[r].id,colModel:this.p.colModel[p]},p)}catch(n){g=
a.jgrid.htmlDecode(this.rows[r].cells[p].innerHTML)}c?(l=parseFloat(g),isNaN(l)||(d+=l,void 0===k&&(k=h=l),h=Math.min(h,l),k=Math.max(k,l),q++)):e?f.push({id:this.rows[r].id,value:g}):f.push(g)}r++}if(c)switch(c.toLowerCase()){case "sum":f=d;break;case "avg":f=d/q;break;case "count":f=m-1;break;case "min":f=h;break;case "max":f=k}}}});return f},clearGridData:function(b){return this.each(function(){if(this.grid){"boolean"!==typeof b&&(b=!1);if(this.p.deepempty)a("#"+a.jgrid.jqID(this.p.id)+" tbody:first tr:gt(0)").remove();
else{var e=a("#"+a.jgrid.jqID(this.p.id)+" tbody:first tr:first")[0];a("#"+a.jgrid.jqID(this.p.id)+" tbody:first").empty().append(e)}this.p.footerrow&&b&&a(".ui-jqgrid-ftable td",this.grid.sDiv).html("&#160;");this.p.selrow=null;this.p.selarrrow=[];this.p.savedRow=[];this.p.records=0;this.p.page=1;this.p.lastpage=0;this.p.reccount=0;this.p.data=[];this.p._index={};this.updatepager(!0,!1)}})},getInd:function(b,e){var c=!1,f;this.each(function(){(f=a(this).jqGrid("getGridRowById",b))&&(c=!0===e?f:f.rowIndex)});
return c},bindKeys:function(b){var e=a.extend({onEnter:null,onSpace:null,onLeftKey:null,onRightKey:null,scrollingRows:!0},b||{});return this.each(function(){var b=this;a("body").is("[role]")||a("body").attr("role","application");b.p.scrollrows=e.scrollingRows;a(b).keydown(function(f){var g=a(b).find("tr[tabindex=0]")[0],d,h,k,l=b.p.treeReader.expanded_field;if(g)if(k=b.p._index[a.jgrid.stripPref(b.p.idPrefix,g.id)],37===f.keyCode||38===f.keyCode||39===f.keyCode||40===f.keyCode){if(38===f.keyCode){h=
g.previousSibling;d="";if(h)if(a(h).is(":hidden"))for(;h;){if(h=h.previousSibling,!a(h).is(":hidden")&&a(h).hasClass("jqgrow")){d=h.id;break}}else d=h.id;a(b).jqGrid("setSelection",d,!0,f);f.preventDefault()}if(40===f.keyCode){h=g.nextSibling;d="";if(h)if(a(h).is(":hidden"))for(;h;){if(h=h.nextSibling,!a(h).is(":hidden")&&a(h).hasClass("jqgrow")){d=h.id;break}}else d=h.id;a(b).jqGrid("setSelection",d,!0,f);f.preventDefault()}37===f.keyCode&&(b.p.treeGrid&&b.p.data[k][l]&&a(g).find("div.treeclick").trigger("click"),
...
a.isFunction(e.onSpace)&&e.onSpace.call(b,b.p.selrow))})})},unbindKeys:function(){return this.each(function(){a(this).unbind("keydown")})},getLocalRow:function(b){var e=!1,c;this.each(function(){void 0!==b&&(c=this.p._index[a.jgrid.stripPref(this.p.idPrefix,b)],0<=c&&(e=this.p.data[c]))});return e},progressBar:function(b){b=a.extend({htmlcontent:"",method:"hide",loadtype:"disable"},b||{});return this.each(function(){var e="show"===b.method?!0:!1;""!==b.htmlcontent&&a("#load_"+a.jgrid.jqID(this.p.id)).html(b.htmlcontent);
switch(b.loadtype){case "enable":a("#load_"+a.jgrid.jqID(this.p.id)).toggle(e);break;case "block":a("#lui_"+a.jgrid.jqID(this.p.id)).toggle(e),a("#load_"+a.jgrid.jqID(this.p.id)).toggle(e)}})}})})(jQuery);
...
c.rows[b].id,l,d,b,e))||(f={}));0<a("input.hasDatepicker",g).length&&a("input.hasDatepicker",g).datepicker("hide");if("remote"===c.p.cellsubmit)if(c.p.cellurl){var s={};c.p.autoencode&&(d=a.jgrid.htmlEncode(d));s[l]=d;r=c.p.prmNames;k=r.id;p=r.oper;s[k]=a.jgrid.stripPref(c.p.idPrefix,c.rows[b].id);s[p]=r.editoper;s=a.extend(f,s);a(c).jqGrid("progressBar",{method:"show",loadtype:c.p.loadui,htmlcontent:a.jgrid.defaults.savetext||"Saving..."});c.grid.hDiv.loading=!0;a.ajax(a.extend({url:c.p.cellurl,
data:a.isFunction(c.p.serializeCellData)?c.p.serializeCellData.call(c,s):s,type:"POST",complete:function(f,k){a(c).jqGrid("progressBar",{method:"hide",loadtype:c.p.loadui});c.grid.hDiv.loading=!1;if("success"===k){var n=a(c).triggerHandler("jqGridAfterSubmitCell",[c,f,s.id,l,d,b,e])||[!0,""];!0===n[0]&&a.isFunction(c.p.afterSubmitCell)&&(n=c.p.afterSubmitCell.call(c,f,s.id,l,d,b,e));!0===n[0]?(a(g).empty(),a(c).jqGrid("setCell",c.rows[b].id,e,h,!1,!1,!0),a(g).addClass("dirty-cell"),a(c.rows[b]).addClass("edited"),
...
"move"),a.fn.jqDrag)a(k).jqDrag(m);else try{a(k).draggable({handle:a("#"+a.jgrid.jqID(m.id))})}catch(n){}if(c.resize)if(a.fn.jqResize)a(k).append("<div class='jqResize ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se'></div>"),a("#"+a.jgrid.jqID(b.themodal)).jqResize(".jqResize",b.scrollelm?"#"+a.jgrid.jqID(b.scrollelm):!1);else try{a(k).resizable({handles:"se, sw",alsoResize:b.scrollelm?"#"+a.jgrid.jqID(b.scrollelm):!1})}catch(s){}!0===c.closeOnEscape&&a(k).keydown(function(d){27===
...
e.custom_element.call(k,c,e))n=a(n).addClass("customelement").attr({id:e.id,name:e.name}),a(h).empty().append(n);else throw"e2";else throw"e1";}catch(s){"e1"===s&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===s?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof s?s:s.message,a.jgrid.edit.bClose)}}return h},
...
l,p;p="";var m="=",r,q=a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"+e.p.direction+"' id='gsh_"+e.p.id+"_"+k.name+"' ></th>"),n=a("<div style='position:relative;height:auto;padding-right:0.3em;padding-left:0.3em;'></div>"),s=a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper' headers=''></td><td class='ui-search-input' headers=''></td><td class='ui-search-clear' headers=''></td></tr></table>");!0===this.hidden&&a(q).css("display","none");this.search=
!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");l=a.extend({},this.searchoptions||{});if(this.search){if(b.searchOperators){p=l.sopt?l.sopt[0]:"select"===k.stype?"eq":b.defaultSearch;for(r=0;r<b.odata.length;r++)if(b.odata[r].oper===p){m=b.operands[p]||"";break}p="<a title='"+(null!=l.searchtitle?l.searchtitle:b.operandTitle)+"' style='padding-right: 0.5em;' soper='"+p+"' class='soptclass' colname='"+this.name+"'>"+m+"</a>"}a("td:eq(0)",s).attr("colindex",f).append(p);void 0===l.clearSearch&&
(l.clearSearch=!0);l.clearSearch?(p=b.resetTitle||"Clear Search Value",a("td:eq(2)",s).append("<a title='"+p+"' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>"+b.resetIcon+"</a>")):a("td:eq(2)",s).hide();switch(this.stype){case "select":if(p=this.surl||l.dataUrl)a(n).append(s),a.ajax(a.extend({url:p,dataType:"html",success:function(d){void 0!==l.buildSelect?(d=l.buildSelect(d))&&a("td:eq(1)",s).append(d):a("td:eq(1)",s).append(d);void 0!==l.defaultValue&&a("select",n).val(l.defaultValue);
a("select",n).attr({name:k.index||k.name,id:"gs_"+e.p.idPrefix+k.name});l.attr&&a("select",n).attr(l.attr);a("select",n).css({width:"100%"});a.jgrid.bindEv.call(e,a("select",n)[0],l);!0===b.autosearch&&a("select",n).change(function(){c();return!1});d=null}},a.jgrid.ajaxOptions,e.p.ajaxSelectOptions||{}));else{var u,y,t;k.searchoptions?(u=void 0===k.searchoptions.value?"":k.searchoptions.value,y=void 0===k.searchoptions.separator?":":k.searchoptions.separator,t=void 0===k.searchoptions.delimiter?";":
k.searchoptions.delimiter):k.editoptions&&(u=void 0===k.editoptions.value?"":k.editoptions.value,y=void 0===k.editoptions.separator?":":k.editoptions.separator,t=void 0===k.editoptions.delimiter?";":k.editoptions.delimiter);if(u){var x=document.createElement("select");x.style.width="100%";a(x).attr({name:k.index||k.name,id:"gs_"+e.p.idPrefix+k.name});var A;if("string"===typeof u)for(p=u.split(t),A=0;A<p.length;A++)u=p[A].split(y),t=document.createElement("option"),t.value=u[0],t.innerHTML=u[1],x.appendChild(t);
else if("object"===typeof u)for(A in u)u.hasOwnProperty(A)&&(t=document.createElement("option"),t.value=A,t.innerHTML=u[A],x.appendChild(t));void 0!==l.defaultValue&&a(x).val(l.defaultValue);l.attr&&a(x).attr(l.attr);a(n).append(s);a.jgrid.bindEv.call(e,x,l);a("td:eq(1)",s).append(x);!0===b.autosearch&&a(x).change(function(){c();return!1})}}break;case "text":y=void 0!==l.defaultValue?l.defaultValue:"";a("td:eq(1)",s).append("<input type='text' style='width:100%;padding:0px;' name='"+(k.index||k.name)+
"' id='gs_"+e.p.idPrefix+k.name+"' value='"+y+"'/>");a(n).append(s);l.attr&&a("input",n).attr(l.attr);a.jgrid.bindEv.call(e,a("input",n)[0],l);!0===b.autosearch&&(b.searchOnEnter?a("input",n).keypress(function(a){return 13===(a.charCode||a.keyCode||0)?(c(),!1):this}):a("input",n).keydown(function(a){switch(a.which){case 13:return!1;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:d&&clearTimeout(d),d=setTimeout(function(){c()},b.autosearchDelay)}}));break;case "custom":a("td:eq(1)",
s).append("<span style='width:95%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+e.p.idPrefix+k.name+"'/>");a(n).append(s);try{if(a.isFunction(l.custom_element))if(x=l.custom_element.call(e,void 0!==l.defaultValue?l.defaultValue:"",l))x=a(x).addClass("customelement"),a(n).find("span[name='"+(k.index||k.name)+"']").append(x);else throw"e2";else throw"e1";}catch(w){"e1"===w&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===
w?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof w?w:w.message,a.jgrid.edit.bClose)}}}a(q).append(n);a(g).append(q);b.searchOperators||a("td:eq(0)",s).hide()});a("table thead",e.grid.hDiv).append(g);b.searchOperators&&(a(".soptclass",g).click(function(b){var c=a(this).offset();f(this,c.left,c.top);b.stopPropagation()}),a("body").on("click",function(b){"soptclass"!==b.target.className&&
a("#sopt_menu").hide()}));a(".clearsearchclass",g).click(function(d){d=a(this).parents("tr:first");var f=parseInt(a("td.ui-search-oper",d).attr("colindex"),10),g=a.extend({},e.p.colModel[f].searchoptions||{}),g=g.defaultValue?g.defaultValue:"";"select"===e.p.colModel[f].stype?g?a("td.ui-search-input select",d).val(g):a("td.ui-search-input select",d)[0].selectedIndex=0:a("td.ui-search-input input",d).val(g);!0===b.autosearch&&c()});this.ftoolbar=!0;this.triggerToolbar=c;this.clearToolbar=function(c){var d=
{},f=0,g;c="boolean"!==typeof c?!0:c;a.each(e.p.colModel,function(){var b,c=a("#gs_"+e.p.idPrefix+a.jgrid.jqID(this.name),!0===this.frozen&&!0===e.p.frozenColumns?e.grid.fhDiv:e.grid.hDiv);this.searchoptions&&void 0!==this.searchoptions.defaultValue&&(b=this.searchoptions.defaultValue);g=this.index||this.name;switch(this.stype){case "select":c.find("option").each(function(c){0===c&&(this.selected=!0);if(a(this).val()===b)return this.selected=!0,!1});if(void 0!==b)d[g]=b,f++;else try{delete e.p.postData[g]}catch(h){}break;
case "text":c.val(b||"");if(void 0!==b)d[g]=b,f++;else try{delete e.p.postData[g]}catch(n){}break;case "custom":a.isFunction(this.searchoptions.custom_value)&&0<c.length&&"SPAN"===c[0].nodeName.toUpperCase()&&this.searchoptions.custom_value.call(e,c.children(".customelement:first"),"set",b||"")}});var m=0<f?!0:!1;e.p.resetsearch=!0;if(!0===b.stringResult||"local"===e.p.datatype){var r='{"groupOp":"'+b.groupOp+'","rules":[',q=0;a.each(d,function(a,b){0<q&&(r+=",");r+='{"field":"'+a+'",';r+='"op":"eq",';
r+='"data":"'+(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}';q++});r+="]}";a.extend(e.p.postData,{filters:r});a.each(["searchField","searchString","searchOper"],function(a,b){e.p.postData.hasOwnProperty(b)&&delete e.p.postData[b]})}else a.extend(e.p.postData,d);var n;e.p.searchurl&&(n=e.p.url,a(e).jqGrid("setGridParam",{url:e.p.searchurl}));var s="stop"===a(e).triggerHandler("jqGridToolbarBeforeClear")?!0:!1;!s&&a.isFunction(b.beforeClear)&&(s=b.beforeClear.call(e));s||c&&a(e).jqGrid("setGridParam",
{search:m}).trigger("reloadGrid",[{page:1}]);n&&a(e).jqGrid("setGridParam",{url:n});a(e).triggerHandler("jqGridToolbarAfterClear");a.isFunction(b.afterClear)&&b.afterClear()};this.toggleToolbar=function(){var b=a("tr.ui-search-toolbar",e.grid.hDiv),c=!0===e.p.frozenColumns?a("tr.ui-search-toolbar",e.grid.fhDiv):!1;"none"===b.css("display")?(b.show(),c&&c.show()):(b.hide(),c&&c.hide())}}})},destroyFilterToolbar:function(){return this.each(function(){this.ftoolbar&&(this.toggleToolbar=this.clearToolbar=
this.triggerToolbar=null,this.ftoolbar=!1,a(this.grid.hDiv).find("table thead tr.ui-search-toolbar").remove())})},destroyGroupHeader:function(b){void 0===b&&(b=!0);return this.each(function(){var e,c,f,g,d,h;c=this.grid;var k=a("table.ui-jqgrid-htable thead",c.hDiv),l=this.p.colModel;if(c){a(this).unbind(".setGroupHeaders");e=a("<tr>",{role:"row"}).addClass("ui-jqgrid-labels");g=c.headers;c=0;for(f=g.length;c<f;c++){d=l[c].hidden?"none":"";d=a(g[c].el).width(g[c].width).css("display",d);try{d.removeAttr("rowSpan")}catch(p){d.attr("rowSpan",
1)}e.append(d);h=d.children("span.ui-jqgrid-resize");0<h.length&&(h[0].style.height="");d.children("div")[0].style.top=""}a(k).children("tr.ui-jqgrid-labels").remove();a(k).prepend(e);!0===b&&a(this).jqGrid("setGridParam",{groupHeader:null})}})},setGroupHeaders:function(b){b=a.extend({useColSpanStyle:!1,groupHeaders:[]},b||{});return this.each(function(){this.p.groupHeader=b;var e,c,f=0,g,d,h,k,l,p=this.p.colModel,m=p.length,r=this.grid.headers,q=a("table.ui-jqgrid-htable",this.grid.hDiv),n=q.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header");
g=q.children("thead");var s=q.find(".jqg-first-row-header");void 0===s[0]?s=a("<tr>",{role:"row","aria-hidden":"true"}).addClass("jqg-first-row-header").css("height","auto"):s.empty();var u,y=function(a,b){var c=b.length,d;for(d=0;d<c;d++)if(b[d].startColumnName===a)return d;return-1};a(this).prepend(g);g=a("<tr>",{role:"row"}).addClass("ui-jqgrid-labels jqg-third-row-header");for(e=0;e<m;e++)if(h=r[e].el,k=a(h),c=p[e],d={height:"0px",width:r[e].width+"px",display:c.hidden?"none":""},a("<th>",{role:"gridcell"}).css(d).addClass("ui-first-th-"+
this.p.direction).appendTo(s),h.style.width="",d=y(c.name,b.groupHeaders),0<=d){d=b.groupHeaders[d];f=d.numberOfColumns;l=d.titleText;for(d=c=0;d<f&&e+d<m;d++)p[e+d].hidden||c++;d=a("<th>").attr({role:"columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-"+this.p.direction).css({height:"22px","border-top":"0 none"}).html(l);0<c&&d.attr("colspan",String(c));this.p.headertitles&&d.attr("title",d.text());0===c&&d.hide();k.before(d);g.append(h);--f}else 0===f?b.useColSpanStyle?k.attr("rowspan",
"2"):(a("<th>",{role:"columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-"+this.p.direction).css({display:c.hidden?"none":"","border-top":"0 none"}).insertBefore(k),g.append(h)):(g.append(h),f--);p=a(this).children("thead");p.prepend(s);g.insertAfter(n);q.append(p);b.useColSpanStyle&&(q.find("span.ui-jqgrid-resize").each(function(){var b=a(this).parent();b.is(":visible")&&(this.style.cssText="height: "+b.height()+"px !important; cursor: col-resize;")}),q.find("div.ui-jqgrid-sortable").each(function(){var b=
a(this),c=b.parent();c.is(":visible")&&c.is(":has(span.ui-jqgrid-resize)")&&b.css("top",(c.height()-b.outerHeight())/2+"px")}));u=p.find("tr.jqg-first-row-header");a(this).bind("jqGridResizeStop.setGroupHeaders",function(a,b,c){u.find("th").eq(c).width(b)})})},setFrozenColumns:function(){return this.each(function(){if(this.grid){var b=this,e=b.p.colModel,c=0,f=e.length,g=-1,d=!1;if(!0!==b.p.subGrid&&!0!==b.p.treeGrid&&!0!==b.p.cellEdit&&!b.p.sortable&&!b.p.scroll){b.p.rownumbers&&c++;for(b.p.multiselect&&
c++;c<f;){if(!0===e[c].frozen)d=!0,g=c;else break;c++}if(0<=g&&d){e=b.p.caption?a(b.grid.cDiv).outerHeight():0;c=a(".ui-jqgrid-htable","#gview_"+a.jgrid.jqID(b.p.id)).height();b.p.toppager&&(e+=a(b.grid.topDiv).outerHeight());!0===b.p.toolbar[0]&&"bottom"!==b.p.toolbar[1]&&(e+=a(b.grid.uDiv).outerHeight());b.grid.fhDiv=a('<div style="position:absolute;left:0px;top:'+e+"px;height:"+c+'px;" class="frozen-div ui-state-default ui-jqgrid-hdiv"></div>');b.grid.fbDiv=a('<div style="position:absolute;left:0px;top:'+
(parseInt(e,10)+parseInt(c,10)+1)+'px;overflow-y:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>');a("#gview_"+a.jgrid.jqID(b.p.id)).append(b.grid.fhDiv);f=a(".ui-jqgrid-htable","#gview_"+a.jgrid.jqID(b.p.id)).clone(!0);if(b.p.groupHeader){a("tr.jqg-first-row-header, tr.jqg-third-row-header",f).each(function(){a("th:gt("+g+")",this).remove()});var h=-1,k=-1,l,p;a("tr.jqg-second-row-header th",f).each(function(){l=parseInt(a(this).attr("colspan"),10);if(p=parseInt(a(this).attr("rowspan"),10))h++,
k++;l&&(h+=l,k++);if(h===g)return!1});h!==g&&(k=g);a("tr.jqg-second-row-header",f).each(function(){a("th:gt("+k+")",this).remove()})}else a("tr",f).each(function(){a("th:gt("+g+")",this).remove()});a(f).width(1);a(b.grid.fhDiv).append(f).mousemove(function(a){if(b.grid.resizing)return b.grid.dragMove(a),!1});b.p.footerrow&&(f=a(".ui-jqgrid-bdiv","#gview_"+a.jgrid.jqID(b.p.id)).height(),b.grid.fsDiv=a('<div style="position:absolute;left:0px;top:'+(parseInt(e,10)+parseInt(c,10)+parseInt(f,10)+1)+'px;" class="frozen-sdiv ui-jqgrid-sdiv"></div>'),
a("#gview_"+a.jgrid.jqID(b.p.id)).append(b.grid.fsDiv),e=a(".ui-jqgrid-ftable","#gview_"+a.jgrid.jqID(b.p.id)).clone(!0),a("tr",e).each(function(){a("td:gt("+g+")",this).remove()}),a(e).width(1),a(b.grid.fsDiv).append(e));a(b).bind("jqGridResizeStop.setFrozenColumns",function(c,d,e){c=a(".ui-jqgrid-htable",b.grid.fhDiv);a("th:eq("+e+")",c).width(d);c=a(".ui-jqgrid-btable",b.grid.fbDiv);a("tr:first td:eq("+e+")",c).width(d);b.p.footerrow&&(c=a(".ui-jqgrid-ftable",b.grid.fsDiv),a("tr:first td:eq("+
e+")",c).width(d))});a(b).bind("jqGridSortCol.setFrozenColumns",function(c,d,e){c=a("tr.ui-jqgrid-labels:last th:eq("+b.p.lastsort+")",b.grid.fhDiv);d=a("tr.ui-jqgrid-labels:last th:eq("+e+")",b.grid.fhDiv);a("span.ui-grid-ico-sort",c).addClass("ui-state-disabled");a(c).attr("aria-selected","false");a("span.ui-icon-"+b.p.sortorder,d).removeClass("ui-state-disabled");a(d).attr("aria-selected","true");b.p.viewsortcols[0]||b.p.lastsort===e||(a("span.s-ico",c).hide(),a("span.s-ico",d).show())});a("#gview_"+
a.jgrid.jqID(b.p.id)).append(b.grid.fbDiv);a(b.grid.bDiv).scroll(function(){a(b.grid.fbDiv).scrollTop(a(this).scrollTop())});!0===b.p.hoverrows&&a("#"+a.jgrid.jqID(b.p.id)).unbind("mouseover").unbind("mouseout");a(b).bind("jqGridAfterGridComplete.setFrozenColumns",function(){a("#"+a.jgrid.jqID(b.p.id)+"_frozen").remove();a(b.grid.fbDiv).height(a(b.grid.bDiv).height()-16);var c=a("#"+a.jgrid.jqID(b.p.id)).clone(!0);a("tr[role=row]",c).each(function(){a("td[role=gridcell]:gt("+g+")",this).remove()});
...
"_frozen").addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover");a("#"+a.jgrid.jqID(this.id),"#"+a.jgrid.jqID(b.p.id)+"_frozen").removeClass("ui-state-hover")}));c=null});b.grid.hDiv.loading||a(b).triggerHandler("jqGridAfterGridComplete");b.p.frozenColumns=!0}}}})},destroyFrozenColumns:function(){return this.each(function(){if(this.grid&&!0===this.p.frozenColumns){a(this.grid.fhDiv).remove();a(this.grid.fbDiv).remove();this.grid.fhDiv=null;this.grid.fbDiv=null;this.p.footerrow&&
...
0;e<b.groups.length;e++)g=a("<tr></tr>"),h.append(g),k=a("<td class='first'></td>"),g.append(k),k=a("<td colspan='4'></td>"),k.append(this.createTableForGroup(b.groups[e],b)),g.append(k);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)h.append(this.createTableRowForRule(b.rules[e],b));return h};this.createTableRowForRule=function(b,c){var d=this,e=a("#"+a.jgrid.jqID(f.id))[0]||null,h=a("<tr></tr>"),g,l,y,t,x="",A;h.append("<td class='first'></td>");
var w=a("<td class='columns'></td>");h.append(w);var z=a("<select></select>"),v,D=[];w.append(z);z.bind("change",function(){b.field=a(z).val();y=a(this).parents("tr:first");for(g=0;g<d.p.columns.length;g++)if(d.p.columns[g].name===b.field){t=d.p.columns[g];break}if(t){t.searchoptions.id=a.jgrid.randId();k&&"text"===t.inputtype&&!t.searchoptions.size&&(t.searchoptions.size=10);var c=a.jgrid.createEl.call(e,t.inputtype,t.searchoptions,"",!0,d.p.ajaxSelectOptions||{},!0);a(c).addClass("input-elm");l=
t.searchoptions.sopt?t.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(t.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;var f="",h=0;D=[];a.each(d.p.ops,function(){D.push(this.oper)});for(g=0;g<l.length;g++)v=a.inArray(l[g],D),-1!==v&&(0===h&&(b.op=d.p.ops[v].oper),f+="<option value='"+d.p.ops[v].oper+"'>"+d.p.ops[v].text+"</option>",h++);a(".selectopts",y).empty().append(f);a(".selectopts",y)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(f=parseInt(a("select.selectopts",y)[0].offsetWidth,
10)+1,a(".selectopts",y).width(f),a(".selectopts",y).css("width","auto"));a(".data",y).empty().append(c);a.jgrid.bindEv.call(e,c,t.searchoptions);a(".input-elm",y).bind("change",function(c){c=c.target;b.data="SPAN"===c.nodeName.toUpperCase()&&t.searchoptions&&a.isFunction(t.searchoptions.custom_value)?t.searchoptions.custom_value.call(e,a(c).children(".customelement:first"),"get"):c.value;d.onchange()});setTimeout(function(){b.data=a(c).val();d.onchange()},0)}});for(g=w=0;g<d.p.columns.length;g++){A=
void 0===d.p.columns[g].search?!0:d.p.columns[g].search;var C=!0===d.p.columns[g].hidden;if(!0===d.p.columns[g].searchoptions.searchhidden&&A||A&&!C)A="",b.field===d.p.columns[g].name&&(A=" selected='selected'",w=g),x+="<option value='"+d.p.columns[g].name+"'"+A+">"+d.p.columns[g].label+"</option>"}z.append(x);x=a("<td class='operators'></td>");h.append(x);t=f.columns[w];t.searchoptions.id=a.jgrid.randId();k&&"text"===t.inputtype&&!t.searchoptions.size&&(t.searchoptions.size=10);w=a.jgrid.createEl.call(e,
t.inputtype,t.searchoptions,b.data,!0,d.p.ajaxSelectOptions||{},!0);if("nu"===b.op||"nn"===b.op)a(w).attr("readonly","true"),a(w).attr("disabled","true");var B=a("<select class='selectopts'></select>");x.append(B);B.bind("change",function(){b.op=a(B).val();y=a(this).parents("tr:first");var c=a(".input-elm",y)[0];"nu"===b.op||"nn"===b.op?(b.data="","SELECT"!==c.tagName.toUpperCase()&&(c.value=""),c.setAttribute("readonly","true"),c.setAttribute("disabled","true")):("SELECT"===c.tagName.toUpperCase()&&
(b.data=c.value),c.removeAttribute("readonly"),c.removeAttribute("disabled"));d.onchange()});l=t.searchoptions.sopt?t.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(t.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;x="";a.each(d.p.ops,function(){D.push(this.oper)});for(g=0;g<l.length;g++)v=a.inArray(l[g],D),-1!==v&&(A=b.op===d.p.ops[v].oper?" selected='selected'":"",x+="<option value='"+d.p.ops[v].oper+"'"+A+">"+d.p.ops[v].text+"</option>");B.append(x);x=a("<td class='data'></td>");h.append(x);
x.append(w);a.jgrid.bindEv.call(e,w,t.searchoptions);a(w).addClass("input-elm").bind("change",function(){b.data="custom"===t.inputtype?t.searchoptions.custom_value.call(e,a(this).children(".customelement:first"),"get"):a(this).val();d.onchange()});x=a("<td></td>");h.append(x);!0===this.p.ruleButtons&&(w=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),x.append(w),w.bind("click",function(){for(g=0;g<c.rules.length;g++)if(c.rules[g]===b){c.rules.splice(g,1);break}d.reDraw();
...
p;"string"===typeof l&&(l=a.jgrid.parse(l));!0===b.recreateFilter&&a("#"+a.jgrid.jqID(k.themodal)).remove();if(void 0!==a("#"+a.jgrid.jqID(k.themodal))[0])c(a("#fbox_"+a.jgrid.jqID(+f.p.id)));else{var m=a("<div><div id='"+g+"' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_"+a.jgrid.jqID(f.p.id)),r="left",q="";"rtl"===f.p.direction&&(r="right",q=" style='text-align:left'",m.attr("dir","rtl"));var n=a.extend([],f.p.colModel),s="<a id='"+g+"_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>"+
b.Find+"</a>",u="<a id='"+g+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+b.Reset+"</a>",y="",t="",x,A=!1,w=-1;b.showQuery&&(y="<a id='"+g+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");b.columns.length?(n=b.columns,w=0,x=n[0].index||n[0].name):a.each(n,function(a,b){b.label||(b.label=f.p.colNames[a]);if(!A){var c=
void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&!0===b.searchoptions.searchhidden&&c||c&&!d)A=!0,x=b.index||b.name,w=a}});if(!l&&x||!1===b.multipleSearch){var z="eq";0<=w&&n[w].searchoptions&&n[w].searchoptions.sopt?z=n[w].searchoptions.sopt[0]:b.sopt&&b.sopt.length&&(z=b.sopt[0]);l={groupOp:"AND",rules:[{field:x,op:z,data:""}]}}A=!1;b.tmplNames&&b.tmplNames.length&&(A=!0,t=b.tmplLabel,t+="<select class='ui-template'>",t+="<option value='default'>Default</option>",a.each(b.tmplNames,
function(a,b){t+="<option value='"+a+"'>"+b+"</option>"}),t+="</select>");r="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+g+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+r+"'>"+u+t+"</td><td class='EditButton' "+q+">"+y+s+"</td></tr></tbody></table>";g=a.jgrid.jqID(g);a("#"+g).jqFilter({columns:n,filter:b.loadDefaults?l:null,showQuery:b.showQuery,errorcheck:b.errorcheck,sopt:b.sopt,
...
form:"edit"},a.jgrid.edit,c||{});b[a(this)[0].p.id]=c;return this.each(function(){function f(){a(t+" > tbody > tr > td .FormElement").each(function(){var b=a(".customelement",this);if(b.length){var c=a(b[0]).attr("name");a.each(n.p.colModel,function(){if(this.name===c&&this.editoptions&&a.isFunction(this.editoptions.custom_value)){try{if(v[c]=this.editoptions.custom_value.call(n,a("#"+a.jgrid.jqID(c),t),"get"),void 0===v[c])throw"e1";}catch(b){"e1"===b?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+
a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,b.message,a.jgrid.edit.bClose)}return!0}})}else{switch(a(this).get(0).type){case "checkbox":a(this).is(":checked")?v[this.name]=a(this).val():(b=a(this).attr("offval"),v[this.name]=b);break;case "select-one":v[this.name]=a("option:selected",this).val();break;case "select-multiple":v[this.name]=a(this).val();v[this.name]=v[this.name]?v[this.name].join(","):"";a("option:selected",this).each(function(b,c){a(c).text()});
break;case "password":case "text":case "textarea":case "button":v[this.name]=a(this).val()}n.p.autoencode&&(v[this.name]=a.jgrid.htmlEncode(v[this.name]))}});return!0}function g(c,d,e,f){var h,g,k,l=0,m,p,q,r=[],s=!1,t="",w;for(w=1;w<=f;w++)t+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==c&&(s=a(d).jqGrid("getInd",c));a(d.p.colModel).each(function(w){h=this.name;p=(g=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";
if("cb"!==h&&"subgrid"!==h&&!0===this.editable&&"rn"!==h){if(!1===s)m="";else if(h===d.p.ExpandColumn&&!0===d.p.treeGrid)m=a("td[role='gridcell']:eq("+w+")",d.rows[s]).text();else{try{m=a.unformat.call(d,a("td[role='gridcell']:eq("+w+")",d.rows[s]),{rowId:c,colModel:this},w)}catch(v){m=this.edittype&&"textarea"===this.edittype?a("td[role='gridcell']:eq("+w+")",d.rows[s]).text():a("td[role='gridcell']:eq("+w+")",d.rows[s]).html()}if(!m||"&nbsp;"===m||"&#160;"===m||1===m.length&&160===m.charCodeAt(0))m=
""}var x=a.extend({},this.editoptions||{},{id:h,name:h,rowId:c}),D=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),y=parseInt(D.rowpos,10)||l+1,A=parseInt(2*(parseInt(D.colpos,10)||1),10);"_empty"===c&&x.defaultValue&&(m=a.isFunction(x.defaultValue)?x.defaultValue.call(n):x.defaultValue);this.edittype||(this.edittype="text");n.p.autoencode&&(m=a.jgrid.htmlDecode(m));q=a.jgrid.createEl.call(n,this.edittype,x,m,!1,a.extend({},a.jgrid.ajaxOptions,d.p.ajaxSelectOptions||
{}));if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)b[n.p.id]._savedData[h]=m;a(q).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(q).addClass("ui-widget-content ui-corner-all");k=a(e).find("tr[rowpos="+y+"]");if(D.rowabove){var z=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+D.rowcontent+"</td></tr>");a(e).append(z);z[0].rp=y}0===k.length&&(k=a("<tr "+p+" rowpos='"+y+"'></tr>").addClass("FormData").attr("id","tr_"+h),a(k).append(t),a(e).append(k),
k[0].rp=y);a("td:eq("+(A-2)+")",k[0]).html(void 0===D.label?d.p.colNames[w]:D.label);a("td:eq("+(A-1)+")",k[0]).append(D.elmprefix).append(q).append(D.elmsuffix);"custom"===this.edittype&&a.isFunction(x.custom_value)&&x.custom_value.call(n,a("#"+h,u),"set",m);a.jgrid.bindEv.call(n,q,x);r[l]=w;l++}});0<l&&(w=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+d.p.id+"_id' value='"+
c+"'/></td></tr>"),w[0].rp=l+999,a(e).append(w),b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)&&(b[n.p.id]._savedData[d.p.id+"_id"]=c);return r}function d(c,d,e){var f,h=0,g,k,l,m,p;if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)b[n.p.id]._savedData={},b[n.p.id]._savedData[d.p.id+"_id"]=c;var q=d.p.colModel;if("_empty"===c)a(q).each(function(){f=this.name;l=a.extend({},this.editoptions||{});(k=a("#"+a.jgrid.jqID(f),e))&&k.length&&null!==k[0]&&(m="","custom"===this.edittype&&a.isFunction(l.custom_value)?
...
b[n.p.id].checkOnUpdate)&&(b[n.p.id]._savedData[f]=m)}),a("#id_g",e).val(c);else{var r=a(d).jqGrid("getInd",c,!0);r&&(a('td[role="gridcell"]',r).each(function(k){f=q[k].name;if("cb"!==f&&"subgrid"!==f&&"rn"!==f&&!0===q[k].editable){if(f===d.p.ExpandColumn&&!0===d.p.treeGrid)g=a(this).text();else try{g=a.unformat.call(d,a(this),{rowId:c,colModel:q[k]},k)}catch(l){g="textarea"===q[k].edittype?a(this).text():a(this).html()}n.p.autoencode&&(g=a.jgrid.htmlDecode(g));if(!0===b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)b[n.p.id]._savedData[f]=
g;f=a.jgrid.jqID(f);switch(q[k].edittype){case "password":case "text":case "button":case "image":case "textarea":if("&nbsp;"===g||"&#160;"===g||1===g.length&&160===g.charCodeAt(0))g="";a("#"+f,e).val(g);break;case "select":var m=g.split(","),m=a.map(m,function(b){return a.trim(b)});a("#"+f+" option",e).each(function(){q[k].editoptions.multiple||a.trim(g)!==a.trim(a(this).text())&&m[0]!==a.trim(a(this).text())&&m[0]!==a.trim(a(this).val())?q[k].editoptions.multiple?-1<a.inArray(a.trim(a(this).text()),
m)||-1<a.inArray(a.trim(a(this).val()),m)?this.selected=!0:this.selected=!1:this.selected=!1:this.selected=!0});break;case "checkbox":g=String(g);if(q[k].editoptions&&q[k].editoptions.value)if(q[k].editoptions.value.split(":")[0]===g)a("#"+f,e)[n.p.useProp?"prop":"attr"]({checked:!0,defaultChecked:!0});else a("#"+f,e)[n.p.useProp?"prop":"attr"]({checked:!1,defaultChecked:!1});else g=g.toLowerCase(),0>g.search(/(false|f|0|no|n|off|undefined)/i)&&""!==g?(a("#"+f,e)[n.p.useProp?"prop":"attr"]("checked",
!0),a("#"+f,e)[n.p.useProp?"prop":"attr"]("defaultChecked",!0)):(a("#"+f,e)[n.p.useProp?"prop":"attr"]("checked",!1),a("#"+f,e)[n.p.useProp?"prop":"attr"]("defaultChecked",!1));break;case "custom":try{if(q[k].editoptions&&a.isFunction(q[k].editoptions.custom_value))q[k].editoptions.custom_value.call(n,a("#"+f,e),"set",g);else throw"e1";}catch(p){"e1"===p?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,
p.message,a.jgrid.edit.bClose)}}h++}}),0<h&&a("#id_g",t).val(c))}}function h(){a.each(n.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&v.hasOwnProperty(b.name)&&""===v[b.name]&&(v[b.name]="null")})}function k(){var e,f=[!0,"",""],g={},k=n.p.prmNames,l,m,p,q,r,w=a(n).triggerHandler("jqGridAddEditBeforeCheckValues",[a(u),C]);w&&"object"===typeof w&&(v=w);a.isFunction(b[n.p.id].beforeCheckValues)&&(w=b[n.p.id].beforeCheckValues.call(n,v,a(u),C))&&"object"===typeof w&&(v=w);for(p in v)if(v.hasOwnProperty(p)&&
(f=a.jgrid.checkValues.call(n,v[p],p),!1===f[0]))break;h();f[0]&&(g=a(n).triggerHandler("jqGridAddEditClickSubmit",[b[n.p.id],v,C]),void 0===g&&a.isFunction(b[n.p.id].onclickSubmit)&&(g=b[n.p.id].onclickSubmit.call(n,b[n.p.id],v,C)||{}),f=a(n).triggerHandler("jqGridAddEditBeforeSubmit",[v,a(u),C]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].beforeSubmit)&&(f=b[n.p.id].beforeSubmit.call(n,v,a(u),C)));if(f[0]&&!b[n.p.id].processing){b[n.p.id].processing=!0;a("#sData",t+"_2").addClass("ui-state-active");
p=b[n.p.id].url||a(n).jqGrid("getGridParam","editurl");m=k.oper;l="clientArray"===p?n.p.keyName:k.id;v[m]="_empty"===a.trim(v[n.p.id+"_id"])?k.addoper:k.editoper;v[m]!==k.addoper?v[l]=v[n.p.id+"_id"]:void 0===v[l]&&(v[l]=v[n.p.id+"_id"]);delete v[n.p.id+"_id"];v=a.extend(v,b[n.p.id].editData,g);if(!0===n.p.treeGrid)for(r in v[m]===k.addoper&&(q=a(n).jqGrid("getGridParam","selrow"),v["adjacency"===n.p.treeGridModel?n.p.treeReader.parent_id_field:"parent_id"]=q),n.p.treeReader)n.p.treeReader.hasOwnProperty(r)&&
(g=n.p.treeReader[r],!v.hasOwnProperty(g)||v[m]===k.addoper&&"parent_id_field"===r||delete v[g]);v[l]=a.jgrid.stripPref(n.p.idPrefix,v[l]);r=a.extend({url:p,type:b[n.p.id].mtype,data:a.isFunction(b[n.p.id].serializeEditData)?b[n.p.id].serializeEditData.call(n,v):v,complete:function(g,h){var p;a("#sData",t+"_2").removeClass("ui-state-active");v[l]=n.p.idPrefix+v[l];300<=g.status&&304!==g.status?(f[0]=!1,f[1]=a(n).triggerHandler("jqGridAddEditErrorTextFormat",[g,C]),a.isFunction(b[n.p.id].errorTextFormat)?
f[1]=b[n.p.id].errorTextFormat.call(n,g,C):f[1]=h+" Status: '"+g.statusText+"'. Error code: "+g.status):(f=a(n).triggerHandler("jqGridAddEditAfterSubmit",[g,v,C]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].afterSubmit)&&(f=b[n.p.id].afterSubmit.call(n,g,v,C)));if(!1===f[0])a(".FormError",u).html(f[1]),a(".FormError",u).show();else if(n.p.autoencode&&a.each(v,function(b,c){v[b]=a.jgrid.htmlDecode(c)}),v[m]===k.addoper?(f[2]||(f[2]=a.jgrid.randId()),null==v[l]||"_empty"===v[l]?v[l]=f[2]:
f[2]=v[l],b[n.p.id].reloadAfterSubmit?a(n).trigger("reloadGrid"):!0===n.p.treeGrid?a(n).jqGrid("addChildNode",f[2],q,v):a(n).jqGrid("addRowData",f[2],v,c.addedrow),b[n.p.id].closeAfterAdd?(!0!==n.p.treeGrid&&a(n).jqGrid("setSelection",f[2]),a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form})):b[n.p.id].clearAfterAdd&&d("_empty",n,u)):(b[n.p.id].reloadAfterSubmit?
(a(n).trigger("reloadGrid"),b[n.p.id].closeAfterEdit||setTimeout(function(){a(n).jqGrid("setSelection",v[l])},1E3)):!0===n.p.treeGrid?a(n).jqGrid("setTreeRow",v[l],v):a(n).jqGrid("setRowData",v[l],v),b[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form})),a.isFunction(b[n.p.id].afterComplete)&&(e=g,setTimeout(function(){a(n).triggerHandler("jqGridAddEditAfterComplete",
[e,v,a(u),C]);b[n.p.id].afterComplete.call(n,e,v,a(u),C);e=null},500)),b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)if(a(u).data("disabled",!1),"_empty"!==b[n.p.id]._savedData[n.p.id+"_id"])for(p in b[n.p.id]._savedData)b[n.p.id]._savedData.hasOwnProperty(p)&&v[p]&&(b[n.p.id]._savedData[p]=v[p]);b[n.p.id].processing=!1;try{a(":input:visible",u)[0].focus()}catch(r){}}},a.jgrid.ajaxOptions,b[n.p.id].ajaxEditOptions);r.url||b[n.p.id].useDataProxy||(a.isFunction(n.p.dataProxy)?b[n.p.id].useDataProxy=
!0:(f[0]=!1,f[1]+=" "+a.jgrid.errors.nourl));f[0]&&(b[n.p.id].useDataProxy?(g=n.p.dataProxy.call(n,r,"set_"+n.p.id),void 0===g&&(g=[!0,""]),!1===g[0]?(f[0]=!1,f[1]=g[1]||"Error deleting the selected row!"):(r.data.oper===k.addoper&&b[n.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form}),r.data.oper===k.editoper&&b[n.p.id].closeAfterEdit&&
a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form}))):"clientArray"===r.url?(b[n.p.id].reloadAfterSubmit=!1,v=r.data,r.complete({status:200,statusText:""},"")):a.ajax(r))}!1===f[0]&&(a(".FormError",u).html(f[1]),a(".FormError",u).show())}function l(a,b){var c=!1,d;for(d in a)if(a.hasOwnProperty(d)&&a[d]!=b[d]){c=!0;break}return c}function p(){var c=
!0;a(".FormError",u).hide();b[n.p.id].checkOnUpdate&&(v={},f(),D=l(v,b[n.p.id]._savedData))&&(a(u).data("disabled",!0),a(".confirm","#"+x.themodal).show(),c=!1);return c}function m(){var b;if("_empty"!==e&&void 0!==n.p.savedRow&&0<n.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(b=0;b<n.p.savedRow.length;b++)if(n.p.savedRow[b].id==e){a(n).jqGrid("restoreRow",e);break}}function r(b,c){var d=c[1].length-1;0===b?a("#pData",t+"_2").addClass("ui-state-disabled"):void 0!==c[1][b-1]&&a("#"+
a.jgrid.jqID(c[1][b-1])).hasClass("ui-state-disabled")?a("#pData",t+"_2").addClass("ui-state-disabled"):a("#pData",t+"_2").removeClass("ui-state-disabled");b===d?a("#nData",t+"_2").addClass("ui-state-disabled"):void 0!==c[1][b+1]&&a("#"+a.jgrid.jqID(c[1][b+1])).hasClass("ui-state-disabled")?a("#nData",t+"_2").addClass("ui-state-disabled"):a("#nData",t+"_2").removeClass("ui-state-disabled")}function q(){var b=a(n).jqGrid("getDataIDs"),c=a("#id_g",t).val();return[a.inArray(c,b),b]}var n=this;if(n.grid&&
e){var s=n.p.id,u="FrmGrid_"+s,y="TblGrid_"+s,t="#"+a.jgrid.jqID(y),x={themodal:"editmod"+s,modalhead:"edithd"+s,modalcontent:"editcnt"+s,scrollelm:u},A=!0,w=1,z=0,v,D,C;"new"===e?(e="_empty",C="add",c.caption=b[n.p.id].addCaption):(c.caption=b[n.p.id].editCaption,C="edit");c.recreateForm||a(n).data("formProp")&&a.extend(b[a(this)[0].p.id],a(n).data("formProp"));var B=!0;c.checkOnUpdate&&c.jqModal&&!c.modal&&(B=!1);var G=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+
"px",A=isNaN(b[a(this)[0].p.id].datawidth)?b[a(this)[0].p.id].datawidth:b[a(this)[0].p.id].datawidth+"px",G=a("<form name='FormPost' id='"+u+"' class='FormGrid' onSubmit='return false;' style='width:"+A+";overflow:auto;position:relative;height:"+G+";'></form>").data("disabled",!1),H=a("<table id='"+y+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),u="#"+a.jgrid.jqID(u);a(G).append("<div class='FormError ui-state-error' style='display:none;'></div>");a(G).append("<div class='tinfo topinfo'>"+
b[n.p.id].topinfo+"</div>");a(n.p.colModel).each(function(){var a=this.formoptions;w=Math.max(w,a?a.colpos||0:0);z=Math.max(z,a?a.rowpos||0:0)});a(G).append(H);A=a(n).triggerHandler("jqGridAddEditBeforeInitData",[G,C]);void 0===A&&(A=!0);A&&a.isFunction(b[n.p.id].beforeInitData)&&(A=b[n.p.id].beforeInitData.call(n,G,C));if(!1!==A){m();g(e,n,H,w);var A="rtl"===n.p.direction?!0:!1,F="<a id='"+(A?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
L="<a id='"+(A?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",Q="<a id='sData' class='fm-button ui-state-default ui-corner-all'>"+c.bSubmit+"</a>",X="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+c.bCancel+"</a>",y="<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"+y+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+
(A?L+F:F+L)+"</td><td class='EditButton'>"+Q+X+"</td></tr></tbody></table>";if(0<z){var ca=[];a.each(a(H)[0].rows,function(a,b){ca[a]=b});ca.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(ca,function(b,c){a("tbody",H).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(s);var S=!1;!0===c.closeOnEscape&&(c.closeOnEscape=!1,S=!0);y=a("<div></div>").append(G).append(y);a(G).append("<div class='binfo topinfo bottominfo'>"+b[n.p.id].bottominfo+"</div>");a.jgrid.createModal(x,y,b[a(this)[0].p.id],"#gview_"+
a.jgrid.jqID(n.p.id),a("#gbox_"+a.jgrid.jqID(n.p.id))[0]);A&&(a("#pData, #nData",t+"_2").css("float","right"),a(".EditButton",t+"_2").css("text-align","left"));b[n.p.id].topinfo&&a(".tinfo",u).show();b[n.p.id].bottominfo&&a(".binfo",u).show();y=y=null;a("#"+a.jgrid.jqID(x.themodal)).keydown(function(d){var e=d.target;if(!0===a(u).data("disabled"))return!1;if(!0===b[n.p.id].savekey[0]&&d.which===b[n.p.id].savekey[1]&&"TEXTAREA"!==e.tagName)return a("#sData",t+"_2").trigger("click"),!1;if(27===d.which){if(!p())return!1;
S&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:c.gbox,jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1}if(!0===b[n.p.id].navkeys[0]){if("_empty"===a("#id_g",t).val())return!0;if(d.which===b[n.p.id].navkeys[1])return a("#pData",t+"_2").trigger("click"),!1;if(d.which===b[n.p.id].navkeys[2])return a("#nData",t+"_2").trigger("click"),!1}});c.checkOnUpdate&&(a("a.ui-jqdialog-titlebar-close span","#"+a.jgrid.jqID(x.themodal)).removeClass("jqmClose"),
a("a.ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(x.themodal)).unbind("click").click(function(){if(!p())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1}));c.saveicon=a.extend([!0,"left","ui-icon-disk"],c.saveicon);c.closeicon=a.extend([!0,"left","ui-icon-close"],c.closeicon);!0===c.saveicon[0]&&a("#sData",t+"_2").addClass("right"===
c.saveicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+c.saveicon[2]+"'></span>");!0===c.closeicon[0]&&a("#cData",t+"_2").addClass("right"===c.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+c.closeicon[2]+"'></span>");if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)Q="<a id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bYes+"</a>",L="<a id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+
c.bNo+"</a>",X="<a id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bExit+"</a>",y=c.zIndex||999,y++,a("<div class='"+c.overlayClass+" jqgrid-overlay confirm' style='z-index:"+y+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(y+1)+"'>"+c.saveData+"<br/><br/>"+Q+L+X+"</div>").insertAfter(u),a("#sNew","#"+a.jgrid.jqID(x.themodal)).click(function(){k();a(u).data("disabled",!1);a(".confirm","#"+a.jgrid.jqID(x.themodal)).hide();
return!1}),a("#nNew","#"+a.jgrid.jqID(x.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(x.themodal)).hide();a(u).data("disabled",!1);setTimeout(function(){a(":input:visible",u)[0].focus()},0);return!1}),a("#cNew","#"+a.jgrid.jqID(x.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(x.themodal)).hide();a(u).data("disabled",!1);a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,
form:b[n.p.id].form});return!1});a(n).triggerHandler("jqGridAddEditInitializeForm",[a(u),C]);a.isFunction(b[n.p.id].onInitializeForm)&&b[n.p.id].onInitializeForm.call(n,a(u),C);"_empty"!==e&&b[n.p.id].viewPagerButtons?a("#pData,#nData",t+"_2").show():a("#pData,#nData",t+"_2").hide();a(n).triggerHandler("jqGridAddEditBeforeShowForm",[a(u),C]);a.isFunction(b[n.p.id].beforeShowForm)&&b[n.p.id].beforeShowForm.call(n,a(u),C);a("#"+a.jgrid.jqID(x.themodal)).data("onClose",b[n.p.id].onClose);a.jgrid.viewModal("#"+
a.jgrid.jqID(x.themodal),{gbox:"#gbox_"+a.jgrid.jqID(s),jqm:c.jqModal,overlay:c.overlay,modal:c.modal,overlayClass:c.overlayClass,onHide:function(b){var c=a("#editmod"+s)[0].style.height;-1<c.indexOf("px")&&(c=parseFloat(c));a(n).data("formProp",{top:parseFloat(a(b.w).css("top")),left:parseFloat(a(b.w).css("left")),width:a(b.w).width(),height:c,dataheight:a(u).height(),datawidth:a(u).width()});b.w.remove();b.o&&b.o.remove()}});B||a("."+a.jgrid.jqID(c.overlayClass)).click(function(){if(!p())return!1;
a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a(".fm-button","#"+a.jgrid.jqID(x.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",t+"_2").click(function(){v={};a(".FormError",u).hide();f();"_empty"===v[n.p.id+"_id"]?k():!0===c.checkOnSubmit?(D=l(v,b[n.p.id]._savedData))?
(a(u).data("disabled",!0),a(".confirm","#"+a.jgrid.jqID(x.themodal)).show()):k():k();return!1});a("#cData",t+"_2").click(function(){if(!p())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a("#nData",t+"_2").click(function(){if(!p())return!1;a(".FormError",u).hide();var b=q();b[0]=parseInt(b[0],10);if(-1!==b[0]&&b[1][b[0]+1]){a(n).triggerHandler("jqGridAddEditClickPgButtons",
["next",a(u),b[1][b[0]]]);var e;if(a.isFunction(c.onclickPgButtons)&&(e=c.onclickPgButtons.call(n,"next",a(u),b[1][b[0]]),void 0!==e&&!1===e)||a("#"+a.jgrid.jqID(b[1][b[0]+1])).hasClass("ui-state-disabled"))return!1;d(b[1][b[0]+1],n,u);a(n).jqGrid("setSelection",b[1][b[0]+1]);a(n).triggerHandler("jqGridAddEditAfterClickPgButtons",["next",a(u),b[1][b[0]]]);a.isFunction(c.afterclickPgButtons)&&c.afterclickPgButtons.call(n,"next",a(u),b[1][b[0]+1]);r(b[0]+1,b)}return!1});a("#pData",t+"_2").click(function(){if(!p())return!1;
a(".FormError",u).hide();var b=q();if(-1!==b[0]&&b[1][b[0]-1]){a(n).triggerHandler("jqGridAddEditClickPgButtons",["prev",a(u),b[1][b[0]]]);var e;if(a.isFunction(c.onclickPgButtons)&&(e=c.onclickPgButtons.call(n,"prev",a(u),b[1][b[0]]),void 0!==e&&!1===e)||a("#"+a.jgrid.jqID(b[1][b[0]-1])).hasClass("ui-state-disabled"))return!1;d(b[1][b[0]-1],n,u);a(n).jqGrid("setSelection",b[1][b[0]-1]);a(n).triggerHandler("jqGridAddEditAfterClickPgButtons",["prev",a(u),b[1][b[0]]]);a.isFunction(c.afterclickPgButtons)&&
c.afterclickPgButtons.call(n,"prev",a(u),b[1][b[0]-1]);r(b[0]-1,b)}return!1});a(n).triggerHandler("jqGridAddEditAfterShowForm",[a(u),C]);a.isFunction(b[n.p.id].afterShowForm)&&b[n.p.id].afterShowForm.call(n,a("#"+u),C);B=q();r(B[0],B)}}})},viewGridRow:function(e,c){c=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,jqModal:!0,closeOnEscape:!1,labelswidth:"30%",closeicon:[],navkeys:[!1,38,40],onClose:null,beforeShowForm:null,beforeInitData:null,
viewPagerButtons:!0,recreateForm:!1,removemodal:!0,form:"view"},a.jgrid.view,c||{});b[a(this)[0].p.id]=c;return this.each(function(){function f(){!0!==b[l.p.id].closeOnEscape&&!0!==b[l.p.id].navkeys[0]||setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(s.modalhead)).attr("tabindex","-1").focus()},0)}function g(b,d,e,f){var g,h,k,l=0,n,m,p=[],q=!1,r,s="<td class='CaptionTD form-view-label ui-widget-content' width='"+c.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",
t="",u=["integer","number","currency"],w=0,v=0,x,y,A;for(r=1;r<=f;r++)t+=1===r?s:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(d.p.colModel).each(function(){(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,u)?w=Math.max(w,parseInt(this.width,10)):v=Math.max(v,parseInt(this.width,10)))});x=0!==w?w:0!==v?v:0;q=a(d).jqGrid("getInd",
b);a(d.p.colModel).each(function(b){g=this.name;y=!1;m=(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";A="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&A){n=!1===q?"":g===d.p.ExpandColumn&&!0===d.p.treeGrid?a("td:eq("+b+")",d.rows[q]).text():a("td:eq("+b+")",d.rows[q]).html();y="right"===this.align&&0!==x?!0:!1;var c=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),r=parseInt(c.rowpos,10)||
l+1,s=parseInt(2*(parseInt(c.colpos,10)||1),10);if(c.rowabove){var u=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+c.rowcontent+"</td></tr>");a(e).append(u);u[0].rp=r}k=a(e).find("tr[rowpos="+r+"]");0===k.length&&(k=a("<tr "+m+" rowpos='"+r+"'></tr>").addClass("FormData").attr("id","trv_"+g),a(k).append(t),a(e).append(k),k[0].rp=r);a("td:eq("+(s-2)+")",k[0]).html("<b>"+(void 0===c.label?d.p.colNames[b]:c.label)+"</b>");a("td:eq("+(s-1)+")",k[0]).append("<span>"+n+"</span>").attr("id","v_"+g);
y&&a("td:eq("+(s-1)+") span",k[0]).css({"text-align":"right",width:x+"px"});p[l]=b;l++}});0<l&&(b=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+b+"'/></td></tr>"),b[0].rp=l+99,a(e).append(b));return p}function d(b,c){var d,e,f=0,g,h;if(h=a(c).jqGrid("getInd",b,!0))a("td",h).each(function(b){d=c.p.colModel[b].name;e=c.p.colModel[b].editrules&&!0===c.p.colModel[b].editrules.edithidden?
...
p,n="ViewTbl_"+p,s={themodal:"viewmod"+p,modalhead:"viewhd"+p,modalcontent:"viewcnt"+p,scrollelm:m},u=a.isFunction(b[l.p.id].beforeInitData)?b[l.p.id].beforeInitData:!1,y=!0,t=1,x=0;c.recreateForm||a(l).data("viewProp")&&a.extend(b[a(this)[0].p.id],a(l).data("viewProp"));var A=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",w=isNaN(b[a(this)[0].p.id].datawidth)?b[a(this)[0].p.id].datawidth:b[a(this)[0].p.id].datawidth+"px",q=a("<form name='FormPost' id='"+
q+"' class='FormGrid' style='width:"+w+";overflow:auto;position:relative;height:"+A+";'></form>"),z=a("<table id='"+n+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");a(l.p.colModel).each(function(){var a=this.formoptions;t=Math.max(t,a?a.colpos||0:0);x=Math.max(x,a?a.rowpos||0:0)});a(q).append(z);u&&(y=u.call(l,q),void 0===y&&(y=!0));if(!1!==y){g(e,l,z,t);n="rtl"===l.p.direction?!0:!1;u="<a id='"+(n?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
y="<a id='"+(n?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";A="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+c.bClose+"</a>";if(0<x){var v=[];a.each(a(z)[0].rows,function(a,b){v[a]=b});v.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(v,function(b,c){a("tbody",z).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(p);q=a("<div></div>").append(q).append("<table border='0' class='EditTable' id='"+
r+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+c.labelswidth+"'>"+(n?y+u:u+y)+"</td><td class='EditButton'>"+A+"</td></tr></tbody></table>");a.jgrid.createModal(s,q,c,"#gview_"+a.jgrid.jqID(l.p.id),a("#gview_"+a.jgrid.jqID(l.p.id))[0]);n&&(a("#pData, #nData","#"+r+"_2").css("float","right"),a(".EditButton","#"+r+"_2").css("text-align","left"));c.viewPagerButtons||a("#pData, #nData","#"+r+"_2").hide();q=null;a("#"+s.themodal).keydown(function(d){if(27===d.which)return b[l.p.id].closeOnEscape&&
a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:c.gbox,jqm:c.jqModal,onClose:c.onClose,removemodal:b[l.p.id].removemodal,formprop:!b[l.p.id].recreateForm,form:b[l.p.id].form}),!1;if(!0===c.navkeys[0]){if(d.which===c.navkeys[1])return a("#pData","#"+r+"_2").trigger("click"),!1;if(d.which===c.navkeys[2])return a("#nData","#"+r+"_2").trigger("click"),!1}});c.closeicon=a.extend([!0,"left","ui-icon-close"],c.closeicon);!0===c.closeicon[0]&&a("#cData","#"+r+"_2").addClass("right"===c.closeicon[1]?"fm-button-icon-right":
"fm-button-icon-left").append("<span class='ui-icon "+c.closeicon[2]+"'></span>");a.isFunction(c.beforeShowForm)&&c.beforeShowForm.call(l,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(s.themodal),{gbox:"#gbox_"+a.jgrid.jqID(p),jqm:c.jqModal,overlay:c.overlay,modal:c.modal,onHide:function(b){a(l).data("viewProp",{top:parseFloat(a(b.w).css("top")),left:parseFloat(a(b.w).css("left")),width:a(b.w).width(),height:a(b.w).height(),dataheight:a("#"+m).height(),datawidth:a("#"+m).width()});b.w.remove();b.o&&
b.o.remove()}});a(".fm-button:not(.ui-state-disabled)","#"+r+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});f();a("#cData","#"+r+"_2").click(function(){a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:c.jqModal,onClose:c.onClose,removemodal:b[l.p.id].removemodal,formprop:!b[l.p.id].recreateForm,form:b[l.p.id].form});return!1});a("#nData","#"+r+"_2").click(function(){a("#FormError","#"+r).hide();var b=k();
...
jqModal:!0,closeOnEscape:!1,delData:{},delicon:[],cancelicon:[],onClose:null,ajaxDelOptions:{},processing:!1,serializeDelData:null,useDataProxy:!1},a.jgrid.del,c||{});b[a(this)[0].p.id]=c;return this.each(function(){var f=this;if(f.grid&&e){var g=a.isFunction(b[f.p.id].beforeShowForm),d=a.isFunction(b[f.p.id].afterShowForm),h=a.isFunction(b[f.p.id].beforeInitData)?b[f.p.id].beforeInitData:!1,k=f.p.id,l={},p=!0,m="DelTbl_"+a.jgrid.jqID(k),r,q,n,s,u="DelTbl_"+k,y={themodal:"delmod"+k,modalhead:"delhd"+
k,modalcontent:"delcnt"+k,scrollelm:m};a.isArray(e)&&(e=e.join());if(void 0!==a("#"+a.jgrid.jqID(y.themodal))[0]){h&&(p=h.call(f,a("#"+m)),void 0===p&&(p=!0));if(!1===p)return;a("#DelData>td","#"+m).text(e);a("#DelError","#"+m).hide();!0===b[f.p.id].processing&&(b[f.p.id].processing=!1,a("#dData","#"+m).removeClass("ui-state-active"));g&&b[f.p.id].beforeShowForm.call(f,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(y.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:b[f.p.id].jqModal,jqM:!1,overlay:b[f.p.id].overlay,
modal:b[f.p.id].modal})}else{var t=isNaN(b[f.p.id].dataheight)?b[f.p.id].dataheight:b[f.p.id].dataheight+"px",x=isNaN(c.datawidth)?c.datawidth:c.datawidth+"px",u="<div id='"+u+"' class='formdata' style='width:"+x+";overflow:auto;position:relative;height:"+t+";'><table class='DelTable'><tbody>",u=u+"<tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>",u=u+("<tr id='DelData' style='display:none'><td >"+e+"</td></tr>"),u=u+('<tr><td class="delmsg" style="white-space:pre;">'+
...
a.jgrid.jqID(k);a.jgrid.createModal(y,u,c,"#gview_"+a.jgrid.jqID(f.p.id),a("#gview_"+a.jgrid.jqID(f.p.id))[0]);h&&(p=h.call(f,a(u)),void 0===p&&(p=!0));if(!1===p)return;a(".fm-button","#"+m+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});c.delicon=a.extend([!0,"left","ui-icon-scissors"],b[f.p.id].delicon);c.cancelicon=a.extend([!0,"left","ui-icon-cancel"],b[f.p.id].cancelicon);!0===c.delicon[0]&&a("#dData","#"+m+"_2").addClass("right"===
...
else{if(!0===f.p.treeGrid)try{a(f).jqGrid("delTreeNode",f.p.idPrefix+g[0])}catch(n){}else for(l=0;l<g.length;l++)a(f).jqGrid("delRowData",f.p.idPrefix+g[l]);f.p.selrow=null;f.p.selarrrow=[]}a.isFunction(b[f.p.id].afterComplete)&&setTimeout(function(){b[f.p.id].afterComplete.call(f,e,g)},500)}b[f.p.id].processing=!1;d[0]&&a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:c.jqModal,onClose:b[f.p.id].onClose})}},a.jgrid.ajaxOptions,b[f.p.id].ajaxDelOptions);e.url||b[f.p.id].useDataProxy||
(a.isFunction(f.p.dataProxy)?b[f.p.id].useDataProxy=!0:(d[0]=!1,d[1]+=" "+a.jgrid.errors.nourl));d[0]&&(b[f.p.id].useDataProxy?(e=f.p.dataProxy.call(f,e,"del_"+f.p.id),void 0===e&&(e=[!0,""]),!1===e[0]?(d[0]=!1,d[1]=e[1]||"Error deleting the selected row!"):a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:c.jqModal,onClose:b[f.p.id].onClose})):"clientArray"===e.url?(r=e.data,e.complete({status:200,statusText:""},"")):a.ajax(e))}!1===d[0]&&(a("#DelError>td","#"+m).html(d[1]),
a("#DelError","#"+m).show());return!1});a("#eData","#"+m+"_2").click(function(){a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:b[f.p.id].jqModal,onClose:b[f.p.id].onClose});return!1});g&&b[f.p.id].beforeShowForm.call(f,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(y.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:b[f.p.id].jqModal,overlay:b[f.p.id].overlay,modal:b[f.p.id].modal})}d&&b[f.p.id].afterShowForm.call(f,a("#"+m));!0===b[f.p.id].closeOnEscape&&setTimeout(function(){a(".ui-jqdialog-titlebar-close",
"#"+a.jgrid.jqID(y.modalhead)).attr("tabindex","-1").focus()},0)}})},navGrid:function(b,c,f,g,d,h,k){c=a.extend({edit:!0,editicon:"ui-icon-pencil",add:!0,addicon:"ui-icon-plus",del:!0,delicon:"ui-icon-trash",search:!0,searchicon:"ui-icon-search",refresh:!0,refreshicon:"ui-icon-refresh",refreshstate:"firstpage",view:!1,viewicon:"ui-icon-document",position:"left",closeOnEscape:!0,beforeRefresh:null,afterRefresh:null,cloneToTop:!1,alertwidth:200,alertheight:"auto",alerttop:null,alertleft:null,alertzIndex:null},
...
a.jgrid.jqID(p.p.id),a("#gbox_"+a.jgrid.jqID(p.p.id))[0],!0));var r=1,q,n=function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},s=function(){a(this).removeClass("ui-state-hover")};c.cloneToTop&&p.p.toppager&&(r=2);for(q=0;q<r;q++){var u=a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),y,t;0===q?(y=b,t=p.p.id,y===p.p.toppager&&(t+="_top",r=1)):(y=p.p.toppager,t=
p.p.id+"_top");"rtl"===p.p.direction&&a(u).attr("dir","rtl").css("float","right");c.add&&(g=g||{},m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.addicon+"'></span>"+c.addtext+"</div>"),a("tr",u).append(m),a(m,u).attr({title:c.addtitle||"",id:g.id||"add_"+t}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(c.addfunc)?c.addfunc.call(p):a(p).jqGrid("editGridRow","new",g));return!1}).hover(n,s),m=null);c.edit&&(m=
a("<td class='ui-pg-button ui-corner-all'></td>"),f=f||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.editicon+"'></span>"+c.edittext+"</div>"),a("tr",u).append(m),a(m,u).attr({title:c.edittitle||"",id:f.id||"edit_"+t}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var b=p.p.selrow;b?a.isFunction(c.editfunc)?c.editfunc.call(p,b):a(p).jqGrid("editGridRow",b,f):(a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+a.jgrid.jqID(p.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,
s),m=null);c.view&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),k=k||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.viewicon+"'></span>"+c.viewtext+"</div>"),a("tr",u).append(m),a(m,u).attr({title:c.viewtitle||"",id:k.id||"view_"+t}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var b=p.p.selrow;b?a.isFunction(c.viewfunc)?c.viewfunc.call(p,b):a(p).jqGrid("viewGridRow",b,k):(a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+a.jgrid.jqID(p.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,
s),m=null);c.del&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),d=d||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.delicon+"'></span>"+c.deltext+"</div>"),a("tr",u).append(m),a(m,u).attr({title:c.deltitle||"",id:d.id||"del_"+t}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var b;p.p.multiselect?(b=p.p.selarrrow,0===b.length&&(b=null)):b=p.p.selrow;b?a.isFunction(c.delfunc)?c.delfunc.call(p,b):a(p).jqGrid("delGridRow",b,d):(a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+
a.jgrid.jqID(p.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,s),m=null);(c.add||c.edit||c.del||c.view)&&a("tr",u).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");c.search&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),h=h||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.searchicon+"'></span>"+c.searchtext+"</div>"),a("tr",u).append(m),a(m,u).attr({title:c.searchtitle||"",id:h.id||"search_"+t}).click(function(){a(this).hasClass("ui-state-disabled")||
(a.isFunction(c.searchfunc)?c.searchfunc.call(p,h):a(p).jqGrid("searchGrid",h));return!1}).hover(n,s),h.showOnLoad&&!0===h.showOnLoad&&a(m,u).click(),m=null);c.refresh&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+c.refreshicon+"'></span>"+c.refreshtext+"</div>"),a("tr",u).append(m),a(m,u).attr({title:c.refreshtitle||"",id:"refresh_"+t}).click(function(){if(!a(this).hasClass("ui-state-disabled")){a.isFunction(c.beforeRefresh)&&c.beforeRefresh.call(p);
p.p.search=!1;p.p.resetsearch=!0;try{if("currentfilter"!==c.refreshstate){var b=p.p.id;p.p.postData.filters="";try{a("#fbox_"+a.jgrid.jqID(b)).jqFilter("resetFilter")}catch(d){}a.isFunction(p.clearToolbar)&&p.clearToolbar.call(p,!1)}}catch(e){}switch(c.refreshstate){case "firstpage":a(p).trigger("reloadGrid",[{page:1}]);break;case "current":case "currentfilter":a(p).trigger("reloadGrid",[{current:!0}])}a.isFunction(c.afterRefresh)&&c.afterRefresh.call(p)}return!1}).hover(n,s),m=null);m=a(".ui-jqgrid").css("font-size")||
"11px";a("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+m+";visibility:hidden;' ></div>");m=a(u).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(y+"_"+c.position,y).append(u);p.p._nvtd&&(m>p.p._nvtd[0]&&(a(y+"_"+c.position,y).width(m),p.p._nvtd[0]=m),p.p._nvtd[1]=m);u=m=m=null;this.nav=!0}}}})},navButtonAdd:function(b,c){c=a.extend({caption:"newButton",title:"",buttonicon:"ui-icon-newwin",onClickButton:null,position:"last",cursor:"pointer"},
...
(function(a){a.jgrid.extend({groupingSetup:function(){return this.each(function(){var b,e,c=this.p.colModel,f=this.p.groupingView;if(null===f||"object"!==typeof f&&!a.isFunction(f))this.p.grouping=!1;else if(f.groupField.length){void 0===f.visibiltyOnNextGrouping&&(f.visibiltyOnNextGrouping=[]);f.lastvalues=[];f._locgr||(f.groups=[]);f.counters=[];for(b=0;b<f.groupField.length;b++)f.groupOrder[b]||(f.groupOrder[b]="asc"),f.groupText[b]||(f.groupText[b]="{0}"),"boolean"!==typeof f.groupColumnShow[b]&&
...
d=a("#"+a.jgrid.jqID(b)),d=d.length?d[0].nextSibling:null,h=a("#"+a.jgrid.jqID(b)+" span.tree-wrap-"+this.p.direction),k=function(b){b=a.map(b.split(" "),function(a){if(a.substring(0,g.length+1)===g+"_")return parseInt(a.substring(g.length+1),10)});return 0<b.length?b[0]:void 0},l,p,m=!1,r=this.p.frozenColumns?this.p.id+"_frozen":!1,q=(l=r?a("#"+a.jgrid.jqID(b),"#"+a.jgrid.jqID(r)):!1)&&l.length?l[0].nextSibling:null;if(h.hasClass(c)){if(d)for(;d;){l=k(d.className);if(void 0!==l&&l<=f)break;a(d).hide();
d=d.nextSibling;r&&(a(q).hide(),q=q.nextSibling)}h.removeClass(c).addClass(e);m=!0}else{if(d)for(p=void 0;d;){l=k(d.className);void 0===p&&(p=void 0===l);if(void 0!==l){if(l<=f)break;l===f+1&&(a(d).show().find(">td>span.tree-wrap-"+this.p.direction).removeClass(c).addClass(e),r&&a(q).show().find(">td>span.tree-wrap-"+this.p.direction).removeClass(c).addClass(e))}else p&&(a(d).show(),r&&a(q).show());d=d.nextSibling;r&&(q=q.nextSibling)}h.removeClass(e).addClass(c)}a(this).triggerHandler("jqGridGroupingClickGroup",
[b,m]);a.isFunction(this.p.onClickGroup)&&this.p.onClickGroup.call(this,b,m)});return!1},groupingRender:function(b,e,c,f){return this.each(function(){function g(a,b,c){var d=!1;if(0===b)d=c[a];else{var e=c[a].idx;if(0===e)d=c[a];else for(;0<=a;a--)if(c[a].idx===e-b){d=c[a];break}}return d}function d(b,c,d,f){var k=g(b,c,d),l=h.p.colModel,n,m=k.cnt;b="";var p;for(p=f;p<e;p++){var q="<td "+h.formatCol(p,1,"")+">&#160;</td>",r="{0}";a.each(k.summary,function(){if(this.nm===l[p].name){l[p].summaryTpl&&
(r=l[p].summaryTpl);"string"===typeof this.st&&"avg"===this.st.toLowerCase()&&(this.sd&&this.vd?this.v/=this.vd:this.v&&0<m&&(this.v/=m));try{this.groupCount=k.cnt,this.groupIndex=k.dataIndex,this.groupValue=k.value,n=h.formatter("",this.v,p,this)}catch(b){n=this.v}q="<td "+h.formatCol(p,1,"")+">"+a.jgrid.template(r,n)+"</td>";return!1}});b+=q}return b}var h=this,k=h.p.groupingView,l="",p="",m,r,q=k.groupCollapse?k.plusicon:k.minusicon,n,s=[],u=k.groupField.length,q=q+(" tree-wrap-"+h.p.direction);
a.each(h.p.colModel,function(a,b){var c;for(c=0;c<u;c++)if(k.groupField[c]===b.name){s[c]=a;break}});var y=0,t=a.makeArray(k.groupSummary),x;t.reverse();x=h.p.multiselect?' colspan="2"':"";a.each(k.groups,function(g,w){if(k._locgr&&!(w.startRow+w.cnt>(c-1)*f&&w.startRow<c*f))return!0;y++;r=h.p.id+"ghead_"+w.idx;m=r+"_"+g;p="<span style='cursor:pointer;' class='ui-icon "+q+"' onclick=\"jQuery('#"+a.jgrid.jqID(h.p.id)+"').jqGrid('groupingToggle','"+m+"');return false;\"></span>";try{a.isArray(k.formatDisplayField)&&
a.isFunction(k.formatDisplayField[w.idx])?(w.displayValue=k.formatDisplayField[w.idx].call(h,w.displayValue,w.value,h.p.colModel[s[w.idx]],w.idx,k),n=w.displayValue):n=h.formatter(m,w.displayValue,s[w.idx],w.value)}catch(z){n=w.displayValue}var v="",v=a.isFunction(k.groupText[w.idx])?k.groupText[w.idx].call(h,n,w.cnt,w.summary):a.jgrid.template(k.groupText[w.idx],n,w.cnt,w.summary);"string"!==typeof v&&"number"!==typeof v&&(v=n);"header"===k.groupSummaryPos[w.idx]?(l+='<tr id="'+m+'"'+(k.groupCollapse&&
0<w.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+h.p.direction+" "+r+'"><td style="padding-left:'+12*w.idx+'px;"'+x+">"+p+v+"</td>",l+=d(g,0,k.groups,!1===k.groupColumnShow[w.idx]?""===x?2:3:""===x?1:2),l+="</tr>"):l+='<tr id="'+m+'"'+(k.groupCollapse&&0<w.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+h.p.direction+" "+r+'"><td style="padding-left:'+12*w.idx+'px;" colspan="'+(!1===k.groupColumnShow[w.idx]?e-1:
e)+'">'+p+v+"</td></tr>";if(u-1===w.idx){var v=k.groups[g+1],D,C=0;D=w.startRow;var B=void 0!==v?v.startRow:k.groups[g].startRow+k.groups[g].cnt;k._locgr&&(C=(c-1)*f,C>w.startRow&&(D=C));for(;D<B&&b[D-C];D++)l+=b[D-C].join("");if("header"!==k.groupSummaryPos[w.idx]){var G;if(void 0!==v){for(G=0;G<k.groupField.length&&v.dataIndex!==k.groupField[G];G++);y=k.groupField.length-G}for(v=0;v<y;v++)t[v]&&(C="",k.groupCollapse&&!k.showSummaryOnHide&&(C=' style="display:none;"'),l+="<tr"+C+' jqfootlevel="'+
(w.idx-v)+'" role="row" class="ui-widget-content jqfoot ui-row-'+h.p.direction+'">',l+=d(g,v,k.groups,0),l+="</tr>");y=G}}});a("#"+a.jgrid.jqID(h.p.id)+" tbody:first").append(l);l=null})},groupingGroupBy:function(b,e){return this.each(function(){"string"===typeof b&&(b=[b]);var c=this.p.groupingView;this.p.grouping=!0;c._locgr=!1;void 0===c.visibiltyOnNextGrouping&&(c.visibiltyOnNextGrouping=[]);var f;for(f=0;f<c.groupField.length;f++)!c.groupColumnShow[f]&&c.visibiltyOnNextGrouping[f]&&a(this).jqGrid("showCol",
c.groupField[f]);for(f=0;f<b.length;f++)c.visibiltyOnNextGrouping[f]=a("#"+a.jgrid.jqID(this.p.id)+"_"+a.jgrid.jqID(b[f])).is(":visible");this.p.groupingView=a.extend(this.p.groupingView,e||{});c.groupField=b;a(this).trigger("reloadGrid")})},groupingRemove:function(b){return this.each(function(){void 0===b&&(b=!0);this.p.grouping=!1;if(!0===b){var e=this.p.groupingView,c;for(c=0;c<e.groupField.length;c++)!e.groupColumnShow[c]&&e.visibiltyOnNextGrouping[c]&&a(this).jqGrid("showCol",e.groupField);a("tr.jqgroup, tr.jqfoot",
"#"+a.jgrid.jqID(this.p.id)+" tbody:first").remove();a("tr.jqgrow:hidden","#"+a.jgrid.jqID(this.p.id)+" tbody:first").show()}else a(this).trigger("reloadGrid")})},groupingCalculations:{handler:function(a,e,c,f,g,d){var h={sum:function(){return parseFloat(e||0)+parseFloat(d[c]||0)},min:function(){return""===e?parseFloat(d[c]||0):Math.min(parseFloat(e),parseFloat(d[c]||0))},max:function(){return""===e?parseFloat(d[c]||0):Math.max(parseFloat(e),parseFloat(d[c]||0))},count:function(){""===e&&(e=0);return d.hasOwnProperty(c)?
e+1:0},avg:function(){return h.sum()}};if(!h[a])throw"jqGrid Grouping No such method: "+a;a=h[a]();null!=f&&("fixed"===g?a=a.toFixed(f):(f=Math.pow(10,f),a=Math.round(a*f)/f));return a}}})})(jQuery);
...
d===c.p.ExpandColumn;if(l)e=a("span:first",this).html();else try{e=a.unformat.call(c,this,{rowId:b,colModel:m[f]},f)}catch(p){e=m[f].edittype&&"textarea"===m[f].edittype?a(this).text():a(this).html()}if("cb"!==d&&"subgrid"!==d&&"rn"!==d&&(c.p.autoencode&&(e=a.jgrid.htmlDecode(e)),k[d]=e,!0===m[f].editable)){null===h&&(h=f);l?a("span:first",this).html(""):a(this).html("");var s=a.extend({},m[f].editoptions||{},{id:b+"_"+d,name:d,rowId:b});m[f].edittype||(m[f].edittype="text");if("&nbsp;"===e||"&#160;"===
e||1===e.length&&160===e.charCodeAt(0))e="";var x=a.jgrid.createEl.call(c,m[f].edittype,s,e,!0,a.extend({},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||{}));a(x).addClass("editable");l?a("span:first",this).append(x):a(this).append(x);a.jgrid.bindEv.call(c,x,s);"select"===m[f].edittype&&void 0!==m[f].editoptions&&!0===m[f].editoptions.multiple&&void 0===m[f].editoptions.dataUrl&&a.jgrid.msie&&a(x).width(a(x).width());g++}}),0<g&&(k.id=b,c.p.savedRow.push(k),a(l).attr("editable","1"),p.focusField&&("number"===
...
afterrestorefunc:null,restoreAfterError:!0,mtype:"POST",saveui:"enable",savetext:a.jgrid.defaults.savetext||"Saving..."},a.jgrid.inlineEdit,l),p=!1,m=this[0],r,q={},n={},s={},u,y,t,x=!1;if(!m.grid)return p;t=a(m).jqGrid("getInd",b,!0);if(!1===t)return p;k=a.isFunction(l.beforeSaveRow)?l.beforeSaveRow.call(m,l,b):void 0;void 0===k&&(k=!0);if(k){k=a(t).attr("editable");l.url=l.url||m.p.editurl;if("1"===k){var A;a('td[role="gridcell"]',t).each(function(b){A=m.p.colModel[b];r=A.name;if("cb"!==r&&"subgrid"!==
r&&!0===A.editable&&"rn"!==r&&!a(this).hasClass("not-editable-cell")){switch(A.edittype){case "checkbox":var c=["Yes","No"];A.editoptions&&(c=A.editoptions.value.split(":"));q[r]=a("input",this).is(":checked")?c[0]:c[1];break;case "text":case "password":case "textarea":case "button":q[r]=a("input, textarea",this).val();break;case "select":if(A.editoptions.multiple){var c=a("select",this),d=[];q[r]=a(c).val();q[r]=q[r]?q[r].join(","):"";a("select option:selected",this).each(function(b,c){d[b]=a(c).text()});
n[r]=d.join(",")}else q[r]=a("select option:selected",this).val(),n[r]=a("select option:selected",this).text();A.formatter&&"select"===A.formatter&&(n={});break;case "custom":try{if(A.editoptions&&a.isFunction(A.editoptions.custom_value)){if(q[r]=A.editoptions.custom_value.call(m,a(".customelement",this),"get"),void 0===q[r])throw"e2";}else throw"e1";}catch(e){"e1"===e&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===e?a.jgrid.info_dialog(a.jgrid.errors.errcap,
"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}y=a.jgrid.checkValues.call(m,q[r],b);if(!1===y[0])return!1;m.p.autoencode&&(q[r]=a.jgrid.htmlEncode(q[r]));"clientArray"!==l.url&&A.editoptions&&!0===A.editoptions.NullIfEmpty&&""===q[r]&&(s[r]="null",x=!0)}});if(!1===y[0]){try{var w=a(m).jqGrid("getGridRowById",b),z=a.jgrid.findPos(w);a.jgrid.info_dialog(a.jgrid.errors.errcap,y[1],a.jgrid.edit.bClose,
{left:z[0],top:z[1]+a(w).outerHeight()})}catch(v){alert(y[1])}return p}k=m.p.prmNames;w=b;z=!1===m.p.keyName?k.id:m.p.keyName;q&&(q[k.oper]=k.editoper,void 0===q[z]||""===q[z]?q[z]=b:t.id!==m.p.idPrefix+q[z]&&(k=a.jgrid.stripPref(m.p.idPrefix,b),void 0!==m.p._index[k]&&(m.p._index[q[z]]=m.p._index[k],delete m.p._index[k]),b=m.p.idPrefix+q[z],a(t).attr("id",b),m.p.selrow===w&&(m.p.selrow=b),a.isArray(m.p.selarrrow)&&(k=a.inArray(w,m.p.selarrrow),0<=k&&(m.p.selarrrow[k]=b)),m.p.multiselect&&(k="jqg_"+
m.p.id+"_"+b,a("input.cbox",t).attr("id",k).attr("name",k))),void 0===m.p.inlineData&&(m.p.inlineData={}),q=a.extend({},q,m.p.inlineData,l.extraparam));if("clientArray"===l.url){q=a.extend({},q,n);m.p.autoencode&&a.each(q,function(b,c){q[b]=a.jgrid.htmlDecode(c)});k=a(m).jqGrid("setRowData",b,q);a(t).attr("editable","0");for(z=0;z<m.p.savedRow.length;z++)if(String(m.p.savedRow[z].id)===String(w)){u=z;break}0<=u&&m.p.savedRow.splice(u,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[b,k,q,l]);a.isFunction(l.aftersavefunc)&&
l.aftersavefunc.call(m,b,k,q,l);p=!0;a(t).removeClass("jqgrid-new-row").unbind("keydown")}else a(m).jqGrid("progressBar",{method:"show",loadtype:l.saveui,htmlcontent:l.savetext}),s=a.extend({},q,s),s[z]=a.jgrid.stripPref(m.p.idPrefix,s[z]),a.ajax(a.extend({url:l.url,data:a.isFunction(m.p.serializeRowData)?m.p.serializeRowData.call(m,s):s,type:l.mtype,async:!1,complete:function(c,d){a(m).jqGrid("progressBar",{method:"hide",loadtype:l.saveui,htmlcontent:l.savetext});if("success"===d){var e=!0,f;f=a(m).triggerHandler("jqGridInlineSuccessSaveRow",
[c,b,l]);a.isArray(f)||(f=[!0,s]);f[0]&&a.isFunction(l.successfunc)&&(f=l.successfunc.call(m,c));a.isArray(f)?(e=f[0],q=f[1]||q):e=f;if(!0===e){m.p.autoencode&&a.each(q,function(b,c){q[b]=a.jgrid.htmlDecode(c)});x&&a.each(q,function(a,b){"null"===q[a]&&(q[a]="")});q=a.extend({},q,n);a(m).jqGrid("setRowData",b,q);a(t).attr("editable","0");for(e=0;e<m.p.savedRow.length;e++)if(String(m.p.savedRow[e].id)===String(b)){u=e;break}0<=u&&m.p.savedRow.splice(u,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",
[b,c,q,l]);a.isFunction(l.aftersavefunc)&&l.aftersavefunc.call(m,b,c,q,l);p=!0;a(t).removeClass("jqgrid-new-row").unbind("keydown")}else a(m).triggerHandler("jqGridInlineErrorSaveRow",[b,c,d,null,l]),a.isFunction(l.errorfunc)&&l.errorfunc.call(m,b,c,d,null),!0===l.restoreAfterError&&a(m).jqGrid("restoreRow",b,l.afterrestorefunc)}},error:function(c,d,e){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();a(m).triggerHandler("jqGridInlineErrorSaveRow",[b,c,d,e,l]);if(a.isFunction(l.errorfunc))l.errorfunc.call(m,
...
f);return this.each(function(){var c=this,d=-1,e,k={},l;if(c.grid&&(e=a(c).jqGrid("getInd",b,!0),!1!==e&&(l=a.isFunction(f.beforeCancelRow)?f.beforeCancelRow.call(c,f,b):void 0,void 0===l&&(l=!0),l))){for(l=0;l<c.p.savedRow.length;l++)if(String(c.p.savedRow[l].id)===String(b)){d=l;break}if(0<=d){if(a.isFunction(a.fn.datepicker))try{a("input.hasDatepicker","#"+a.jgrid.jqID(e.id)).datepicker("hide")}catch(p){}a.each(c.p.colModel,function(){!0===this.editable&&c.p.savedRow[d].hasOwnProperty(this.name)&&
(k[this.name]=c.p.savedRow[d][this.name])});a(c).jqGrid("setRowData",b,k);a(e).attr("editable","0").unbind("keydown");c.p.savedRow.splice(d,1);a("#"+a.jgrid.jqID(b),"#"+a.jgrid.jqID(c.p.id)).hasClass("jqgrid-new-row")&&setTimeout(function(){a(c).jqGrid("delRowData",b);a(c).jqGrid("showAddEditButtons")},0)}a(c).triggerHandler("jqGridInlineAfterRestoreRow",[b]);a.isFunction(f.afterrestorefunc)&&f.afterrestorefunc.call(c,b)}})},addRow:function(b){b=a.extend(!0,{rowID:null,initdata:{},position:"first",
useDefValues:!0,useFormatter:!1,addRowParams:{extraparam:{}}},b||{});return this.each(function(){if(this.grid){var e=this,c=a.isFunction(b.beforeAddRow)?b.beforeAddRow.call(e,b.addRowParams):void 0;void 0===c&&(c=!0);c&&(b.rowID=a.isFunction(b.rowID)?b.rowID.call(e,b):null!=b.rowID?b.rowID:a.jgrid.randId(),!0===b.useDefValues&&a(e.p.colModel).each(function(){if(this.editoptions&&this.editoptions.defaultValue){var c=this.editoptions.defaultValue,c=a.isFunction(c)?c.call(e):c;b.initdata[this.name]=
c}}),a(e).jqGrid("addRowData",b.rowID,b.initdata,b.position),b.rowID=e.p.idPrefix+b.rowID,a("#"+a.jgrid.jqID(b.rowID),"#"+a.jgrid.jqID(e.p.id)).addClass("jqgrid-new-row"),b.useFormatter?a("#"+a.jgrid.jqID(b.rowID)+" .ui-inline-edit","#"+a.jgrid.jqID(e.p.id)).click():(c=e.p.prmNames,b.addRowParams.extraparam[c.oper]=c.addoper,a(e).jqGrid("editRow",b.rowID,b.addRowParams),a(e).jqGrid("setSelection",b.rowID)))}})},inlineNav:function(b,e){e=a.extend(!0,{edit:!0,editicon:"ui-icon-pencil",add:!0,addicon:"ui-icon-plus",
...
extraparam:{},url:null},d[h].formatoptions),e.addParams.addRowParams={keys:d.keys,oneditfunc:d.onEdit,successfunc:d.onSuccess,url:d.url,extraparam:d.extraparam,aftersavefunc:d.afterSave,errorfunc:d.onError,afterrestorefunc:d.afterRestore});break}}e.add&&a(c).jqGrid("navButtonAdd",b,{caption:e.addtext,title:e.addtitle,buttonicon:e.addicon,id:c.p.id+"_iladd",onClickButton:function(){a(c).jqGrid("addRow",e.addParams);e.addParams.useFormatter||(a("#"+g+"_ilsave").removeClass("ui-state-disabled"),a("#"+
g+"_ilcancel").removeClass("ui-state-disabled"),a("#"+g+"_iladd").addClass("ui-state-disabled"),a("#"+g+"_iledit").addClass("ui-state-disabled"))}});e.edit&&a(c).jqGrid("navButtonAdd",b,{caption:e.edittext,title:e.edittitle,buttonicon:e.editicon,id:c.p.id+"_iledit",onClickButton:function(){var b=a(c).jqGrid("getGridParam","selrow");b?(a(c).jqGrid("editRow",b,e.editParams),a("#"+g+"_ilsave").removeClass("ui-state-disabled"),a("#"+g+"_ilcancel").removeClass("ui-state-disabled"),a("#"+g+"_iladd").addClass("ui-state-disabled"),
a("#"+g+"_iledit").addClass("ui-state-disabled")):(a.jgrid.viewModal("#alertmod",{gbox:"#gbox_"+g,jqm:!0}),a("#jqg_alrt").focus())}});e.save&&(a(c).jqGrid("navButtonAdd",b,{caption:e.savetext||"",title:e.savetitle||"Save row",buttonicon:e.saveicon,id:c.p.id+"_ilsave",onClickButton:function(){var b=c.p.savedRow[0].id;if(b){var d=c.p.prmNames,f=d.oper,h=e.editParams;a("#"+a.jgrid.jqID(b),"#"+g).hasClass("jqgrid-new-row")?(e.addParams.addRowParams.extraparam[f]=d.addoper,h=e.addParams.addRowParams):
...
1+(parseInt(c.p.page,10)-1)*parseInt(c.p.rowNum,10))});b._update_&&b._update_.apply(this,[f,g])},a("tbody:first",c).sortable(b),a("tbody:first > .jqgrow",c).disableSelection())})},gridDnD:function(b){return this.each(function(){function c(){var b=a.data(f,"dnd");a("tr.jqgrow:not(.ui-draggable)",f).draggable(a.isFunction(b.drag)?b.drag.call(a(f),b):b.drag)}var f=this,g,d;if(f.grid&&!f.p.treeGrid&&a.fn.draggable&&a.fn.droppable)if(void 0===a("#jqgrid_dnd")[0]&&a("body").append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>"),
...
b=a(b).closest("table.ui-jqgrid-btable");return 0<b.length&&void 0!==a.data(b[0],"dnd")?(b=a.data(b[0],"dnd").connectWith,-1!==a.inArray("#"+a.jgrid.jqID(this.id),b)?!0:!1):!1},drop:function(c,d){if(a(d.draggable).hasClass("jqgrow")){var e=a(d.draggable).attr("id"),e=d.draggable.parent().parent().jqGrid("getRowData",e);if(!b.dropbyname){var g=0,r={},q,n,s=a("#"+a.jgrid.jqID(this.id)).jqGrid("getGridParam","colModel");try{for(n in e)e.hasOwnProperty(n)&&(q=s[g].name,"cb"!==q&&"rn"!==q&&"subgrid"!==
q&&e.hasOwnProperty(n)&&s[g]&&(r[q]=e[n]),g++);e=r}catch(u){}}d.helper.dropped=!0;b.beforedrop&&a.isFunction(b.beforedrop)&&(q=b.beforedrop.call(this,c,d,e,a("#"+a.jgrid.jqID(f.p.id)),a(this)),void 0!==q&&null!==q&&"object"===typeof q&&(e=q));if(d.helper.dropped){var y;b.autoid&&(a.isFunction(b.autoid)?y=b.autoid.call(this,e):(y=Math.ceil(1E3*Math.random()),y=b.autoidprefix+y));a("#"+a.jgrid.jqID(this.id)).jqGrid("addRowData",y,e,b.droppos)}b.ondrop&&a.isFunction(b.ondrop)&&b.ondrop.call(this,c,d,
...
colTotals:!1,groupSummary:!0,groupSummaryPos:"header",frozenStaticCols:!1},c||{});this.each(function(){function c(a,d,e){a=b.call(a,d,e);return 0<a.length?a[0]:null}function q(a,b){var c=0,d=!0,e;for(e in a){if(a[e]!=this[c]){d=!1;break}c++;if(c>=this.length)break}d&&(y=b);return d}function n(b,c,d,e){var f=c.length,g,l,m,n,p="",q=[];a.isArray(d)?(n=d.length,q=d):(n=1,q[0]=d);h=[];k=[];for(m=h.root=0;m<n;m++){var r=[],s;for(g=0;g<f;g++){if(null==d)s=l=a.trim(c[g].member)+"_"+c[g].aggregator,q[0]=
s;else{s=d[m].replace(/\s+/g,"");try{l=1===f?p+s:p+s+"_"+c[g].aggregator+"_"+String(g)}catch(t){}}var u=l=isNaN(parseInt(l,10))?l:l+" ",w=r,v=l,x=e[l],y=c[g].member,z=b,A=void 0;switch(c[g].aggregator){case "sum":A=parseFloat(x||0)+parseFloat(z[y]||0);break;case "count":if(""===x||null==x)x=0;A=z.hasOwnProperty(y)?x+1:0;break;case "min":A=""===x||null==x?parseFloat(z[y]||0):Math.min(parseFloat(x),parseFloat(z[y]||0));break;case "max":A=""===x||null==x?parseFloat(z[y]||0):Math.max(parseFloat(x),parseFloat(z[y]||
0))}e[u]=w[v]=A;1>=m&&"_r_Totals"!==s&&""===p&&(p=s)}h[l]=r;k[l]=q[m]}return e}function s(a){var b,c,d,e,g;for(d in a)if(a.hasOwnProperty(d)){if("object"!==typeof a[d]){if("level"===d){void 0===Q[a.level]&&(Q[a.level]="",0<a.level&&"_r_Totals"!==a.text&&(p[a.level-1]={useColSpanStyle:!1,groupHeaders:[]}));if(Q[a.level]!==a.text&&a.children.length&&"_r_Totals"!==a.text&&0<a.level){p[a.level-1].groupHeaders.push({titleText:a.label,numberOfColumns:0});c=p[a.level-1].groupHeaders.length-1;g=0===c?ca:
X+z;if(a.level-1===(m.rowTotals?1:0)&&0<c){var h=p[a.level-1].groupHeaders[c-1].numberOfColumns;h&&(g=h+1+m.aggregates.length)}p[a.level-1].groupHeaders[c].startColumnName=f[g].name;p[a.level-1].groupHeaders[c].numberOfColumns=f.length-g;X=f.length}Q[a.level]=a.text}if(a.level===w&&"level"===d&&0<w)if(1<z){c=1;for(b in a.fields)1===c&&p[w-1].groupHeaders.push({startColumnName:b,numberOfColumns:1,titleText:a.text}),c++;p[w-1].groupHeaders[p[w-1].groupHeaders.length-1].numberOfColumns=c-1}else p.splice(w-
1,1)}null!=a[d]&&"object"===typeof a[d]&&s(a[d]);if("level"===d&&0<a.level)for(b in c=0,a.fields)if(a.fields.hasOwnProperty(b)){g={};for(e in m.aggregates[c])if(m.aggregates[c].hasOwnProperty(e))switch(e){case "member":case "label":case "aggregator":break;default:g[e]=m.aggregates[c][e]}1<z?(g.name=b,g.label=m.aggregates[c].label||a.label):(g.name=a.text,g.label="_r_Totals"===a.text?m.rowTotalsText:a.label);f.push(g);c++}}}var u,y,t,x=e.length,A,w,z,v,D=0;m.rowTotals&&0<m.yDimension.length&&(m.yDimension.splice(0,
0,{dataName:m.yDimension[0].dataName}),m.yDimension[0].converter=function(){return"_r_Totals"});A=a.isArray(m.xDimension)?m.xDimension.length:0;w=m.yDimension.length;z=a.isArray(m.aggregates)?m.aggregates.length:0;if(0===A||0===z)throw"xDimension or aggregates optiona are not set!";var C;for(t=0;t<A;t++)C={name:m.xDimension[t].dataName,frozen:m.frozenStaticCols},null==m.xDimension[t].isGroupField&&(m.xDimension[t].isGroupField=!0),C=a.extend(!0,C,m.xDimension[t]),f.push(C);C=A-1;for(var B={};D<x;){u=
e[D];var G=[],H=[];v={};t=0;do G[t]=a.trim(u[m.xDimension[t].dataName]),v[m.xDimension[t].dataName]=G[t],t++;while(t<A);var F=0;y=-1;t=c(g,q,G);if(!t){F=0;if(1<=w){for(F=0;F<w;F++)H[F]=a.trim(u[m.yDimension[F].dataName]),m.yDimension[F].converter&&a.isFunction(m.yDimension[F].converter)&&(H[F]=m.yDimension[F].converter.call(this,H[F],G,H));v=n(u,m.aggregates,H,v)}else 0===w&&(v=n(u,m.aggregates,null,v));g.push(v)}else if(0<=y){F=0;if(1<=w){for(F=0;F<w;F++)H[F]=a.trim(u[m.yDimension[F].dataName]),
m.yDimension[F].converter&&a.isFunction(m.yDimension[F].converter)&&(H[F]=m.yDimension[F].converter.call(this,H[F],G,H));t=n(u,m.aggregates,H,t)}else 0===w&&(t=n(u,m.aggregates,null,t));g[y]=t}u=0;var G=v=null,L;for(L in h)if(h.hasOwnProperty(L)){if(0===u)B.children&&void 0!==B.children||(B={text:L,level:0,children:[],label:L}),v=B.children;else{G=null;for(t=0;t<v.length;t++)if(v[t].text===L){G=v[t];break}G?v=G.children:(v.push({children:[],text:L,level:u,fields:h[L],label:k[L]}),v=v[v.length-1].children)}u++}D++}var Q=
[],X=f.length,ca=X;0<w&&(p[w-1]={useColSpanStyle:!1,groupHeaders:[]});s(B);if(m.colTotals)for(D=g.length;D--;)for(t=A;t<f.length;t++)x=f[t].name,d[x]=d[x]?d[x]+parseFloat(g[D][x]||0):parseFloat(g[D][x]||0);if(0<C)for(t=0;t<C;t++)f[t].isGroupField&&(l.groupingView.groupField.push(f[t].name),l.groupingView.groupSummary.push(m.groupSummary),l.groupingView.groupSummaryPos.push(m.groupSummaryPos));else l.grouping=!1;l.sortname=f[C].name;l.groupingView.hideFirstGroupCol=!0});return{colModel:f,rows:g,groupOptions:l,
...
url:a.isFunction(c.p.subGridUrl)?c.p.subGridUrl.call(c,f):c.p.subGridUrl,dataType:c.p.subgridtype,data:a.isFunction(c.p.serializeSubGridData)?c.p.serializeSubGridData.call(c,f):f,complete:function(b){"xml"===c.p.subgridtype?g(b.responseXML,e):d(a.jgrid.parse(b.responseText),e)}},a.jgrid.ajaxOptions,c.p.ajaxSubgridOptions||{}))}return!1},k,l,p,m=0,r,q;a.each(c.p.colModel,function(){!0!==this.hidden&&"rn"!==this.name&&"cb"!==this.name||m++});var n=c.rows.length,s=1;void 0!==e&&0<e&&(s=e,n=e+1);for(;s<
n;)a(c.rows[s]).hasClass("jqgrow")&&(c.p.scroll&&a(c.rows[s].cells[b]).unbind("click"),a(c.rows[s].cells[b]).bind("click",function(){var d=a(this).parent("tr")[0];q=d.nextSibling;if(a(this).hasClass("sgcollapsed")){l=c.p.id;k=d.id;r=a(c).triggerHandler("jqGridSubGridBeforeExpand",[l+"_"+k,k]);(r=!1===r||"stop"===r?!1:!0)&&a.isFunction(c.p.subGridBeforeExpand)&&(r=c.p.subGridBeforeExpand.call(c,l+"_"+k,k));if(!1===r)return!1;!0===c.p.subGridOptions.reloadOnExpand||!1===c.p.subGridOptions.reloadOnExpand&&
!a(q).hasClass("ui-subgrid")?(p=1<=b?"<td colspan='"+b+"'>&#160;</td>":"",a(d).after("<tr role='row' class='ui-subgrid'>"+p+"<td class='ui-widget-content subgrid-cell'><span class='ui-icon "+c.p.subGridOptions.openicon+"'></span></td><td colspan='"+parseInt(c.p.colNames.length-1-m,10)+"' class='ui-widget-content subgrid-data'><div id="+l+"_"+k+" class='tablediv'></div></td></tr>"),a(c).triggerHandler("jqGridSubGridRowExpanded",[l+"_"+k,k]),a.isFunction(c.p.subGridRowExpanded)?c.p.subGridRowExpanded.call(c,
l+"_"+k,k):h(d)):a(q).show();a(this).html("<a style='cursor:pointer;'><span class='ui-icon "+c.p.subGridOptions.minusicon+"'></span></a>").removeClass("sgcollapsed").addClass("sgexpanded");c.p.subGridOptions.selectOnExpand&&a(c).jqGrid("setSelection",k)}else if(a(this).hasClass("sgexpanded")){r=a(c).triggerHandler("jqGridSubGridRowColapsed",[l+"_"+k,k]);r=!1===r||"stop"===r?!1:!0;k=d.id;r&&a.isFunction(c.p.subGridRowColapsed)&&(r=c.p.subGridRowColapsed.call(c,l+"_"+k,k));if(!1===r)return!1;!0===c.p.subGridOptions.reloadOnExpand?
a(q).remove(".ui-subgrid"):a(q).hasClass("ui-subgrid")&&a(q).hide();a(this).html("<a style='cursor:pointer;'><span class='ui-icon "+c.p.subGridOptions.plusicon+"'></span></a>").removeClass("sgexpanded").addClass("sgcollapsed");c.p.subGridOptions.selectOnCollapse&&a(c).jqGrid("setSelection",k)}return!1})),s++;!0===c.p.subGridOptions.expandOnLoad&&a(c.rows).filter(".jqgrow").each(function(b,c){a(c.cells[0]).click()});c.subGridXml=function(a,b){g(a,b)};c.subGridJson=function(a,b){d(a,b)}}})},expandSubGridRow:function(b){return this.each(function(){if((this.grid||
b)&&!0===this.p.subGrid){var e=a(this).jqGrid("getInd",b,!0);e&&(e=a("td.sgcollapsed",e)[0])&&a(e).trigger("click")}})},collapseSubGridRow:function(b){return this.each(function(){if((this.grid||b)&&!0===this.p.subGrid){var e=a(this).jqGrid("getInd",b,!0);e&&(e=a("td.sgexpanded",e)[0])&&a(e).trigger("click")}})},toggleSubGridRow:function(b){return this.each(function(){if((this.grid||b)&&!0===this.p.subGrid){var e=a(this).jqGrid("getInd",b,!0);if(e){var c=a("td.sgcollapsed",e)[0];c?a(c).trigger("click"):
(c=a("td.sgexpanded",e)[0])&&a(c).trigger("click")}}})}})})(jQuery);
...
if(e.length)for(k in e)e.hasOwnProperty(k)&&(e[k][g]=parseInt(e[k][g],10)-h)}}})},addChildNode:function(b,e,c,f){var g=this[0];if(c){var d=g.p.treeReader.expanded_field,h=g.p.treeReader.leaf_field,k=g.p.treeReader.level_field,l=g.p.treeReader.parent_id_field,p=g.p.treeReader.left_field,m=g.p.treeReader.right_field,r=g.p.treeReader.loaded,q,n,s,u,y;q=0;var t=e,x;void 0===f&&(f=!1);if(null==b){y=g.p.data.length-1;if(0<=y)for(;0<=y;)q=Math.max(q,parseInt(g.p.data[y][g.p.localReader.id],10)),y--;b=q+
1}var A=a(g).jqGrid("getInd",e);x=!1;void 0===e||null===e||""===e?(t=e=null,q="last",u=g.p.tree_root_level,y=g.p.data.length+1):(q="after",n=g.p._index[e],s=g.p.data[n],e=s[g.p.localReader.id],u=parseInt(s[k],10)+1,y=a(g).jqGrid("getFullTreeNode",s),y.length?(t=y=y[y.length-1][g.p.localReader.id],y=a(g).jqGrid("getInd",t)+1):y=a(g).jqGrid("getInd",e)+1,s[h]&&(x=!0,s[d]=!0,a(g.rows[A]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(g.p.treeIcons.leaf+
" tree-leaf").addClass(g.p.treeIcons.minus+" tree-minus"),g.p.data[n][h]=!1,s[r]=!0));n=y+1;void 0===c[d]&&(c[d]=!1);void 0===c[r]&&(c[r]=!1);c[k]=u;void 0===c[h]&&(c[h]=!0);"adjacency"===g.p.treeGridModel&&(c[l]=e);if("nested"===g.p.treeGridModel){var w;if(null!==e){h=parseInt(s[m],10);k=a.jgrid.from(g.p.data);k=k.greaterOrEquals(m,h,{stype:"integer"});k=k.select();if(k.length)for(w in k)k.hasOwnProperty(w)&&(k[w][p]=k[w][p]>h?parseInt(k[w][p],10)+2:k[w][p],k[w][m]=k[w][m]>=h?parseInt(k[w][m],10)+
2:k[w][m]);c[p]=h;c[m]=h+1}else{h=parseInt(a(g).jqGrid("getCol",m,!1,"max"),10);k=a.jgrid.from(g.p.data).greater(p,h,{stype:"integer"}).select();if(k.length)for(w in k)k.hasOwnProperty(w)&&(k[w][p]=parseInt(k[w][p],10)+2);k=a.jgrid.from(g.p.data).greater(m,h,{stype:"integer"}).select();if(k.length)for(w in k)k.hasOwnProperty(w)&&(k[w][m]=parseInt(k[w][m],10)+2);c[p]=h+1;c[m]=h+2}}if(null===e||a(g).jqGrid("isNodeLoaded",s)||x)a(g).jqGrid("addRowData",b,c,q,t),a(g).jqGrid("setTreeNode",y,n);s&&!s[d]&&
...
function(a){return k(this,a,"jqmShow")};a.fn.jqmShow=function(b){return this.each(function(){a.jqm.open(this._jqm,b)})};a.fn.jqmHide=function(b){return this.each(function(){a.jqm.close(this._jqm,b)})};a.jqm={hash:{},open:function(b,h){var k=e[b],r=k.c,q="."+r.closeClass,n=parseInt(k.w.css("z-index")),n=0<n?n:3E3,s=a("<div></div>").css({height:"100%",width:"100%",position:"fixed",left:0,top:0,"z-index":n-1,opacity:r.overlay/100});if(k.a)return f;k.t=h;k.a=!0;k.w.css("z-index",n);r.modal?(c[0]||setTimeout(function(){d("bind")},
1),c.push(b)):0<r.overlay?r.closeoverlay&&k.w.jqmAddClose(s):s=f;k.o=s?s.addClass(r.overlayClass).prependTo("body"):f;r.ajax?(n=r.target||k.w,s=r.ajax,n="string"==typeof n?a(n,k.w):a(n),s="@"==s.substr(0,1)?a(h).attr(s.substring(1)):s,n.html(r.ajaxText).load(s,function(){r.onLoad&&r.onLoad.call(this,k);q&&k.w.jqmAddClose(a(q,k.w));g(k)})):q&&k.w.jqmAddClose(a(q,k.w));r.toTop&&k.o&&k.w.before('<span id="jqmP'+k.w[0]._jqm+'"></span>').insertAfter(k.o);r.onShow?r.onShow(k):k.w.show();g(k);return f},

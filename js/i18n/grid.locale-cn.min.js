...
a.jgrid,{defaults:{locale:"cn"},locales:{cn:a.extend({},b,{name:"中文",nameEnglish:"Chinese"}),zh:a.extend({},b,{name:"中文",nameEnglish:"Chinese"}),"zh-CN":a.extend({},b,{name:"中文(中华人民共和国)",nameEnglish:"Chinese (Simplified, PRC)"})}})});
/*
